# Playbook — Event Storming and State Modeling

## Purpose

Discover business occurrences while avoiding the event-as-command anti-pattern.
...
1. Start from outcomes.
2. Identify states and invariants.
3. Separate commands, events, decisions, and timers.
4. Add actors and authority.
5. Test late and contradictory information.
