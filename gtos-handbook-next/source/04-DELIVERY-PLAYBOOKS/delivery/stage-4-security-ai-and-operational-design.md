# Stage 4 — Security, AI, and Operational Design

## Objective

Complete threat models, identity, policy, agent mandates, evidence controls, SLOs, runbooks, and recovery design.
...
- **STOP:** AI tool use bypasses policy.
- **STOP:** No decision-time evidence reconstruction.
- **STOP:** Recovery lacks reconciliation.
