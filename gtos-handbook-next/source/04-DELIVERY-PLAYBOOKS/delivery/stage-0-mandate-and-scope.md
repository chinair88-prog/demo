# Stage 0 — Mandate and Scope

## Objective

Establish the transformation mandate, sponsors, business boundaries, authority, expected outcomes, and funding model.
...
- **STOP:** No accountable sponsor.
- **STOP:** Scope defined as a technology replacement only.
- **STOP:** No measurable business baseline.
