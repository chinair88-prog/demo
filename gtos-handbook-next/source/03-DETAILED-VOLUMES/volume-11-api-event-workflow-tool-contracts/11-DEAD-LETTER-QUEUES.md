...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Dead Letter Queues**.
...
|---|---|
| `DeadLetterQueues` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeadLetterQueuesVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeadLetterQueuesDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeadLetterQueuesEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeadLetterQueuesException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateDeadLetterQueues`
- `ApproveDeadLetterQueues`
- `ActivateDeadLetterQueues`
- `SuspendDeadLetterQueues`
- `CorrectDeadLetterQueues`
- `RetireDeadLetterQueues`

Reference Events:

- `DeadLetterQueuesCreated`
- `DeadLetterQueuesValidated`
- `DeadLetterQueuesApproved`
- `DeadLetterQueuesActivated`
- `DeadLetterQueuesSuspended`
- `DeadLetterQueuesCorrected`
- `DeadLetterQueuesRetired`

Reference queries:

- `GetDeadLetterQueues`
- `ListDeadLetterQueuesRecords`
- `GetDeadLetterQueuesTimeline`
- `GetDeadLetterQueuesEvidence`
- `GetDeadLetterQueuesDecisionPackage`
- `GetDeadLetterQueuesExceptions`
- `GetDeadLetterQueuesAuditTrail`

Reference API surface:

```text
POST /api/v1/deadletterqueues/commands
GET  /api/v1/deadletterqueues/{id}
GET  /api/v1/deadletterqueues/{id}/timeline
GET  /api/v1/deadletterqueues/{id}/evidence
GET  /api/v1/deadletterqueues/{id}/decisions
POST /api/v1/deadletterqueues/{id}/exceptions
POST /api/v1/deadletterqueues/{id}/corrections
```
...
|---|---|
| `deadletterqueues_aggregate` | authoritative subject |
| `deadletterqueues_version` | immutable submitted, approved, issued, or signed versions |
| `deadletterqueues_relationship` | governed relationships |
| `deadletterqueues_decision` | binding Decisions and rationale |
| `deadletterqueues_evidence_link` | provenance and evidence relationships |
| `deadletterqueues_event_outbox` | transactional Event publication |
| `deadletterqueues_idempotency` | duplicate-write protection |
| `deadletterqueues_exception` | exception, claim, dispute, or hold |
| `deadletterqueues_correction` | correction and supersession lineage |
| `deadletterqueues_audit` | privileged action evidence |
