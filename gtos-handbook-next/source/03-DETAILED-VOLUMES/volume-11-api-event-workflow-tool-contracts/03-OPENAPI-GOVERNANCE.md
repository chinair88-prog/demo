...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for OpenAPI Governance**.
...
|---|---|
| `OpenAPIGovernance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OpenAPIGovernanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OpenAPIGovernanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OpenAPIGovernanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OpenAPIGovernanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateOpenAPIGovernance`
- `ValidateOpenAPIGovernance`
- `ApproveOpenAPIGovernance`
- `ActivateOpenAPIGovernance`
- `SuspendOpenAPIGovernance`
- `CorrectOpenAPIGovernance`
- `RetireOpenAPIGovernance`

Reference Events:

- `OpenAPIGovernanceCreated`
- `OpenAPIGovernanceValidated`
- `OpenAPIGovernanceApproved`
- `OpenAPIGovernanceActivated`
- `OpenAPIGovernanceSuspended`
- `OpenAPIGovernanceCorrected`
- `OpenAPIGovernanceRetired`

Reference queries:

- `GetOpenAPIGovernance`
- `ListOpenAPIGovernanceRecords`
- `GetOpenAPIGovernanceTimeline`
- `GetOpenAPIGovernanceEvidence`
- `GetOpenAPIGovernanceDecisionPackage`
- `GetOpenAPIGovernanceExceptions`
- `GetOpenAPIGovernanceAuditTrail`

Reference API surface:

```text
POST /api/v1/openapigovernance/commands
GET  /api/v1/openapigovernance/{id}
GET  /api/v1/openapigovernance/{id}/timeline
GET  /api/v1/openapigovernance/{id}/evidence
GET  /api/v1/openapigovernance/{id}/decisions
POST /api/v1/openapigovernance/{id}/exceptions
POST /api/v1/openapigovernance/{id}/corrections
```
...
|---|---|
| `openapigovernance_aggregate` | authoritative subject |
| `openapigovernance_version` | immutable submitted, approved, issued, or signed versions |
| `openapigovernance_relationship` | governed relationships |
| `openapigovernance_decision` | binding Decisions and rationale |
| `openapigovernance_evidence_link` | provenance and evidence relationships |
| `openapigovernance_event_outbox` | transactional Event publication |
| `openapigovernance_idempotency` | duplicate-write protection |
| `openapigovernance_exception` | exception, claim, dispute, or hold |
| `openapigovernance_correction` | correction and supersession lineage |
| `openapigovernance_audit` | privileged action evidence |
