...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Contract Testing**.
...
|---|---|
| `ContractTesting` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractTestingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractTestingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractTestingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractTestingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateContractTesting`
- `ApproveContractTesting`
- `ActivateContractTesting`
- `SuspendContractTesting`
- `CorrectContractTesting`
- `RetireContractTesting`

Reference Events:

- `ContractTestingCreated`
- `ContractTestingValidated`
- `ContractTestingApproved`
- `ContractTestingActivated`
- `ContractTestingSuspended`
- `ContractTestingCorrected`
- `ContractTestingRetired`

Reference queries:

- `GetContractTesting`
- `ListContractTestingRecords`
- `GetContractTestingTimeline`
- `GetContractTestingEvidence`
- `GetContractTestingDecisionPackage`
- `GetContractTestingExceptions`
- `GetContractTestingAuditTrail`

Reference API surface:

```text
POST /api/v1/contracttesting/commands
GET  /api/v1/contracttesting/{id}
GET  /api/v1/contracttesting/{id}/timeline
GET  /api/v1/contracttesting/{id}/evidence
GET  /api/v1/contracttesting/{id}/decisions
POST /api/v1/contracttesting/{id}/exceptions
POST /api/v1/contracttesting/{id}/corrections
```
...
|---|---|
| `contracttesting_aggregate` | authoritative subject |
| `contracttesting_version` | immutable submitted, approved, issued, or signed versions |
| `contracttesting_relationship` | governed relationships |
| `contracttesting_decision` | binding Decisions and rationale |
| `contracttesting_evidence_link` | provenance and evidence relationships |
| `contracttesting_event_outbox` | transactional Event publication |
| `contracttesting_idempotency` | duplicate-write protection |
| `contracttesting_exception` | exception, claim, dispute, or hold |
| `contracttesting_correction` | correction and supersession lineage |
| `contracttesting_audit` | privileged action evidence |
