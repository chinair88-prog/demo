# REST and BFF Standards

| Metadata | Value |
|---|---|
| Volume | `11` |
| Chapter ID | `V11-01` |
| Subject | `RESTandBFFStandards` |
...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for REST and BFF Standards**.
...
|---|---|
| `RESTandBFFStandards` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RESTandBFFStandardsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RESTandBFFStandardsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RESTandBFFStandardsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RESTandBFFStandardsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateRESTandBFFStandards`
- `ValidateRESTandBFFStandards`
- `ApproveRESTandBFFStandards`
- `ActivateRESTandBFFStandards`
- `SuspendRESTandBFFStandards`
- `CorrectRESTandBFFStandards`
- `RetireRESTandBFFStandards`

Reference Events:

- `RESTandBFFStandardsCreated`
- `RESTandBFFStandardsValidated`
- `RESTandBFFStandardsApproved`
- `RESTandBFFStandardsActivated`
- `RESTandBFFStandardsSuspended`
- `RESTandBFFStandardsCorrected`
- `RESTandBFFStandardsRetired`

Reference queries:

- `GetRESTandBFFStandards`
- `ListRESTandBFFStandardsRecords`
- `GetRESTandBFFStandardsTimeline`
- `GetRESTandBFFStandardsEvidence`
- `GetRESTandBFFStandardsDecisionPackage`
- `GetRESTandBFFStandardsExceptions`
- `GetRESTandBFFStandardsAuditTrail`

Reference API surface:

```text
POST /api/v1/restandbffstandards/commands
GET  /api/v1/restandbffstandards/{id}
GET  /api/v1/restandbffstandards/{id}/timeline
GET  /api/v1/restandbffstandards/{id}/evidence
GET  /api/v1/restandbffstandards/{id}/decisions
POST /api/v1/restandbffstandards/{id}/exceptions
POST /api/v1/restandbffstandards/{id}/corrections
```
...
|---|---|
| `restandbffstandards_aggregate` | authoritative subject |
| `restandbffstandards_version` | immutable submitted, approved, issued, or signed versions |
| `restandbffstandards_relationship` | governed relationships |
| `restandbffstandards_decision` | binding Decisions and rationale |
| `restandbffstandards_evidence_link` | provenance and evidence relationships |
| `restandbffstandards_event_outbox` | transactional Event publication |
| `restandbffstandards_idempotency` | duplicate-write protection |
| `restandbffstandards_exception` | exception, claim, dispute, or hold |
| `restandbffstandards_correction` | correction and supersession lineage |
| `restandbffstandards_audit` | privileged action evidence |
