...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Policy Contracts**.
...
|---|---|
| `PolicyContracts` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PolicyContractsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PolicyContractsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PolicyContractsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PolicyContractsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePolicyContracts`
- `ValidatePolicyContracts`
- `ApprovePolicyContracts`
- `ActivatePolicyContracts`
- `SuspendPolicyContracts`
- `CorrectPolicyContracts`
- `RetirePolicyContracts`

Reference Events:

- `PolicyContractsCreated`
- `PolicyContractsValidated`
- `PolicyContractsApproved`
- `PolicyContractsActivated`
- `PolicyContractsSuspended`
- `PolicyContractsCorrected`
- `PolicyContractsRetired`

Reference queries:

- `GetPolicyContracts`
- `ListPolicyContractsRecords`
- `GetPolicyContractsTimeline`
- `GetPolicyContractsEvidence`
- `GetPolicyContractsDecisionPackage`
- `GetPolicyContractsExceptions`
- `GetPolicyContractsAuditTrail`

Reference API surface:

```text
POST /api/v1/policycontracts/commands
GET  /api/v1/policycontracts/{id}
GET  /api/v1/policycontracts/{id}/timeline
GET  /api/v1/policycontracts/{id}/evidence
GET  /api/v1/policycontracts/{id}/decisions
POST /api/v1/policycontracts/{id}/exceptions
POST /api/v1/policycontracts/{id}/corrections
```
...
|---|---|
| `policycontracts_aggregate` | authoritative subject |
| `policycontracts_version` | immutable submitted, approved, issued, or signed versions |
| `policycontracts_relationship` | governed relationships |
| `policycontracts_decision` | binding Decisions and rationale |
| `policycontracts_evidence_link` | provenance and evidence relationships |
| `policycontracts_event_outbox` | transactional Event publication |
| `policycontracts_idempotency` | duplicate-write protection |
| `policycontracts_exception` | exception, claim, dispute, or hold |
| `policycontracts_correction` | correction and supersession lineage |
| `policycontracts_audit` | privileged action evidence |
