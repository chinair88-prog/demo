...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for AsyncAPI Governance**.
...
|---|---|
| `AsyncAPIGovernance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AsyncAPIGovernanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AsyncAPIGovernanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AsyncAPIGovernanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AsyncAPIGovernanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAsyncAPIGovernance`
- `ValidateAsyncAPIGovernance`
- `ApproveAsyncAPIGovernance`
- `ActivateAsyncAPIGovernance`
- `SuspendAsyncAPIGovernance`
- `CorrectAsyncAPIGovernance`
- `RetireAsyncAPIGovernance`

Reference Events:

- `AsyncAPIGovernanceCreated`
- `AsyncAPIGovernanceValidated`
- `AsyncAPIGovernanceApproved`
- `AsyncAPIGovernanceActivated`
- `AsyncAPIGovernanceSuspended`
- `AsyncAPIGovernanceCorrected`
- `AsyncAPIGovernanceRetired`

Reference queries:

- `GetAsyncAPIGovernance`
- `ListAsyncAPIGovernanceRecords`
- `GetAsyncAPIGovernanceTimeline`
- `GetAsyncAPIGovernanceEvidence`
- `GetAsyncAPIGovernanceDecisionPackage`
- `GetAsyncAPIGovernanceExceptions`
- `GetAsyncAPIGovernanceAuditTrail`

Reference API surface:

```text
POST /api/v1/asyncapigovernance/commands
GET  /api/v1/asyncapigovernance/{id}
GET  /api/v1/asyncapigovernance/{id}/timeline
GET  /api/v1/asyncapigovernance/{id}/evidence
GET  /api/v1/asyncapigovernance/{id}/decisions
POST /api/v1/asyncapigovernance/{id}/exceptions
POST /api/v1/asyncapigovernance/{id}/corrections
```
...
|---|---|
| `asyncapigovernance_aggregate` | authoritative subject |
| `asyncapigovernance_version` | immutable submitted, approved, issued, or signed versions |
| `asyncapigovernance_relationship` | governed relationships |
| `asyncapigovernance_decision` | binding Decisions and rationale |
| `asyncapigovernance_evidence_link` | provenance and evidence relationships |
| `asyncapigovernance_event_outbox` | transactional Event publication |
| `asyncapigovernance_idempotency` | duplicate-write protection |
| `asyncapigovernance_exception` | exception, claim, dispute, or hold |
| `asyncapigovernance_correction` | correction and supersession lineage |
| `asyncapigovernance_audit` | privileged action evidence |
