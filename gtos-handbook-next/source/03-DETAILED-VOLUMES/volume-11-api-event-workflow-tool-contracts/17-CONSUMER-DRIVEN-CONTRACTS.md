...
| Volume | `11` |
| Chapter ID | `V11-17` |
| Subject | `Consumer-DrivenContracts` |
...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Consumer-Driven Contracts**.
...
|---|---|
| `Consumer-DrivenContracts` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Consumer-DrivenContractsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Consumer-DrivenContractsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Consumer-DrivenContractsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Consumer-DrivenContractsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateConsumer-DrivenContracts`
- `ValidateConsumer-DrivenContracts`
- `ApproveConsumer-DrivenContracts`
- `ActivateConsumer-DrivenContracts`
- `SuspendConsumer-DrivenContracts`
- `CorrectConsumer-DrivenContracts`
- `RetireConsumer-DrivenContracts`

Reference Events:

- `Consumer-DrivenContractsCreated`
- `Consumer-DrivenContractsValidated`
- `Consumer-DrivenContractsApproved`
- `Consumer-DrivenContractsActivated`
- `Consumer-DrivenContractsSuspended`
- `Consumer-DrivenContractsCorrected`
- `Consumer-DrivenContractsRetired`

Reference queries:

- `GetConsumer-DrivenContracts`
- `ListConsumer-DrivenContractsRecords`
- `GetConsumer-DrivenContractsTimeline`
- `GetConsumer-DrivenContractsEvidence`
- `GetConsumer-DrivenContractsDecisionPackage`
- `GetConsumer-DrivenContractsExceptions`
- `GetConsumer-DrivenContractsAuditTrail`

Reference API surface:

```text
POST /api/v1/consumer_drivencontracts/commands
GET  /api/v1/consumer_drivencontracts/{id}
GET  /api/v1/consumer_drivencontracts/{id}/timeline
GET  /api/v1/consumer_drivencontracts/{id}/evidence
GET  /api/v1/consumer_drivencontracts/{id}/decisions
POST /api/v1/consumer_drivencontracts/{id}/exceptions
POST /api/v1/consumer_drivencontracts/{id}/corrections
```
...
|---|---|
| `consumer_drivencontracts_aggregate` | authoritative subject |
| `consumer_drivencontracts_version` | immutable submitted, approved, issued, or signed versions |
| `consumer_drivencontracts_relationship` | governed relationships |
| `consumer_drivencontracts_decision` | binding Decisions and rationale |
| `consumer_drivencontracts_evidence_link` | provenance and evidence relationships |
| `consumer_drivencontracts_event_outbox` | transactional Event publication |
| `consumer_drivencontracts_idempotency` | duplicate-write protection |
| `consumer_drivencontracts_exception` | exception, claim, dispute, or hold |
| `consumer_drivencontracts_correction` | correction and supersession lineage |
| `consumer_drivencontracts_audit` | privileged action evidence |
