...
|---|---|
| Volume | `11` |
| Chapter ID | `V11-SYNTH` |
| Subject | `ContractConformanceMatrix` |
...
This chapter defines how GTOS shall **trace every API, Event, workflow, webhook, policy contract and AI Tool to owner, schema, version, security, tests, consumers, deprecation and repository evidence**.
...
|---|---|
| `ContractConformanceMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractConformanceMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractConformanceMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractConformanceMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractConformanceMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ContractConformanceMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateContractConformanceMatrix`
- `ValidateContractConformanceMatrix`
- `ApproveContractConformanceMatrix`
- `ActivateContractConformanceMatrix`
- `SuspendContractConformanceMatrix`
- `CorrectContractConformanceMatrix`
- `RetireContractConformanceMatrix`

Reference Events:

- `ContractConformanceMatrixCreated`
- `ContractConformanceMatrixValidated`
- `ContractConformanceMatrixApproved`
- `ContractConformanceMatrixActivated`
- `ContractConformanceMatrixSuspended`
- `ContractConformanceMatrixCorrected`
- `ContractConformanceMatrixRetired`

Reference queries:

- `GetContractConformanceMatrix`
- `ListContractConformanceMatrixRecords`
- `GetContractConformanceMatrixTimeline`
- `GetContractConformanceMatrixEvidence`
- `GetContractConformanceMatrixDecisionPackage`
- `GetContractConformanceMatrixExceptions`
- `GetContractConformanceMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/contractconformancematrix/commands
GET  /api/v1/contractconformancematrix/{id}
GET  /api/v1/contractconformancematrix/{id}/timeline
GET  /api/v1/contractconformancematrix/{id}/evidence
GET  /api/v1/contractconformancematrix/{id}/decisions
POST /api/v1/contractconformancematrix/{id}/exceptions
POST /api/v1/contractconformancematrix/{id}/corrections
```
...
|---|---|
| `contractconformancematrix_aggregate` | authoritative subject |
| `contractconformancematrix_version` | immutable submitted, approved, issued, or signed versions |
| `contractconformancematrix_relationship` | governed relationships |
| `contractconformancematrix_decision` | binding Decisions and rationale |
| `contractconformancematrix_evidence_link` | provenance and evidence relationships |
| `contractconformancematrix_event_outbox` | transactional Event publication |
| `contractconformancematrix_idempotency` | duplicate-write protection |
| `contractconformancematrix_exception` | exception, claim, dispute, or hold |
| `contractconformancematrix_correction` | correction and supersession lineage |
| `contractconformancematrix_audit` | privileged action evidence |
