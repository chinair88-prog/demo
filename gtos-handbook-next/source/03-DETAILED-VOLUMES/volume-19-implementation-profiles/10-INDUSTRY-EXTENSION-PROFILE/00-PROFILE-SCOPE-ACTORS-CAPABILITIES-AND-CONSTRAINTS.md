# Industry Extension Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-10-00` |
| Subject | `IndustryExtensionProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Industry Extension Profile**.
...
|---|---|
| `IndustryExtensionProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IndustryExtensionProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IndustryExtensionProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IndustryExtensionProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IndustryExtensionProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
IndustryExtensionProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateIndustryExtensionProfile`
- `ValidateIndustryExtensionProfile`
- `ApproveIndustryExtensionProfile`
- `ActivateIndustryExtensionProfile`
- `SuspendIndustryExtensionProfile`
- `CorrectIndustryExtensionProfile`
- `RetireIndustryExtensionProfile`

Reference Events:

- `IndustryExtensionProfileCreated`
- `IndustryExtensionProfileValidated`
- `IndustryExtensionProfileApproved`
- `IndustryExtensionProfileActivated`
- `IndustryExtensionProfileSuspended`
- `IndustryExtensionProfileCorrected`
- `IndustryExtensionProfileRetired`

Reference queries:

- `GetIndustryExtensionProfile`
- `ListIndustryExtensionProfileRecords`
- `GetIndustryExtensionProfileTimeline`
- `GetIndustryExtensionProfileEvidence`
- `GetIndustryExtensionProfileDecisionPackage`
- `GetIndustryExtensionProfileExceptions`
- `GetIndustryExtensionProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/industryextensionprofile/commands
GET  /api/v1/industryextensionprofile/{id}
GET  /api/v1/industryextensionprofile/{id}/timeline
GET  /api/v1/industryextensionprofile/{id}/evidence
GET  /api/v1/industryextensionprofile/{id}/decisions
POST /api/v1/industryextensionprofile/{id}/exceptions
POST /api/v1/industryextensionprofile/{id}/corrections
```
...
|---|---|
| `industryextensionprofile_aggregate` | authoritative subject |
| `industryextensionprofile_version` | immutable submitted, approved, issued, or signed versions |
| `industryextensionprofile_relationship` | governed relationships |
| `industryextensionprofile_decision` | binding Decisions and rationale |
| `industryextensionprofile_evidence_link` | provenance and evidence relationships |
| `industryextensionprofile_event_outbox` | transactional Event publication |
| `industryextensionprofile_idempotency` | duplicate-write protection |
| `industryextensionprofile_exception` | exception, claim, dispute, or hold |
| `industryextensionprofile_correction` | correction and supersession lineage |
| `industryextensionprofile_audit` | privileged action evidence |
