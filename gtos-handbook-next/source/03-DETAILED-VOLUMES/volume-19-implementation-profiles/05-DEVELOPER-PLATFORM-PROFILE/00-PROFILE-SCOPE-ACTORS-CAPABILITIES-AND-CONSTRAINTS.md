# Developer Platform Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-05-00` |
| Subject | `DeveloperPlatformProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Developer Platform Profile**.
...
|---|---|
| `DeveloperPlatformProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPlatformProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPlatformProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPlatformProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPlatformProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DeveloperPlatformProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDeveloperPlatformProfile`
- `ValidateDeveloperPlatformProfile`
- `ApproveDeveloperPlatformProfile`
- `ActivateDeveloperPlatformProfile`
- `SuspendDeveloperPlatformProfile`
- `CorrectDeveloperPlatformProfile`
- `RetireDeveloperPlatformProfile`

Reference Events:

- `DeveloperPlatformProfileCreated`
- `DeveloperPlatformProfileValidated`
- `DeveloperPlatformProfileApproved`
- `DeveloperPlatformProfileActivated`
- `DeveloperPlatformProfileSuspended`
- `DeveloperPlatformProfileCorrected`
- `DeveloperPlatformProfileRetired`

Reference queries:

- `GetDeveloperPlatformProfile`
- `ListDeveloperPlatformProfileRecords`
- `GetDeveloperPlatformProfileTimeline`
- `GetDeveloperPlatformProfileEvidence`
- `GetDeveloperPlatformProfileDecisionPackage`
- `GetDeveloperPlatformProfileExceptions`
- `GetDeveloperPlatformProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/developerplatformprofile/commands
GET  /api/v1/developerplatformprofile/{id}
GET  /api/v1/developerplatformprofile/{id}/timeline
GET  /api/v1/developerplatformprofile/{id}/evidence
GET  /api/v1/developerplatformprofile/{id}/decisions
POST /api/v1/developerplatformprofile/{id}/exceptions
POST /api/v1/developerplatformprofile/{id}/corrections
```
...
|---|---|
| `developerplatformprofile_aggregate` | authoritative subject |
| `developerplatformprofile_version` | immutable submitted, approved, issued, or signed versions |
| `developerplatformprofile_relationship` | governed relationships |
| `developerplatformprofile_decision` | binding Decisions and rationale |
| `developerplatformprofile_evidence_link` | provenance and evidence relationships |
| `developerplatformprofile_event_outbox` | transactional Event publication |
| `developerplatformprofile_idempotency` | duplicate-write protection |
| `developerplatformprofile_exception` | exception, claim, dispute, or hold |
| `developerplatformprofile_correction` | correction and supersession lineage |
| `developerplatformprofile_audit` | privileged action evidence |
