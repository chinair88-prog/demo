# Operator Profile — Deployment, Migration, Testing, Certification, and Evidence

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-03-02` |
| Subject | `OperatorProfileConformance` |
...
This chapter defines how GTOS shall **define deployment parameters, migration, test journeys, partner certification, release evidence, exceptions and continuous conformance for Operator Profile**.
...
|---|---|
| `OperatorProfileConformance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileConformanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileConformanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileConformanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileConformanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
OperatorProfileConformance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateOperatorProfileConformance`
- `ValidateOperatorProfileConformance`
- `ApproveOperatorProfileConformance`
- `ActivateOperatorProfileConformance`
- `SuspendOperatorProfileConformance`
- `CorrectOperatorProfileConformance`
- `RetireOperatorProfileConformance`

Reference Events:

- `OperatorProfileConformanceCreated`
- `OperatorProfileConformanceValidated`
- `OperatorProfileConformanceApproved`
- `OperatorProfileConformanceActivated`
- `OperatorProfileConformanceSuspended`
- `OperatorProfileConformanceCorrected`
- `OperatorProfileConformanceRetired`

Reference queries:

- `GetOperatorProfileConformance`
- `ListOperatorProfileConformanceRecords`
- `GetOperatorProfileConformanceTimeline`
- `GetOperatorProfileConformanceEvidence`
- `GetOperatorProfileConformanceDecisionPackage`
- `GetOperatorProfileConformanceExceptions`
- `GetOperatorProfileConformanceAuditTrail`

Reference API surface:

```text
POST /api/v1/operatorprofileconformance/commands
GET  /api/v1/operatorprofileconformance/{id}
GET  /api/v1/operatorprofileconformance/{id}/timeline
GET  /api/v1/operatorprofileconformance/{id}/evidence
GET  /api/v1/operatorprofileconformance/{id}/decisions
POST /api/v1/operatorprofileconformance/{id}/exceptions
POST /api/v1/operatorprofileconformance/{id}/corrections
```
...
|---|---|
| `operatorprofileconformance_aggregate` | authoritative subject |
| `operatorprofileconformance_version` | immutable submitted, approved, issued, or signed versions |
| `operatorprofileconformance_relationship` | governed relationships |
| `operatorprofileconformance_decision` | binding Decisions and rationale |
| `operatorprofileconformance_evidence_link` | provenance and evidence relationships |
| `operatorprofileconformance_event_outbox` | transactional Event publication |
| `operatorprofileconformance_idempotency` | duplicate-write protection |
| `operatorprofileconformance_exception` | exception, claim, dispute, or hold |
| `operatorprofileconformance_correction` | correction and supersession lineage |
| `operatorprofileconformance_audit` | privileged action evidence |
