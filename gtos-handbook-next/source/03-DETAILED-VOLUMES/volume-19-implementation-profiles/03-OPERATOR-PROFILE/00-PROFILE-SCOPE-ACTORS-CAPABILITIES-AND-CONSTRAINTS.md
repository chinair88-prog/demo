# Operator Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-03-00` |
| Subject | `OperatorProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Operator Profile**.
...
|---|---|
| `OperatorProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OperatorProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `SuspendOperatorProfile`
- `CorrectOperatorProfile`
- `RetireOperatorProfile`

Reference Events:

- `OperatorProfileCreated`
- `OperatorProfileValidated`
- `OperatorProfileApproved`
- `OperatorProfileActivated`
- `OperatorProfileSuspended`
- `OperatorProfileCorrected`
- `OperatorProfileRetired`

Reference queries:

- `GetOperatorProfile`
- `ListOperatorProfileRecords`
- `GetOperatorProfileTimeline`
- `GetOperatorProfileEvidence`
- `GetOperatorProfileDecisionPackage`
- `GetOperatorProfileExceptions`
- `GetOperatorProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/operatorprofile/commands
GET  /api/v1/operatorprofile/{id}
GET  /api/v1/operatorprofile/{id}/timeline
GET  /api/v1/operatorprofile/{id}/evidence
GET  /api/v1/operatorprofile/{id}/decisions
POST /api/v1/operatorprofile/{id}/exceptions
POST /api/v1/operatorprofile/{id}/corrections
```
...
|---|---|
| `operatorprofile_aggregate` | authoritative subject |
| `operatorprofile_version` | immutable submitted, approved, issued, or signed versions |
| `operatorprofile_relationship` | governed relationships |
| `operatorprofile_decision` | binding Decisions and rationale |
| `operatorprofile_evidence_link` | provenance and evidence relationships |
| `operatorprofile_event_outbox` | transactional Event publication |
| `operatorprofile_idempotency` | duplicate-write protection |
| `operatorprofile_exception` | exception, claim, dispute, or hold |
| `operatorprofile_correction` | correction and supersession lineage |
| `operatorprofile_audit` | privileged action evidence |
