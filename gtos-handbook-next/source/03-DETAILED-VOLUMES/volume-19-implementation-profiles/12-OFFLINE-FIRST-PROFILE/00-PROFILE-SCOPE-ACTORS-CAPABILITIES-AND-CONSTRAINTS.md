# Offline-First Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-12-00` |
| Subject | `Offline-FirstProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Offline-First Profile**.
...
|---|---|
| `Offline-FirstProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Offline-FirstProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Offline-FirstProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Offline-FirstProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Offline-FirstProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Offline-FirstProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateOffline-FirstProfile`
- `ValidateOffline-FirstProfile`
- `ApproveOffline-FirstProfile`
- `ActivateOffline-FirstProfile`
- `SuspendOffline-FirstProfile`
- `CorrectOffline-FirstProfile`
- `RetireOffline-FirstProfile`

Reference Events:

- `Offline-FirstProfileCreated`
- `Offline-FirstProfileValidated`
- `Offline-FirstProfileApproved`
- `Offline-FirstProfileActivated`
- `Offline-FirstProfileSuspended`
- `Offline-FirstProfileCorrected`
- `Offline-FirstProfileRetired`

Reference queries:

- `GetOffline-FirstProfile`
- `ListOffline-FirstProfileRecords`
- `GetOffline-FirstProfileTimeline`
- `GetOffline-FirstProfileEvidence`
- `GetOffline-FirstProfileDecisionPackage`
- `GetOffline-FirstProfileExceptions`
- `GetOffline-FirstProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/offline_firstprofile/commands
GET  /api/v1/offline_firstprofile/{id}
GET  /api/v1/offline_firstprofile/{id}/timeline
GET  /api/v1/offline_firstprofile/{id}/evidence
GET  /api/v1/offline_firstprofile/{id}/decisions
POST /api/v1/offline_firstprofile/{id}/exceptions
POST /api/v1/offline_firstprofile/{id}/corrections
```
...
|---|---|
| `offline_firstprofile_aggregate` | authoritative subject |
| `offline_firstprofile_version` | immutable submitted, approved, issued, or signed versions |
| `offline_firstprofile_relationship` | governed relationships |
| `offline_firstprofile_decision` | binding Decisions and rationale |
| `offline_firstprofile_evidence_link` | provenance and evidence relationships |
| `offline_firstprofile_event_outbox` | transactional Event publication |
| `offline_firstprofile_idempotency` | duplicate-write protection |
| `offline_firstprofile_exception` | exception, claim, dispute, or hold |
| `offline_firstprofile_correction` | correction and supersession lineage |
| `offline_firstprofile_audit` | privileged action evidence |
