# High-Assurance Regulated Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-14-00` |
| Subject | `High-AssuranceRegulatedProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for High-Assurance Regulated Profile**.
...
|---|---|
| `High-AssuranceRegulatedProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `High-AssuranceRegulatedProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `High-AssuranceRegulatedProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `High-AssuranceRegulatedProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `High-AssuranceRegulatedProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
High-AssuranceRegulatedProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateHigh-AssuranceRegulatedProfile`
- `ValidateHigh-AssuranceRegulatedProfile`
- `ApproveHigh-AssuranceRegulatedProfile`
- `ActivateHigh-AssuranceRegulatedProfile`
- `SuspendHigh-AssuranceRegulatedProfile`
- `CorrectHigh-AssuranceRegulatedProfile`
- `RetireHigh-AssuranceRegulatedProfile`

Reference Events:

- `High-AssuranceRegulatedProfileCreated`
- `High-AssuranceRegulatedProfileValidated`
- `High-AssuranceRegulatedProfileApproved`
- `High-AssuranceRegulatedProfileActivated`
- `High-AssuranceRegulatedProfileSuspended`
- `High-AssuranceRegulatedProfileCorrected`
- `High-AssuranceRegulatedProfileRetired`

Reference queries:

- `GetHigh-AssuranceRegulatedProfile`
- `ListHigh-AssuranceRegulatedProfileRecords`
- `GetHigh-AssuranceRegulatedProfileTimeline`
- `GetHigh-AssuranceRegulatedProfileEvidence`
- `GetHigh-AssuranceRegulatedProfileDecisionPackage`
- `GetHigh-AssuranceRegulatedProfileExceptions`
- `GetHigh-AssuranceRegulatedProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/high_assuranceregulatedprofile/commands
GET  /api/v1/high_assuranceregulatedprofile/{id}
GET  /api/v1/high_assuranceregulatedprofile/{id}/timeline
GET  /api/v1/high_assuranceregulatedprofile/{id}/evidence
GET  /api/v1/high_assuranceregulatedprofile/{id}/decisions
POST /api/v1/high_assuranceregulatedprofile/{id}/exceptions
POST /api/v1/high_assuranceregulatedprofile/{id}/corrections
```
...
|---|---|
| `high_assuranceregulatedprofile_aggregate` | authoritative subject |
| `high_assuranceregulatedprofile_version` | immutable submitted, approved, issued, or signed versions |
| `high_assuranceregulatedprofile_relationship` | governed relationships |
| `high_assuranceregulatedprofile_decision` | binding Decisions and rationale |
| `high_assuranceregulatedprofile_evidence_link` | provenance and evidence relationships |
| `high_assuranceregulatedprofile_event_outbox` | transactional Event publication |
| `high_assuranceregulatedprofile_idempotency` | duplicate-write protection |
| `high_assuranceregulatedprofile_exception` | exception, claim, dispute, or hold |
| `high_assuranceregulatedprofile_correction` | correction and supersession lineage |
| `high_assuranceregulatedprofile_audit` | privileged action evidence |
