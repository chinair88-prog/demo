# Commodity Extension Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-09-00` |
| Subject | `CommodityExtensionProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Commodity Extension Profile**.
...
|---|---|
| `CommodityExtensionProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CommodityExtensionProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CommodityExtensionProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CommodityExtensionProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CommodityExtensionProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
CommodityExtensionProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateCommodityExtensionProfile`
- `ValidateCommodityExtensionProfile`
- `ApproveCommodityExtensionProfile`
- `ActivateCommodityExtensionProfile`
- `SuspendCommodityExtensionProfile`
- `CorrectCommodityExtensionProfile`
- `RetireCommodityExtensionProfile`

Reference Events:

- `CommodityExtensionProfileCreated`
- `CommodityExtensionProfileValidated`
- `CommodityExtensionProfileApproved`
- `CommodityExtensionProfileActivated`
- `CommodityExtensionProfileSuspended`
- `CommodityExtensionProfileCorrected`
- `CommodityExtensionProfileRetired`

Reference queries:

- `GetCommodityExtensionProfile`
- `ListCommodityExtensionProfileRecords`
- `GetCommodityExtensionProfileTimeline`
- `GetCommodityExtensionProfileEvidence`
- `GetCommodityExtensionProfileDecisionPackage`
- `GetCommodityExtensionProfileExceptions`
- `GetCommodityExtensionProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/commodityextensionprofile/commands
GET  /api/v1/commodityextensionprofile/{id}
GET  /api/v1/commodityextensionprofile/{id}/timeline
GET  /api/v1/commodityextensionprofile/{id}/evidence
GET  /api/v1/commodityextensionprofile/{id}/decisions
POST /api/v1/commodityextensionprofile/{id}/exceptions
POST /api/v1/commodityextensionprofile/{id}/corrections
```
...
|---|---|
| `commodityextensionprofile_aggregate` | authoritative subject |
| `commodityextensionprofile_version` | immutable submitted, approved, issued, or signed versions |
| `commodityextensionprofile_relationship` | governed relationships |
| `commodityextensionprofile_decision` | binding Decisions and rationale |
| `commodityextensionprofile_evidence_link` | provenance and evidence relationships |
| `commodityextensionprofile_event_outbox` | transactional Event publication |
| `commodityextensionprofile_idempotency` | duplicate-write protection |
| `commodityextensionprofile_exception` | exception, claim, dispute, or hold |
| `commodityextensionprofile_correction` | correction and supersession lineage |
| `commodityextensionprofile_audit` | privileged action evidence |
