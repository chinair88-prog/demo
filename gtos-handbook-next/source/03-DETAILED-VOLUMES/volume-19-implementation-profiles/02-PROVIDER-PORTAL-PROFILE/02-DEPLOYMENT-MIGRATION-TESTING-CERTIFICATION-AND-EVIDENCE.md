# Provider Portal Profile — Deployment, Migration, Testing, Certification, and Evidence

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-02-02` |
| Subject | `ProviderPortalProfileConformance` |
...
This chapter defines how GTOS shall **define deployment parameters, migration, test journeys, partner certification, release evidence, exceptions and continuous conformance for Provider Portal Profile**.
...
|---|---|
| `ProviderPortalProfileConformance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileConformanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileConformanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileConformanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileConformanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ProviderPortalProfileConformance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateProviderPortalProfileConformance`
- `ValidateProviderPortalProfileConformance`
- `ApproveProviderPortalProfileConformance`
- `ActivateProviderPortalProfileConformance`
- `SuspendProviderPortalProfileConformance`
- `CorrectProviderPortalProfileConformance`
- `RetireProviderPortalProfileConformance`

Reference Events:

- `ProviderPortalProfileConformanceCreated`
- `ProviderPortalProfileConformanceValidated`
- `ProviderPortalProfileConformanceApproved`
- `ProviderPortalProfileConformanceActivated`
- `ProviderPortalProfileConformanceSuspended`
- `ProviderPortalProfileConformanceCorrected`
- `ProviderPortalProfileConformanceRetired`

Reference queries:

- `GetProviderPortalProfileConformance`
- `ListProviderPortalProfileConformanceRecords`
- `GetProviderPortalProfileConformanceTimeline`
- `GetProviderPortalProfileConformanceEvidence`
- `GetProviderPortalProfileConformanceDecisionPackage`
- `GetProviderPortalProfileConformanceExceptions`
- `GetProviderPortalProfileConformanceAuditTrail`

Reference API surface:

```text
POST /api/v1/providerportalprofileconformance/commands
GET  /api/v1/providerportalprofileconformance/{id}
GET  /api/v1/providerportalprofileconformance/{id}/timeline
GET  /api/v1/providerportalprofileconformance/{id}/evidence
GET  /api/v1/providerportalprofileconformance/{id}/decisions
POST /api/v1/providerportalprofileconformance/{id}/exceptions
POST /api/v1/providerportalprofileconformance/{id}/corrections
```
...
|---|---|
| `providerportalprofileconformance_aggregate` | authoritative subject |
| `providerportalprofileconformance_version` | immutable submitted, approved, issued, or signed versions |
| `providerportalprofileconformance_relationship` | governed relationships |
| `providerportalprofileconformance_decision` | binding Decisions and rationale |
| `providerportalprofileconformance_evidence_link` | provenance and evidence relationships |
| `providerportalprofileconformance_event_outbox` | transactional Event publication |
| `providerportalprofileconformance_idempotency` | duplicate-write protection |
| `providerportalprofileconformance_exception` | exception, claim, dispute, or hold |
| `providerportalprofileconformance_correction` | correction and supersession lineage |
| `providerportalprofileconformance_audit` | privileged action evidence |
