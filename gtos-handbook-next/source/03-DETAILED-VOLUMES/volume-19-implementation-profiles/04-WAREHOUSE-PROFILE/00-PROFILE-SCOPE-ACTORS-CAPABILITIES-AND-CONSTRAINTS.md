# Warehouse Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-04-00` |
| Subject | `WarehouseProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Warehouse Profile**.
...
|---|---|
| `WarehouseProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateWarehouseProfile`
- `ApproveWarehouseProfile`
- `ActivateWarehouseProfile`
- `SuspendWarehouseProfile`
- `CorrectWarehouseProfile`
- `RetireWarehouseProfile`

Reference Events:

- `WarehouseProfileCreated`
- `WarehouseProfileValidated`
- `WarehouseProfileApproved`
- `WarehouseProfileActivated`
- `WarehouseProfileSuspended`
- `WarehouseProfileCorrected`
- `WarehouseProfileRetired`

Reference queries:

- `GetWarehouseProfile`
- `ListWarehouseProfileRecords`
- `GetWarehouseProfileTimeline`
- `GetWarehouseProfileEvidence`
- `GetWarehouseProfileDecisionPackage`
- `GetWarehouseProfileExceptions`
- `GetWarehouseProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/warehouseprofile/commands
GET  /api/v1/warehouseprofile/{id}
GET  /api/v1/warehouseprofile/{id}/timeline
GET  /api/v1/warehouseprofile/{id}/evidence
GET  /api/v1/warehouseprofile/{id}/decisions
POST /api/v1/warehouseprofile/{id}/exceptions
POST /api/v1/warehouseprofile/{id}/corrections
```
...
|---|---|
| `warehouseprofile_aggregate` | authoritative subject |
| `warehouseprofile_version` | immutable submitted, approved, issued, or signed versions |
| `warehouseprofile_relationship` | governed relationships |
| `warehouseprofile_decision` | binding Decisions and rationale |
| `warehouseprofile_evidence_link` | provenance and evidence relationships |
| `warehouseprofile_event_outbox` | transactional Event publication |
| `warehouseprofile_idempotency` | duplicate-write protection |
| `warehouseprofile_exception` | exception, claim, dispute, or hold |
| `warehouseprofile_correction` | correction and supersession lineage |
| `warehouseprofile_audit` | privileged action evidence |
