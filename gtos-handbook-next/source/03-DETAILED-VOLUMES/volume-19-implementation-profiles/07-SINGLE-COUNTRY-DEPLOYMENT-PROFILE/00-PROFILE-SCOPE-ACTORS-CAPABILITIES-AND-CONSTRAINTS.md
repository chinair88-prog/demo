# Single-Country Deployment Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-07-00` |
| Subject | `Single-CountryDeploymentProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Single-Country Deployment Profile**.
...
|---|---|
| `Single-CountryDeploymentProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Single-CountryDeploymentProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateSingle-CountryDeploymentProfile`
- `ValidateSingle-CountryDeploymentProfile`
- `ApproveSingle-CountryDeploymentProfile`
- `ActivateSingle-CountryDeploymentProfile`
- `SuspendSingle-CountryDeploymentProfile`
- `CorrectSingle-CountryDeploymentProfile`
- `RetireSingle-CountryDeploymentProfile`

Reference Events:

- `Single-CountryDeploymentProfileCreated`
- `Single-CountryDeploymentProfileValidated`
- `Single-CountryDeploymentProfileApproved`
- `Single-CountryDeploymentProfileActivated`
- `Single-CountryDeploymentProfileSuspended`
- `Single-CountryDeploymentProfileCorrected`
- `Single-CountryDeploymentProfileRetired`

Reference queries:

- `GetSingle-CountryDeploymentProfile`
- `ListSingle-CountryDeploymentProfileRecords`
- `GetSingle-CountryDeploymentProfileTimeline`
- `GetSingle-CountryDeploymentProfileEvidence`
- `GetSingle-CountryDeploymentProfileDecisionPackage`
- `GetSingle-CountryDeploymentProfileExceptions`
- `GetSingle-CountryDeploymentProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/single_countrydeploymentprofile/commands
GET  /api/v1/single_countrydeploymentprofile/{id}
GET  /api/v1/single_countrydeploymentprofile/{id}/timeline
GET  /api/v1/single_countrydeploymentprofile/{id}/evidence
GET  /api/v1/single_countrydeploymentprofile/{id}/decisions
POST /api/v1/single_countrydeploymentprofile/{id}/exceptions
POST /api/v1/single_countrydeploymentprofile/{id}/corrections
```
...
|---|---|
| `single_countrydeploymentprofile_aggregate` | authoritative subject |
| `single_countrydeploymentprofile_version` | immutable submitted, approved, issued, or signed versions |
| `single_countrydeploymentprofile_relationship` | governed relationships |
| `single_countrydeploymentprofile_decision` | binding Decisions and rationale |
| `single_countrydeploymentprofile_evidence_link` | provenance and evidence relationships |
| `single_countrydeploymentprofile_event_outbox` | transactional Event publication |
| `single_countrydeploymentprofile_idempotency` | duplicate-write protection |
| `single_countrydeploymentprofile_exception` | exception, claim, dispute, or hold |
| `single_countrydeploymentprofile_correction` | correction and supersession lineage |
| `single_countrydeploymentprofile_audit` | privileged action evidence |
