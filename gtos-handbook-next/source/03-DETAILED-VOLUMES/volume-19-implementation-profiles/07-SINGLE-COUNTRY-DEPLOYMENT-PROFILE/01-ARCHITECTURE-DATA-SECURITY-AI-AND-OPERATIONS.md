# Single-Country Deployment Profile — Architecture, Data, Security, AI, and Operations

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-07-01` |
| Subject | `Single-CountryDeploymentProfileArchitecture` |
...
This chapter defines how GTOS shall **define services, Portals, data, contracts, workflows, AI, trust boundaries, SLOs, runbooks, resilience and cost for Single-Country Deployment Profile**.
...
|---|---|
| `Single-CountryDeploymentProfileArchitecture` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileArchitectureVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileArchitectureDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileArchitectureEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileArchitectureException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Single-CountryDeploymentProfileArchitecture {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateSingle-CountryDeploymentProfileArchitecture`
- `ValidateSingle-CountryDeploymentProfileArchitecture`
- `ApproveSingle-CountryDeploymentProfileArchitecture`
- `ActivateSingle-CountryDeploymentProfileArchitecture`
- `SuspendSingle-CountryDeploymentProfileArchitecture`
- `CorrectSingle-CountryDeploymentProfileArchitecture`
- `RetireSingle-CountryDeploymentProfileArchitecture`

Reference Events:

- `Single-CountryDeploymentProfileArchitectureCreated`
- `Single-CountryDeploymentProfileArchitectureValidated`
- `Single-CountryDeploymentProfileArchitectureApproved`
- `Single-CountryDeploymentProfileArchitectureActivated`
- `Single-CountryDeploymentProfileArchitectureSuspended`
- `Single-CountryDeploymentProfileArchitectureCorrected`
- `Single-CountryDeploymentProfileArchitectureRetired`

Reference queries:

- `GetSingle-CountryDeploymentProfileArchitecture`
- `ListSingle-CountryDeploymentProfileArchitectureRecords`
- `GetSingle-CountryDeploymentProfileArchitectureTimeline`
- `GetSingle-CountryDeploymentProfileArchitectureEvidence`
- `GetSingle-CountryDeploymentProfileArchitectureDecisionPackage`
- `GetSingle-CountryDeploymentProfileArchitectureExceptions`
- `GetSingle-CountryDeploymentProfileArchitectureAuditTrail`

Reference API surface:

```text
POST /api/v1/single_countrydeploymentprofilearchitecture/commands
GET  /api/v1/single_countrydeploymentprofilearchitecture/{id}
GET  /api/v1/single_countrydeploymentprofilearchitecture/{id}/timeline
GET  /api/v1/single_countrydeploymentprofilearchitecture/{id}/evidence
GET  /api/v1/single_countrydeploymentprofilearchitecture/{id}/decisions
POST /api/v1/single_countrydeploymentprofilearchitecture/{id}/exceptions
POST /api/v1/single_countrydeploymentprofilearchitecture/{id}/corrections
```
...
|---|---|
| `single_countrydeploymentprofilearchitecture_aggregate` | authoritative subject |
| `single_countrydeploymentprofilearchitecture_version` | immutable submitted, approved, issued, or signed versions |
| `single_countrydeploymentprofilearchitecture_relationship` | governed relationships |
| `single_countrydeploymentprofilearchitecture_decision` | binding Decisions and rationale |
| `single_countrydeploymentprofilearchitecture_evidence_link` | provenance and evidence relationships |
| `single_countrydeploymentprofilearchitecture_event_outbox` | transactional Event publication |
| `single_countrydeploymentprofilearchitecture_idempotency` | duplicate-write protection |
| `single_countrydeploymentprofilearchitecture_exception` | exception, claim, dispute, or hold |
| `single_countrydeploymentprofilearchitecture_correction` | correction and supersession lineage |
| `single_countrydeploymentprofilearchitecture_audit` | privileged action evidence |
