# Definition of Done and Documentation as Code

| Metadata | Value |
|---|---|
| Volume | `15` |
| Chapter ID | `V15-19` |
| Subject | `DefinitionofDoneandDocumentationasCode` |
...
| Accountable owner | Engineering Council |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Definition of Done and Documentation as Code**.
...
The accountable owner is **Engineering Council**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `DefinitionofDoneandDocumentationasCode` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DefinitionofDoneandDocumentationasCodeVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DefinitionofDoneandDocumentationasCodeDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DefinitionofDoneandDocumentationasCodeEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DefinitionofDoneandDocumentationasCodeException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DefinitionofDoneandDocumentationasCode {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDefinitionofDoneandDocumentationasCode`
- `ValidateDefinitionofDoneandDocumentationasCode`
- `ApproveDefinitionofDoneandDocumentationasCode`
- `ActivateDefinitionofDoneandDocumentationasCode`
- `SuspendDefinitionofDoneandDocumentationasCode`
- `CorrectDefinitionofDoneandDocumentationasCode`
- `RetireDefinitionofDoneandDocumentationasCode`

Reference Events:

- `DefinitionofDoneandDocumentationasCodeCreated`
- `DefinitionofDoneandDocumentationasCodeValidated`
- `DefinitionofDoneandDocumentationasCodeApproved`
- `DefinitionofDoneandDocumentationasCodeActivated`
- `DefinitionofDoneandDocumentationasCodeSuspended`
- `DefinitionofDoneandDocumentationasCodeCorrected`
- `DefinitionofDoneandDocumentationasCodeRetired`

Reference queries:

- `GetDefinitionofDoneandDocumentationasCode`
- `ListDefinitionofDoneandDocumentationasCodeRecords`
- `GetDefinitionofDoneandDocumentationasCodeTimeline`
- `GetDefinitionofDoneandDocumentationasCodeEvidence`
- `GetDefinitionofDoneandDocumentationasCodeDecisionPackage`
- `GetDefinitionofDoneandDocumentationasCodeExceptions`
- `GetDefinitionofDoneandDocumentationasCodeAuditTrail`

Reference API surface:

```text
POST /api/v1/definitionofdoneanddocumentationascode/commands
GET  /api/v1/definitionofdoneanddocumentationascode/{id}
GET  /api/v1/definitionofdoneanddocumentationascode/{id}/timeline
GET  /api/v1/definitionofdoneanddocumentationascode/{id}/evidence
GET  /api/v1/definitionofdoneanddocumentationascode/{id}/decisions
POST /api/v1/definitionofdoneanddocumentationascode/{id}/exceptions
POST /api/v1/definitionofdoneanddocumentationascode/{id}/corrections
```
...
|---|---|
| `definitionofdoneanddocumentationascode_aggregate` | authoritative subject |
| `definitionofdoneanddocumentationascode_version` | immutable submitted, approved, issued, or signed versions |
| `definitionofdoneanddocumentationascode_relationship` | governed relationships |
| `definitionofdoneanddocumentationascode_decision` | binding Decisions and rationale |
| `definitionofdoneanddocumentationascode_evidence_link` | provenance and evidence relationships |
| `definitionofdoneanddocumentationascode_event_outbox` | transactional Event publication |
| `definitionofdoneanddocumentationascode_idempotency` | duplicate-write protection |
| `definitionofdoneanddocumentationascode_exception` | exception, claim, dispute, or hold |
| `definitionofdoneanddocumentationascode_correction` | correction and supersession lineage |
| `definitionofdoneanddocumentationascode_audit` | privileged action evidence |
...
- `Definition of Done and Documentation as Code` is part of the target GTOS handbook scope.
