...
| Volume | `15` |
| Chapter ID | `V15-00` |
| Subject | `EngineeringHandbookIntroduction` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Engineering Handbook Introduction**.
...
|---|---|
| `EngineeringHandbookIntroduction` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EngineeringHandbookIntroductionVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EngineeringHandbookIntroductionDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EngineeringHandbookIntroductionEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EngineeringHandbookIntroductionException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
EngineeringHandbookIntroduction {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateEngineeringHandbookIntroduction`
- `ValidateEngineeringHandbookIntroduction`
- `ApproveEngineeringHandbookIntroduction`
- `ActivateEngineeringHandbookIntroduction`
- `SuspendEngineeringHandbookIntroduction`
- `CorrectEngineeringHandbookIntroduction`
- `RetireEngineeringHandbookIntroduction`

Reference Events:

- `EngineeringHandbookIntroductionCreated`
- `EngineeringHandbookIntroductionValidated`
- `EngineeringHandbookIntroductionApproved`
- `EngineeringHandbookIntroductionActivated`
- `EngineeringHandbookIntroductionSuspended`
- `EngineeringHandbookIntroductionCorrected`
- `EngineeringHandbookIntroductionRetired`

Reference queries:

- `GetEngineeringHandbookIntroduction`
- `ListEngineeringHandbookIntroductionRecords`
- `GetEngineeringHandbookIntroductionTimeline`
- `GetEngineeringHandbookIntroductionEvidence`
- `GetEngineeringHandbookIntroductionDecisionPackage`
- `GetEngineeringHandbookIntroductionExceptions`
- `GetEngineeringHandbookIntroductionAuditTrail`

Reference API surface:

```text
POST /api/v1/engineeringhandbookintroduction/commands
GET  /api/v1/engineeringhandbookintroduction/{id}
GET  /api/v1/engineeringhandbookintroduction/{id}/timeline
GET  /api/v1/engineeringhandbookintroduction/{id}/evidence
GET  /api/v1/engineeringhandbookintroduction/{id}/decisions
POST /api/v1/engineeringhandbookintroduction/{id}/exceptions
POST /api/v1/engineeringhandbookintroduction/{id}/corrections
```
...
|---|---|
| `engineeringhandbookintroduction_aggregate` | authoritative subject |
| `engineeringhandbookintroduction_version` | immutable submitted, approved, issued, or signed versions |
| `engineeringhandbookintroduction_relationship` | governed relationships |
| `engineeringhandbookintroduction_decision` | binding Decisions and rationale |
| `engineeringhandbookintroduction_evidence_link` | provenance and evidence relationships |
| `engineeringhandbookintroduction_event_outbox` | transactional Event publication |
| `engineeringhandbookintroduction_idempotency` | duplicate-write protection |
| `engineeringhandbookintroduction_exception` | exception, claim, dispute, or hold |
| `engineeringhandbookintroduction_correction` | correction and supersession lineage |
| `engineeringhandbookintroduction_audit` | privileged action evidence |
...
- `Engineering Handbook Introduction` is part of the target GTOS handbook scope.
