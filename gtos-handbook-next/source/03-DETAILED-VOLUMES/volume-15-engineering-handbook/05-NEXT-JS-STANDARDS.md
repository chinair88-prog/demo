...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Next.js Standards**.
...
|---|---|
| `Next.jsStandards` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Next.jsStandardsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Next.jsStandardsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Next.jsStandardsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Next.jsStandardsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateNext.jsStandards`
- `ValidateNext.jsStandards`
- `ApproveNext.jsStandards`
- `ActivateNext.jsStandards`
- `SuspendNext.jsStandards`
- `CorrectNext.jsStandards`
- `RetireNext.jsStandards`

Reference Events:

- `Next.jsStandardsCreated`
- `Next.jsStandardsValidated`
- `Next.jsStandardsApproved`
- `Next.jsStandardsActivated`
- `Next.jsStandardsSuspended`
- `Next.jsStandardsCorrected`
- `Next.jsStandardsRetired`

Reference queries:

- `GetNext.jsStandards`
- `ListNext.jsStandardsRecords`
- `GetNext.jsStandardsTimeline`
- `GetNext.jsStandardsEvidence`
- `GetNext.jsStandardsDecisionPackage`
- `GetNext.jsStandardsExceptions`
- `GetNext.jsStandardsAuditTrail`

Reference API surface:

```text
POST /api/v1/next_jsstandards/commands
GET  /api/v1/next_jsstandards/{id}
GET  /api/v1/next_jsstandards/{id}/timeline
GET  /api/v1/next_jsstandards/{id}/evidence
GET  /api/v1/next_jsstandards/{id}/decisions
POST /api/v1/next_jsstandards/{id}/exceptions
POST /api/v1/next_jsstandards/{id}/corrections
```
...
|---|---|
| `next_jsstandards_aggregate` | authoritative subject |
| `next_jsstandards_version` | immutable submitted, approved, issued, or signed versions |
| `next_jsstandards_relationship` | governed relationships |
| `next_jsstandards_decision` | binding Decisions and rationale |
| `next_jsstandards_evidence_link` | provenance and evidence relationships |
| `next_jsstandards_event_outbox` | transactional Event publication |
| `next_jsstandards_idempotency` | duplicate-write protection |
| `next_jsstandards_exception` | exception, claim, dispute, or hold |
| `next_jsstandards_correction` | correction and supersession lineage |
| `next_jsstandards_audit` | privileged action evidence |
...
- `Next.js Standards` is part of the target GTOS handbook scope.
