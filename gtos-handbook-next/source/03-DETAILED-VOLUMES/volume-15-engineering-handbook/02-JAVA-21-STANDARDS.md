...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Java 21 Standards**.
...
|---|---|
| `Java21Standards` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Java21StandardsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Java21StandardsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Java21StandardsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Java21StandardsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateJava21Standards`
- `ValidateJava21Standards`
- `ApproveJava21Standards`
- `ActivateJava21Standards`
- `SuspendJava21Standards`
- `CorrectJava21Standards`
- `RetireJava21Standards`

Reference Events:

- `Java21StandardsCreated`
- `Java21StandardsValidated`
- `Java21StandardsApproved`
- `Java21StandardsActivated`
- `Java21StandardsSuspended`
- `Java21StandardsCorrected`
- `Java21StandardsRetired`

Reference queries:

- `GetJava21Standards`
- `ListJava21StandardsRecords`
- `GetJava21StandardsTimeline`
- `GetJava21StandardsEvidence`
- `GetJava21StandardsDecisionPackage`
- `GetJava21StandardsExceptions`
- `GetJava21StandardsAuditTrail`

Reference API surface:

```text
POST /api/v1/java21standards/commands
GET  /api/v1/java21standards/{id}
GET  /api/v1/java21standards/{id}/timeline
GET  /api/v1/java21standards/{id}/evidence
GET  /api/v1/java21standards/{id}/decisions
POST /api/v1/java21standards/{id}/exceptions
POST /api/v1/java21standards/{id}/corrections
```
...
|---|---|
| `java21standards_aggregate` | authoritative subject |
| `java21standards_version` | immutable submitted, approved, issued, or signed versions |
| `java21standards_relationship` | governed relationships |
| `java21standards_decision` | binding Decisions and rationale |
| `java21standards_evidence_link` | provenance and evidence relationships |
| `java21standards_event_outbox` | transactional Event publication |
| `java21standards_idempotency` | duplicate-write protection |
| `java21standards_exception` | exception, claim, dispute, or hold |
| `java21standards_correction` | correction and supersession lineage |
| `java21standards_audit` | privileged action evidence |
...
- `Java 21 Standards` is part of the target GTOS handbook scope.
