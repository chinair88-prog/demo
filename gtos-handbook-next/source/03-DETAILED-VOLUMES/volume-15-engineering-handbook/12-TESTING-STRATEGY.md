...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Testing Strategy**.
...
|---|---|
| `TestingStrategy` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestingStrategyVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestingStrategyDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestingStrategyEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestingStrategyException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveTestingStrategy`
- `ActivateTestingStrategy`
- `SuspendTestingStrategy`
- `CorrectTestingStrategy`
- `RetireTestingStrategy`

Reference Events:

- `TestingStrategyCreated`
- `TestingStrategyValidated`
- `TestingStrategyApproved`
- `TestingStrategyActivated`
- `TestingStrategySuspended`
- `TestingStrategyCorrected`
- `TestingStrategyRetired`

Reference queries:

- `GetTestingStrategy`
- `ListTestingStrategyRecords`
- `GetTestingStrategyTimeline`
- `GetTestingStrategyEvidence`
- `GetTestingStrategyDecisionPackage`
- `GetTestingStrategyExceptions`
- `GetTestingStrategyAuditTrail`

Reference API surface:

```text
POST /api/v1/testingstrategy/commands
GET  /api/v1/testingstrategy/{id}
GET  /api/v1/testingstrategy/{id}/timeline
GET  /api/v1/testingstrategy/{id}/evidence
GET  /api/v1/testingstrategy/{id}/decisions
POST /api/v1/testingstrategy/{id}/exceptions
POST /api/v1/testingstrategy/{id}/corrections
```
...
|---|---|
| `testingstrategy_aggregate` | authoritative subject |
| `testingstrategy_version` | immutable submitted, approved, issued, or signed versions |
| `testingstrategy_relationship` | governed relationships |
| `testingstrategy_decision` | binding Decisions and rationale |
| `testingstrategy_evidence_link` | provenance and evidence relationships |
| `testingstrategy_event_outbox` | transactional Event publication |
| `testingstrategy_idempotency` | duplicate-write protection |
| `testingstrategy_exception` | exception, claim, dispute, or hold |
| `testingstrategy_correction` | correction and supersession lineage |
| `testingstrategy_audit` | privileged action evidence |
...
- `Testing Strategy` is part of the target GTOS handbook scope.
