# WhatsApp Admin — Routes, Pages, Components, and BFF Contracts

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P09-01` |
| Subject | `WhatsAppAdminRouteRegistry` |
...
This chapter defines how GTOS shall **inventory routes, layouts, pages, components, server/client boundaries, BFFs, APIs, realtime channels and ownership for channel operators and support managers, covering templates, consent, conversation routing, provider state, human handoff, audit**.
...
|---|---|
| `WhatsAppAdminRouteRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminRouteRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminRouteRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminRouteRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminRouteRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WhatsAppAdminRouteRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWhatsAppAdminRouteRegistry`
- `ValidateWhatsAppAdminRouteRegistry`
- `ApproveWhatsAppAdminRouteRegistry`
- `ActivateWhatsAppAdminRouteRegistry`
- `SuspendWhatsAppAdminRouteRegistry`
- `CorrectWhatsAppAdminRouteRegistry`
- `RetireWhatsAppAdminRouteRegistry`

Reference Events:

- `WhatsAppAdminRouteRegistryCreated`
- `WhatsAppAdminRouteRegistryValidated`
- `WhatsAppAdminRouteRegistryApproved`
- `WhatsAppAdminRouteRegistryActivated`
- `WhatsAppAdminRouteRegistrySuspended`
- `WhatsAppAdminRouteRegistryCorrected`
- `WhatsAppAdminRouteRegistryRetired`

Reference queries:

- `GetWhatsAppAdminRouteRegistry`
- `ListWhatsAppAdminRouteRegistryRecords`
- `GetWhatsAppAdminRouteRegistryTimeline`
- `GetWhatsAppAdminRouteRegistryEvidence`
- `GetWhatsAppAdminRouteRegistryDecisionPackage`
- `GetWhatsAppAdminRouteRegistryExceptions`
- `GetWhatsAppAdminRouteRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/whatsappadminrouteregistry/commands
GET  /api/v1/whatsappadminrouteregistry/{id}
GET  /api/v1/whatsappadminrouteregistry/{id}/timeline
GET  /api/v1/whatsappadminrouteregistry/{id}/evidence
GET  /api/v1/whatsappadminrouteregistry/{id}/decisions
POST /api/v1/whatsappadminrouteregistry/{id}/exceptions
POST /api/v1/whatsappadminrouteregistry/{id}/corrections
```
...
|---|---|
| `whatsappadminrouteregistry_aggregate` | authoritative subject |
| `whatsappadminrouteregistry_version` | immutable submitted, approved, issued, or signed versions |
| `whatsappadminrouteregistry_relationship` | governed relationships |
| `whatsappadminrouteregistry_decision` | binding Decisions and rationale |
| `whatsappadminrouteregistry_evidence_link` | provenance and evidence relationships |
| `whatsappadminrouteregistry_event_outbox` | transactional Event publication |
| `whatsappadminrouteregistry_idempotency` | duplicate-write protection |
| `whatsappadminrouteregistry_exception` | exception, claim, dispute, or hold |
| `whatsappadminrouteregistry_correction` | correction and supersession lineage |
| `whatsappadminrouteregistry_audit` | privileged action evidence |
