# Quality Dashboard — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P11-00` |
| Subject | `QualityDashboardPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for quality managers, inspectors and auditors, covering inspection plans, evidence, defects, nonconformance, release, corrective actions**.
...
|---|---|
| `QualityDashboardPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
QualityDashboardPortal {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateQualityDashboardPortal`
- `ValidateQualityDashboardPortal`
- `ApproveQualityDashboardPortal`
- `ActivateQualityDashboardPortal`
- `SuspendQualityDashboardPortal`
- `CorrectQualityDashboardPortal`
- `RetireQualityDashboardPortal`

Reference Events:

- `QualityDashboardPortalCreated`
- `QualityDashboardPortalValidated`
- `QualityDashboardPortalApproved`
- `QualityDashboardPortalActivated`
- `QualityDashboardPortalSuspended`
- `QualityDashboardPortalCorrected`
- `QualityDashboardPortalRetired`

Reference queries:

- `GetQualityDashboardPortal`
- `ListQualityDashboardPortalRecords`
- `GetQualityDashboardPortalTimeline`
- `GetQualityDashboardPortalEvidence`
- `GetQualityDashboardPortalDecisionPackage`
- `GetQualityDashboardPortalExceptions`
- `GetQualityDashboardPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/qualitydashboardportal/commands
GET  /api/v1/qualitydashboardportal/{id}
GET  /api/v1/qualitydashboardportal/{id}/timeline
GET  /api/v1/qualitydashboardportal/{id}/evidence
GET  /api/v1/qualitydashboardportal/{id}/decisions
POST /api/v1/qualitydashboardportal/{id}/exceptions
POST /api/v1/qualitydashboardportal/{id}/corrections
```
...
|---|---|
| `qualitydashboardportal_aggregate` | authoritative subject |
| `qualitydashboardportal_version` | immutable submitted, approved, issued, or signed versions |
| `qualitydashboardportal_relationship` | governed relationships |
| `qualitydashboardportal_decision` | binding Decisions and rationale |
| `qualitydashboardportal_evidence_link` | provenance and evidence relationships |
| `qualitydashboardportal_event_outbox` | transactional Event publication |
| `qualitydashboardportal_idempotency` | duplicate-write protection |
| `qualitydashboardportal_exception` | exception, claim, dispute, or hold |
| `qualitydashboardportal_correction` | correction and supersession lineage |
| `qualitydashboardportal_audit` | privileged action evidence |
