# Customer Portal — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P05-00` |
| Subject | `CustomerPortalPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for buyer organizations and users, covering identity, demand, RFQ, quotation, PI, payment, PO, production, quality, shipping, inventory, finance**.
...
|---|---|
| `CustomerPortalPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
CustomerPortalPortal {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateCustomerPortalPortal`
- `ValidateCustomerPortalPortal`
- `ApproveCustomerPortalPortal`
- `ActivateCustomerPortalPortal`
- `SuspendCustomerPortalPortal`
- `CorrectCustomerPortalPortal`
- `RetireCustomerPortalPortal`

Reference Events:

- `CustomerPortalPortalCreated`
- `CustomerPortalPortalValidated`
- `CustomerPortalPortalApproved`
- `CustomerPortalPortalActivated`
- `CustomerPortalPortalSuspended`
- `CustomerPortalPortalCorrected`
- `CustomerPortalPortalRetired`

Reference queries:

- `GetCustomerPortalPortal`
- `ListCustomerPortalPortalRecords`
- `GetCustomerPortalPortalTimeline`
- `GetCustomerPortalPortalEvidence`
- `GetCustomerPortalPortalDecisionPackage`
- `GetCustomerPortalPortalExceptions`
- `GetCustomerPortalPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/customerportalportal/commands
GET  /api/v1/customerportalportal/{id}
GET  /api/v1/customerportalportal/{id}/timeline
GET  /api/v1/customerportalportal/{id}/evidence
GET  /api/v1/customerportalportal/{id}/decisions
POST /api/v1/customerportalportal/{id}/exceptions
POST /api/v1/customerportalportal/{id}/corrections
```
...
|---|---|
| `customerportalportal_aggregate` | authoritative subject |
| `customerportalportal_version` | immutable submitted, approved, issued, or signed versions |
| `customerportalportal_relationship` | governed relationships |
| `customerportalportal_decision` | binding Decisions and rationale |
| `customerportalportal_evidence_link` | provenance and evidence relationships |
| `customerportalportal_event_outbox` | transactional Event publication |
| `customerportalportal_idempotency` | duplicate-write protection |
| `customerportalportal_exception` | exception, claim, dispute, or hold |
| `customerportalportal_correction` | correction and supersession lineage |
| `customerportalportal_audit` | privileged action evidence |
