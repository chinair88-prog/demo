# Customer Portal — Identity, Session, Authorization, and Trust Boundaries

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P05-02` |
| Subject | `CustomerPortalAccessModel` |
...
This chapter defines how GTOS shall **govern login, session, role, relationship, tenant, facility, channel, delegation, impersonation and privileged action for buyer organizations and users, covering identity, demand, RFQ, quotation, PI, payment, PO, production, quality, shipping, inventory, finance**.
...
|---|---|
| `CustomerPortalAccessModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalAccessModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalAccessModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalAccessModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalAccessModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
CustomerPortalAccessModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateCustomerPortalAccessModel`
- `ValidateCustomerPortalAccessModel`
- `ApproveCustomerPortalAccessModel`
- `ActivateCustomerPortalAccessModel`
- `SuspendCustomerPortalAccessModel`
- `CorrectCustomerPortalAccessModel`
- `RetireCustomerPortalAccessModel`

Reference Events:

- `CustomerPortalAccessModelCreated`
- `CustomerPortalAccessModelValidated`
- `CustomerPortalAccessModelApproved`
- `CustomerPortalAccessModelActivated`
- `CustomerPortalAccessModelSuspended`
- `CustomerPortalAccessModelCorrected`
- `CustomerPortalAccessModelRetired`

Reference queries:

- `GetCustomerPortalAccessModel`
- `ListCustomerPortalAccessModelRecords`
- `GetCustomerPortalAccessModelTimeline`
- `GetCustomerPortalAccessModelEvidence`
- `GetCustomerPortalAccessModelDecisionPackage`
- `GetCustomerPortalAccessModelExceptions`
- `GetCustomerPortalAccessModelAuditTrail`

Reference API surface:

```text
POST /api/v1/customerportalaccessmodel/commands
GET  /api/v1/customerportalaccessmodel/{id}
GET  /api/v1/customerportalaccessmodel/{id}/timeline
GET  /api/v1/customerportalaccessmodel/{id}/evidence
GET  /api/v1/customerportalaccessmodel/{id}/decisions
POST /api/v1/customerportalaccessmodel/{id}/exceptions
POST /api/v1/customerportalaccessmodel/{id}/corrections
```
...
|---|---|
| `customerportalaccessmodel_aggregate` | authoritative subject |
| `customerportalaccessmodel_version` | immutable submitted, approved, issued, or signed versions |
| `customerportalaccessmodel_relationship` | governed relationships |
| `customerportalaccessmodel_decision` | binding Decisions and rationale |
| `customerportalaccessmodel_evidence_link` | provenance and evidence relationships |
| `customerportalaccessmodel_event_outbox` | transactional Event publication |
| `customerportalaccessmodel_idempotency` | duplicate-write protection |
| `customerportalaccessmodel_exception` | exception, claim, dispute, or hold |
| `customerportalaccessmodel_correction` | correction and supersession lineage |
| `customerportalaccessmodel_audit` | privileged action evidence |
