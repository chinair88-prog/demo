# Customer Portal — Routes, Pages, Components, and BFF Contracts

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P05-01` |
| Subject | `CustomerPortalRouteRegistry` |
...
This chapter defines how GTOS shall **inventory routes, layouts, pages, components, server/client boundaries, BFFs, APIs, realtime channels and ownership for buyer organizations and users, covering identity, demand, RFQ, quotation, PI, payment, PO, production, quality, shipping, inventory, finance**.
...
|---|---|
| `CustomerPortalRouteRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalRouteRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalRouteRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalRouteRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalRouteRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
CustomerPortalRouteRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateCustomerPortalRouteRegistry`
- `ValidateCustomerPortalRouteRegistry`
- `ApproveCustomerPortalRouteRegistry`
- `ActivateCustomerPortalRouteRegistry`
- `SuspendCustomerPortalRouteRegistry`
- `CorrectCustomerPortalRouteRegistry`
- `RetireCustomerPortalRouteRegistry`

Reference Events:

- `CustomerPortalRouteRegistryCreated`
- `CustomerPortalRouteRegistryValidated`
- `CustomerPortalRouteRegistryApproved`
- `CustomerPortalRouteRegistryActivated`
- `CustomerPortalRouteRegistrySuspended`
- `CustomerPortalRouteRegistryCorrected`
- `CustomerPortalRouteRegistryRetired`

Reference queries:

- `GetCustomerPortalRouteRegistry`
- `ListCustomerPortalRouteRegistryRecords`
- `GetCustomerPortalRouteRegistryTimeline`
- `GetCustomerPortalRouteRegistryEvidence`
- `GetCustomerPortalRouteRegistryDecisionPackage`
- `GetCustomerPortalRouteRegistryExceptions`
- `GetCustomerPortalRouteRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/customerportalrouteregistry/commands
GET  /api/v1/customerportalrouteregistry/{id}
GET  /api/v1/customerportalrouteregistry/{id}/timeline
GET  /api/v1/customerportalrouteregistry/{id}/evidence
GET  /api/v1/customerportalrouteregistry/{id}/decisions
POST /api/v1/customerportalrouteregistry/{id}/exceptions
POST /api/v1/customerportalrouteregistry/{id}/corrections
```
...
|---|---|
| `customerportalrouteregistry_aggregate` | authoritative subject |
| `customerportalrouteregistry_version` | immutable submitted, approved, issued, or signed versions |
| `customerportalrouteregistry_relationship` | governed relationships |
| `customerportalrouteregistry_decision` | binding Decisions and rationale |
| `customerportalrouteregistry_evidence_link` | provenance and evidence relationships |
| `customerportalrouteregistry_event_outbox` | transactional Event publication |
| `customerportalrouteregistry_idempotency` | duplicate-write protection |
| `customerportalrouteregistry_exception` | exception, claim, dispute, or hold |
| `customerportalrouteregistry_correction` | correction and supersession lineage |
| `customerportalrouteregistry_audit` | privileged action evidence |
