# Developer Portal — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P08-00` |
| Subject | `DeveloperPortalPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for internal and external developers, covering API discovery, credentials, contracts, sandbox, webhook, documentation, certification**.
...
|---|---|
| `DeveloperPortalPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPortalPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPortalPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPortalPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeveloperPortalPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DeveloperPortalPortal {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDeveloperPortalPortal`
- `ValidateDeveloperPortalPortal`
- `ApproveDeveloperPortalPortal`
- `ActivateDeveloperPortalPortal`
- `SuspendDeveloperPortalPortal`
- `CorrectDeveloperPortalPortal`
- `RetireDeveloperPortalPortal`

Reference Events:

- `DeveloperPortalPortalCreated`
- `DeveloperPortalPortalValidated`
- `DeveloperPortalPortalApproved`
- `DeveloperPortalPortalActivated`
- `DeveloperPortalPortalSuspended`
- `DeveloperPortalPortalCorrected`
- `DeveloperPortalPortalRetired`

Reference queries:

- `GetDeveloperPortalPortal`
- `ListDeveloperPortalPortalRecords`
- `GetDeveloperPortalPortalTimeline`
- `GetDeveloperPortalPortalEvidence`
- `GetDeveloperPortalPortalDecisionPackage`
- `GetDeveloperPortalPortalExceptions`
- `GetDeveloperPortalPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/developerportalportal/commands
GET  /api/v1/developerportalportal/{id}
GET  /api/v1/developerportalportal/{id}/timeline
GET  /api/v1/developerportalportal/{id}/evidence
GET  /api/v1/developerportalportal/{id}/decisions
POST /api/v1/developerportalportal/{id}/exceptions
POST /api/v1/developerportalportal/{id}/corrections
```
...
|---|---|
| `developerportalportal_aggregate` | authoritative subject |
| `developerportalportal_version` | immutable submitted, approved, issued, or signed versions |
| `developerportalportal_relationship` | governed relationships |
| `developerportalportal_decision` | binding Decisions and rationale |
| `developerportalportal_evidence_link` | provenance and evidence relationships |
| `developerportalportal_event_outbox` | transactional Event publication |
| `developerportalportal_idempotency` | duplicate-write protection |
| `developerportalportal_exception` | exception, claim, dispute, or hold |
| `developerportalportal_correction` | correction and supersession lineage |
| `developerportalportal_audit` | privileged action evidence |
