# Partner Portal — Identity, Session, Authorization, and Trust Boundaries

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P07-02` |
| Subject | `PartnerPortalAccessModel` |
...
This chapter defines how GTOS shall **govern login, session, role, relationship, tenant, facility, channel, delegation, impersonation and privileged action for suppliers, factories and commercial partners, covering profile, products, quotations, PI, PO, production, quality, documents, settlement**.
...
|---|---|
| `PartnerPortalAccessModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalAccessModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalAccessModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalAccessModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalAccessModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PartnerPortalAccessModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePartnerPortalAccessModel`
- `ValidatePartnerPortalAccessModel`
- `ApprovePartnerPortalAccessModel`
- `ActivatePartnerPortalAccessModel`
- `SuspendPartnerPortalAccessModel`
- `CorrectPartnerPortalAccessModel`
- `RetirePartnerPortalAccessModel`

Reference Events:

- `PartnerPortalAccessModelCreated`
- `PartnerPortalAccessModelValidated`
- `PartnerPortalAccessModelApproved`
- `PartnerPortalAccessModelActivated`
- `PartnerPortalAccessModelSuspended`
- `PartnerPortalAccessModelCorrected`
- `PartnerPortalAccessModelRetired`

Reference queries:

- `GetPartnerPortalAccessModel`
- `ListPartnerPortalAccessModelRecords`
- `GetPartnerPortalAccessModelTimeline`
- `GetPartnerPortalAccessModelEvidence`
- `GetPartnerPortalAccessModelDecisionPackage`
- `GetPartnerPortalAccessModelExceptions`
- `GetPartnerPortalAccessModelAuditTrail`

Reference API surface:

```text
POST /api/v1/partnerportalaccessmodel/commands
GET  /api/v1/partnerportalaccessmodel/{id}
GET  /api/v1/partnerportalaccessmodel/{id}/timeline
GET  /api/v1/partnerportalaccessmodel/{id}/evidence
GET  /api/v1/partnerportalaccessmodel/{id}/decisions
POST /api/v1/partnerportalaccessmodel/{id}/exceptions
POST /api/v1/partnerportalaccessmodel/{id}/corrections
```
...
|---|---|
| `partnerportalaccessmodel_aggregate` | authoritative subject |
| `partnerportalaccessmodel_version` | immutable submitted, approved, issued, or signed versions |
| `partnerportalaccessmodel_relationship` | governed relationships |
| `partnerportalaccessmodel_decision` | binding Decisions and rationale |
| `partnerportalaccessmodel_evidence_link` | provenance and evidence relationships |
| `partnerportalaccessmodel_event_outbox` | transactional Event publication |
| `partnerportalaccessmodel_idempotency` | duplicate-write protection |
| `partnerportalaccessmodel_exception` | exception, claim, dispute, or hold |
| `partnerportalaccessmodel_correction` | correction and supersession lineage |
| `partnerportalaccessmodel_audit` | privileged action evidence |
