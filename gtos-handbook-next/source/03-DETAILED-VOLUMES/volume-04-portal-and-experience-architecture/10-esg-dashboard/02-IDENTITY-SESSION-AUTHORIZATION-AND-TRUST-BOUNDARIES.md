# ESG Dashboard — Identity, Session, Authorization, and Trust Boundaries

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P10-02` |
| Subject | `ESGDashboardAccessModel` |
...
This chapter defines how GTOS shall **govern login, session, role, relationship, tenant, facility, channel, delegation, impersonation and privileged action for sustainability, compliance and executive users, covering ESG metrics, evidence, lineage, methodology, uncertainty, reporting**.
...
|---|---|
| `ESGDashboardAccessModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardAccessModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardAccessModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardAccessModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardAccessModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ESGDashboardAccessModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateESGDashboardAccessModel`
- `ValidateESGDashboardAccessModel`
- `ApproveESGDashboardAccessModel`
- `ActivateESGDashboardAccessModel`
- `SuspendESGDashboardAccessModel`
- `CorrectESGDashboardAccessModel`
- `RetireESGDashboardAccessModel`

Reference Events:

- `ESGDashboardAccessModelCreated`
- `ESGDashboardAccessModelValidated`
- `ESGDashboardAccessModelApproved`
- `ESGDashboardAccessModelActivated`
- `ESGDashboardAccessModelSuspended`
- `ESGDashboardAccessModelCorrected`
- `ESGDashboardAccessModelRetired`

Reference queries:

- `GetESGDashboardAccessModel`
- `ListESGDashboardAccessModelRecords`
- `GetESGDashboardAccessModelTimeline`
- `GetESGDashboardAccessModelEvidence`
- `GetESGDashboardAccessModelDecisionPackage`
- `GetESGDashboardAccessModelExceptions`
- `GetESGDashboardAccessModelAuditTrail`

Reference API surface:

```text
POST /api/v1/esgdashboardaccessmodel/commands
GET  /api/v1/esgdashboardaccessmodel/{id}
GET  /api/v1/esgdashboardaccessmodel/{id}/timeline
GET  /api/v1/esgdashboardaccessmodel/{id}/evidence
GET  /api/v1/esgdashboardaccessmodel/{id}/decisions
POST /api/v1/esgdashboardaccessmodel/{id}/exceptions
POST /api/v1/esgdashboardaccessmodel/{id}/corrections
```
...
|---|---|
| `esgdashboardaccessmodel_aggregate` | authoritative subject |
| `esgdashboardaccessmodel_version` | immutable submitted, approved, issued, or signed versions |
| `esgdashboardaccessmodel_relationship` | governed relationships |
| `esgdashboardaccessmodel_decision` | binding Decisions and rationale |
| `esgdashboardaccessmodel_evidence_link` | provenance and evidence relationships |
| `esgdashboardaccessmodel_event_outbox` | transactional Event publication |
| `esgdashboardaccessmodel_idempotency` | duplicate-write protection |
| `esgdashboardaccessmodel_exception` | exception, claim, dispute, or hold |
| `esgdashboardaccessmodel_correction` | correction and supersession lineage |
| `esgdashboardaccessmodel_audit` | privileged action evidence |
