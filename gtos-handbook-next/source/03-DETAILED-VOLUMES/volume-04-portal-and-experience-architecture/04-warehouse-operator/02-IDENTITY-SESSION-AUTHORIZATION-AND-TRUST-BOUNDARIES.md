# Warehouse Operator — Identity, Session, Authorization, and Trust Boundaries

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P04-02` |
| Subject | `WarehouseOperatorAccessModel` |
...
This chapter defines how GTOS shall **govern login, session, role, relationship, tenant, facility, channel, delegation, impersonation and privileged action for warehouse staff and supervisors, covering receiving, putaway, inventory, picking, packing, dispatch, counts, discrepancies**.
...
|---|---|
| `WarehouseOperatorAccessModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorAccessModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorAccessModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorAccessModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorAccessModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WarehouseOperatorAccessModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWarehouseOperatorAccessModel`
- `ValidateWarehouseOperatorAccessModel`
- `ApproveWarehouseOperatorAccessModel`
- `ActivateWarehouseOperatorAccessModel`
- `SuspendWarehouseOperatorAccessModel`
- `CorrectWarehouseOperatorAccessModel`
- `RetireWarehouseOperatorAccessModel`

Reference Events:

- `WarehouseOperatorAccessModelCreated`
- `WarehouseOperatorAccessModelValidated`
- `WarehouseOperatorAccessModelApproved`
- `WarehouseOperatorAccessModelActivated`
- `WarehouseOperatorAccessModelSuspended`
- `WarehouseOperatorAccessModelCorrected`
- `WarehouseOperatorAccessModelRetired`

Reference queries:

- `GetWarehouseOperatorAccessModel`
- `ListWarehouseOperatorAccessModelRecords`
- `GetWarehouseOperatorAccessModelTimeline`
- `GetWarehouseOperatorAccessModelEvidence`
- `GetWarehouseOperatorAccessModelDecisionPackage`
- `GetWarehouseOperatorAccessModelExceptions`
- `GetWarehouseOperatorAccessModelAuditTrail`

Reference API surface:

```text
POST /api/v1/warehouseoperatoraccessmodel/commands
GET  /api/v1/warehouseoperatoraccessmodel/{id}
GET  /api/v1/warehouseoperatoraccessmodel/{id}/timeline
GET  /api/v1/warehouseoperatoraccessmodel/{id}/evidence
GET  /api/v1/warehouseoperatoraccessmodel/{id}/decisions
POST /api/v1/warehouseoperatoraccessmodel/{id}/exceptions
POST /api/v1/warehouseoperatoraccessmodel/{id}/corrections
```
...
|---|---|
| `warehouseoperatoraccessmodel_aggregate` | authoritative subject |
| `warehouseoperatoraccessmodel_version` | immutable submitted, approved, issued, or signed versions |
| `warehouseoperatoraccessmodel_relationship` | governed relationships |
| `warehouseoperatoraccessmodel_decision` | binding Decisions and rationale |
| `warehouseoperatoraccessmodel_evidence_link` | provenance and evidence relationships |
| `warehouseoperatoraccessmodel_event_outbox` | transactional Event publication |
| `warehouseoperatoraccessmodel_idempotency` | duplicate-write protection |
| `warehouseoperatoraccessmodel_exception` | exception, claim, dispute, or hold |
| `warehouseoperatoraccessmodel_correction` | correction and supersession lineage |
| `warehouseoperatoraccessmodel_audit` | privileged action evidence |
