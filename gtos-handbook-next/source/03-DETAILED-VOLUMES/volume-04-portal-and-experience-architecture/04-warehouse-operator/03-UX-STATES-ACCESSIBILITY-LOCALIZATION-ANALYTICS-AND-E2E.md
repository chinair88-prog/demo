# Warehouse Operator — UX States, Accessibility, Localization, Analytics, and E2E

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P04-03` |
| Subject | `WarehouseOperatorExperienceStandard` |
...
| Accountable owner | Portal Architecture / Warehouse Operator |
...
This chapter defines how GTOS shall **specify loading, empty, partial, stale, error, denied, offline, accessibility, RTL/LTR, analytics, audit and test journeys for warehouse staff and supervisors, covering receiving, putaway, inventory, picking, packing, dispatch, counts, discrepancies**.
...
The accountable owner is **Portal Architecture / Warehouse Operator**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `WarehouseOperatorExperienceStandard` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorExperienceStandardVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorExperienceStandardDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorExperienceStandardEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorExperienceStandardException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WarehouseOperatorExperienceStandard {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWarehouseOperatorExperienceStandard`
- `ValidateWarehouseOperatorExperienceStandard`
- `ApproveWarehouseOperatorExperienceStandard`
- `ActivateWarehouseOperatorExperienceStandard`
- `SuspendWarehouseOperatorExperienceStandard`
- `CorrectWarehouseOperatorExperienceStandard`
- `RetireWarehouseOperatorExperienceStandard`

Reference Events:

- `WarehouseOperatorExperienceStandardCreated`
- `WarehouseOperatorExperienceStandardValidated`
- `WarehouseOperatorExperienceStandardApproved`
- `WarehouseOperatorExperienceStandardActivated`
- `WarehouseOperatorExperienceStandardSuspended`
- `WarehouseOperatorExperienceStandardCorrected`
- `WarehouseOperatorExperienceStandardRetired`

Reference queries:

- `GetWarehouseOperatorExperienceStandard`
- `ListWarehouseOperatorExperienceStandardRecords`
- `GetWarehouseOperatorExperienceStandardTimeline`
- `GetWarehouseOperatorExperienceStandardEvidence`
- `GetWarehouseOperatorExperienceStandardDecisionPackage`
- `GetWarehouseOperatorExperienceStandardExceptions`
- `GetWarehouseOperatorExperienceStandardAuditTrail`

Reference API surface:

```text
POST /api/v1/warehouseoperatorexperiencestandard/commands
GET  /api/v1/warehouseoperatorexperiencestandard/{id}
GET  /api/v1/warehouseoperatorexperiencestandard/{id}/timeline
GET  /api/v1/warehouseoperatorexperiencestandard/{id}/evidence
GET  /api/v1/warehouseoperatorexperiencestandard/{id}/decisions
POST /api/v1/warehouseoperatorexperiencestandard/{id}/exceptions
POST /api/v1/warehouseoperatorexperiencestandard/{id}/corrections
```
...
|---|---|
| `warehouseoperatorexperiencestandard_aggregate` | authoritative subject |
| `warehouseoperatorexperiencestandard_version` | immutable submitted, approved, issued, or signed versions |
| `warehouseoperatorexperiencestandard_relationship` | governed relationships |
| `warehouseoperatorexperiencestandard_decision` | binding Decisions and rationale |
| `warehouseoperatorexperiencestandard_evidence_link` | provenance and evidence relationships |
| `warehouseoperatorexperiencestandard_event_outbox` | transactional Event publication |
| `warehouseoperatorexperiencestandard_idempotency` | duplicate-write protection |
| `warehouseoperatorexperiencestandard_exception` | exception, claim, dispute, or hold |
| `warehouseoperatorexperiencestandard_correction` | correction and supersession lineage |
| `warehouseoperatorexperiencestandard_audit` | privileged action evidence |
...
- Warehouse Operator: primary experience for warehouse staff and supervisors.
