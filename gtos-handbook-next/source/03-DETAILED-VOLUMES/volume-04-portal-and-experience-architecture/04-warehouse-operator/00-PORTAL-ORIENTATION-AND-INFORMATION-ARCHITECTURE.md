# Warehouse Operator — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P04-00` |
| Subject | `WarehouseOperatorPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for warehouse staff and supervisors, covering receiving, putaway, inventory, picking, packing, dispatch, counts, discrepancies**.
...
|---|---|
| `WarehouseOperatorPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WarehouseOperatorPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWarehouseOperatorPortal`
- `ValidateWarehouseOperatorPortal`
- `ApproveWarehouseOperatorPortal`
- `ActivateWarehouseOperatorPortal`
- `SuspendWarehouseOperatorPortal`
- `CorrectWarehouseOperatorPortal`
- `RetireWarehouseOperatorPortal`

Reference Events:

- `WarehouseOperatorPortalCreated`
- `WarehouseOperatorPortalValidated`
- `WarehouseOperatorPortalApproved`
- `WarehouseOperatorPortalActivated`
- `WarehouseOperatorPortalSuspended`
- `WarehouseOperatorPortalCorrected`
- `WarehouseOperatorPortalRetired`

Reference queries:

- `GetWarehouseOperatorPortal`
- `ListWarehouseOperatorPortalRecords`
- `GetWarehouseOperatorPortalTimeline`
- `GetWarehouseOperatorPortalEvidence`
- `GetWarehouseOperatorPortalDecisionPackage`
- `GetWarehouseOperatorPortalExceptions`
- `GetWarehouseOperatorPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/warehouseoperatorportal/commands
GET  /api/v1/warehouseoperatorportal/{id}
GET  /api/v1/warehouseoperatorportal/{id}/timeline
GET  /api/v1/warehouseoperatorportal/{id}/evidence
GET  /api/v1/warehouseoperatorportal/{id}/decisions
POST /api/v1/warehouseoperatorportal/{id}/exceptions
POST /api/v1/warehouseoperatorportal/{id}/corrections
```
...
|---|---|
| `warehouseoperatorportal_aggregate` | authoritative subject |
| `warehouseoperatorportal_version` | immutable submitted, approved, issued, or signed versions |
| `warehouseoperatorportal_relationship` | governed relationships |
| `warehouseoperatorportal_decision` | binding Decisions and rationale |
| `warehouseoperatorportal_evidence_link` | provenance and evidence relationships |
| `warehouseoperatorportal_event_outbox` | transactional Event publication |
| `warehouseoperatorportal_idempotency` | duplicate-write protection |
| `warehouseoperatorportal_exception` | exception, claim, dispute, or hold |
| `warehouseoperatorportal_correction` | correction and supersession lineage |
| `warehouseoperatorportal_audit` | privileged action evidence |
