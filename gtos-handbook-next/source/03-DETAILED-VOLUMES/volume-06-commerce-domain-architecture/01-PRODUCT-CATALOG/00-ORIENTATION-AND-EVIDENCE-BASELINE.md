# Product Catalog — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-01-00` |
| Subject | `ProductCatalogDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Product Catalog**.
...
|---|---|
| `ProductCatalogDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateProductCatalogDomain`
- `ValidateProductCatalogDomain`
- `ApproveProductCatalogDomain`
- `ActivateProductCatalogDomain`
- `SuspendProductCatalogDomain`
- `CorrectProductCatalogDomain`
- `RetireProductCatalogDomain`

Reference Events:

- `ProductCatalogDomainCreated`
- `ProductCatalogDomainValidated`
- `ProductCatalogDomainApproved`
- `ProductCatalogDomainActivated`
- `ProductCatalogDomainSuspended`
- `ProductCatalogDomainCorrected`
- `ProductCatalogDomainRetired`

Reference queries:

- `GetProductCatalogDomain`
- `ListProductCatalogDomainRecords`
- `GetProductCatalogDomainTimeline`
- `GetProductCatalogDomainEvidence`
- `GetProductCatalogDomainDecisionPackage`
- `GetProductCatalogDomainExceptions`
- `GetProductCatalogDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/productcatalogdomain/commands
GET  /api/v1/productcatalogdomain/{id}
GET  /api/v1/productcatalogdomain/{id}/timeline
GET  /api/v1/productcatalogdomain/{id}/evidence
GET  /api/v1/productcatalogdomain/{id}/decisions
POST /api/v1/productcatalogdomain/{id}/exceptions
POST /api/v1/productcatalogdomain/{id}/corrections
```
...
|---|---|
| `productcatalogdomain_aggregate` | authoritative subject |
| `productcatalogdomain_version` | immutable submitted, approved, issued, or signed versions |
| `productcatalogdomain_relationship` | governed relationships |
| `productcatalogdomain_decision` | binding Decisions and rationale |
| `productcatalogdomain_evidence_link` | provenance and evidence relationships |
| `productcatalogdomain_event_outbox` | transactional Event publication |
| `productcatalogdomain_idempotency` | duplicate-write protection |
| `productcatalogdomain_exception` | exception, claim, dispute, or hold |
| `productcatalogdomain_correction` | correction and supersession lineage |
| `productcatalogdomain_audit` | privileged action evidence |
