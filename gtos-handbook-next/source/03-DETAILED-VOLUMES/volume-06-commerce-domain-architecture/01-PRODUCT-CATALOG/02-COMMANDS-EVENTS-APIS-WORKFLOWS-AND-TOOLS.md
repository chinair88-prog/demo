# Product Catalog — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-01-02` |
| Subject | `ProductCatalogContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Product Catalog**.
...
|---|---|
| `ProductCatalogContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ProductCatalogContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateProductCatalogContractModel`
- `ValidateProductCatalogContractModel`
- `ApproveProductCatalogContractModel`
- `ActivateProductCatalogContractModel`
- `SuspendProductCatalogContractModel`
- `CorrectProductCatalogContractModel`
- `RetireProductCatalogContractModel`

Reference Events:

- `ProductCatalogContractModelCreated`
- `ProductCatalogContractModelValidated`
- `ProductCatalogContractModelApproved`
- `ProductCatalogContractModelActivated`
- `ProductCatalogContractModelSuspended`
- `ProductCatalogContractModelCorrected`
- `ProductCatalogContractModelRetired`

Reference queries:

- `GetProductCatalogContractModel`
- `ListProductCatalogContractModelRecords`
- `GetProductCatalogContractModelTimeline`
- `GetProductCatalogContractModelEvidence`
- `GetProductCatalogContractModelDecisionPackage`
- `GetProductCatalogContractModelExceptions`
- `GetProductCatalogContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/productcatalogcontractmodel/commands
GET  /api/v1/productcatalogcontractmodel/{id}
GET  /api/v1/productcatalogcontractmodel/{id}/timeline
GET  /api/v1/productcatalogcontractmodel/{id}/evidence
GET  /api/v1/productcatalogcontractmodel/{id}/decisions
POST /api/v1/productcatalogcontractmodel/{id}/exceptions
POST /api/v1/productcatalogcontractmodel/{id}/corrections
```
...
|---|---|
| `productcatalogcontractmodel_aggregate` | authoritative subject |
| `productcatalogcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `productcatalogcontractmodel_relationship` | governed relationships |
| `productcatalogcontractmodel_decision` | binding Decisions and rationale |
| `productcatalogcontractmodel_evidence_link` | provenance and evidence relationships |
| `productcatalogcontractmodel_event_outbox` | transactional Event publication |
| `productcatalogcontractmodel_idempotency` | duplicate-write protection |
| `productcatalogcontractmodel_exception` | exception, claim, dispute, or hold |
| `productcatalogcontractmodel_correction` | correction and supersession lineage |
| `productcatalogcontractmodel_audit` | privileged action evidence |
