# Product Catalog — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-01-01` |
| Subject | `ProductCatalogAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Product Catalog**.
...
|---|---|
| `ProductCatalogAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ProductCatalogAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateProductCatalogAggregateModel`
- `ValidateProductCatalogAggregateModel`
- `ApproveProductCatalogAggregateModel`
- `ActivateProductCatalogAggregateModel`
- `SuspendProductCatalogAggregateModel`
- `CorrectProductCatalogAggregateModel`
- `RetireProductCatalogAggregateModel`

Reference Events:

- `ProductCatalogAggregateModelCreated`
- `ProductCatalogAggregateModelValidated`
- `ProductCatalogAggregateModelApproved`
- `ProductCatalogAggregateModelActivated`
- `ProductCatalogAggregateModelSuspended`
- `ProductCatalogAggregateModelCorrected`
- `ProductCatalogAggregateModelRetired`

Reference queries:

- `GetProductCatalogAggregateModel`
- `ListProductCatalogAggregateModelRecords`
- `GetProductCatalogAggregateModelTimeline`
- `GetProductCatalogAggregateModelEvidence`
- `GetProductCatalogAggregateModelDecisionPackage`
- `GetProductCatalogAggregateModelExceptions`
- `GetProductCatalogAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/productcatalogaggregatemodel/commands
GET  /api/v1/productcatalogaggregatemodel/{id}
GET  /api/v1/productcatalogaggregatemodel/{id}/timeline
GET  /api/v1/productcatalogaggregatemodel/{id}/evidence
GET  /api/v1/productcatalogaggregatemodel/{id}/decisions
POST /api/v1/productcatalogaggregatemodel/{id}/exceptions
POST /api/v1/productcatalogaggregatemodel/{id}/corrections
```
...
|---|---|
| `productcatalogaggregatemodel_aggregate` | authoritative subject |
| `productcatalogaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `productcatalogaggregatemodel_relationship` | governed relationships |
| `productcatalogaggregatemodel_decision` | binding Decisions and rationale |
| `productcatalogaggregatemodel_evidence_link` | provenance and evidence relationships |
| `productcatalogaggregatemodel_event_outbox` | transactional Event publication |
| `productcatalogaggregatemodel_idempotency` | duplicate-write protection |
| `productcatalogaggregatemodel_exception` | exception, claim, dispute, or hold |
| `productcatalogaggregatemodel_correction` | correction and supersession lineage |
| `productcatalogaggregatemodel_audit` | privileged action evidence |
