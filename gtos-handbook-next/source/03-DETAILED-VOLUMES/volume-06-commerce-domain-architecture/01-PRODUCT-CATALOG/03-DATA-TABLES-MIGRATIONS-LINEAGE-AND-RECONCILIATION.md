# Product Catalog — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-01-03` |
| Subject | `ProductCatalogDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Product Catalog**.
...
|---|---|
| `ProductCatalogDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProductCatalogDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateProductCatalogDataModel`
- `ValidateProductCatalogDataModel`
- `ApproveProductCatalogDataModel`
- `ActivateProductCatalogDataModel`
- `SuspendProductCatalogDataModel`
- `CorrectProductCatalogDataModel`
- `RetireProductCatalogDataModel`

Reference Events:

- `ProductCatalogDataModelCreated`
- `ProductCatalogDataModelValidated`
- `ProductCatalogDataModelApproved`
- `ProductCatalogDataModelActivated`
- `ProductCatalogDataModelSuspended`
- `ProductCatalogDataModelCorrected`
- `ProductCatalogDataModelRetired`

Reference queries:

- `GetProductCatalogDataModel`
- `ListProductCatalogDataModelRecords`
- `GetProductCatalogDataModelTimeline`
- `GetProductCatalogDataModelEvidence`
- `GetProductCatalogDataModelDecisionPackage`
- `GetProductCatalogDataModelExceptions`
- `GetProductCatalogDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/productcatalogdatamodel/commands
GET  /api/v1/productcatalogdatamodel/{id}
GET  /api/v1/productcatalogdatamodel/{id}/timeline
GET  /api/v1/productcatalogdatamodel/{id}/evidence
GET  /api/v1/productcatalogdatamodel/{id}/decisions
POST /api/v1/productcatalogdatamodel/{id}/exceptions
POST /api/v1/productcatalogdatamodel/{id}/corrections
```
...
|---|---|
| `productcatalogdatamodel_aggregate` | authoritative subject |
| `productcatalogdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `productcatalogdatamodel_relationship` | governed relationships |
| `productcatalogdatamodel_decision` | binding Decisions and rationale |
| `productcatalogdatamodel_evidence_link` | provenance and evidence relationships |
| `productcatalogdatamodel_event_outbox` | transactional Event publication |
| `productcatalogdatamodel_idempotency` | duplicate-write protection |
| `productcatalogdatamodel_exception` | exception, claim, dispute, or hold |
| `productcatalogdatamodel_correction` | correction and supersession lineage |
| `productcatalogdatamodel_audit` | privileged action evidence |
