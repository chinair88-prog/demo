# Billing — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-10-01` |
| Subject | `BillingAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Billing**.
...
|---|---|
| `BillingAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
BillingAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateBillingAggregateModel`
- `ValidateBillingAggregateModel`
- `ApproveBillingAggregateModel`
- `ActivateBillingAggregateModel`
- `SuspendBillingAggregateModel`
- `CorrectBillingAggregateModel`
- `RetireBillingAggregateModel`

Reference Events:

- `BillingAggregateModelCreated`
- `BillingAggregateModelValidated`
- `BillingAggregateModelApproved`
- `BillingAggregateModelActivated`
- `BillingAggregateModelSuspended`
- `BillingAggregateModelCorrected`
- `BillingAggregateModelRetired`

Reference queries:

- `GetBillingAggregateModel`
- `ListBillingAggregateModelRecords`
- `GetBillingAggregateModelTimeline`
- `GetBillingAggregateModelEvidence`
- `GetBillingAggregateModelDecisionPackage`
- `GetBillingAggregateModelExceptions`
- `GetBillingAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/billingaggregatemodel/commands
GET  /api/v1/billingaggregatemodel/{id}
GET  /api/v1/billingaggregatemodel/{id}/timeline
GET  /api/v1/billingaggregatemodel/{id}/evidence
GET  /api/v1/billingaggregatemodel/{id}/decisions
POST /api/v1/billingaggregatemodel/{id}/exceptions
POST /api/v1/billingaggregatemodel/{id}/corrections
```
...
|---|---|
| `billingaggregatemodel_aggregate` | authoritative subject |
| `billingaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `billingaggregatemodel_relationship` | governed relationships |
| `billingaggregatemodel_decision` | binding Decisions and rationale |
| `billingaggregatemodel_evidence_link` | provenance and evidence relationships |
| `billingaggregatemodel_event_outbox` | transactional Event publication |
| `billingaggregatemodel_idempotency` | duplicate-write protection |
| `billingaggregatemodel_exception` | exception, claim, dispute, or hold |
| `billingaggregatemodel_correction` | correction and supersession lineage |
| `billingaggregatemodel_audit` | privileged action evidence |
