# Billing — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-10-03` |
| Subject | `BillingDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Billing**.
...
|---|---|
| `BillingDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateBillingDataModel`
- `ValidateBillingDataModel`
- `ApproveBillingDataModel`
- `ActivateBillingDataModel`
- `SuspendBillingDataModel`
- `CorrectBillingDataModel`
- `RetireBillingDataModel`

Reference Events:

- `BillingDataModelCreated`
- `BillingDataModelValidated`
- `BillingDataModelApproved`
- `BillingDataModelActivated`
- `BillingDataModelSuspended`
- `BillingDataModelCorrected`
- `BillingDataModelRetired`

Reference queries:

- `GetBillingDataModel`
- `ListBillingDataModelRecords`
- `GetBillingDataModelTimeline`
- `GetBillingDataModelEvidence`
- `GetBillingDataModelDecisionPackage`
- `GetBillingDataModelExceptions`
- `GetBillingDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/billingdatamodel/commands
GET  /api/v1/billingdatamodel/{id}
GET  /api/v1/billingdatamodel/{id}/timeline
GET  /api/v1/billingdatamodel/{id}/evidence
GET  /api/v1/billingdatamodel/{id}/decisions
POST /api/v1/billingdatamodel/{id}/exceptions
POST /api/v1/billingdatamodel/{id}/corrections
```
...
|---|---|
| `billingdatamodel_aggregate` | authoritative subject |
| `billingdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `billingdatamodel_relationship` | governed relationships |
| `billingdatamodel_decision` | binding Decisions and rationale |
| `billingdatamodel_evidence_link` | provenance and evidence relationships |
| `billingdatamodel_event_outbox` | transactional Event publication |
| `billingdatamodel_idempotency` | duplicate-write protection |
| `billingdatamodel_exception` | exception, claim, dispute, or hold |
| `billingdatamodel_correction` | correction and supersession lineage |
| `billingdatamodel_audit` | privileged action evidence |
