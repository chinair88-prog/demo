# Finance Control — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-11-03` |
| Subject | `FinanceControlDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Finance Control**.
...
|---|---|
| `FinanceControlDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
FinanceControlDataModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateFinanceControlDataModel`
- `ValidateFinanceControlDataModel`
- `ApproveFinanceControlDataModel`
- `ActivateFinanceControlDataModel`
- `SuspendFinanceControlDataModel`
- `CorrectFinanceControlDataModel`
- `RetireFinanceControlDataModel`

Reference Events:

- `FinanceControlDataModelCreated`
- `FinanceControlDataModelValidated`
- `FinanceControlDataModelApproved`
- `FinanceControlDataModelActivated`
- `FinanceControlDataModelSuspended`
- `FinanceControlDataModelCorrected`
- `FinanceControlDataModelRetired`

Reference queries:

- `GetFinanceControlDataModel`
- `ListFinanceControlDataModelRecords`
- `GetFinanceControlDataModelTimeline`
- `GetFinanceControlDataModelEvidence`
- `GetFinanceControlDataModelDecisionPackage`
- `GetFinanceControlDataModelExceptions`
- `GetFinanceControlDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/financecontroldatamodel/commands
GET  /api/v1/financecontroldatamodel/{id}
GET  /api/v1/financecontroldatamodel/{id}/timeline
GET  /api/v1/financecontroldatamodel/{id}/evidence
GET  /api/v1/financecontroldatamodel/{id}/decisions
POST /api/v1/financecontroldatamodel/{id}/exceptions
POST /api/v1/financecontroldatamodel/{id}/corrections
```
...
|---|---|
| `financecontroldatamodel_aggregate` | authoritative subject |
| `financecontroldatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `financecontroldatamodel_relationship` | governed relationships |
| `financecontroldatamodel_decision` | binding Decisions and rationale |
| `financecontroldatamodel_evidence_link` | provenance and evidence relationships |
| `financecontroldatamodel_event_outbox` | transactional Event publication |
| `financecontroldatamodel_idempotency` | duplicate-write protection |
| `financecontroldatamodel_exception` | exception, claim, dispute, or hold |
| `financecontroldatamodel_correction` | correction and supersession lineage |
| `financecontroldatamodel_audit` | privileged action evidence |
