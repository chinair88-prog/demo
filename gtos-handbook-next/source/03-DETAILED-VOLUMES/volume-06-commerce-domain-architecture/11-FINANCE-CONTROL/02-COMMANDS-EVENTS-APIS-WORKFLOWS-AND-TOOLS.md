# Finance Control — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-11-02` |
| Subject | `FinanceControlContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Finance Control**.
...
|---|---|
| `FinanceControlContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
FinanceControlContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateFinanceControlContractModel`
- `ValidateFinanceControlContractModel`
- `ApproveFinanceControlContractModel`
- `ActivateFinanceControlContractModel`
- `SuspendFinanceControlContractModel`
- `CorrectFinanceControlContractModel`
- `RetireFinanceControlContractModel`

Reference Events:

- `FinanceControlContractModelCreated`
- `FinanceControlContractModelValidated`
- `FinanceControlContractModelApproved`
- `FinanceControlContractModelActivated`
- `FinanceControlContractModelSuspended`
- `FinanceControlContractModelCorrected`
- `FinanceControlContractModelRetired`

Reference queries:

- `GetFinanceControlContractModel`
- `ListFinanceControlContractModelRecords`
- `GetFinanceControlContractModelTimeline`
- `GetFinanceControlContractModelEvidence`
- `GetFinanceControlContractModelDecisionPackage`
- `GetFinanceControlContractModelExceptions`
- `GetFinanceControlContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/financecontrolcontractmodel/commands
GET  /api/v1/financecontrolcontractmodel/{id}
GET  /api/v1/financecontrolcontractmodel/{id}/timeline
GET  /api/v1/financecontrolcontractmodel/{id}/evidence
GET  /api/v1/financecontrolcontractmodel/{id}/decisions
POST /api/v1/financecontrolcontractmodel/{id}/exceptions
POST /api/v1/financecontrolcontractmodel/{id}/corrections
```
...
|---|---|
| `financecontrolcontractmodel_aggregate` | authoritative subject |
| `financecontrolcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `financecontrolcontractmodel_relationship` | governed relationships |
| `financecontrolcontractmodel_decision` | binding Decisions and rationale |
| `financecontrolcontractmodel_evidence_link` | provenance and evidence relationships |
| `financecontrolcontractmodel_event_outbox` | transactional Event publication |
| `financecontrolcontractmodel_idempotency` | duplicate-write protection |
| `financecontrolcontractmodel_exception` | exception, claim, dispute, or hold |
| `financecontrolcontractmodel_correction` | correction and supersession lineage |
| `financecontrolcontractmodel_audit` | privileged action evidence |
