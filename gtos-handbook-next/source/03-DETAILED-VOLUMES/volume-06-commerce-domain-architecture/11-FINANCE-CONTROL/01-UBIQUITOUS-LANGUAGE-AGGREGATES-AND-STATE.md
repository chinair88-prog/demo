# Finance Control — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-11-01` |
| Subject | `FinanceControlAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Finance Control**.
...
|---|---|
| `FinanceControlAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinanceControlAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
FinanceControlAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateFinanceControlAggregateModel`
- `ValidateFinanceControlAggregateModel`
- `ApproveFinanceControlAggregateModel`
- `ActivateFinanceControlAggregateModel`
- `SuspendFinanceControlAggregateModel`
- `CorrectFinanceControlAggregateModel`
- `RetireFinanceControlAggregateModel`

Reference Events:

- `FinanceControlAggregateModelCreated`
- `FinanceControlAggregateModelValidated`
- `FinanceControlAggregateModelApproved`
- `FinanceControlAggregateModelActivated`
- `FinanceControlAggregateModelSuspended`
- `FinanceControlAggregateModelCorrected`
- `FinanceControlAggregateModelRetired`

Reference queries:

- `GetFinanceControlAggregateModel`
- `ListFinanceControlAggregateModelRecords`
- `GetFinanceControlAggregateModelTimeline`
- `GetFinanceControlAggregateModelEvidence`
- `GetFinanceControlAggregateModelDecisionPackage`
- `GetFinanceControlAggregateModelExceptions`
- `GetFinanceControlAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/financecontrolaggregatemodel/commands
GET  /api/v1/financecontrolaggregatemodel/{id}
GET  /api/v1/financecontrolaggregatemodel/{id}/timeline
GET  /api/v1/financecontrolaggregatemodel/{id}/evidence
GET  /api/v1/financecontrolaggregatemodel/{id}/decisions
POST /api/v1/financecontrolaggregatemodel/{id}/exceptions
POST /api/v1/financecontrolaggregatemodel/{id}/corrections
```
...
|---|---|
| `financecontrolaggregatemodel_aggregate` | authoritative subject |
| `financecontrolaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `financecontrolaggregatemodel_relationship` | governed relationships |
| `financecontrolaggregatemodel_decision` | binding Decisions and rationale |
| `financecontrolaggregatemodel_evidence_link` | provenance and evidence relationships |
| `financecontrolaggregatemodel_event_outbox` | transactional Event publication |
| `financecontrolaggregatemodel_idempotency` | duplicate-write protection |
| `financecontrolaggregatemodel_exception` | exception, claim, dispute, or hold |
| `financecontrolaggregatemodel_correction` | correction and supersession lineage |
| `financecontrolaggregatemodel_audit` | privileged action evidence |
