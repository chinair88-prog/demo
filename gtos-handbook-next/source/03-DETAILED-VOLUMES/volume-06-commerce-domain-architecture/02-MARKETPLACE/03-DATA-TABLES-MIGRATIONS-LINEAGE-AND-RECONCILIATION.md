# Marketplace — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-02-03` |
| Subject | `MarketplaceDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Marketplace**.
...
|---|---|
| `MarketplaceDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateMarketplaceDataModel`
- `ValidateMarketplaceDataModel`
- `ApproveMarketplaceDataModel`
- `ActivateMarketplaceDataModel`
- `SuspendMarketplaceDataModel`
- `CorrectMarketplaceDataModel`
- `RetireMarketplaceDataModel`

Reference Events:

- `MarketplaceDataModelCreated`
- `MarketplaceDataModelValidated`
- `MarketplaceDataModelApproved`
- `MarketplaceDataModelActivated`
- `MarketplaceDataModelSuspended`
- `MarketplaceDataModelCorrected`
- `MarketplaceDataModelRetired`

Reference queries:

- `GetMarketplaceDataModel`
- `ListMarketplaceDataModelRecords`
- `GetMarketplaceDataModelTimeline`
- `GetMarketplaceDataModelEvidence`
- `GetMarketplaceDataModelDecisionPackage`
- `GetMarketplaceDataModelExceptions`
- `GetMarketplaceDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/marketplacedatamodel/commands
GET  /api/v1/marketplacedatamodel/{id}
GET  /api/v1/marketplacedatamodel/{id}/timeline
GET  /api/v1/marketplacedatamodel/{id}/evidence
GET  /api/v1/marketplacedatamodel/{id}/decisions
POST /api/v1/marketplacedatamodel/{id}/exceptions
POST /api/v1/marketplacedatamodel/{id}/corrections
```
...
|---|---|
| `marketplacedatamodel_aggregate` | authoritative subject |
| `marketplacedatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `marketplacedatamodel_relationship` | governed relationships |
| `marketplacedatamodel_decision` | binding Decisions and rationale |
| `marketplacedatamodel_evidence_link` | provenance and evidence relationships |
| `marketplacedatamodel_event_outbox` | transactional Event publication |
| `marketplacedatamodel_idempotency` | duplicate-write protection |
| `marketplacedatamodel_exception` | exception, claim, dispute, or hold |
| `marketplacedatamodel_correction` | correction and supersession lineage |
| `marketplacedatamodel_audit` | privileged action evidence |
