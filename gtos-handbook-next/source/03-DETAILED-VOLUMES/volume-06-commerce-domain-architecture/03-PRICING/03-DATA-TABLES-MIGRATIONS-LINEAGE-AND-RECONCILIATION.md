# Pricing — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-03-03` |
| Subject | `PricingDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Pricing**.
...
|---|---|
| `PricingDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePricingDataModel`
- `ValidatePricingDataModel`
- `ApprovePricingDataModel`
- `ActivatePricingDataModel`
- `SuspendPricingDataModel`
- `CorrectPricingDataModel`
- `RetirePricingDataModel`

Reference Events:

- `PricingDataModelCreated`
- `PricingDataModelValidated`
- `PricingDataModelApproved`
- `PricingDataModelActivated`
- `PricingDataModelSuspended`
- `PricingDataModelCorrected`
- `PricingDataModelRetired`

Reference queries:

- `GetPricingDataModel`
- `ListPricingDataModelRecords`
- `GetPricingDataModelTimeline`
- `GetPricingDataModelEvidence`
- `GetPricingDataModelDecisionPackage`
- `GetPricingDataModelExceptions`
- `GetPricingDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/pricingdatamodel/commands
GET  /api/v1/pricingdatamodel/{id}
GET  /api/v1/pricingdatamodel/{id}/timeline
GET  /api/v1/pricingdatamodel/{id}/evidence
GET  /api/v1/pricingdatamodel/{id}/decisions
POST /api/v1/pricingdatamodel/{id}/exceptions
POST /api/v1/pricingdatamodel/{id}/corrections
```
...
|---|---|
| `pricingdatamodel_aggregate` | authoritative subject |
| `pricingdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `pricingdatamodel_relationship` | governed relationships |
| `pricingdatamodel_decision` | binding Decisions and rationale |
| `pricingdatamodel_evidence_link` | provenance and evidence relationships |
| `pricingdatamodel_event_outbox` | transactional Event publication |
| `pricingdatamodel_idempotency` | duplicate-write protection |
| `pricingdatamodel_exception` | exception, claim, dispute, or hold |
| `pricingdatamodel_correction` | correction and supersession lineage |
| `pricingdatamodel_audit` | privileged action evidence |
