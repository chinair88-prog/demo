# Tajerestan Trade Core — Portals, AI, Security, SLOs, Tests, and Operations

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-14-04` |
| Subject | `TajerestanTradeCoreOperatingProfile` |
...
| Accountable owner | Commerce Architecture / Tajerestan Trade Core |
...
This chapter defines how GTOS shall **define Portal journeys, AI participation, trust boundaries, SLOs, runbooks, tests, migration, examples, and conformance for Tajerestan Trade Core**.
...
The accountable owner is **Commerce Architecture / Tajerestan Trade Core**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `TajerestanTradeCoreOperatingProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreOperatingProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreOperatingProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreOperatingProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreOperatingProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TajerestanTradeCoreOperatingProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTajerestanTradeCoreOperatingProfile`
- `ValidateTajerestanTradeCoreOperatingProfile`
- `ApproveTajerestanTradeCoreOperatingProfile`
- `ActivateTajerestanTradeCoreOperatingProfile`
- `SuspendTajerestanTradeCoreOperatingProfile`
- `CorrectTajerestanTradeCoreOperatingProfile`
- `RetireTajerestanTradeCoreOperatingProfile`

Reference Events:

- `TajerestanTradeCoreOperatingProfileCreated`
- `TajerestanTradeCoreOperatingProfileValidated`
- `TajerestanTradeCoreOperatingProfileApproved`
- `TajerestanTradeCoreOperatingProfileActivated`
- `TajerestanTradeCoreOperatingProfileSuspended`
- `TajerestanTradeCoreOperatingProfileCorrected`
- `TajerestanTradeCoreOperatingProfileRetired`

Reference queries:

- `GetTajerestanTradeCoreOperatingProfile`
- `ListTajerestanTradeCoreOperatingProfileRecords`
- `GetTajerestanTradeCoreOperatingProfileTimeline`
- `GetTajerestanTradeCoreOperatingProfileEvidence`
- `GetTajerestanTradeCoreOperatingProfileDecisionPackage`
- `GetTajerestanTradeCoreOperatingProfileExceptions`
- `GetTajerestanTradeCoreOperatingProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/tajerestantradecoreoperatingprofile/commands
GET  /api/v1/tajerestantradecoreoperatingprofile/{id}
GET  /api/v1/tajerestantradecoreoperatingprofile/{id}/timeline
GET  /api/v1/tajerestantradecoreoperatingprofile/{id}/evidence
GET  /api/v1/tajerestantradecoreoperatingprofile/{id}/decisions
POST /api/v1/tajerestantradecoreoperatingprofile/{id}/exceptions
POST /api/v1/tajerestantradecoreoperatingprofile/{id}/corrections
```
...
|---|---|
| `tajerestantradecoreoperatingprofile_aggregate` | authoritative subject |
| `tajerestantradecoreoperatingprofile_version` | immutable submitted, approved, issued, or signed versions |
| `tajerestantradecoreoperatingprofile_relationship` | governed relationships |
| `tajerestantradecoreoperatingprofile_decision` | binding Decisions and rationale |
| `tajerestantradecoreoperatingprofile_evidence_link` | provenance and evidence relationships |
| `tajerestantradecoreoperatingprofile_event_outbox` | transactional Event publication |
| `tajerestantradecoreoperatingprofile_idempotency` | duplicate-write protection |
| `tajerestantradecoreoperatingprofile_exception` | exception, claim, dispute, or hold |
| `tajerestantradecoreoperatingprofile_correction` | correction and supersession lineage |
| `tajerestantradecoreoperatingprofile_audit` | privileged action evidence |
...
- Named capability `Tajerestan Trade Core` is part of the target handbook scope.
