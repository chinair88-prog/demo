# Tajerestan Trade Core — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-14-01` |
| Subject | `TajerestanTradeCoreAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Tajerestan Trade Core**.
...
|---|---|
| `TajerestanTradeCoreAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TajerestanTradeCoreAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTajerestanTradeCoreAggregateModel`
- `ValidateTajerestanTradeCoreAggregateModel`
- `ApproveTajerestanTradeCoreAggregateModel`
- `ActivateTajerestanTradeCoreAggregateModel`
- `SuspendTajerestanTradeCoreAggregateModel`
- `CorrectTajerestanTradeCoreAggregateModel`
- `RetireTajerestanTradeCoreAggregateModel`

Reference Events:

- `TajerestanTradeCoreAggregateModelCreated`
- `TajerestanTradeCoreAggregateModelValidated`
- `TajerestanTradeCoreAggregateModelApproved`
- `TajerestanTradeCoreAggregateModelActivated`
- `TajerestanTradeCoreAggregateModelSuspended`
- `TajerestanTradeCoreAggregateModelCorrected`
- `TajerestanTradeCoreAggregateModelRetired`

Reference queries:

- `GetTajerestanTradeCoreAggregateModel`
- `ListTajerestanTradeCoreAggregateModelRecords`
- `GetTajerestanTradeCoreAggregateModelTimeline`
- `GetTajerestanTradeCoreAggregateModelEvidence`
- `GetTajerestanTradeCoreAggregateModelDecisionPackage`
- `GetTajerestanTradeCoreAggregateModelExceptions`
- `GetTajerestanTradeCoreAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/tajerestantradecoreaggregatemodel/commands
GET  /api/v1/tajerestantradecoreaggregatemodel/{id}
GET  /api/v1/tajerestantradecoreaggregatemodel/{id}/timeline
GET  /api/v1/tajerestantradecoreaggregatemodel/{id}/evidence
GET  /api/v1/tajerestantradecoreaggregatemodel/{id}/decisions
POST /api/v1/tajerestantradecoreaggregatemodel/{id}/exceptions
POST /api/v1/tajerestantradecoreaggregatemodel/{id}/corrections
```
...
|---|---|
| `tajerestantradecoreaggregatemodel_aggregate` | authoritative subject |
| `tajerestantradecoreaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `tajerestantradecoreaggregatemodel_relationship` | governed relationships |
| `tajerestantradecoreaggregatemodel_decision` | binding Decisions and rationale |
| `tajerestantradecoreaggregatemodel_evidence_link` | provenance and evidence relationships |
| `tajerestantradecoreaggregatemodel_event_outbox` | transactional Event publication |
| `tajerestantradecoreaggregatemodel_idempotency` | duplicate-write protection |
| `tajerestantradecoreaggregatemodel_exception` | exception, claim, dispute, or hold |
| `tajerestantradecoreaggregatemodel_correction` | correction and supersession lineage |
| `tajerestantradecoreaggregatemodel_audit` | privileged action evidence |
