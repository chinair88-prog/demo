# Manufacturing — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-13-01` |
| Subject | `ManufacturingAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Manufacturing**.
...
|---|---|
| `ManufacturingAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ManufacturingAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateManufacturingAggregateModel`
- `ValidateManufacturingAggregateModel`
- `ApproveManufacturingAggregateModel`
- `ActivateManufacturingAggregateModel`
- `SuspendManufacturingAggregateModel`
- `CorrectManufacturingAggregateModel`
- `RetireManufacturingAggregateModel`

Reference Events:

- `ManufacturingAggregateModelCreated`
- `ManufacturingAggregateModelValidated`
- `ManufacturingAggregateModelApproved`
- `ManufacturingAggregateModelActivated`
- `ManufacturingAggregateModelSuspended`
- `ManufacturingAggregateModelCorrected`
- `ManufacturingAggregateModelRetired`

Reference queries:

- `GetManufacturingAggregateModel`
- `ListManufacturingAggregateModelRecords`
- `GetManufacturingAggregateModelTimeline`
- `GetManufacturingAggregateModelEvidence`
- `GetManufacturingAggregateModelDecisionPackage`
- `GetManufacturingAggregateModelExceptions`
- `GetManufacturingAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/manufacturingaggregatemodel/commands
GET  /api/v1/manufacturingaggregatemodel/{id}
GET  /api/v1/manufacturingaggregatemodel/{id}/timeline
GET  /api/v1/manufacturingaggregatemodel/{id}/evidence
GET  /api/v1/manufacturingaggregatemodel/{id}/decisions
POST /api/v1/manufacturingaggregatemodel/{id}/exceptions
POST /api/v1/manufacturingaggregatemodel/{id}/corrections
```
...
|---|---|
| `manufacturingaggregatemodel_aggregate` | authoritative subject |
| `manufacturingaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `manufacturingaggregatemodel_relationship` | governed relationships |
| `manufacturingaggregatemodel_decision` | binding Decisions and rationale |
| `manufacturingaggregatemodel_evidence_link` | provenance and evidence relationships |
| `manufacturingaggregatemodel_event_outbox` | transactional Event publication |
| `manufacturingaggregatemodel_idempotency` | duplicate-write protection |
| `manufacturingaggregatemodel_exception` | exception, claim, dispute, or hold |
| `manufacturingaggregatemodel_correction` | correction and supersession lineage |
| `manufacturingaggregatemodel_audit` | privileged action evidence |
