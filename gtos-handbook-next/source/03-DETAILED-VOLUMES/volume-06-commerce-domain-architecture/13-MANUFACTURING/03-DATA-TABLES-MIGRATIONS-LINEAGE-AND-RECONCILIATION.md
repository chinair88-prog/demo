# Manufacturing — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-13-03` |
| Subject | `ManufacturingDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Manufacturing**.
...
|---|---|
| `ManufacturingDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ManufacturingDataModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateManufacturingDataModel`
- `ValidateManufacturingDataModel`
- `ApproveManufacturingDataModel`
- `ActivateManufacturingDataModel`
- `SuspendManufacturingDataModel`
- `CorrectManufacturingDataModel`
- `RetireManufacturingDataModel`

Reference Events:

- `ManufacturingDataModelCreated`
- `ManufacturingDataModelValidated`
- `ManufacturingDataModelApproved`
- `ManufacturingDataModelActivated`
- `ManufacturingDataModelSuspended`
- `ManufacturingDataModelCorrected`
- `ManufacturingDataModelRetired`

Reference queries:

- `GetManufacturingDataModel`
- `ListManufacturingDataModelRecords`
- `GetManufacturingDataModelTimeline`
- `GetManufacturingDataModelEvidence`
- `GetManufacturingDataModelDecisionPackage`
- `GetManufacturingDataModelExceptions`
- `GetManufacturingDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/manufacturingdatamodel/commands
GET  /api/v1/manufacturingdatamodel/{id}
GET  /api/v1/manufacturingdatamodel/{id}/timeline
GET  /api/v1/manufacturingdatamodel/{id}/evidence
GET  /api/v1/manufacturingdatamodel/{id}/decisions
POST /api/v1/manufacturingdatamodel/{id}/exceptions
POST /api/v1/manufacturingdatamodel/{id}/corrections
```
...
|---|---|
| `manufacturingdatamodel_aggregate` | authoritative subject |
| `manufacturingdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `manufacturingdatamodel_relationship` | governed relationships |
| `manufacturingdatamodel_decision` | binding Decisions and rationale |
| `manufacturingdatamodel_evidence_link` | provenance and evidence relationships |
| `manufacturingdatamodel_event_outbox` | transactional Event publication |
| `manufacturingdatamodel_idempotency` | duplicate-write protection |
| `manufacturingdatamodel_exception` | exception, claim, dispute, or hold |
| `manufacturingdatamodel_correction` | correction and supersession lineage |
| `manufacturingdatamodel_audit` | privileged action evidence |
