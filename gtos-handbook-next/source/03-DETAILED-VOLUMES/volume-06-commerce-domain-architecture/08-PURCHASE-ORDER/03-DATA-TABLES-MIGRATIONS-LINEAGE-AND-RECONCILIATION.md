# Purchase Order — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-08-03` |
| Subject | `PurchaseOrderDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Purchase Order**.
...
|---|---|
| `PurchaseOrderDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePurchaseOrderDataModel`
- `ValidatePurchaseOrderDataModel`
- `ApprovePurchaseOrderDataModel`
- `ActivatePurchaseOrderDataModel`
- `SuspendPurchaseOrderDataModel`
- `CorrectPurchaseOrderDataModel`
- `RetirePurchaseOrderDataModel`

Reference Events:

- `PurchaseOrderDataModelCreated`
- `PurchaseOrderDataModelValidated`
- `PurchaseOrderDataModelApproved`
- `PurchaseOrderDataModelActivated`
- `PurchaseOrderDataModelSuspended`
- `PurchaseOrderDataModelCorrected`
- `PurchaseOrderDataModelRetired`

Reference queries:

- `GetPurchaseOrderDataModel`
- `ListPurchaseOrderDataModelRecords`
- `GetPurchaseOrderDataModelTimeline`
- `GetPurchaseOrderDataModelEvidence`
- `GetPurchaseOrderDataModelDecisionPackage`
- `GetPurchaseOrderDataModelExceptions`
- `GetPurchaseOrderDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/purchaseorderdatamodel/commands
GET  /api/v1/purchaseorderdatamodel/{id}
GET  /api/v1/purchaseorderdatamodel/{id}/timeline
GET  /api/v1/purchaseorderdatamodel/{id}/evidence
GET  /api/v1/purchaseorderdatamodel/{id}/decisions
POST /api/v1/purchaseorderdatamodel/{id}/exceptions
POST /api/v1/purchaseorderdatamodel/{id}/corrections
```
...
|---|---|
| `purchaseorderdatamodel_aggregate` | authoritative subject |
| `purchaseorderdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `purchaseorderdatamodel_relationship` | governed relationships |
| `purchaseorderdatamodel_decision` | binding Decisions and rationale |
| `purchaseorderdatamodel_evidence_link` | provenance and evidence relationships |
| `purchaseorderdatamodel_event_outbox` | transactional Event publication |
| `purchaseorderdatamodel_idempotency` | duplicate-write protection |
| `purchaseorderdatamodel_exception` | exception, claim, dispute, or hold |
| `purchaseorderdatamodel_correction` | correction and supersession lineage |
| `purchaseorderdatamodel_audit` | privileged action evidence |
