# Purchase Order — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-08-00` |
| Subject | `PurchaseOrderDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Purchase Order**.
...
|---|---|
| `PurchaseOrderDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PurchaseOrderDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePurchaseOrderDomain`
- `ValidatePurchaseOrderDomain`
- `ApprovePurchaseOrderDomain`
- `ActivatePurchaseOrderDomain`
- `SuspendPurchaseOrderDomain`
- `CorrectPurchaseOrderDomain`
- `RetirePurchaseOrderDomain`

Reference Events:

- `PurchaseOrderDomainCreated`
- `PurchaseOrderDomainValidated`
- `PurchaseOrderDomainApproved`
- `PurchaseOrderDomainActivated`
- `PurchaseOrderDomainSuspended`
- `PurchaseOrderDomainCorrected`
- `PurchaseOrderDomainRetired`

Reference queries:

- `GetPurchaseOrderDomain`
- `ListPurchaseOrderDomainRecords`
- `GetPurchaseOrderDomainTimeline`
- `GetPurchaseOrderDomainEvidence`
- `GetPurchaseOrderDomainDecisionPackage`
- `GetPurchaseOrderDomainExceptions`
- `GetPurchaseOrderDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/purchaseorderdomain/commands
GET  /api/v1/purchaseorderdomain/{id}
GET  /api/v1/purchaseorderdomain/{id}/timeline
GET  /api/v1/purchaseorderdomain/{id}/evidence
GET  /api/v1/purchaseorderdomain/{id}/decisions
POST /api/v1/purchaseorderdomain/{id}/exceptions
POST /api/v1/purchaseorderdomain/{id}/corrections
```
...
|---|---|
| `purchaseorderdomain_aggregate` | authoritative subject |
| `purchaseorderdomain_version` | immutable submitted, approved, issued, or signed versions |
| `purchaseorderdomain_relationship` | governed relationships |
| `purchaseorderdomain_decision` | binding Decisions and rationale |
| `purchaseorderdomain_evidence_link` | provenance and evidence relationships |
| `purchaseorderdomain_event_outbox` | transactional Event publication |
| `purchaseorderdomain_idempotency` | duplicate-write protection |
| `purchaseorderdomain_exception` | exception, claim, dispute, or hold |
| `purchaseorderdomain_correction` | correction and supersession lineage |
| `purchaseorderdomain_audit` | privileged action evidence |
