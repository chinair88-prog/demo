# Contract — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-06-02` |
| Subject | `ContractContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Contract**.
...
|---|---|
| `ContractContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateContractContractModel`
- `ValidateContractContractModel`
- `ApproveContractContractModel`
- `ActivateContractContractModel`
- `SuspendContractContractModel`
- `CorrectContractContractModel`
- `RetireContractContractModel`

Reference Events:

- `ContractContractModelCreated`
- `ContractContractModelValidated`
- `ContractContractModelApproved`
- `ContractContractModelActivated`
- `ContractContractModelSuspended`
- `ContractContractModelCorrected`
- `ContractContractModelRetired`

Reference queries:

- `GetContractContractModel`
- `ListContractContractModelRecords`
- `GetContractContractModelTimeline`
- `GetContractContractModelEvidence`
- `GetContractContractModelDecisionPackage`
- `GetContractContractModelExceptions`
- `GetContractContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/contractcontractmodel/commands
GET  /api/v1/contractcontractmodel/{id}
GET  /api/v1/contractcontractmodel/{id}/timeline
GET  /api/v1/contractcontractmodel/{id}/evidence
GET  /api/v1/contractcontractmodel/{id}/decisions
POST /api/v1/contractcontractmodel/{id}/exceptions
POST /api/v1/contractcontractmodel/{id}/corrections
```
...
|---|---|
| `contractcontractmodel_aggregate` | authoritative subject |
| `contractcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `contractcontractmodel_relationship` | governed relationships |
| `contractcontractmodel_decision` | binding Decisions and rationale |
| `contractcontractmodel_evidence_link` | provenance and evidence relationships |
| `contractcontractmodel_event_outbox` | transactional Event publication |
| `contractcontractmodel_idempotency` | duplicate-write protection |
| `contractcontractmodel_exception` | exception, claim, dispute, or hold |
| `contractcontractmodel_correction` | correction and supersession lineage |
| `contractcontractmodel_audit` | privileged action evidence |
