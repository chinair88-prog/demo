# Proforma Invoice — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-07-01` |
| Subject | `ProformaInvoiceAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Proforma Invoice**.
...
|---|---|
| `ProformaInvoiceAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ProformaInvoiceAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateProformaInvoiceAggregateModel`
- `ValidateProformaInvoiceAggregateModel`
- `ApproveProformaInvoiceAggregateModel`
- `ActivateProformaInvoiceAggregateModel`
- `SuspendProformaInvoiceAggregateModel`
- `CorrectProformaInvoiceAggregateModel`
- `RetireProformaInvoiceAggregateModel`

Reference Events:

- `ProformaInvoiceAggregateModelCreated`
- `ProformaInvoiceAggregateModelValidated`
- `ProformaInvoiceAggregateModelApproved`
- `ProformaInvoiceAggregateModelActivated`
- `ProformaInvoiceAggregateModelSuspended`
- `ProformaInvoiceAggregateModelCorrected`
- `ProformaInvoiceAggregateModelRetired`

Reference queries:

- `GetProformaInvoiceAggregateModel`
- `ListProformaInvoiceAggregateModelRecords`
- `GetProformaInvoiceAggregateModelTimeline`
- `GetProformaInvoiceAggregateModelEvidence`
- `GetProformaInvoiceAggregateModelDecisionPackage`
- `GetProformaInvoiceAggregateModelExceptions`
- `GetProformaInvoiceAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/proformainvoiceaggregatemodel/commands
GET  /api/v1/proformainvoiceaggregatemodel/{id}
GET  /api/v1/proformainvoiceaggregatemodel/{id}/timeline
GET  /api/v1/proformainvoiceaggregatemodel/{id}/evidence
GET  /api/v1/proformainvoiceaggregatemodel/{id}/decisions
POST /api/v1/proformainvoiceaggregatemodel/{id}/exceptions
POST /api/v1/proformainvoiceaggregatemodel/{id}/corrections
```
...
|---|---|
| `proformainvoiceaggregatemodel_aggregate` | authoritative subject |
| `proformainvoiceaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `proformainvoiceaggregatemodel_relationship` | governed relationships |
| `proformainvoiceaggregatemodel_decision` | binding Decisions and rationale |
| `proformainvoiceaggregatemodel_evidence_link` | provenance and evidence relationships |
| `proformainvoiceaggregatemodel_event_outbox` | transactional Event publication |
| `proformainvoiceaggregatemodel_idempotency` | duplicate-write protection |
| `proformainvoiceaggregatemodel_exception` | exception, claim, dispute, or hold |
| `proformainvoiceaggregatemodel_correction` | correction and supersession lineage |
| `proformainvoiceaggregatemodel_audit` | privileged action evidence |
