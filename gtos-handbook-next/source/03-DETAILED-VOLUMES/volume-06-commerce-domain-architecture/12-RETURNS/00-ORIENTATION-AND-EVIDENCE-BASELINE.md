# Returns — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-12-00` |
| Subject | `ReturnsDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Returns**.
...
|---|---|
| `ReturnsDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateReturnsDomain`
- `ValidateReturnsDomain`
- `ApproveReturnsDomain`
- `ActivateReturnsDomain`
- `SuspendReturnsDomain`
- `CorrectReturnsDomain`
- `RetireReturnsDomain`

Reference Events:

- `ReturnsDomainCreated`
- `ReturnsDomainValidated`
- `ReturnsDomainApproved`
- `ReturnsDomainActivated`
- `ReturnsDomainSuspended`
- `ReturnsDomainCorrected`
- `ReturnsDomainRetired`

Reference queries:

- `GetReturnsDomain`
- `ListReturnsDomainRecords`
- `GetReturnsDomainTimeline`
- `GetReturnsDomainEvidence`
- `GetReturnsDomainDecisionPackage`
- `GetReturnsDomainExceptions`
- `GetReturnsDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/returnsdomain/commands
GET  /api/v1/returnsdomain/{id}
GET  /api/v1/returnsdomain/{id}/timeline
GET  /api/v1/returnsdomain/{id}/evidence
GET  /api/v1/returnsdomain/{id}/decisions
POST /api/v1/returnsdomain/{id}/exceptions
POST /api/v1/returnsdomain/{id}/corrections
```
...
|---|---|
| `returnsdomain_aggregate` | authoritative subject |
| `returnsdomain_version` | immutable submitted, approved, issued, or signed versions |
| `returnsdomain_relationship` | governed relationships |
| `returnsdomain_decision` | binding Decisions and rationale |
| `returnsdomain_evidence_link` | provenance and evidence relationships |
| `returnsdomain_event_outbox` | transactional Event publication |
| `returnsdomain_idempotency` | duplicate-write protection |
| `returnsdomain_exception` | exception, claim, dispute, or hold |
| `returnsdomain_correction` | correction and supersession lineage |
| `returnsdomain_audit` | privileged action evidence |
