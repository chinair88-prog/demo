# Quotation — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-05-02` |
| Subject | `QuotationContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Quotation**.
...
|---|---|
| `QuotationContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
QuotationContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateQuotationContractModel`
- `ValidateQuotationContractModel`
- `ApproveQuotationContractModel`
- `ActivateQuotationContractModel`
- `SuspendQuotationContractModel`
- `CorrectQuotationContractModel`
- `RetireQuotationContractModel`

Reference Events:

- `QuotationContractModelCreated`
- `QuotationContractModelValidated`
- `QuotationContractModelApproved`
- `QuotationContractModelActivated`
- `QuotationContractModelSuspended`
- `QuotationContractModelCorrected`
- `QuotationContractModelRetired`

Reference queries:

- `GetQuotationContractModel`
- `ListQuotationContractModelRecords`
- `GetQuotationContractModelTimeline`
- `GetQuotationContractModelEvidence`
- `GetQuotationContractModelDecisionPackage`
- `GetQuotationContractModelExceptions`
- `GetQuotationContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/quotationcontractmodel/commands
GET  /api/v1/quotationcontractmodel/{id}
GET  /api/v1/quotationcontractmodel/{id}/timeline
GET  /api/v1/quotationcontractmodel/{id}/evidence
GET  /api/v1/quotationcontractmodel/{id}/decisions
POST /api/v1/quotationcontractmodel/{id}/exceptions
POST /api/v1/quotationcontractmodel/{id}/corrections
```
...
|---|---|
| `quotationcontractmodel_aggregate` | authoritative subject |
| `quotationcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `quotationcontractmodel_relationship` | governed relationships |
| `quotationcontractmodel_decision` | binding Decisions and rationale |
| `quotationcontractmodel_evidence_link` | provenance and evidence relationships |
| `quotationcontractmodel_event_outbox` | transactional Event publication |
| `quotationcontractmodel_idempotency` | duplicate-write protection |
| `quotationcontractmodel_exception` | exception, claim, dispute, or hold |
| `quotationcontractmodel_correction` | correction and supersession lineage |
| `quotationcontractmodel_audit` | privileged action evidence |
