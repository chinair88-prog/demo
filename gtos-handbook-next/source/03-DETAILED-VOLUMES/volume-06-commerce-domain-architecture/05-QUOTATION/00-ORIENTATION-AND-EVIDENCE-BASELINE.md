# Quotation — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-05-00` |
| Subject | `QuotationDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Quotation**.
...
|---|---|
| `QuotationDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateQuotationDomain`
- `ValidateQuotationDomain`
- `ApproveQuotationDomain`
- `ActivateQuotationDomain`
- `SuspendQuotationDomain`
- `CorrectQuotationDomain`
- `RetireQuotationDomain`

Reference Events:

- `QuotationDomainCreated`
- `QuotationDomainValidated`
- `QuotationDomainApproved`
- `QuotationDomainActivated`
- `QuotationDomainSuspended`
- `QuotationDomainCorrected`
- `QuotationDomainRetired`

Reference queries:

- `GetQuotationDomain`
- `ListQuotationDomainRecords`
- `GetQuotationDomainTimeline`
- `GetQuotationDomainEvidence`
- `GetQuotationDomainDecisionPackage`
- `GetQuotationDomainExceptions`
- `GetQuotationDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/quotationdomain/commands
GET  /api/v1/quotationdomain/{id}
GET  /api/v1/quotationdomain/{id}/timeline
GET  /api/v1/quotationdomain/{id}/evidence
GET  /api/v1/quotationdomain/{id}/decisions
POST /api/v1/quotationdomain/{id}/exceptions
POST /api/v1/quotationdomain/{id}/corrections
```
...
|---|---|
| `quotationdomain_aggregate` | authoritative subject |
| `quotationdomain_version` | immutable submitted, approved, issued, or signed versions |
| `quotationdomain_relationship` | governed relationships |
| `quotationdomain_decision` | binding Decisions and rationale |
| `quotationdomain_evidence_link` | provenance and evidence relationships |
| `quotationdomain_event_outbox` | transactional Event publication |
| `quotationdomain_idempotency` | duplicate-write protection |
| `quotationdomain_exception` | exception, claim, dispute, or hold |
| `quotationdomain_correction` | correction and supersession lineage |
| `quotationdomain_audit` | privileged action evidence |
