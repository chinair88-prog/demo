# AI Model and Provider Registry

| Metadata | Value |
|---|---|
| Volume | `20` |
| Chapter ID | `V20-15` |
| Subject | `AIModelandProviderRegistry` |
...
| Accountable owner | Documentation and Conformance Council |
...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the AI Model and Provider Registry**.
...
The accountable owner is **Documentation and Conformance Council**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `AIModelandProviderRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIModelandProviderRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIModelandProviderRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIModelandProviderRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIModelandProviderRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
AIModelandProviderRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateAIModelandProviderRegistry`
- `ValidateAIModelandProviderRegistry`
- `ApproveAIModelandProviderRegistry`
- `ActivateAIModelandProviderRegistry`
- `SuspendAIModelandProviderRegistry`
- `CorrectAIModelandProviderRegistry`
- `RetireAIModelandProviderRegistry`

Reference Events:

- `AIModelandProviderRegistryCreated`
- `AIModelandProviderRegistryValidated`
- `AIModelandProviderRegistryApproved`
- `AIModelandProviderRegistryActivated`
- `AIModelandProviderRegistrySuspended`
- `AIModelandProviderRegistryCorrected`
- `AIModelandProviderRegistryRetired`

Reference queries:

- `GetAIModelandProviderRegistry`
- `ListAIModelandProviderRegistryRecords`
- `GetAIModelandProviderRegistryTimeline`
- `GetAIModelandProviderRegistryEvidence`
- `GetAIModelandProviderRegistryDecisionPackage`
- `GetAIModelandProviderRegistryExceptions`
- `GetAIModelandProviderRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/aimodelandproviderregistry/commands
GET  /api/v1/aimodelandproviderregistry/{id}
GET  /api/v1/aimodelandproviderregistry/{id}/timeline
GET  /api/v1/aimodelandproviderregistry/{id}/evidence
GET  /api/v1/aimodelandproviderregistry/{id}/decisions
POST /api/v1/aimodelandproviderregistry/{id}/exceptions
POST /api/v1/aimodelandproviderregistry/{id}/corrections
```
...
|---|---|
| `aimodelandproviderregistry_aggregate` | authoritative subject |
| `aimodelandproviderregistry_version` | immutable submitted, approved, issued, or signed versions |
| `aimodelandproviderregistry_relationship` | governed relationships |
| `aimodelandproviderregistry_decision` | binding Decisions and rationale |
| `aimodelandproviderregistry_evidence_link` | provenance and evidence relationships |
| `aimodelandproviderregistry_event_outbox` | transactional Event publication |
| `aimodelandproviderregistry_idempotency` | duplicate-write protection |
| `aimodelandproviderregistry_exception` | exception, claim, dispute, or hold |
| `aimodelandproviderregistry_correction` | correction and supersession lineage |
| `aimodelandproviderregistry_audit` | privileged action evidence |
...
- This appendix chapter specifies how the generated reference must be built.
- A generated catalogue is not authoritative unless its source, cutoff, validation and conflicts are visible.
- Final populated registries require full repository extraction and conformance review.
