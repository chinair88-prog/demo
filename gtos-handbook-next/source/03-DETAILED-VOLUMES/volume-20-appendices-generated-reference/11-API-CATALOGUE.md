...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the API Catalogue**.
...
|---|---|
| `APICatalogue` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `APICatalogueVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `APICatalogueDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `APICatalogueEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `APICatalogueException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAPICatalogue`
- `ValidateAPICatalogue`
- `ApproveAPICatalogue`
- `ActivateAPICatalogue`
- `SuspendAPICatalogue`
- `CorrectAPICatalogue`
- `RetireAPICatalogue`
...
- `APICatalogueCreated`
- `APICatalogueValidated`
- `APICatalogueApproved`
- `APICatalogueActivated`
- `APICatalogueSuspended`
- `APICatalogueCorrected`
- `APICatalogueRetired`

Reference queries:

- `GetAPICatalogue`
- `ListAPICatalogueRecords`
- `GetAPICatalogueTimeline`
- `GetAPICatalogueEvidence`
- `GetAPICatalogueDecisionPackage`
- `GetAPICatalogueExceptions`
- `GetAPICatalogueAuditTrail`

Reference API surface:

```text
POST /api/v1/apicatalogue/commands
GET  /api/v1/apicatalogue/{id}
GET  /api/v1/apicatalogue/{id}/timeline
GET  /api/v1/apicatalogue/{id}/evidence
GET  /api/v1/apicatalogue/{id}/decisions
POST /api/v1/apicatalogue/{id}/exceptions
POST /api/v1/apicatalogue/{id}/corrections
```
...
|---|---|
| `apicatalogue_aggregate` | authoritative subject |
| `apicatalogue_version` | immutable submitted, approved, issued, or signed versions |
| `apicatalogue_relationship` | governed relationships |
| `apicatalogue_decision` | binding Decisions and rationale |
| `apicatalogue_evidence_link` | provenance and evidence relationships |
| `apicatalogue_event_outbox` | transactional Event publication |
| `apicatalogue_idempotency` | duplicate-write protection |
| `apicatalogue_exception` | exception, claim, dispute, or hold |
| `apicatalogue_correction` | correction and supersession lineage |
| `apicatalogue_audit` | privileged action evidence |
