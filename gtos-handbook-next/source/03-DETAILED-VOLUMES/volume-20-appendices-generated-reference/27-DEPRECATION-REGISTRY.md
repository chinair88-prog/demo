...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Deprecation Registry**.
...
|---|---|
| `DeprecationRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveDeprecationRegistry`
- `ActivateDeprecationRegistry`
- `SuspendDeprecationRegistry`
- `CorrectDeprecationRegistry`
- `RetireDeprecationRegistry`

Reference Events:

- `DeprecationRegistryCreated`
- `DeprecationRegistryValidated`
- `DeprecationRegistryApproved`
- `DeprecationRegistryActivated`
- `DeprecationRegistrySuspended`
- `DeprecationRegistryCorrected`
- `DeprecationRegistryRetired`

Reference queries:

- `GetDeprecationRegistry`
- `ListDeprecationRegistryRecords`
- `GetDeprecationRegistryTimeline`
- `GetDeprecationRegistryEvidence`
- `GetDeprecationRegistryDecisionPackage`
- `GetDeprecationRegistryExceptions`
- `GetDeprecationRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/deprecationregistry/commands
GET  /api/v1/deprecationregistry/{id}
GET  /api/v1/deprecationregistry/{id}/timeline
GET  /api/v1/deprecationregistry/{id}/evidence
GET  /api/v1/deprecationregistry/{id}/decisions
POST /api/v1/deprecationregistry/{id}/exceptions
POST /api/v1/deprecationregistry/{id}/corrections
```
...
|---|---|
| `deprecationregistry_aggregate` | authoritative subject |
| `deprecationregistry_version` | immutable submitted, approved, issued, or signed versions |
| `deprecationregistry_relationship` | governed relationships |
| `deprecationregistry_decision` | binding Decisions and rationale |
| `deprecationregistry_evidence_link` | provenance and evidence relationships |
| `deprecationregistry_event_outbox` | transactional Event publication |
| `deprecationregistry_idempotency` | duplicate-write protection |
| `deprecationregistry_exception` | exception, claim, dispute, or hold |
| `deprecationregistry_correction` | correction and supersession lineage |
| `deprecationregistry_audit` | privileged action evidence |
