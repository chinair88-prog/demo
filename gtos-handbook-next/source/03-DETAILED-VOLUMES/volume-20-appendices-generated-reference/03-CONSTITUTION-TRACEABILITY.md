...
| Volume | `20` |
| Chapter ID | `V20-03` |
| Subject | `ConstitutionTraceability` |
...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Constitution Traceability**.
...
|---|---|
| `ConstitutionTraceability` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConstitutionTraceabilityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConstitutionTraceabilityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConstitutionTraceabilityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConstitutionTraceabilityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ConstitutionTraceability {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateConstitutionTraceability`
- `ValidateConstitutionTraceability`
- `ApproveConstitutionTraceability`
- `ActivateConstitutionTraceability`
- `SuspendConstitutionTraceability`
- `CorrectConstitutionTraceability`
- `RetireConstitutionTraceability`

Reference Events:

- `ConstitutionTraceabilityCreated`
- `ConstitutionTraceabilityValidated`
- `ConstitutionTraceabilityApproved`
- `ConstitutionTraceabilityActivated`
- `ConstitutionTraceabilitySuspended`
- `ConstitutionTraceabilityCorrected`
- `ConstitutionTraceabilityRetired`

Reference queries:

- `GetConstitutionTraceability`
- `ListConstitutionTraceabilityRecords`
- `GetConstitutionTraceabilityTimeline`
- `GetConstitutionTraceabilityEvidence`
- `GetConstitutionTraceabilityDecisionPackage`
- `GetConstitutionTraceabilityExceptions`
- `GetConstitutionTraceabilityAuditTrail`

Reference API surface:

```text
POST /api/v1/constitutiontraceability/commands
GET  /api/v1/constitutiontraceability/{id}
GET  /api/v1/constitutiontraceability/{id}/timeline
GET  /api/v1/constitutiontraceability/{id}/evidence
GET  /api/v1/constitutiontraceability/{id}/decisions
POST /api/v1/constitutiontraceability/{id}/exceptions
POST /api/v1/constitutiontraceability/{id}/corrections
```
...
|---|---|
| `constitutiontraceability_aggregate` | authoritative subject |
| `constitutiontraceability_version` | immutable submitted, approved, issued, or signed versions |
| `constitutiontraceability_relationship` | governed relationships |
| `constitutiontraceability_decision` | binding Decisions and rationale |
| `constitutiontraceability_evidence_link` | provenance and evidence relationships |
| `constitutiontraceability_event_outbox` | transactional Event publication |
| `constitutiontraceability_idempotency` | duplicate-write protection |
| `constitutiontraceability_exception` | exception, claim, dispute, or hold |
| `constitutiontraceability_correction` | correction and supersession lineage |
| `constitutiontraceability_audit` | privileged action evidence |
