...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Event Catalogue**.
...
|---|---|
| `EventCatalogue` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventCatalogueVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventCatalogueDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventCatalogueEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventCatalogueException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveEventCatalogue`
- `ActivateEventCatalogue`
- `SuspendEventCatalogue`
- `CorrectEventCatalogue`
- `RetireEventCatalogue`

Reference Events:

- `EventCatalogueCreated`
- `EventCatalogueValidated`
- `EventCatalogueApproved`
- `EventCatalogueActivated`
- `EventCatalogueSuspended`
- `EventCatalogueCorrected`
- `EventCatalogueRetired`

Reference queries:

- `GetEventCatalogue`
- `ListEventCatalogueRecords`
- `GetEventCatalogueTimeline`
- `GetEventCatalogueEvidence`
- `GetEventCatalogueDecisionPackage`
- `GetEventCatalogueExceptions`
- `GetEventCatalogueAuditTrail`

Reference API surface:

```text
POST /api/v1/eventcatalogue/commands
GET  /api/v1/eventcatalogue/{id}
GET  /api/v1/eventcatalogue/{id}/timeline
GET  /api/v1/eventcatalogue/{id}/evidence
GET  /api/v1/eventcatalogue/{id}/decisions
POST /api/v1/eventcatalogue/{id}/exceptions
POST /api/v1/eventcatalogue/{id}/corrections
```
...
|---|---|
| `eventcatalogue_aggregate` | authoritative subject |
| `eventcatalogue_version` | immutable submitted, approved, issued, or signed versions |
| `eventcatalogue_relationship` | governed relationships |
| `eventcatalogue_decision` | binding Decisions and rationale |
| `eventcatalogue_evidence_link` | provenance and evidence relationships |
| `eventcatalogue_event_outbox` | transactional Event publication |
| `eventcatalogue_idempotency` | duplicate-write protection |
| `eventcatalogue_exception` | exception, claim, dispute, or hold |
| `eventcatalogue_correction` | correction and supersession lineage |
| `eventcatalogue_audit` | privileged action evidence |
