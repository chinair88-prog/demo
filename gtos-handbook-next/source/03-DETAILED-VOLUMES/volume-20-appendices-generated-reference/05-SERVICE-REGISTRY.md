...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Service Registry**.
...
|---|---|
| `ServiceRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `SuspendServiceRegistry`
- `CorrectServiceRegistry`
- `RetireServiceRegistry`

Reference Events:

- `ServiceRegistryCreated`
- `ServiceRegistryValidated`
- `ServiceRegistryApproved`
- `ServiceRegistryActivated`
- `ServiceRegistrySuspended`
- `ServiceRegistryCorrected`
- `ServiceRegistryRetired`

Reference queries:

- `GetServiceRegistry`
- `ListServiceRegistryRecords`
- `GetServiceRegistryTimeline`
- `GetServiceRegistryEvidence`
- `GetServiceRegistryDecisionPackage`
- `GetServiceRegistryExceptions`
- `GetServiceRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/serviceregistry/commands
GET  /api/v1/serviceregistry/{id}
GET  /api/v1/serviceregistry/{id}/timeline
GET  /api/v1/serviceregistry/{id}/evidence
GET  /api/v1/serviceregistry/{id}/decisions
POST /api/v1/serviceregistry/{id}/exceptions
POST /api/v1/serviceregistry/{id}/corrections
```
...
|---|---|
| `serviceregistry_aggregate` | authoritative subject |
| `serviceregistry_version` | immutable submitted, approved, issued, or signed versions |
| `serviceregistry_relationship` | governed relationships |
| `serviceregistry_decision` | binding Decisions and rationale |
| `serviceregistry_evidence_link` | provenance and evidence relationships |
| `serviceregistry_event_outbox` | transactional Event publication |
| `serviceregistry_idempotency` | duplicate-write protection |
| `serviceregistry_exception` | exception, claim, dispute, or hold |
| `serviceregistry_correction` | correction and supersession lineage |
| `serviceregistry_audit` | privileged action evidence |
