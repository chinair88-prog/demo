...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Runbook Index**.
...
|---|---|
| `RunbookIndex` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RunbookIndexVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RunbookIndexDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RunbookIndexEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RunbookIndexException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `RunbookIndexCreated`
- `RunbookIndexValidated`
- `RunbookIndexApproved`
- `RunbookIndexActivated`
- `RunbookIndexSuspended`
- `RunbookIndexCorrected`
- `RunbookIndexRetired`

Reference queries:

- `GetRunbookIndex`
- `ListRunbookIndexRecords`
- `GetRunbookIndexTimeline`
- `GetRunbookIndexEvidence`
- `GetRunbookIndexDecisionPackage`
- `GetRunbookIndexExceptions`
- `GetRunbookIndexAuditTrail`

Reference API surface:

```text
POST /api/v1/runbookindex/commands
GET  /api/v1/runbookindex/{id}
GET  /api/v1/runbookindex/{id}/timeline
GET  /api/v1/runbookindex/{id}/evidence
GET  /api/v1/runbookindex/{id}/decisions
POST /api/v1/runbookindex/{id}/exceptions
POST /api/v1/runbookindex/{id}/corrections
```
...
|---|---|
| `runbookindex_aggregate` | authoritative subject |
| `runbookindex_version` | immutable submitted, approved, issued, or signed versions |
| `runbookindex_relationship` | governed relationships |
| `runbookindex_decision` | binding Decisions and rationale |
| `runbookindex_evidence_link` | provenance and evidence relationships |
| `runbookindex_event_outbox` | transactional Event publication |
| `runbookindex_idempotency` | duplicate-write protection |
| `runbookindex_exception` | exception, claim, dispute, or hold |
| `runbookindex_correction` | correction and supersession lineage |
| `runbookindex_audit` | privileged action evidence |
