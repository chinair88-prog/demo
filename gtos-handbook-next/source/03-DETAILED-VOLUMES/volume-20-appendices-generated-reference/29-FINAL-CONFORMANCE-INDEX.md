# Final Conformance Index

| Metadata | Value |
|---|---|
| Volume | `20` |
| Chapter ID | `V20-29` |
| Subject | `FinalConformanceIndex` |
...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Final Conformance Index**.
...
|---|---|
| `FinalConformanceIndex` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinalConformanceIndexVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinalConformanceIndexDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinalConformanceIndexEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `FinalConformanceIndexException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
FinalConformanceIndex {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateFinalConformanceIndex`
- `ValidateFinalConformanceIndex`
- `ApproveFinalConformanceIndex`
- `ActivateFinalConformanceIndex`
- `SuspendFinalConformanceIndex`
- `CorrectFinalConformanceIndex`
- `RetireFinalConformanceIndex`

Reference Events:

- `FinalConformanceIndexCreated`
- `FinalConformanceIndexValidated`
- `FinalConformanceIndexApproved`
- `FinalConformanceIndexActivated`
- `FinalConformanceIndexSuspended`
- `FinalConformanceIndexCorrected`
- `FinalConformanceIndexRetired`

Reference queries:

- `GetFinalConformanceIndex`
- `ListFinalConformanceIndexRecords`
- `GetFinalConformanceIndexTimeline`
- `GetFinalConformanceIndexEvidence`
- `GetFinalConformanceIndexDecisionPackage`
- `GetFinalConformanceIndexExceptions`
- `GetFinalConformanceIndexAuditTrail`

Reference API surface:

```text
POST /api/v1/finalconformanceindex/commands
GET  /api/v1/finalconformanceindex/{id}
GET  /api/v1/finalconformanceindex/{id}/timeline
GET  /api/v1/finalconformanceindex/{id}/evidence
GET  /api/v1/finalconformanceindex/{id}/decisions
POST /api/v1/finalconformanceindex/{id}/exceptions
POST /api/v1/finalconformanceindex/{id}/corrections
```
...
|---|---|
| `finalconformanceindex_aggregate` | authoritative subject |
| `finalconformanceindex_version` | immutable submitted, approved, issued, or signed versions |
| `finalconformanceindex_relationship` | governed relationships |
| `finalconformanceindex_decision` | binding Decisions and rationale |
| `finalconformanceindex_evidence_link` | provenance and evidence relationships |
| `finalconformanceindex_event_outbox` | transactional Event publication |
| `finalconformanceindex_idempotency` | duplicate-write protection |
| `finalconformanceindex_exception` | exception, claim, dispute, or hold |
| `finalconformanceindex_correction` | correction and supersession lineage |
| `finalconformanceindex_audit` | privileged action evidence |
