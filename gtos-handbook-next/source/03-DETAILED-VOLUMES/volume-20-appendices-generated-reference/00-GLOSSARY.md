...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Glossary**.
...
|---|---|
| `Glossary` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `GlossaryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `GlossaryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `GlossaryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `GlossaryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `GetGlossaryTimeline`
- `GetGlossaryEvidence`
- `GetGlossaryDecisionPackage`
- `GetGlossaryExceptions`
- `GetGlossaryAuditTrail`

Reference API surface:

```text
POST /api/v1/glossary/commands
GET  /api/v1/glossary/{id}
GET  /api/v1/glossary/{id}/timeline
GET  /api/v1/glossary/{id}/evidence
GET  /api/v1/glossary/{id}/decisions
POST /api/v1/glossary/{id}/exceptions
POST /api/v1/glossary/{id}/corrections
```
...
|---|---|
| `glossary_aggregate` | authoritative subject |
| `glossary_version` | immutable submitted, approved, issued, or signed versions |
| `glossary_relationship` | governed relationships |
| `glossary_decision` | binding Decisions and rationale |
| `glossary_evidence_link` | provenance and evidence relationships |
| `glossary_event_outbox` | transactional Event publication |
| `glossary_idempotency` | duplicate-write protection |
| `glossary_exception` | exception, claim, dispute, or hold |
| `glossary_correction` | correction and supersession lineage |
| `glossary_audit` | privileged action evidence |
