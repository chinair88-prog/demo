...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Table Dictionary**.
...
|---|---|
| `TableDictionary` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableDictionaryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableDictionaryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableDictionaryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableDictionaryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateTableDictionary`
- `ApproveTableDictionary`
- `ActivateTableDictionary`
- `SuspendTableDictionary`
- `CorrectTableDictionary`
- `RetireTableDictionary`

Reference Events:

- `TableDictionaryCreated`
- `TableDictionaryValidated`
- `TableDictionaryApproved`
- `TableDictionaryActivated`
- `TableDictionarySuspended`
- `TableDictionaryCorrected`
- `TableDictionaryRetired`

Reference queries:

- `GetTableDictionary`
- `ListTableDictionaryRecords`
- `GetTableDictionaryTimeline`
- `GetTableDictionaryEvidence`
- `GetTableDictionaryDecisionPackage`
- `GetTableDictionaryExceptions`
- `GetTableDictionaryAuditTrail`

Reference API surface:

```text
POST /api/v1/tabledictionary/commands
GET  /api/v1/tabledictionary/{id}
GET  /api/v1/tabledictionary/{id}/timeline
GET  /api/v1/tabledictionary/{id}/evidence
GET  /api/v1/tabledictionary/{id}/decisions
POST /api/v1/tabledictionary/{id}/exceptions
POST /api/v1/tabledictionary/{id}/corrections
```
...
|---|---|
| `tabledictionary_aggregate` | authoritative subject |
| `tabledictionary_version` | immutable submitted, approved, issued, or signed versions |
| `tabledictionary_relationship` | governed relationships |
| `tabledictionary_decision` | binding Decisions and rationale |
| `tabledictionary_evidence_link` | provenance and evidence relationships |
| `tabledictionary_event_outbox` | transactional Event publication |
| `tabledictionary_idempotency` | duplicate-write protection |
| `tabledictionary_exception` | exception, claim, dispute, or hold |
| `tabledictionary_correction` | correction and supersession lineage |
| `tabledictionary_audit` | privileged action evidence |
