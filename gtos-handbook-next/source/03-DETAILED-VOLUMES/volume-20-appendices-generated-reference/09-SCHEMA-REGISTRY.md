...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Schema Registry**.
...
|---|---|
| `SchemaRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveSchemaRegistry`
- `ActivateSchemaRegistry`
- `SuspendSchemaRegistry`
- `CorrectSchemaRegistry`
- `RetireSchemaRegistry`

Reference Events:

- `SchemaRegistryCreated`
- `SchemaRegistryValidated`
- `SchemaRegistryApproved`
- `SchemaRegistryActivated`
- `SchemaRegistrySuspended`
- `SchemaRegistryCorrected`
- `SchemaRegistryRetired`

Reference queries:

- `GetSchemaRegistry`
- `ListSchemaRegistryRecords`
- `GetSchemaRegistryTimeline`
- `GetSchemaRegistryEvidence`
- `GetSchemaRegistryDecisionPackage`
- `GetSchemaRegistryExceptions`
- `GetSchemaRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/schemaregistry/commands
GET  /api/v1/schemaregistry/{id}
GET  /api/v1/schemaregistry/{id}/timeline
GET  /api/v1/schemaregistry/{id}/evidence
GET  /api/v1/schemaregistry/{id}/decisions
POST /api/v1/schemaregistry/{id}/exceptions
POST /api/v1/schemaregistry/{id}/corrections
```
...
|---|---|
| `schemaregistry_aggregate` | authoritative subject |
| `schemaregistry_version` | immutable submitted, approved, issued, or signed versions |
| `schemaregistry_relationship` | governed relationships |
| `schemaregistry_decision` | binding Decisions and rationale |
| `schemaregistry_evidence_link` | provenance and evidence relationships |
| `schemaregistry_event_outbox` | transactional Event publication |
| `schemaregistry_idempotency` | duplicate-write protection |
| `schemaregistry_exception` | exception, claim, dispute, or hold |
| `schemaregistry_correction` | correction and supersession lineage |
| `schemaregistry_audit` | privileged action evidence |
