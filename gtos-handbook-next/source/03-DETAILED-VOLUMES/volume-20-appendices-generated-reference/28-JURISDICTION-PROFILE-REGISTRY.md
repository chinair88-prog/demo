...
| Volume | `20` |
| Chapter ID | `V20-28` |
| Subject | `JurisdictionProfileRegistry` |
...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Jurisdiction Profile Registry**.
...
|---|---|
| `JurisdictionProfileRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `JurisdictionProfileRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `JurisdictionProfileRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `JurisdictionProfileRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `JurisdictionProfileRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateJurisdictionProfileRegistry`
- `ValidateJurisdictionProfileRegistry`
- `ApproveJurisdictionProfileRegistry`
- `ActivateJurisdictionProfileRegistry`
- `SuspendJurisdictionProfileRegistry`
- `CorrectJurisdictionProfileRegistry`
- `RetireJurisdictionProfileRegistry`

Reference Events:

- `JurisdictionProfileRegistryCreated`
- `JurisdictionProfileRegistryValidated`
- `JurisdictionProfileRegistryApproved`
- `JurisdictionProfileRegistryActivated`
- `JurisdictionProfileRegistrySuspended`
- `JurisdictionProfileRegistryCorrected`
- `JurisdictionProfileRegistryRetired`

Reference queries:

- `GetJurisdictionProfileRegistry`
- `ListJurisdictionProfileRegistryRecords`
- `GetJurisdictionProfileRegistryTimeline`
- `GetJurisdictionProfileRegistryEvidence`
- `GetJurisdictionProfileRegistryDecisionPackage`
- `GetJurisdictionProfileRegistryExceptions`
- `GetJurisdictionProfileRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/jurisdictionprofileregistry/commands
GET  /api/v1/jurisdictionprofileregistry/{id}
GET  /api/v1/jurisdictionprofileregistry/{id}/timeline
GET  /api/v1/jurisdictionprofileregistry/{id}/evidence
GET  /api/v1/jurisdictionprofileregistry/{id}/decisions
POST /api/v1/jurisdictionprofileregistry/{id}/exceptions
POST /api/v1/jurisdictionprofileregistry/{id}/corrections
```
...
|---|---|
| `jurisdictionprofileregistry_aggregate` | authoritative subject |
| `jurisdictionprofileregistry_version` | immutable submitted, approved, issued, or signed versions |
| `jurisdictionprofileregistry_relationship` | governed relationships |
| `jurisdictionprofileregistry_decision` | binding Decisions and rationale |
| `jurisdictionprofileregistry_evidence_link` | provenance and evidence relationships |
| `jurisdictionprofileregistry_event_outbox` | transactional Event publication |
| `jurisdictionprofileregistry_idempotency` | duplicate-write protection |
| `jurisdictionprofileregistry_exception` | exception, claim, dispute, or hold |
| `jurisdictionprofileregistry_correction` | correction and supersession lineage |
| `jurisdictionprofileregistry_audit` | privileged action evidence |
