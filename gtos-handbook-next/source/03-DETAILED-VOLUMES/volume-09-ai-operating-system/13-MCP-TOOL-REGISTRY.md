...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for MCP Tool Registry**.
...
|---|---|
| `MCPToolRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveMCPToolRegistry`
- `ActivateMCPToolRegistry`
- `SuspendMCPToolRegistry`
- `CorrectMCPToolRegistry`
- `RetireMCPToolRegistry`

Reference Events:

- `MCPToolRegistryCreated`
- `MCPToolRegistryValidated`
- `MCPToolRegistryApproved`
- `MCPToolRegistryActivated`
- `MCPToolRegistrySuspended`
- `MCPToolRegistryCorrected`
- `MCPToolRegistryRetired`

Reference queries:

- `GetMCPToolRegistry`
- `ListMCPToolRegistryRecords`
- `GetMCPToolRegistryTimeline`
- `GetMCPToolRegistryEvidence`
- `GetMCPToolRegistryDecisionPackage`
- `GetMCPToolRegistryExceptions`
- `GetMCPToolRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/mcptoolregistry/commands
GET  /api/v1/mcptoolregistry/{id}
GET  /api/v1/mcptoolregistry/{id}/timeline
GET  /api/v1/mcptoolregistry/{id}/evidence
GET  /api/v1/mcptoolregistry/{id}/decisions
POST /api/v1/mcptoolregistry/{id}/exceptions
POST /api/v1/mcptoolregistry/{id}/corrections
```
...
|---|---|
| `mcptoolregistry_aggregate` | authoritative subject |
| `mcptoolregistry_version` | immutable submitted, approved, issued, or signed versions |
| `mcptoolregistry_relationship` | governed relationships |
| `mcptoolregistry_decision` | binding Decisions and rationale |
| `mcptoolregistry_evidence_link` | provenance and evidence relationships |
| `mcptoolregistry_event_outbox` | transactional Event publication |
| `mcptoolregistry_idempotency` | duplicate-write protection |
| `mcptoolregistry_exception` | exception, claim, dispute, or hold |
| `mcptoolregistry_correction` | correction and supersession lineage |
| `mcptoolregistry_audit` | privileged action evidence |
