...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for RAG and Retrieval**.
...
|---|---|
| `RAGandRetrieval` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RAGandRetrievalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RAGandRetrievalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RAGandRetrievalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RAGandRetrievalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateRAGandRetrieval`
- `ValidateRAGandRetrieval`
- `ApproveRAGandRetrieval`
- `ActivateRAGandRetrieval`
- `SuspendRAGandRetrieval`
- `CorrectRAGandRetrieval`
- `RetireRAGandRetrieval`

Reference Events:

- `RAGandRetrievalCreated`
- `RAGandRetrievalValidated`
- `RAGandRetrievalApproved`
- `RAGandRetrievalActivated`
- `RAGandRetrievalSuspended`
- `RAGandRetrievalCorrected`
- `RAGandRetrievalRetired`

Reference queries:

- `GetRAGandRetrieval`
- `ListRAGandRetrievalRecords`
- `GetRAGandRetrievalTimeline`
- `GetRAGandRetrievalEvidence`
- `GetRAGandRetrievalDecisionPackage`
- `GetRAGandRetrievalExceptions`
- `GetRAGandRetrievalAuditTrail`

Reference API surface:

```text
POST /api/v1/ragandretrieval/commands
GET  /api/v1/ragandretrieval/{id}
GET  /api/v1/ragandretrieval/{id}/timeline
GET  /api/v1/ragandretrieval/{id}/evidence
GET  /api/v1/ragandretrieval/{id}/decisions
POST /api/v1/ragandretrieval/{id}/exceptions
POST /api/v1/ragandretrieval/{id}/corrections
```
...
|---|---|
| `ragandretrieval_aggregate` | authoritative subject |
| `ragandretrieval_version` | immutable submitted, approved, issued, or signed versions |
| `ragandretrieval_relationship` | governed relationships |
| `ragandretrieval_decision` | binding Decisions and rationale |
| `ragandretrieval_evidence_link` | provenance and evidence relationships |
| `ragandretrieval_event_outbox` | transactional Event publication |
| `ragandretrieval_idempotency` | duplicate-write protection |
| `ragandretrieval_exception` | exception, claim, dispute, or hold |
| `ragandretrieval_correction` | correction and supersession lineage |
| `ragandretrieval_audit` | privileged action evidence |
