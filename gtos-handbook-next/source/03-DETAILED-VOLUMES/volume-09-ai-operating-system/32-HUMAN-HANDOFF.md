...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Human Handoff**.
...
|---|---|
| `HumanHandoff` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `HumanHandoffVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `HumanHandoffDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `HumanHandoffEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `HumanHandoffException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `HumanHandoffCreated`
- `HumanHandoffValidated`
- `HumanHandoffApproved`
- `HumanHandoffActivated`
- `HumanHandoffSuspended`
- `HumanHandoffCorrected`
- `HumanHandoffRetired`

Reference queries:

- `GetHumanHandoff`
- `ListHumanHandoffRecords`
- `GetHumanHandoffTimeline`
- `GetHumanHandoffEvidence`
- `GetHumanHandoffDecisionPackage`
- `GetHumanHandoffExceptions`
- `GetHumanHandoffAuditTrail`

Reference API surface:

```text
POST /api/v1/humanhandoff/commands
GET  /api/v1/humanhandoff/{id}
GET  /api/v1/humanhandoff/{id}/timeline
GET  /api/v1/humanhandoff/{id}/evidence
GET  /api/v1/humanhandoff/{id}/decisions
POST /api/v1/humanhandoff/{id}/exceptions
POST /api/v1/humanhandoff/{id}/corrections
```
...
|---|---|
| `humanhandoff_aggregate` | authoritative subject |
| `humanhandoff_version` | immutable submitted, approved, issued, or signed versions |
| `humanhandoff_relationship` | governed relationships |
| `humanhandoff_decision` | binding Decisions and rationale |
| `humanhandoff_evidence_link` | provenance and evidence relationships |
| `humanhandoff_event_outbox` | transactional Event publication |
| `humanhandoff_idempotency` | duplicate-write protection |
| `humanhandoff_exception` | exception, claim, dispute, or hold |
| `humanhandoff_correction` | correction and supersession lineage |
| `humanhandoff_audit` | privileged action evidence |
