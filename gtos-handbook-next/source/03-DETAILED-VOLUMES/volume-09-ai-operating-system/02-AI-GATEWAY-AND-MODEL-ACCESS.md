...
| Volume | `9` |
| Chapter ID | `V09-02` |
| Subject | `AIGatewayandModelAccess` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for AI Gateway and Model Access**.
...
|---|---|
| `AIGatewayandModelAccess` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIGatewayandModelAccessVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIGatewayandModelAccessDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIGatewayandModelAccessEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIGatewayandModelAccessException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
AIGatewayandModelAccess {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateAIGatewayandModelAccess`
- `ValidateAIGatewayandModelAccess`
- `ApproveAIGatewayandModelAccess`
- `ActivateAIGatewayandModelAccess`
- `SuspendAIGatewayandModelAccess`
- `CorrectAIGatewayandModelAccess`
- `RetireAIGatewayandModelAccess`

Reference Events:

- `AIGatewayandModelAccessCreated`
- `AIGatewayandModelAccessValidated`
- `AIGatewayandModelAccessApproved`
- `AIGatewayandModelAccessActivated`
- `AIGatewayandModelAccessSuspended`
- `AIGatewayandModelAccessCorrected`
- `AIGatewayandModelAccessRetired`

Reference queries:

- `GetAIGatewayandModelAccess`
- `ListAIGatewayandModelAccessRecords`
- `GetAIGatewayandModelAccessTimeline`
- `GetAIGatewayandModelAccessEvidence`
- `GetAIGatewayandModelAccessDecisionPackage`
- `GetAIGatewayandModelAccessExceptions`
- `GetAIGatewayandModelAccessAuditTrail`

Reference API surface:

```text
POST /api/v1/aigatewayandmodelaccess/commands
GET  /api/v1/aigatewayandmodelaccess/{id}
GET  /api/v1/aigatewayandmodelaccess/{id}/timeline
GET  /api/v1/aigatewayandmodelaccess/{id}/evidence
GET  /api/v1/aigatewayandmodelaccess/{id}/decisions
POST /api/v1/aigatewayandmodelaccess/{id}/exceptions
POST /api/v1/aigatewayandmodelaccess/{id}/corrections
```
...
|---|---|
| `aigatewayandmodelaccess_aggregate` | authoritative subject |
| `aigatewayandmodelaccess_version` | immutable submitted, approved, issued, or signed versions |
| `aigatewayandmodelaccess_relationship` | governed relationships |
| `aigatewayandmodelaccess_decision` | binding Decisions and rationale |
| `aigatewayandmodelaccess_evidence_link` | provenance and evidence relationships |
| `aigatewayandmodelaccess_event_outbox` | transactional Event publication |
| `aigatewayandmodelaccess_idempotency` | duplicate-write protection |
| `aigatewayandmodelaccess_exception` | exception, claim, dispute, or hold |
| `aigatewayandmodelaccess_correction` | correction and supersession lineage |
| `aigatewayandmodelaccess_audit` | privileged action evidence |
