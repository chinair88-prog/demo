...
| Volume | `9` |
| Chapter ID | `V09-18` |
| Subject | `ModelRegistryandRouting` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Model Registry and Routing**.
...
|---|---|
| `ModelRegistryandRouting` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ModelRegistryandRoutingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ModelRegistryandRoutingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ModelRegistryandRoutingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ModelRegistryandRoutingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ModelRegistryandRouting {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateModelRegistryandRouting`
- `ValidateModelRegistryandRouting`
- `ApproveModelRegistryandRouting`
- `ActivateModelRegistryandRouting`
- `SuspendModelRegistryandRouting`
- `CorrectModelRegistryandRouting`
- `RetireModelRegistryandRouting`

Reference Events:

- `ModelRegistryandRoutingCreated`
- `ModelRegistryandRoutingValidated`
- `ModelRegistryandRoutingApproved`
- `ModelRegistryandRoutingActivated`
- `ModelRegistryandRoutingSuspended`
- `ModelRegistryandRoutingCorrected`
- `ModelRegistryandRoutingRetired`

Reference queries:

- `GetModelRegistryandRouting`
- `ListModelRegistryandRoutingRecords`
- `GetModelRegistryandRoutingTimeline`
- `GetModelRegistryandRoutingEvidence`
- `GetModelRegistryandRoutingDecisionPackage`
- `GetModelRegistryandRoutingExceptions`
- `GetModelRegistryandRoutingAuditTrail`

Reference API surface:

```text
POST /api/v1/modelregistryandrouting/commands
GET  /api/v1/modelregistryandrouting/{id}
GET  /api/v1/modelregistryandrouting/{id}/timeline
GET  /api/v1/modelregistryandrouting/{id}/evidence
GET  /api/v1/modelregistryandrouting/{id}/decisions
POST /api/v1/modelregistryandrouting/{id}/exceptions
POST /api/v1/modelregistryandrouting/{id}/corrections
```
...
|---|---|
| `modelregistryandrouting_aggregate` | authoritative subject |
| `modelregistryandrouting_version` | immutable submitted, approved, issued, or signed versions |
| `modelregistryandrouting_relationship` | governed relationships |
| `modelregistryandrouting_decision` | binding Decisions and rationale |
| `modelregistryandrouting_evidence_link` | provenance and evidence relationships |
| `modelregistryandrouting_event_outbox` | transactional Event publication |
| `modelregistryandrouting_idempotency` | duplicate-write protection |
| `modelregistryandrouting_exception` | exception, claim, dispute, or hold |
| `modelregistryandrouting_correction` | correction and supersession lineage |
| `modelregistryandrouting_audit` | privileged action evidence |
