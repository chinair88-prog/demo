# Knowledge Cutoff and Provenance

| Metadata | Value |
|---|---|
| Volume | `9` |
| Chapter ID | `V09-23` |
| Subject | `KnowledgeCutoffandProvenance` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Knowledge Cutoff and Provenance**.
...
|---|---|
| `KnowledgeCutoffandProvenance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `KnowledgeCutoffandProvenanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `KnowledgeCutoffandProvenanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `KnowledgeCutoffandProvenanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `KnowledgeCutoffandProvenanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
KnowledgeCutoffandProvenance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateKnowledgeCutoffandProvenance`
- `ValidateKnowledgeCutoffandProvenance`
- `ApproveKnowledgeCutoffandProvenance`
- `ActivateKnowledgeCutoffandProvenance`
- `SuspendKnowledgeCutoffandProvenance`
- `CorrectKnowledgeCutoffandProvenance`
- `RetireKnowledgeCutoffandProvenance`

Reference Events:

- `KnowledgeCutoffandProvenanceCreated`
- `KnowledgeCutoffandProvenanceValidated`
- `KnowledgeCutoffandProvenanceApproved`
- `KnowledgeCutoffandProvenanceActivated`
- `KnowledgeCutoffandProvenanceSuspended`
- `KnowledgeCutoffandProvenanceCorrected`
- `KnowledgeCutoffandProvenanceRetired`

Reference queries:

- `GetKnowledgeCutoffandProvenance`
- `ListKnowledgeCutoffandProvenanceRecords`
- `GetKnowledgeCutoffandProvenanceTimeline`
- `GetKnowledgeCutoffandProvenanceEvidence`
- `GetKnowledgeCutoffandProvenanceDecisionPackage`
- `GetKnowledgeCutoffandProvenanceExceptions`
- `GetKnowledgeCutoffandProvenanceAuditTrail`

Reference API surface:

```text
POST /api/v1/knowledgecutoffandprovenance/commands
GET  /api/v1/knowledgecutoffandprovenance/{id}
GET  /api/v1/knowledgecutoffandprovenance/{id}/timeline
GET  /api/v1/knowledgecutoffandprovenance/{id}/evidence
GET  /api/v1/knowledgecutoffandprovenance/{id}/decisions
POST /api/v1/knowledgecutoffandprovenance/{id}/exceptions
POST /api/v1/knowledgecutoffandprovenance/{id}/corrections
```
...
|---|---|
| `knowledgecutoffandprovenance_aggregate` | authoritative subject |
| `knowledgecutoffandprovenance_version` | immutable submitted, approved, issued, or signed versions |
| `knowledgecutoffandprovenance_relationship` | governed relationships |
| `knowledgecutoffandprovenance_decision` | binding Decisions and rationale |
| `knowledgecutoffandprovenance_evidence_link` | provenance and evidence relationships |
| `knowledgecutoffandprovenance_event_outbox` | transactional Event publication |
| `knowledgecutoffandprovenance_idempotency` | duplicate-write protection |
| `knowledgecutoffandprovenance_exception` | exception, claim, dispute, or hold |
| `knowledgecutoffandprovenance_correction` | correction and supersession lineage |
| `knowledgecutoffandprovenance_audit` | privileged action evidence |
