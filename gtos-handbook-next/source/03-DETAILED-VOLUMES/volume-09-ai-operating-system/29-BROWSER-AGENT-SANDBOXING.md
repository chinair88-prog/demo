...
| Volume | `9` |
| Chapter ID | `V09-29` |
| Subject | `BrowserAgentSandboxing` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Browser Agent Sandboxing**.
...
|---|---|
| `BrowserAgentSandboxing` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BrowserAgentSandboxingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BrowserAgentSandboxingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BrowserAgentSandboxingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BrowserAgentSandboxingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
BrowserAgentSandboxing {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateBrowserAgentSandboxing`
- `ValidateBrowserAgentSandboxing`
- `ApproveBrowserAgentSandboxing`
- `ActivateBrowserAgentSandboxing`
- `SuspendBrowserAgentSandboxing`
- `CorrectBrowserAgentSandboxing`
- `RetireBrowserAgentSandboxing`

Reference Events:

- `BrowserAgentSandboxingCreated`
- `BrowserAgentSandboxingValidated`
- `BrowserAgentSandboxingApproved`
- `BrowserAgentSandboxingActivated`
- `BrowserAgentSandboxingSuspended`
- `BrowserAgentSandboxingCorrected`
- `BrowserAgentSandboxingRetired`

Reference queries:

- `GetBrowserAgentSandboxing`
- `ListBrowserAgentSandboxingRecords`
- `GetBrowserAgentSandboxingTimeline`
- `GetBrowserAgentSandboxingEvidence`
- `GetBrowserAgentSandboxingDecisionPackage`
- `GetBrowserAgentSandboxingExceptions`
- `GetBrowserAgentSandboxingAuditTrail`

Reference API surface:

```text
POST /api/v1/browseragentsandboxing/commands
GET  /api/v1/browseragentsandboxing/{id}
GET  /api/v1/browseragentsandboxing/{id}/timeline
GET  /api/v1/browseragentsandboxing/{id}/evidence
GET  /api/v1/browseragentsandboxing/{id}/decisions
POST /api/v1/browseragentsandboxing/{id}/exceptions
POST /api/v1/browseragentsandboxing/{id}/corrections
```
...
|---|---|
| `browseragentsandboxing_aggregate` | authoritative subject |
| `browseragentsandboxing_version` | immutable submitted, approved, issued, or signed versions |
| `browseragentsandboxing_relationship` | governed relationships |
| `browseragentsandboxing_decision` | binding Decisions and rationale |
| `browseragentsandboxing_evidence_link` | provenance and evidence relationships |
| `browseragentsandboxing_event_outbox` | transactional Event publication |
| `browseragentsandboxing_idempotency` | duplicate-write protection |
| `browseragentsandboxing_exception` | exception, claim, dispute, or hold |
| `browseragentsandboxing_correction` | correction and supersession lineage |
| `browseragentsandboxing_audit` | privileged action evidence |
