...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for MCP Tool Gateway**.
...
|---|---|
| `MCPToolGateway` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolGatewayVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolGatewayDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolGatewayEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolGatewayException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateMCPToolGateway`
- `ApproveMCPToolGateway`
- `ActivateMCPToolGateway`
- `SuspendMCPToolGateway`
- `CorrectMCPToolGateway`
- `RetireMCPToolGateway`

Reference Events:

- `MCPToolGatewayCreated`
- `MCPToolGatewayValidated`
- `MCPToolGatewayApproved`
- `MCPToolGatewayActivated`
- `MCPToolGatewaySuspended`
- `MCPToolGatewayCorrected`
- `MCPToolGatewayRetired`

Reference queries:

- `GetMCPToolGateway`
- `ListMCPToolGatewayRecords`
- `GetMCPToolGatewayTimeline`
- `GetMCPToolGatewayEvidence`
- `GetMCPToolGatewayDecisionPackage`
- `GetMCPToolGatewayExceptions`
- `GetMCPToolGatewayAuditTrail`

Reference API surface:

```text
POST /api/v1/mcptoolgateway/commands
GET  /api/v1/mcptoolgateway/{id}
GET  /api/v1/mcptoolgateway/{id}/timeline
GET  /api/v1/mcptoolgateway/{id}/evidence
GET  /api/v1/mcptoolgateway/{id}/decisions
POST /api/v1/mcptoolgateway/{id}/exceptions
POST /api/v1/mcptoolgateway/{id}/corrections
```
...
|---|---|
| `mcptoolgateway_aggregate` | authoritative subject |
| `mcptoolgateway_version` | immutable submitted, approved, issued, or signed versions |
| `mcptoolgateway_relationship` | governed relationships |
| `mcptoolgateway_decision` | binding Decisions and rationale |
| `mcptoolgateway_evidence_link` | provenance and evidence relationships |
| `mcptoolgateway_event_outbox` | transactional Event publication |
| `mcptoolgateway_idempotency` | duplicate-write protection |
| `mcptoolgateway_exception` | exception, claim, dispute, or hold |
| `mcptoolgateway_correction` | correction and supersession lineage |
| `mcptoolgateway_audit` | privileged action evidence |
