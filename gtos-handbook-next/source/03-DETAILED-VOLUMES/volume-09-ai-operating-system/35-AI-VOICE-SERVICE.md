...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for AI Voice Service**.
...
|---|---|
| `AIVoiceService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVoiceServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVoiceServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVoiceServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVoiceServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAIVoiceService`
- `ValidateAIVoiceService`
- `ApproveAIVoiceService`
- `ActivateAIVoiceService`
- `SuspendAIVoiceService`
- `CorrectAIVoiceService`
- `RetireAIVoiceService`

Reference Events:

- `AIVoiceServiceCreated`
- `AIVoiceServiceValidated`
- `AIVoiceServiceApproved`
- `AIVoiceServiceActivated`
- `AIVoiceServiceSuspended`
- `AIVoiceServiceCorrected`
- `AIVoiceServiceRetired`

Reference queries:

- `GetAIVoiceService`
- `ListAIVoiceServiceRecords`
- `GetAIVoiceServiceTimeline`
- `GetAIVoiceServiceEvidence`
- `GetAIVoiceServiceDecisionPackage`
- `GetAIVoiceServiceExceptions`
- `GetAIVoiceServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/aivoiceservice/commands
GET  /api/v1/aivoiceservice/{id}
GET  /api/v1/aivoiceservice/{id}/timeline
GET  /api/v1/aivoiceservice/{id}/evidence
GET  /api/v1/aivoiceservice/{id}/decisions
POST /api/v1/aivoiceservice/{id}/exceptions
POST /api/v1/aivoiceservice/{id}/corrections
```
...
|---|---|
| `aivoiceservice_aggregate` | authoritative subject |
| `aivoiceservice_version` | immutable submitted, approved, issued, or signed versions |
| `aivoiceservice_relationship` | governed relationships |
| `aivoiceservice_decision` | binding Decisions and rationale |
| `aivoiceservice_evidence_link` | provenance and evidence relationships |
| `aivoiceservice_event_outbox` | transactional Event publication |
| `aivoiceservice_idempotency` | duplicate-write protection |
| `aivoiceservice_exception` | exception, claim, dispute, or hold |
| `aivoiceservice_correction` | correction and supersession lineage |
| `aivoiceservice_audit` | privileged action evidence |
