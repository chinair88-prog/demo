...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for AI Compliance Service**.
...
|---|---|
| `AIComplianceService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIComplianceServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIComplianceServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIComplianceServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIComplianceServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAIComplianceService`
- `ValidateAIComplianceService`
- `ApproveAIComplianceService`
- `ActivateAIComplianceService`
- `SuspendAIComplianceService`
- `CorrectAIComplianceService`
- `RetireAIComplianceService`

Reference Events:

- `AIComplianceServiceCreated`
- `AIComplianceServiceValidated`
- `AIComplianceServiceApproved`
- `AIComplianceServiceActivated`
- `AIComplianceServiceSuspended`
- `AIComplianceServiceCorrected`
- `AIComplianceServiceRetired`

Reference queries:

- `GetAIComplianceService`
- `ListAIComplianceServiceRecords`
- `GetAIComplianceServiceTimeline`
- `GetAIComplianceServiceEvidence`
- `GetAIComplianceServiceDecisionPackage`
- `GetAIComplianceServiceExceptions`
- `GetAIComplianceServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/aicomplianceservice/commands
GET  /api/v1/aicomplianceservice/{id}
GET  /api/v1/aicomplianceservice/{id}/timeline
GET  /api/v1/aicomplianceservice/{id}/evidence
GET  /api/v1/aicomplianceservice/{id}/decisions
POST /api/v1/aicomplianceservice/{id}/exceptions
POST /api/v1/aicomplianceservice/{id}/corrections
```
...
|---|---|
| `aicomplianceservice_aggregate` | authoritative subject |
| `aicomplianceservice_version` | immutable submitted, approved, issued, or signed versions |
| `aicomplianceservice_relationship` | governed relationships |
| `aicomplianceservice_decision` | binding Decisions and rationale |
| `aicomplianceservice_evidence_link` | provenance and evidence relationships |
| `aicomplianceservice_event_outbox` | transactional Event publication |
| `aicomplianceservice_idempotency` | duplicate-write protection |
| `aicomplianceservice_exception` | exception, claim, dispute, or hold |
| `aicomplianceservice_correction` | correction and supersession lineage |
| `aicomplianceservice_audit` | privileged action evidence |
