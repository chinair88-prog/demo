...
| Volume | `9` |
| Chapter ID | `V09-28` |
| Subject | `AISecurityandPromptInjection` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for AI Security and Prompt Injection**.
...
|---|---|
| `AISecurityandPromptInjection` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AISecurityandPromptInjectionVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AISecurityandPromptInjectionDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AISecurityandPromptInjectionEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AISecurityandPromptInjectionException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
AISecurityandPromptInjection {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateAISecurityandPromptInjection`
- `ValidateAISecurityandPromptInjection`
- `ApproveAISecurityandPromptInjection`
- `ActivateAISecurityandPromptInjection`
- `SuspendAISecurityandPromptInjection`
- `CorrectAISecurityandPromptInjection`
- `RetireAISecurityandPromptInjection`

Reference Events:

- `AISecurityandPromptInjectionCreated`
- `AISecurityandPromptInjectionValidated`
- `AISecurityandPromptInjectionApproved`
- `AISecurityandPromptInjectionActivated`
- `AISecurityandPromptInjectionSuspended`
- `AISecurityandPromptInjectionCorrected`
- `AISecurityandPromptInjectionRetired`

Reference queries:

- `GetAISecurityandPromptInjection`
- `ListAISecurityandPromptInjectionRecords`
- `GetAISecurityandPromptInjectionTimeline`
- `GetAISecurityandPromptInjectionEvidence`
- `GetAISecurityandPromptInjectionDecisionPackage`
- `GetAISecurityandPromptInjectionExceptions`
- `GetAISecurityandPromptInjectionAuditTrail`

Reference API surface:

```text
POST /api/v1/aisecurityandpromptinjection/commands
GET  /api/v1/aisecurityandpromptinjection/{id}
GET  /api/v1/aisecurityandpromptinjection/{id}/timeline
GET  /api/v1/aisecurityandpromptinjection/{id}/evidence
GET  /api/v1/aisecurityandpromptinjection/{id}/decisions
POST /api/v1/aisecurityandpromptinjection/{id}/exceptions
POST /api/v1/aisecurityandpromptinjection/{id}/corrections
```
...
|---|---|
| `aisecurityandpromptinjection_aggregate` | authoritative subject |
| `aisecurityandpromptinjection_version` | immutable submitted, approved, issued, or signed versions |
| `aisecurityandpromptinjection_relationship` | governed relationships |
| `aisecurityandpromptinjection_decision` | binding Decisions and rationale |
| `aisecurityandpromptinjection_evidence_link` | provenance and evidence relationships |
| `aisecurityandpromptinjection_event_outbox` | transactional Event publication |
| `aisecurityandpromptinjection_idempotency` | duplicate-write protection |
| `aisecurityandpromptinjection_exception` | exception, claim, dispute, or hold |
| `aisecurityandpromptinjection_correction` | correction and supersession lineage |
| `aisecurityandpromptinjection_audit` | privileged action evidence |
