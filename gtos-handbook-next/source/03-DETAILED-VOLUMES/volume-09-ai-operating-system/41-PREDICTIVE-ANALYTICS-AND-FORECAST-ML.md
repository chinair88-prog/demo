# Predictive Analytics and Forecast ML

| Metadata | Value |
|---|---|
| Volume | `9` |
| Chapter ID | `V09-41` |
| Subject | `PredictiveAnalyticsandForecastML` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Predictive Analytics and Forecast ML**.
...
|---|---|
| `PredictiveAnalyticsandForecastML` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PredictiveAnalyticsandForecastMLVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PredictiveAnalyticsandForecastMLDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PredictiveAnalyticsandForecastMLEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PredictiveAnalyticsandForecastMLException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PredictiveAnalyticsandForecastML {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePredictiveAnalyticsandForecastML`
- `ValidatePredictiveAnalyticsandForecastML`
- `ApprovePredictiveAnalyticsandForecastML`
- `ActivatePredictiveAnalyticsandForecastML`
- `SuspendPredictiveAnalyticsandForecastML`
- `CorrectPredictiveAnalyticsandForecastML`
- `RetirePredictiveAnalyticsandForecastML`

Reference Events:

- `PredictiveAnalyticsandForecastMLCreated`
- `PredictiveAnalyticsandForecastMLValidated`
- `PredictiveAnalyticsandForecastMLApproved`
- `PredictiveAnalyticsandForecastMLActivated`
- `PredictiveAnalyticsandForecastMLSuspended`
- `PredictiveAnalyticsandForecastMLCorrected`
- `PredictiveAnalyticsandForecastMLRetired`

Reference queries:

- `GetPredictiveAnalyticsandForecastML`
- `ListPredictiveAnalyticsandForecastMLRecords`
- `GetPredictiveAnalyticsandForecastMLTimeline`
- `GetPredictiveAnalyticsandForecastMLEvidence`
- `GetPredictiveAnalyticsandForecastMLDecisionPackage`
- `GetPredictiveAnalyticsandForecastMLExceptions`
- `GetPredictiveAnalyticsandForecastMLAuditTrail`

Reference API surface:

```text
POST /api/v1/predictiveanalyticsandforecastml/commands
GET  /api/v1/predictiveanalyticsandforecastml/{id}
GET  /api/v1/predictiveanalyticsandforecastml/{id}/timeline
GET  /api/v1/predictiveanalyticsandforecastml/{id}/evidence
GET  /api/v1/predictiveanalyticsandforecastml/{id}/decisions
POST /api/v1/predictiveanalyticsandforecastml/{id}/exceptions
POST /api/v1/predictiveanalyticsandforecastml/{id}/corrections
```
...
|---|---|
| `predictiveanalyticsandforecastml_aggregate` | authoritative subject |
| `predictiveanalyticsandforecastml_version` | immutable submitted, approved, issued, or signed versions |
| `predictiveanalyticsandforecastml_relationship` | governed relationships |
| `predictiveanalyticsandforecastml_decision` | binding Decisions and rationale |
| `predictiveanalyticsandforecastml_evidence_link` | provenance and evidence relationships |
| `predictiveanalyticsandforecastml_event_outbox` | transactional Event publication |
| `predictiveanalyticsandforecastml_idempotency` | duplicate-write protection |
| `predictiveanalyticsandforecastml_exception` | exception, claim, dispute, or hold |
| `predictiveanalyticsandforecastml_correction` | correction and supersession lineage |
| `predictiveanalyticsandforecastml_audit` | privileged action evidence |
