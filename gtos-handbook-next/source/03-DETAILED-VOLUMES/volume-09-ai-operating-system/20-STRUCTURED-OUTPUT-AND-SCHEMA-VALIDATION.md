...
| Volume | `9` |
| Chapter ID | `V09-20` |
| Subject | `StructuredOutputandSchemaValidation` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Structured Output and Schema Validation**.
...
|---|---|
| `StructuredOutputandSchemaValidation` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `StructuredOutputandSchemaValidationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `StructuredOutputandSchemaValidationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `StructuredOutputandSchemaValidationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `StructuredOutputandSchemaValidationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
StructuredOutputandSchemaValidation {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateStructuredOutputandSchemaValidation`
- `ValidateStructuredOutputandSchemaValidation`
- `ApproveStructuredOutputandSchemaValidation`
- `ActivateStructuredOutputandSchemaValidation`
- `SuspendStructuredOutputandSchemaValidation`
- `CorrectStructuredOutputandSchemaValidation`
- `RetireStructuredOutputandSchemaValidation`

Reference Events:

- `StructuredOutputandSchemaValidationCreated`
- `StructuredOutputandSchemaValidationValidated`
- `StructuredOutputandSchemaValidationApproved`
- `StructuredOutputandSchemaValidationActivated`
- `StructuredOutputandSchemaValidationSuspended`
- `StructuredOutputandSchemaValidationCorrected`
- `StructuredOutputandSchemaValidationRetired`

Reference queries:

- `GetStructuredOutputandSchemaValidation`
- `ListStructuredOutputandSchemaValidationRecords`
- `GetStructuredOutputandSchemaValidationTimeline`
- `GetStructuredOutputandSchemaValidationEvidence`
- `GetStructuredOutputandSchemaValidationDecisionPackage`
- `GetStructuredOutputandSchemaValidationExceptions`
- `GetStructuredOutputandSchemaValidationAuditTrail`

Reference API surface:

```text
POST /api/v1/structuredoutputandschemavalidation/commands
GET  /api/v1/structuredoutputandschemavalidation/{id}
GET  /api/v1/structuredoutputandschemavalidation/{id}/timeline
GET  /api/v1/structuredoutputandschemavalidation/{id}/evidence
GET  /api/v1/structuredoutputandschemavalidation/{id}/decisions
POST /api/v1/structuredoutputandschemavalidation/{id}/exceptions
POST /api/v1/structuredoutputandschemavalidation/{id}/corrections
```
...
|---|---|
| `structuredoutputandschemavalidation_aggregate` | authoritative subject |
| `structuredoutputandschemavalidation_version` | immutable submitted, approved, issued, or signed versions |
| `structuredoutputandschemavalidation_relationship` | governed relationships |
| `structuredoutputandschemavalidation_decision` | binding Decisions and rationale |
| `structuredoutputandschemavalidation_evidence_link` | provenance and evidence relationships |
| `structuredoutputandschemavalidation_event_outbox` | transactional Event publication |
| `structuredoutputandschemavalidation_idempotency` | duplicate-write protection |
| `structuredoutputandschemavalidation_exception` | exception, claim, dispute, or hold |
| `structuredoutputandschemavalidation_correction` | correction and supersession lineage |
| `structuredoutputandschemavalidation_audit` | privileged action evidence |
...
- plan and execute only through typed registered Tools
- retain source context and knowledge cutoff
- expose confidence, limitations and policy result
- observe outcomes and trigger recovery or human handoff
...
- central provider and Tool governance
- prompt injection and data exfiltration defense
- sandbox and egress policy
- budget, approval, kill switch and incident containment
