...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Critic and Verifier**.
...
|---|---|
| `CriticandVerifier` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CriticandVerifierVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CriticandVerifierDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CriticandVerifierEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CriticandVerifierException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateCriticandVerifier`
- `ValidateCriticandVerifier`
- `ApproveCriticandVerifier`
- `ActivateCriticandVerifier`
- `SuspendCriticandVerifier`
- `CorrectCriticandVerifier`
- `RetireCriticandVerifier`

Reference Events:

- `CriticandVerifierCreated`
- `CriticandVerifierValidated`
- `CriticandVerifierApproved`
- `CriticandVerifierActivated`
- `CriticandVerifierSuspended`
- `CriticandVerifierCorrected`
- `CriticandVerifierRetired`

Reference queries:

- `GetCriticandVerifier`
- `ListCriticandVerifierRecords`
- `GetCriticandVerifierTimeline`
- `GetCriticandVerifierEvidence`
- `GetCriticandVerifierDecisionPackage`
- `GetCriticandVerifierExceptions`
- `GetCriticandVerifierAuditTrail`

Reference API surface:

```text
POST /api/v1/criticandverifier/commands
GET  /api/v1/criticandverifier/{id}
GET  /api/v1/criticandverifier/{id}/timeline
GET  /api/v1/criticandverifier/{id}/evidence
GET  /api/v1/criticandverifier/{id}/decisions
POST /api/v1/criticandverifier/{id}/exceptions
POST /api/v1/criticandverifier/{id}/corrections
```
...
|---|---|
| `criticandverifier_aggregate` | authoritative subject |
| `criticandverifier_version` | immutable submitted, approved, issued, or signed versions |
| `criticandverifier_relationship` | governed relationships |
| `criticandverifier_decision` | binding Decisions and rationale |
| `criticandverifier_evidence_link` | provenance and evidence relationships |
| `criticandverifier_event_outbox` | transactional Event publication |
| `criticandverifier_idempotency` | duplicate-write protection |
| `criticandverifier_exception` | exception, claim, dispute, or hold |
| `criticandverifier_correction` | correction and supersession lineage |
| `criticandverifier_audit` | privileged action evidence |
