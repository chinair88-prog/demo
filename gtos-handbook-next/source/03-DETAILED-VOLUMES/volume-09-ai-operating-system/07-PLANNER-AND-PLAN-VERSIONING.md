# Planner and Plan Versioning

| Metadata | Value |
|---|---|
| Volume | `9` |
| Chapter ID | `V09-07` |
| Subject | `PlannerandPlanVersioning` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Planner and Plan Versioning**.
...
|---|---|
| `PlannerandPlanVersioning` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlannerandPlanVersioningVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlannerandPlanVersioningDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlannerandPlanVersioningEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlannerandPlanVersioningException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PlannerandPlanVersioning {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePlannerandPlanVersioning`
- `ValidatePlannerandPlanVersioning`
- `ApprovePlannerandPlanVersioning`
- `ActivatePlannerandPlanVersioning`
- `SuspendPlannerandPlanVersioning`
- `CorrectPlannerandPlanVersioning`
- `RetirePlannerandPlanVersioning`

Reference Events:

- `PlannerandPlanVersioningCreated`
- `PlannerandPlanVersioningValidated`
- `PlannerandPlanVersioningApproved`
- `PlannerandPlanVersioningActivated`
- `PlannerandPlanVersioningSuspended`
- `PlannerandPlanVersioningCorrected`
- `PlannerandPlanVersioningRetired`

Reference queries:

- `GetPlannerandPlanVersioning`
- `ListPlannerandPlanVersioningRecords`
- `GetPlannerandPlanVersioningTimeline`
- `GetPlannerandPlanVersioningEvidence`
- `GetPlannerandPlanVersioningDecisionPackage`
- `GetPlannerandPlanVersioningExceptions`
- `GetPlannerandPlanVersioningAuditTrail`

Reference API surface:

```text
POST /api/v1/plannerandplanversioning/commands
GET  /api/v1/plannerandplanversioning/{id}
GET  /api/v1/plannerandplanversioning/{id}/timeline
GET  /api/v1/plannerandplanversioning/{id}/evidence
GET  /api/v1/plannerandplanversioning/{id}/decisions
POST /api/v1/plannerandplanversioning/{id}/exceptions
POST /api/v1/plannerandplanversioning/{id}/corrections
```
...
|---|---|
| `plannerandplanversioning_aggregate` | authoritative subject |
| `plannerandplanversioning_version` | immutable submitted, approved, issued, or signed versions |
| `plannerandplanversioning_relationship` | governed relationships |
| `plannerandplanversioning_decision` | binding Decisions and rationale |
| `plannerandplanversioning_evidence_link` | provenance and evidence relationships |
| `plannerandplanversioning_event_outbox` | transactional Event publication |
| `plannerandplanversioning_idempotency` | duplicate-write protection |
| `plannerandplanversioning_exception` | exception, claim, dispute, or hold |
| `plannerandplanversioning_correction` | correction and supersession lineage |
| `plannerandplanversioning_audit` | privileged action evidence |
