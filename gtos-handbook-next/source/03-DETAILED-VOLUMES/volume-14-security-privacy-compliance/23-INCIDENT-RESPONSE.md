...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Incident Response**.
...
|---|---|
| `IncidentResponse` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentResponseVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentResponseDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentResponseEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentResponseException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `SuspendIncidentResponse`
- `CorrectIncidentResponse`
- `RetireIncidentResponse`
...
- `IncidentResponseSuspended`
- `IncidentResponseCorrected`
- `IncidentResponseRetired`

Reference queries:

- `GetIncidentResponse`
- `ListIncidentResponseRecords`
- `GetIncidentResponseTimeline`
- `GetIncidentResponseEvidence`
- `GetIncidentResponseDecisionPackage`
- `GetIncidentResponseExceptions`
- `GetIncidentResponseAuditTrail`

Reference API surface:

```text
POST /api/v1/incidentresponse/commands
GET  /api/v1/incidentresponse/{id}
GET  /api/v1/incidentresponse/{id}/timeline
GET  /api/v1/incidentresponse/{id}/evidence
GET  /api/v1/incidentresponse/{id}/decisions
POST /api/v1/incidentresponse/{id}/exceptions
POST /api/v1/incidentresponse/{id}/corrections
```
...
|---|---|
| `incidentresponse_aggregate` | authoritative subject |
| `incidentresponse_version` | immutable submitted, approved, issued, or signed versions |
| `incidentresponse_relationship` | governed relationships |
| `incidentresponse_decision` | binding Decisions and rationale |
| `incidentresponse_evidence_link` | provenance and evidence relationships |
| `incidentresponse_event_outbox` | transactional Event publication |
| `incidentresponse_idempotency` | duplicate-write protection |
| `incidentresponse_exception` | exception, claim, dispute, or hold |
| `incidentresponse_correction` | correction and supersession lineage |
| `incidentresponse_audit` | privileged action evidence |
...
- `Incident Response` is part of the target GTOS handbook scope.
