...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Database Security**.
...
|---|---|
| `DatabaseSecurity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseSecurityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseSecurityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseSecurityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseSecurityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateDatabaseSecurity`
- `ValidateDatabaseSecurity`
- `ApproveDatabaseSecurity`
- `ActivateDatabaseSecurity`
- `SuspendDatabaseSecurity`
- `CorrectDatabaseSecurity`
- `RetireDatabaseSecurity`

Reference Events:

- `DatabaseSecurityCreated`
- `DatabaseSecurityValidated`
- `DatabaseSecurityApproved`
- `DatabaseSecurityActivated`
- `DatabaseSecuritySuspended`
- `DatabaseSecurityCorrected`
- `DatabaseSecurityRetired`

Reference queries:

- `GetDatabaseSecurity`
- `ListDatabaseSecurityRecords`
- `GetDatabaseSecurityTimeline`
- `GetDatabaseSecurityEvidence`
- `GetDatabaseSecurityDecisionPackage`
- `GetDatabaseSecurityExceptions`
- `GetDatabaseSecurityAuditTrail`

Reference API surface:

```text
POST /api/v1/databasesecurity/commands
GET  /api/v1/databasesecurity/{id}
GET  /api/v1/databasesecurity/{id}/timeline
GET  /api/v1/databasesecurity/{id}/evidence
GET  /api/v1/databasesecurity/{id}/decisions
POST /api/v1/databasesecurity/{id}/exceptions
POST /api/v1/databasesecurity/{id}/corrections
```
...
|---|---|
| `databasesecurity_aggregate` | authoritative subject |
| `databasesecurity_version` | immutable submitted, approved, issued, or signed versions |
| `databasesecurity_relationship` | governed relationships |
| `databasesecurity_decision` | binding Decisions and rationale |
| `databasesecurity_evidence_link` | provenance and evidence relationships |
| `databasesecurity_event_outbox` | transactional Event publication |
| `databasesecurity_idempotency` | duplicate-write protection |
| `databasesecurity_exception` | exception, claim, dispute, or hold |
| `databasesecurity_correction` | correction and supersession lineage |
| `databasesecurity_audit` | privileged action evidence |
...
- `Database Security` is part of the target GTOS handbook scope.
