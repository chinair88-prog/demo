...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Delegation Security**.
...
|---|---|
| `DelegationSecurity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DelegationSecurityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DelegationSecurityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DelegationSecurityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DelegationSecurityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateDelegationSecurity`
- `ValidateDelegationSecurity`
- `ApproveDelegationSecurity`
- `ActivateDelegationSecurity`
- `SuspendDelegationSecurity`
- `CorrectDelegationSecurity`
- `RetireDelegationSecurity`

Reference Events:

- `DelegationSecurityCreated`
- `DelegationSecurityValidated`
- `DelegationSecurityApproved`
- `DelegationSecurityActivated`
- `DelegationSecuritySuspended`
- `DelegationSecurityCorrected`
- `DelegationSecurityRetired`

Reference queries:

- `GetDelegationSecurity`
- `ListDelegationSecurityRecords`
- `GetDelegationSecurityTimeline`
- `GetDelegationSecurityEvidence`
- `GetDelegationSecurityDecisionPackage`
- `GetDelegationSecurityExceptions`
- `GetDelegationSecurityAuditTrail`

Reference API surface:

```text
POST /api/v1/delegationsecurity/commands
GET  /api/v1/delegationsecurity/{id}
GET  /api/v1/delegationsecurity/{id}/timeline
GET  /api/v1/delegationsecurity/{id}/evidence
GET  /api/v1/delegationsecurity/{id}/decisions
POST /api/v1/delegationsecurity/{id}/exceptions
POST /api/v1/delegationsecurity/{id}/corrections
```
...
|---|---|
| `delegationsecurity_aggregate` | authoritative subject |
| `delegationsecurity_version` | immutable submitted, approved, issued, or signed versions |
| `delegationsecurity_relationship` | governed relationships |
| `delegationsecurity_decision` | binding Decisions and rationale |
| `delegationsecurity_evidence_link` | provenance and evidence relationships |
| `delegationsecurity_event_outbox` | transactional Event publication |
| `delegationsecurity_idempotency` | duplicate-write protection |
| `delegationsecurity_exception` | exception, claim, dispute, or hold |
| `delegationsecurity_correction` | correction and supersession lineage |
| `delegationsecurity_audit` | privileged action evidence |
...
- `Delegation Security` is part of the target GTOS handbook scope.
