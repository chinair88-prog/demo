# Portal and Browser Security

| Metadata | Value |
|---|---|
| Volume | `14` |
| Chapter ID | `V14-15` |
| Subject | `PortalandBrowserSecurity` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Portal and Browser Security**.
...
|---|---|
| `PortalandBrowserSecurity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalandBrowserSecurityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalandBrowserSecurityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalandBrowserSecurityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalandBrowserSecurityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PortalandBrowserSecurity {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePortalandBrowserSecurity`
- `ValidatePortalandBrowserSecurity`
- `ApprovePortalandBrowserSecurity`
- `ActivatePortalandBrowserSecurity`
- `SuspendPortalandBrowserSecurity`
- `CorrectPortalandBrowserSecurity`
- `RetirePortalandBrowserSecurity`

Reference Events:

- `PortalandBrowserSecurityCreated`
- `PortalandBrowserSecurityValidated`
- `PortalandBrowserSecurityApproved`
- `PortalandBrowserSecurityActivated`
- `PortalandBrowserSecuritySuspended`
- `PortalandBrowserSecurityCorrected`
- `PortalandBrowserSecurityRetired`

Reference queries:

- `GetPortalandBrowserSecurity`
- `ListPortalandBrowserSecurityRecords`
- `GetPortalandBrowserSecurityTimeline`
- `GetPortalandBrowserSecurityEvidence`
- `GetPortalandBrowserSecurityDecisionPackage`
- `GetPortalandBrowserSecurityExceptions`
- `GetPortalandBrowserSecurityAuditTrail`

Reference API surface:

```text
POST /api/v1/portalandbrowsersecurity/commands
GET  /api/v1/portalandbrowsersecurity/{id}
GET  /api/v1/portalandbrowsersecurity/{id}/timeline
GET  /api/v1/portalandbrowsersecurity/{id}/evidence
GET  /api/v1/portalandbrowsersecurity/{id}/decisions
POST /api/v1/portalandbrowsersecurity/{id}/exceptions
POST /api/v1/portalandbrowsersecurity/{id}/corrections
```
...
|---|---|
| `portalandbrowsersecurity_aggregate` | authoritative subject |
| `portalandbrowsersecurity_version` | immutable submitted, approved, issued, or signed versions |
| `portalandbrowsersecurity_relationship` | governed relationships |
| `portalandbrowsersecurity_decision` | binding Decisions and rationale |
| `portalandbrowsersecurity_evidence_link` | provenance and evidence relationships |
| `portalandbrowsersecurity_event_outbox` | transactional Event publication |
| `portalandbrowsersecurity_idempotency` | duplicate-write protection |
| `portalandbrowsersecurity_exception` | exception, claim, dispute, or hold |
| `portalandbrowsersecurity_correction` | correction and supersession lineage |
| `portalandbrowsersecurity_audit` | privileged action evidence |
...
- `Portal and Browser Security` is part of the target GTOS handbook scope.
