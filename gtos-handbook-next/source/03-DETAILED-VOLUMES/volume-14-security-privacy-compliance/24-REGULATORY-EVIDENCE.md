...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Regulatory Evidence**.
...
|---|---|
| `RegulatoryEvidence` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RegulatoryEvidenceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RegulatoryEvidenceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RegulatoryEvidenceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RegulatoryEvidenceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateRegulatoryEvidence`
- `ApproveRegulatoryEvidence`
- `ActivateRegulatoryEvidence`
- `SuspendRegulatoryEvidence`
- `CorrectRegulatoryEvidence`
- `RetireRegulatoryEvidence`

Reference Events:

- `RegulatoryEvidenceCreated`
- `RegulatoryEvidenceValidated`
- `RegulatoryEvidenceApproved`
- `RegulatoryEvidenceActivated`
- `RegulatoryEvidenceSuspended`
- `RegulatoryEvidenceCorrected`
- `RegulatoryEvidenceRetired`

Reference queries:

- `GetRegulatoryEvidence`
- `ListRegulatoryEvidenceRecords`
- `GetRegulatoryEvidenceTimeline`
- `GetRegulatoryEvidenceEvidence`
- `GetRegulatoryEvidenceDecisionPackage`
- `GetRegulatoryEvidenceExceptions`
- `GetRegulatoryEvidenceAuditTrail`

Reference API surface:

```text
POST /api/v1/regulatoryevidence/commands
GET  /api/v1/regulatoryevidence/{id}
GET  /api/v1/regulatoryevidence/{id}/timeline
GET  /api/v1/regulatoryevidence/{id}/evidence
GET  /api/v1/regulatoryevidence/{id}/decisions
POST /api/v1/regulatoryevidence/{id}/exceptions
POST /api/v1/regulatoryevidence/{id}/corrections
```
...
|---|---|
| `regulatoryevidence_aggregate` | authoritative subject |
| `regulatoryevidence_version` | immutable submitted, approved, issued, or signed versions |
| `regulatoryevidence_relationship` | governed relationships |
| `regulatoryevidence_decision` | binding Decisions and rationale |
| `regulatoryevidence_evidence_link` | provenance and evidence relationships |
| `regulatoryevidence_event_outbox` | transactional Event publication |
| `regulatoryevidence_idempotency` | duplicate-write protection |
| `regulatoryevidence_exception` | exception, claim, dispute, or hold |
| `regulatoryevidence_correction` | correction and supersession lineage |
| `regulatoryevidence_audit` | privileged action evidence |
...
- `Regulatory Evidence` is part of the target GTOS handbook scope.
