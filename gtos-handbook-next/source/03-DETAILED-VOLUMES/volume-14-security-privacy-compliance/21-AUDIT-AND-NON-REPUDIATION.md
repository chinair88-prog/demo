...
| Volume | `14` |
| Chapter ID | `V14-21` |
| Subject | `AuditandNon-Repudiation` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Audit and Non-Repudiation**.
...
|---|---|
| `AuditandNon-Repudiation` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AuditandNon-RepudiationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AuditandNon-RepudiationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AuditandNon-RepudiationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AuditandNon-RepudiationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
AuditandNon-Repudiation {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateAuditandNon-Repudiation`
- `ValidateAuditandNon-Repudiation`
- `ApproveAuditandNon-Repudiation`
- `ActivateAuditandNon-Repudiation`
- `SuspendAuditandNon-Repudiation`
- `CorrectAuditandNon-Repudiation`
- `RetireAuditandNon-Repudiation`

Reference Events:

- `AuditandNon-RepudiationCreated`
- `AuditandNon-RepudiationValidated`
- `AuditandNon-RepudiationApproved`
- `AuditandNon-RepudiationActivated`
- `AuditandNon-RepudiationSuspended`
- `AuditandNon-RepudiationCorrected`
- `AuditandNon-RepudiationRetired`

Reference queries:

- `GetAuditandNon-Repudiation`
- `ListAuditandNon-RepudiationRecords`
- `GetAuditandNon-RepudiationTimeline`
- `GetAuditandNon-RepudiationEvidence`
- `GetAuditandNon-RepudiationDecisionPackage`
- `GetAuditandNon-RepudiationExceptions`
- `GetAuditandNon-RepudiationAuditTrail`

Reference API surface:

```text
POST /api/v1/auditandnon_repudiation/commands
GET  /api/v1/auditandnon_repudiation/{id}
GET  /api/v1/auditandnon_repudiation/{id}/timeline
GET  /api/v1/auditandnon_repudiation/{id}/evidence
GET  /api/v1/auditandnon_repudiation/{id}/decisions
POST /api/v1/auditandnon_repudiation/{id}/exceptions
POST /api/v1/auditandnon_repudiation/{id}/corrections
```
...
|---|---|
| `auditandnon_repudiation_aggregate` | authoritative subject |
| `auditandnon_repudiation_version` | immutable submitted, approved, issued, or signed versions |
| `auditandnon_repudiation_relationship` | governed relationships |
| `auditandnon_repudiation_decision` | binding Decisions and rationale |
| `auditandnon_repudiation_evidence_link` | provenance and evidence relationships |
| `auditandnon_repudiation_event_outbox` | transactional Event publication |
| `auditandnon_repudiation_idempotency` | duplicate-write protection |
| `auditandnon_repudiation_exception` | exception, claim, dispute, or hold |
| `auditandnon_repudiation_correction` | correction and supersession lineage |
| `auditandnon_repudiation_audit` | privileged action evidence |
...
- `Audit and Non-Repudiation` is part of the target GTOS handbook scope.
