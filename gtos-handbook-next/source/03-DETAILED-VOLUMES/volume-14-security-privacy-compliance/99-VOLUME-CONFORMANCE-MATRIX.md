# Volume 14 Conformance and Evidence Matrix

| Metadata | Value |
|---|---|
| Volume | `14` |
| Chapter ID | `V14-SYNTH` |
| Subject | `Volume14ConformanceMatrix` |
...
This chapter defines how GTOS shall **trace every requirement in Volume 14 to owner, repository source, configuration, deployment, runtime evidence, tests, runbooks, exceptions and review status**.
...
|---|---|
| `Volume14ConformanceMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume14ConformanceMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume14ConformanceMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume14ConformanceMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume14ConformanceMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Volume14ConformanceMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateVolume14ConformanceMatrix`
- `ValidateVolume14ConformanceMatrix`
- `ApproveVolume14ConformanceMatrix`
- `ActivateVolume14ConformanceMatrix`
- `SuspendVolume14ConformanceMatrix`
- `CorrectVolume14ConformanceMatrix`
- `RetireVolume14ConformanceMatrix`

Reference Events:

- `Volume14ConformanceMatrixCreated`
- `Volume14ConformanceMatrixValidated`
- `Volume14ConformanceMatrixApproved`
- `Volume14ConformanceMatrixActivated`
- `Volume14ConformanceMatrixSuspended`
- `Volume14ConformanceMatrixCorrected`
- `Volume14ConformanceMatrixRetired`

Reference queries:

- `GetVolume14ConformanceMatrix`
- `ListVolume14ConformanceMatrixRecords`
- `GetVolume14ConformanceMatrixTimeline`
- `GetVolume14ConformanceMatrixEvidence`
- `GetVolume14ConformanceMatrixDecisionPackage`
- `GetVolume14ConformanceMatrixExceptions`
- `GetVolume14ConformanceMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/volume14conformancematrix/commands
GET  /api/v1/volume14conformancematrix/{id}
GET  /api/v1/volume14conformancematrix/{id}/timeline
GET  /api/v1/volume14conformancematrix/{id}/evidence
GET  /api/v1/volume14conformancematrix/{id}/decisions
POST /api/v1/volume14conformancematrix/{id}/exceptions
POST /api/v1/volume14conformancematrix/{id}/corrections
```
...
|---|---|
| `volume14conformancematrix_aggregate` | authoritative subject |
| `volume14conformancematrix_version` | immutable submitted, approved, issued, or signed versions |
| `volume14conformancematrix_relationship` | governed relationships |
| `volume14conformancematrix_decision` | binding Decisions and rationale |
| `volume14conformancematrix_evidence_link` | provenance and evidence relationships |
| `volume14conformancematrix_event_outbox` | transactional Event publication |
| `volume14conformancematrix_idempotency` | duplicate-write protection |
| `volume14conformancematrix_exception` | exception, claim, dispute, or hold |
| `volume14conformancematrix_correction` | correction and supersession lineage |
| `volume14conformancematrix_audit` | privileged action evidence |
