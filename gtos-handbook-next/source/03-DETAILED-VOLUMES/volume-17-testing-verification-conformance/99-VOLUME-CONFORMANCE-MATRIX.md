# Volume 17 Conformance and Evidence Matrix

| Metadata | Value |
|---|---|
| Volume | `17` |
| Chapter ID | `V17-SYNTH` |
| Subject | `Volume17ConformanceMatrix` |
...
This chapter defines how GTOS shall **trace every requirement in Volume 17 to owner, repository source, configuration, deployment, runtime evidence, tests, runbooks, exceptions and review status**.
...
|---|---|
| `Volume17ConformanceMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume17ConformanceMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume17ConformanceMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume17ConformanceMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume17ConformanceMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Volume17ConformanceMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateVolume17ConformanceMatrix`
- `ValidateVolume17ConformanceMatrix`
- `ApproveVolume17ConformanceMatrix`
- `ActivateVolume17ConformanceMatrix`
- `SuspendVolume17ConformanceMatrix`
- `CorrectVolume17ConformanceMatrix`
- `RetireVolume17ConformanceMatrix`

Reference Events:

- `Volume17ConformanceMatrixCreated`
- `Volume17ConformanceMatrixValidated`
- `Volume17ConformanceMatrixApproved`
- `Volume17ConformanceMatrixActivated`
- `Volume17ConformanceMatrixSuspended`
- `Volume17ConformanceMatrixCorrected`
- `Volume17ConformanceMatrixRetired`

Reference queries:

- `GetVolume17ConformanceMatrix`
- `ListVolume17ConformanceMatrixRecords`
- `GetVolume17ConformanceMatrixTimeline`
- `GetVolume17ConformanceMatrixEvidence`
- `GetVolume17ConformanceMatrixDecisionPackage`
- `GetVolume17ConformanceMatrixExceptions`
- `GetVolume17ConformanceMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/volume17conformancematrix/commands
GET  /api/v1/volume17conformancematrix/{id}
GET  /api/v1/volume17conformancematrix/{id}/timeline
GET  /api/v1/volume17conformancematrix/{id}/evidence
GET  /api/v1/volume17conformancematrix/{id}/decisions
POST /api/v1/volume17conformancematrix/{id}/exceptions
POST /api/v1/volume17conformancematrix/{id}/corrections
```
...
|---|---|
| `volume17conformancematrix_aggregate` | authoritative subject |
| `volume17conformancematrix_version` | immutable submitted, approved, issued, or signed versions |
| `volume17conformancematrix_relationship` | governed relationships |
| `volume17conformancematrix_decision` | binding Decisions and rationale |
| `volume17conformancematrix_evidence_link` | provenance and evidence relationships |
| `volume17conformancematrix_event_outbox` | transactional Event publication |
| `volume17conformancematrix_idempotency` | duplicate-write protection |
| `volume17conformancematrix_exception` | exception, claim, dispute, or hold |
| `volume17conformancematrix_correction` | correction and supersession lineage |
| `volume17conformancematrix_audit` | privileged action evidence |
