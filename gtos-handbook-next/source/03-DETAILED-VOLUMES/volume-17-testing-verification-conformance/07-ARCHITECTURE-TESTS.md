...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Architecture Tests**.
...
|---|---|
| `ArchitectureTests` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ArchitectureTestsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ArchitectureTestsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ArchitectureTestsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ArchitectureTestsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateArchitectureTests`
- `ApproveArchitectureTests`
- `ActivateArchitectureTests`
- `SuspendArchitectureTests`
- `CorrectArchitectureTests`
- `RetireArchitectureTests`

Reference Events:

- `ArchitectureTestsCreated`
- `ArchitectureTestsValidated`
- `ArchitectureTestsApproved`
- `ArchitectureTestsActivated`
- `ArchitectureTestsSuspended`
- `ArchitectureTestsCorrected`
- `ArchitectureTestsRetired`

Reference queries:

- `GetArchitectureTests`
- `ListArchitectureTestsRecords`
- `GetArchitectureTestsTimeline`
- `GetArchitectureTestsEvidence`
- `GetArchitectureTestsDecisionPackage`
- `GetArchitectureTestsExceptions`
- `GetArchitectureTestsAuditTrail`

Reference API surface:

```text
POST /api/v1/architecturetests/commands
...
POST /api/v1/architecturetests/{id}/corrections
```
...
|---|---|
| `architecturetests_aggregate` | authoritative subject |
| `architecturetests_version` | immutable submitted, approved, issued, or signed versions |
| `architecturetests_relationship` | governed relationships |
| `architecturetests_decision` | binding Decisions and rationale |
| `architecturetests_evidence_link` | provenance and evidence relationships |
| `architecturetests_event_outbox` | transactional Event publication |
| `architecturetests_idempotency` | duplicate-write protection |
| `architecturetests_exception` | exception, claim, dispute, or hold |
| `architecturetests_correction` | correction and supersession lineage |
| `architecturetests_audit` | privileged action evidence |
...
- `Architecture Tests` is part of the target GTOS handbook scope.
