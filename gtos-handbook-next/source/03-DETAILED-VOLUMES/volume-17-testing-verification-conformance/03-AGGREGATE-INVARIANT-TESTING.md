...
| Volume | `17` |
| Chapter ID | `V17-03` |
| Subject | `AggregateInvariantTesting` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Aggregate Invariant Testing**.
...
|---|---|
| `AggregateInvariantTesting` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AggregateInvariantTestingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AggregateInvariantTestingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AggregateInvariantTestingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AggregateInvariantTestingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
AggregateInvariantTesting {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateAggregateInvariantTesting`
- `ValidateAggregateInvariantTesting`
- `ApproveAggregateInvariantTesting`
- `ActivateAggregateInvariantTesting`
- `SuspendAggregateInvariantTesting`
- `CorrectAggregateInvariantTesting`
- `RetireAggregateInvariantTesting`

Reference Events:

- `AggregateInvariantTestingCreated`
- `AggregateInvariantTestingValidated`
- `AggregateInvariantTestingApproved`
- `AggregateInvariantTestingActivated`
- `AggregateInvariantTestingSuspended`
- `AggregateInvariantTestingCorrected`
- `AggregateInvariantTestingRetired`

Reference queries:

- `GetAggregateInvariantTesting`
- `ListAggregateInvariantTestingRecords`
- `GetAggregateInvariantTestingTimeline`
- `GetAggregateInvariantTestingEvidence`
- `GetAggregateInvariantTestingDecisionPackage`
- `GetAggregateInvariantTestingExceptions`
- `GetAggregateInvariantTestingAuditTrail`

Reference API surface:

```text
POST /api/v1/aggregateinvarianttesting/commands
GET  /api/v1/aggregateinvarianttesting/{id}
GET  /api/v1/aggregateinvarianttesting/{id}/timeline
GET  /api/v1/aggregateinvarianttesting/{id}/evidence
GET  /api/v1/aggregateinvarianttesting/{id}/decisions
POST /api/v1/aggregateinvarianttesting/{id}/exceptions
POST /api/v1/aggregateinvarianttesting/{id}/corrections
```
...
|---|---|
| `aggregateinvarianttesting_aggregate` | authoritative subject |
| `aggregateinvarianttesting_version` | immutable submitted, approved, issued, or signed versions |
| `aggregateinvarianttesting_relationship` | governed relationships |
| `aggregateinvarianttesting_decision` | binding Decisions and rationale |
| `aggregateinvarianttesting_evidence_link` | provenance and evidence relationships |
| `aggregateinvarianttesting_event_outbox` | transactional Event publication |
| `aggregateinvarianttesting_idempotency` | duplicate-write protection |
| `aggregateinvarianttesting_exception` | exception, claim, dispute, or hold |
| `aggregateinvarianttesting_correction` | correction and supersession lineage |
| `aggregateinvarianttesting_audit` | privileged action evidence |
...
- `Aggregate Invariant Testing` is part of the target GTOS handbook scope.
