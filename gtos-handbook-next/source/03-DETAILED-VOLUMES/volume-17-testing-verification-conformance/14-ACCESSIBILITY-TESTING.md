...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Accessibility Testing**.
...
|---|---|
| `AccessibilityTesting` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AccessibilityTestingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AccessibilityTestingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AccessibilityTestingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AccessibilityTestingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAccessibilityTesting`
- `ValidateAccessibilityTesting`
- `ApproveAccessibilityTesting`
- `ActivateAccessibilityTesting`
- `SuspendAccessibilityTesting`
- `CorrectAccessibilityTesting`
- `RetireAccessibilityTesting`

Reference Events:

- `AccessibilityTestingCreated`
- `AccessibilityTestingValidated`
- `AccessibilityTestingApproved`
- `AccessibilityTestingActivated`
- `AccessibilityTestingSuspended`
- `AccessibilityTestingCorrected`
- `AccessibilityTestingRetired`

Reference queries:

- `GetAccessibilityTesting`
- `ListAccessibilityTestingRecords`
- `GetAccessibilityTestingTimeline`
- `GetAccessibilityTestingEvidence`
- `GetAccessibilityTestingDecisionPackage`
- `GetAccessibilityTestingExceptions`
- `GetAccessibilityTestingAuditTrail`

Reference API surface:

```text
POST /api/v1/accessibilitytesting/commands
GET  /api/v1/accessibilitytesting/{id}
GET  /api/v1/accessibilitytesting/{id}/timeline
GET  /api/v1/accessibilitytesting/{id}/evidence
GET  /api/v1/accessibilitytesting/{id}/decisions
POST /api/v1/accessibilitytesting/{id}/exceptions
POST /api/v1/accessibilitytesting/{id}/corrections
```
...
|---|---|
| `accessibilitytesting_aggregate` | authoritative subject |
| `accessibilitytesting_version` | immutable submitted, approved, issued, or signed versions |
| `accessibilitytesting_relationship` | governed relationships |
| `accessibilitytesting_decision` | binding Decisions and rationale |
| `accessibilitytesting_evidence_link` | provenance and evidence relationships |
| `accessibilitytesting_event_outbox` | transactional Event publication |
| `accessibilitytesting_idempotency` | duplicate-write protection |
| `accessibilitytesting_exception` | exception, claim, dispute, or hold |
| `accessibilitytesting_correction` | correction and supersession lineage |
| `accessibilitytesting_audit` | privileged action evidence |
...
- `Accessibility Testing` is part of the target GTOS handbook scope.
