...
| Volume | `17` |
| Chapter ID | `V17-06` |
| Subject | `DatabaseMigrationVerification` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Database Migration Verification**.
...
|---|---|
| `DatabaseMigrationVerification` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseMigrationVerificationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseMigrationVerificationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseMigrationVerificationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseMigrationVerificationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateDatabaseMigrationVerification`
- `ValidateDatabaseMigrationVerification`
- `ApproveDatabaseMigrationVerification`
- `ActivateDatabaseMigrationVerification`
- `SuspendDatabaseMigrationVerification`
- `CorrectDatabaseMigrationVerification`
- `RetireDatabaseMigrationVerification`

Reference Events:

- `DatabaseMigrationVerificationCreated`
- `DatabaseMigrationVerificationValidated`
- `DatabaseMigrationVerificationApproved`
- `DatabaseMigrationVerificationActivated`
- `DatabaseMigrationVerificationSuspended`
- `DatabaseMigrationVerificationCorrected`
- `DatabaseMigrationVerificationRetired`

Reference queries:

- `GetDatabaseMigrationVerification`
- `ListDatabaseMigrationVerificationRecords`
- `GetDatabaseMigrationVerificationTimeline`
- `GetDatabaseMigrationVerificationEvidence`
- `GetDatabaseMigrationVerificationDecisionPackage`
- `GetDatabaseMigrationVerificationExceptions`
- `GetDatabaseMigrationVerificationAuditTrail`

Reference API surface:

```text
POST /api/v1/databasemigrationverification/commands
GET  /api/v1/databasemigrationverification/{id}
GET  /api/v1/databasemigrationverification/{id}/timeline
GET  /api/v1/databasemigrationverification/{id}/evidence
GET  /api/v1/databasemigrationverification/{id}/decisions
POST /api/v1/databasemigrationverification/{id}/exceptions
POST /api/v1/databasemigrationverification/{id}/corrections
```
...
|---|---|
| `databasemigrationverification_aggregate` | authoritative subject |
| `databasemigrationverification_version` | immutable submitted, approved, issued, or signed versions |
| `databasemigrationverification_relationship` | governed relationships |
| `databasemigrationverification_decision` | binding Decisions and rationale |
| `databasemigrationverification_evidence_link` | provenance and evidence relationships |
| `databasemigrationverification_event_outbox` | transactional Event publication |
| `databasemigrationverification_idempotency` | duplicate-write protection |
| `databasemigrationverification_exception` | exception, claim, dispute, or hold |
| `databasemigrationverification_correction` | correction and supersession lineage |
| `databasemigrationverification_audit` | privileged action evidence |
...
- `Database Migration Verification` is part of the target GTOS handbook scope.
