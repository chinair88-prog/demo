# Identity Migration and Legacy Compatibility

| Metadata | Value |
|---|---|
| Volume | `5` |
| Chapter ID | `V05-19` |
| Subject | `IdentityMigration` |
...
This chapter defines how GTOS shall **migrate duplicate accounts, legacy tenants, old claims, shared credentials, stale roles, and incompatible identifiers safely**.
...
|---|---|
| `IdentityMigration` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityMigrationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityMigrationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityMigrationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityMigrationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ActivateIdentityMigration`
- `SuspendIdentityMigration`
- `CorrectIdentityMigration`
- `RetireIdentityMigration`

Reference Events:

- `IdentityMigrationCreated`
- `IdentityMigrationValidated`
- `IdentityMigrationApproved`
- `IdentityMigrationActivated`
- `IdentityMigrationSuspended`
- `IdentityMigrationCorrected`
- `IdentityMigrationRetired`

Reference queries:

- `GetIdentityMigration`
- `ListIdentityMigrationRecords`
- `GetIdentityMigrationTimeline`
- `GetIdentityMigrationEvidence`
- `GetIdentityMigrationDecisionPackage`
- `GetIdentityMigrationExceptions`
- `GetIdentityMigrationAuditTrail`

Reference API surface:

```text
POST /api/v1/identitymigration/commands
GET  /api/v1/identitymigration/{id}
GET  /api/v1/identitymigration/{id}/timeline
GET  /api/v1/identitymigration/{id}/evidence
GET  /api/v1/identitymigration/{id}/decisions
POST /api/v1/identitymigration/{id}/exceptions
POST /api/v1/identitymigration/{id}/corrections
```
...
|---|---|
| `identitymigration_aggregate` | authoritative subject |
| `identitymigration_version` | immutable submitted, approved, issued, or signed versions |
| `identitymigration_relationship` | governed relationships |
| `identitymigration_decision` | binding Decisions and rationale |
| `identitymigration_evidence_link` | provenance and evidence relationships |
| `identitymigration_event_outbox` | transactional Event publication |
| `identitymigration_idempotency` | duplicate-write protection |
| `identitymigration_exception` | exception, claim, dispute, or hold |
| `identitymigration_correction` | correction and supersession lineage |
| `identitymigration_audit` | privileged action evidence |
