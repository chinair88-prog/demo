...
|---|---|
| `CRMDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CRMDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CRMDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CRMDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CRMDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateCRMDataModel`
- `ValidateCRMDataModel`
- `ApproveCRMDataModel`
- `ActivateCRMDataModel`
- `SuspendCRMDataModel`
- `CorrectCRMDataModel`
- `RetireCRMDataModel`
...
- `CRMDataModelCreated`
- `CRMDataModelValidated`
- `CRMDataModelApproved`
- `CRMDataModelActivated`
- `CRMDataModelSuspended`
- `CRMDataModelCorrected`
- `CRMDataModelRetired`

Reference queries:

- `GetCRMDataModel`
- `ListCRMDataModelRecords`
- `GetCRMDataModelTimeline`
- `GetCRMDataModelEvidence`
- `GetCRMDataModelDecisionPackage`
- `GetCRMDataModelExceptions`
- `GetCRMDataModelAuditTrail`
