...
| Subject | `PickPackShipOperatingProfile` |
...
|---|---|
| `PickPackShipOperatingProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PickPackShipOperatingProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PickPackShipOperatingProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PickPackShipOperatingProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PickPackShipOperatingProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PickPackShipOperatingProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
