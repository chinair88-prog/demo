...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Allocation**.
...
```text
POST /api/v1/allocationaggregatemodel/commands
GET  /api/v1/allocationaggregatemodel/{id}
GET  /api/v1/allocationaggregatemodel/{id}/timeline
GET  /api/v1/allocationaggregatemodel/{id}/evidence
GET  /api/v1/allocationaggregatemodel/{id}/decisions
POST /api/v1/allocationaggregatemodel/{id}/exceptions
POST /api/v1/allocationaggregatemodel/{id}/corrections
```
