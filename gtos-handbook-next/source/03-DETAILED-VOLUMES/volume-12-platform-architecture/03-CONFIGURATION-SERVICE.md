...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Configuration Service**.
...
|---|---|
| `ConfigurationService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConfigurationServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConfigurationServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConfigurationServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConfigurationServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveConfigurationService`
- `ActivateConfigurationService`
- `SuspendConfigurationService`
- `CorrectConfigurationService`
- `RetireConfigurationService`

Reference Events:

- `ConfigurationServiceCreated`
- `ConfigurationServiceValidated`
- `ConfigurationServiceApproved`
- `ConfigurationServiceActivated`
- `ConfigurationServiceSuspended`
- `ConfigurationServiceCorrected`
- `ConfigurationServiceRetired`

Reference queries:

- `GetConfigurationService`
- `ListConfigurationServiceRecords`
- `GetConfigurationServiceTimeline`
- `GetConfigurationServiceEvidence`
- `GetConfigurationServiceDecisionPackage`
- `GetConfigurationServiceExceptions`
- `GetConfigurationServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/configurationservice/commands
GET  /api/v1/configurationservice/{id}
GET  /api/v1/configurationservice/{id}/timeline
GET  /api/v1/configurationservice/{id}/evidence
GET  /api/v1/configurationservice/{id}/decisions
POST /api/v1/configurationservice/{id}/exceptions
POST /api/v1/configurationservice/{id}/corrections
```
...
|---|---|
| `configurationservice_aggregate` | authoritative subject |
| `configurationservice_version` | immutable submitted, approved, issued, or signed versions |
| `configurationservice_relationship` | governed relationships |
| `configurationservice_decision` | binding Decisions and rationale |
| `configurationservice_evidence_link` | provenance and evidence relationships |
| `configurationservice_event_outbox` | transactional Event publication |
| `configurationservice_idempotency` | duplicate-write protection |
| `configurationservice_exception` | exception, claim, dispute, or hold |
| `configurationservice_correction` | correction and supersession lineage |
| `configurationservice_audit` | privileged action evidence |
...
- `Configuration Service` is part of the target GTOS handbook scope.
