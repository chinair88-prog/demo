...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Self-Healing Service**.
...
|---|---|
| `Self-HealingService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Self-HealingServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Self-HealingServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Self-HealingServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Self-HealingServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateSelf-HealingService`
- `ValidateSelf-HealingService`
- `ApproveSelf-HealingService`
- `ActivateSelf-HealingService`
- `SuspendSelf-HealingService`
- `CorrectSelf-HealingService`
- `RetireSelf-HealingService`

Reference Events:

- `Self-HealingServiceCreated`
- `Self-HealingServiceValidated`
- `Self-HealingServiceApproved`
- `Self-HealingServiceActivated`
- `Self-HealingServiceSuspended`
- `Self-HealingServiceCorrected`
- `Self-HealingServiceRetired`

Reference queries:

- `GetSelf-HealingService`
- `ListSelf-HealingServiceRecords`
- `GetSelf-HealingServiceTimeline`
- `GetSelf-HealingServiceEvidence`
- `GetSelf-HealingServiceDecisionPackage`
- `GetSelf-HealingServiceExceptions`
- `GetSelf-HealingServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/self_healingservice/commands
GET  /api/v1/self_healingservice/{id}
GET  /api/v1/self_healingservice/{id}/timeline
GET  /api/v1/self_healingservice/{id}/evidence
GET  /api/v1/self_healingservice/{id}/decisions
POST /api/v1/self_healingservice/{id}/exceptions
POST /api/v1/self_healingservice/{id}/corrections
```
...
|---|---|
| `self_healingservice_aggregate` | authoritative subject |
| `self_healingservice_version` | immutable submitted, approved, issued, or signed versions |
| `self_healingservice_relationship` | governed relationships |
| `self_healingservice_decision` | binding Decisions and rationale |
| `self_healingservice_evidence_link` | provenance and evidence relationships |
| `self_healingservice_event_outbox` | transactional Event publication |
| `self_healingservice_idempotency` | duplicate-write protection |
| `self_healingservice_exception` | exception, claim, dispute, or hold |
| `self_healingservice_correction` | correction and supersession lineage |
| `self_healingservice_audit` | privileged action evidence |
...
- `Self-Healing Service` is part of the target GTOS handbook scope.
