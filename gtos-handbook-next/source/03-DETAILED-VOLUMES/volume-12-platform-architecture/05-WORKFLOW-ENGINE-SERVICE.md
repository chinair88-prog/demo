...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Workflow Engine Service**.
...
|---|---|
| `WorkflowEngineService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowEngineServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowEngineServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowEngineServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowEngineServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateWorkflowEngineService`
- `ApproveWorkflowEngineService`
- `ActivateWorkflowEngineService`
- `SuspendWorkflowEngineService`
- `CorrectWorkflowEngineService`
- `RetireWorkflowEngineService`

Reference Events:

- `WorkflowEngineServiceCreated`
- `WorkflowEngineServiceValidated`
- `WorkflowEngineServiceApproved`
- `WorkflowEngineServiceActivated`
- `WorkflowEngineServiceSuspended`
- `WorkflowEngineServiceCorrected`
- `WorkflowEngineServiceRetired`

Reference queries:

- `GetWorkflowEngineService`
- `ListWorkflowEngineServiceRecords`
- `GetWorkflowEngineServiceTimeline`
- `GetWorkflowEngineServiceEvidence`
- `GetWorkflowEngineServiceDecisionPackage`
- `GetWorkflowEngineServiceExceptions`
- `GetWorkflowEngineServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/workflowengineservice/commands
GET  /api/v1/workflowengineservice/{id}
GET  /api/v1/workflowengineservice/{id}/timeline
GET  /api/v1/workflowengineservice/{id}/evidence
GET  /api/v1/workflowengineservice/{id}/decisions
POST /api/v1/workflowengineservice/{id}/exceptions
POST /api/v1/workflowengineservice/{id}/corrections
```
...
|---|---|
| `workflowengineservice_aggregate` | authoritative subject |
| `workflowengineservice_version` | immutable submitted, approved, issued, or signed versions |
| `workflowengineservice_relationship` | governed relationships |
| `workflowengineservice_decision` | binding Decisions and rationale |
| `workflowengineservice_evidence_link` | provenance and evidence relationships |
| `workflowengineservice_event_outbox` | transactional Event publication |
| `workflowengineservice_idempotency` | duplicate-write protection |
| `workflowengineservice_exception` | exception, claim, dispute, or hold |
| `workflowengineservice_correction` | correction and supersession lineage |
| `workflowengineservice_audit` | privileged action evidence |
...
- `Workflow Engine Service` is part of the target GTOS handbook scope.
