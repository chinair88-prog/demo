...
```text
POST /api/v1/portalrouteregistry/commands
GET  /api/v1/portalrouteregistry/{id}
GET  /api/v1/portalrouteregistry/{id}/timeline
GET  /api/v1/portalrouteregistry/{id}/evidence
GET  /api/v1/portalrouteregistry/{id}/decisions
POST /api/v1/portalrouteregistry/{id}/exceptions
POST /api/v1/portalrouteregistry/{id}/corrections
```
...
|---|---|
| `portalrouteregistry_aggregate` | authoritative subject |
| `portalrouteregistry_version` | immutable submitted, approved, issued, or signed versions |
| `portalrouteregistry_relationship` | governed relationships |
| `portalrouteregistry_decision` | binding Decisions and rationale |
| `portalrouteregistry_evidence_link` | provenance and evidence relationships |
| `portalrouteregistry_event_outbox` | transactional Event publication |
| `portalrouteregistry_idempotency` | duplicate-write protection |
| `portalrouteregistry_exception` | exception, claim, dispute, or hold |
| `portalrouteregistry_correction` | correction and supersession lineage |
| `portalrouteregistry_audit` | privileged action evidence |
