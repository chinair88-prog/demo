...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Retention and Legal Hold**.
...
|---|---|
| `RetentionandLegalHold` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RetentionandLegalHoldVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RetentionandLegalHoldDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RetentionandLegalHoldEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RetentionandLegalHoldException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
RetentionandLegalHold {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateRetentionandLegalHold`
- `ValidateRetentionandLegalHold`
- `ApproveRetentionandLegalHold`
- `ActivateRetentionandLegalHold`
- `SuspendRetentionandLegalHold`
- `CorrectRetentionandLegalHold`
- `RetireRetentionandLegalHold`

Reference Events:

- `RetentionandLegalHoldCreated`
- `RetentionandLegalHoldValidated`
- `RetentionandLegalHoldApproved`
- `RetentionandLegalHoldActivated`
- `RetentionandLegalHoldSuspended`
- `RetentionandLegalHoldCorrected`
- `RetentionandLegalHoldRetired`

Reference queries:

- `GetRetentionandLegalHold`
- `ListRetentionandLegalHoldRecords`
- `GetRetentionandLegalHoldTimeline`
- `GetRetentionandLegalHoldEvidence`
- `GetRetentionandLegalHoldDecisionPackage`
- `GetRetentionandLegalHoldExceptions`
- `GetRetentionandLegalHoldAuditTrail`

Reference API surface:

```text
POST /api/v1/retentionandlegalhold/commands
GET  /api/v1/retentionandlegalhold/{id}
GET  /api/v1/retentionandlegalhold/{id}/timeline
GET  /api/v1/retentionandlegalhold/{id}/evidence
GET  /api/v1/retentionandlegalhold/{id}/decisions
POST /api/v1/retentionandlegalhold/{id}/exceptions
POST /api/v1/retentionandlegalhold/{id}/corrections
```
...
|---|---|
| `retentionandlegalhold_aggregate` | authoritative subject |
| `retentionandlegalhold_version` | immutable submitted, approved, issued, or signed versions |
| `retentionandlegalhold_relationship` | governed relationships |
| `retentionandlegalhold_decision` | binding Decisions and rationale |
| `retentionandlegalhold_evidence_link` | provenance and evidence relationships |
| `retentionandlegalhold_event_outbox` | transactional Event publication |
| `retentionandlegalhold_idempotency` | duplicate-write protection |
| `retentionandlegalhold_exception` | exception, claim, dispute, or hold |
| `retentionandlegalhold_correction` | correction and supersession lineage |
| `retentionandlegalhold_audit` | privileged action evidence |
