...
| Volume | `10` |
| Chapter ID | `V10-33` |
| Subject | `MasterandReferenceData` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Master and Reference Data**.
...
|---|---|
| `MasterandReferenceData` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MasterandReferenceDataVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MasterandReferenceDataDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MasterandReferenceDataEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MasterandReferenceDataException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
MasterandReferenceData {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateMasterandReferenceData`
- `ValidateMasterandReferenceData`
- `ApproveMasterandReferenceData`
- `ActivateMasterandReferenceData`
- `SuspendMasterandReferenceData`
- `CorrectMasterandReferenceData`
- `RetireMasterandReferenceData`

Reference Events:

- `MasterandReferenceDataCreated`
- `MasterandReferenceDataValidated`
- `MasterandReferenceDataApproved`
- `MasterandReferenceDataActivated`
- `MasterandReferenceDataSuspended`
- `MasterandReferenceDataCorrected`
- `MasterandReferenceDataRetired`

Reference queries:

- `GetMasterandReferenceData`
- `ListMasterandReferenceDataRecords`
- `GetMasterandReferenceDataTimeline`
- `GetMasterandReferenceDataEvidence`
- `GetMasterandReferenceDataDecisionPackage`
- `GetMasterandReferenceDataExceptions`
- `GetMasterandReferenceDataAuditTrail`

Reference API surface:

```text
POST /api/v1/masterandreferencedata/commands
GET  /api/v1/masterandreferencedata/{id}
GET  /api/v1/masterandreferencedata/{id}/timeline
GET  /api/v1/masterandreferencedata/{id}/evidence
GET  /api/v1/masterandreferencedata/{id}/decisions
POST /api/v1/masterandreferencedata/{id}/exceptions
POST /api/v1/masterandreferencedata/{id}/corrections
```
...
|---|---|
| `masterandreferencedata_aggregate` | authoritative subject |
| `masterandreferencedata_version` | immutable submitted, approved, issued, or signed versions |
| `masterandreferencedata_relationship` | governed relationships |
| `masterandreferencedata_decision` | binding Decisions and rationale |
| `masterandreferencedata_evidence_link` | provenance and evidence relationships |
| `masterandreferencedata_event_outbox` | transactional Event publication |
| `masterandreferencedata_idempotency` | duplicate-write protection |
| `masterandreferencedata_exception` | exception, claim, dispute, or hold |
| `masterandreferencedata_correction` | correction and supersession lineage |
| `masterandreferencedata_audit` | privileged action evidence |
