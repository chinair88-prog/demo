...
| Volume | `10` |
| Chapter ID | `V10-21` |
| Subject | `DisasterRecoveryforData` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Disaster Recovery for Data**.
...
|---|---|
| `DisasterRecoveryforData` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryforDataVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryforDataDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryforDataEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryforDataException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DisasterRecoveryforData {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDisasterRecoveryforData`
- `ValidateDisasterRecoveryforData`
- `ApproveDisasterRecoveryforData`
- `ActivateDisasterRecoveryforData`
- `SuspendDisasterRecoveryforData`
- `CorrectDisasterRecoveryforData`
- `RetireDisasterRecoveryforData`

Reference Events:

- `DisasterRecoveryforDataCreated`
- `DisasterRecoveryforDataValidated`
- `DisasterRecoveryforDataApproved`
- `DisasterRecoveryforDataActivated`
- `DisasterRecoveryforDataSuspended`
- `DisasterRecoveryforDataCorrected`
- `DisasterRecoveryforDataRetired`

Reference queries:

- `GetDisasterRecoveryforData`
- `ListDisasterRecoveryforDataRecords`
- `GetDisasterRecoveryforDataTimeline`
- `GetDisasterRecoveryforDataEvidence`
- `GetDisasterRecoveryforDataDecisionPackage`
- `GetDisasterRecoveryforDataExceptions`
- `GetDisasterRecoveryforDataAuditTrail`

Reference API surface:

```text
POST /api/v1/disasterrecoveryfordata/commands
GET  /api/v1/disasterrecoveryfordata/{id}
GET  /api/v1/disasterrecoveryfordata/{id}/timeline
GET  /api/v1/disasterrecoveryfordata/{id}/evidence
GET  /api/v1/disasterrecoveryfordata/{id}/decisions
POST /api/v1/disasterrecoveryfordata/{id}/exceptions
POST /api/v1/disasterrecoveryfordata/{id}/corrections
```
...
|---|---|
| `disasterrecoveryfordata_aggregate` | authoritative subject |
| `disasterrecoveryfordata_version` | immutable submitted, approved, issued, or signed versions |
| `disasterrecoveryfordata_relationship` | governed relationships |
| `disasterrecoveryfordata_decision` | binding Decisions and rationale |
| `disasterrecoveryfordata_evidence_link` | provenance and evidence relationships |
| `disasterrecoveryfordata_event_outbox` | transactional Event publication |
| `disasterrecoveryfordata_idempotency` | duplicate-write protection |
| `disasterrecoveryfordata_exception` | exception, claim, dispute, or hold |
| `disasterrecoveryfordata_correction` | correction and supersession lineage |
| `disasterrecoveryfordata_audit` | privileged action evidence |
