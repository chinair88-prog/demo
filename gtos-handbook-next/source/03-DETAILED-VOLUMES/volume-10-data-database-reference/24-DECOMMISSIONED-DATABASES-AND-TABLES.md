# Decommissioned Databases and Tables

| Metadata | Value |
|---|---|
| Volume | `10` |
| Chapter ID | `V10-24` |
| Subject | `DecommissionedDatabasesandTables` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Decommissioned Databases and Tables**.
...
|---|---|
| `DecommissionedDatabasesandTables` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DecommissionedDatabasesandTablesVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DecommissionedDatabasesandTablesDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DecommissionedDatabasesandTablesEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DecommissionedDatabasesandTablesException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DecommissionedDatabasesandTables {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDecommissionedDatabasesandTables`
- `ValidateDecommissionedDatabasesandTables`
- `ApproveDecommissionedDatabasesandTables`
- `ActivateDecommissionedDatabasesandTables`
- `SuspendDecommissionedDatabasesandTables`
- `CorrectDecommissionedDatabasesandTables`
- `RetireDecommissionedDatabasesandTables`

Reference Events:

- `DecommissionedDatabasesandTablesCreated`
- `DecommissionedDatabasesandTablesValidated`
- `DecommissionedDatabasesandTablesApproved`
- `DecommissionedDatabasesandTablesActivated`
- `DecommissionedDatabasesandTablesSuspended`
- `DecommissionedDatabasesandTablesCorrected`
- `DecommissionedDatabasesandTablesRetired`

Reference queries:

- `GetDecommissionedDatabasesandTables`
- `ListDecommissionedDatabasesandTablesRecords`
- `GetDecommissionedDatabasesandTablesTimeline`
- `GetDecommissionedDatabasesandTablesEvidence`
- `GetDecommissionedDatabasesandTablesDecisionPackage`
- `GetDecommissionedDatabasesandTablesExceptions`
- `GetDecommissionedDatabasesandTablesAuditTrail`

Reference API surface:

```text
POST /api/v1/decommissioneddatabasesandtables/commands
GET  /api/v1/decommissioneddatabasesandtables/{id}
GET  /api/v1/decommissioneddatabasesandtables/{id}/timeline
GET  /api/v1/decommissioneddatabasesandtables/{id}/evidence
GET  /api/v1/decommissioneddatabasesandtables/{id}/decisions
POST /api/v1/decommissioneddatabasesandtables/{id}/exceptions
POST /api/v1/decommissioneddatabasesandtables/{id}/corrections
```
...
|---|---|
| `decommissioneddatabasesandtables_aggregate` | authoritative subject |
| `decommissioneddatabasesandtables_version` | immutable submitted, approved, issued, or signed versions |
| `decommissioneddatabasesandtables_relationship` | governed relationships |
| `decommissioneddatabasesandtables_decision` | binding Decisions and rationale |
| `decommissioneddatabasesandtables_evidence_link` | provenance and evidence relationships |
| `decommissioneddatabasesandtables_event_outbox` | transactional Event publication |
| `decommissioneddatabasesandtables_idempotency` | duplicate-write protection |
| `decommissioneddatabasesandtables_exception` | exception, claim, dispute, or hold |
| `decommissioneddatabasesandtables_correction` | correction and supersession lineage |
| `decommissioneddatabasesandtables_audit` | privileged action evidence |
