...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Data Classification**.
...
|---|---|
| `DataClassification` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataClassificationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataClassificationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataClassificationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataClassificationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ActivateDataClassification`
- `SuspendDataClassification`
- `CorrectDataClassification`
- `RetireDataClassification`

Reference Events:

- `DataClassificationCreated`
- `DataClassificationValidated`
- `DataClassificationApproved`
- `DataClassificationActivated`
- `DataClassificationSuspended`
- `DataClassificationCorrected`
- `DataClassificationRetired`

Reference queries:

- `GetDataClassification`
- `ListDataClassificationRecords`
- `GetDataClassificationTimeline`
- `GetDataClassificationEvidence`
- `GetDataClassificationDecisionPackage`
- `GetDataClassificationExceptions`
- `GetDataClassificationAuditTrail`

Reference API surface:

```text
POST /api/v1/dataclassification/commands
GET  /api/v1/dataclassification/{id}
GET  /api/v1/dataclassification/{id}/timeline
GET  /api/v1/dataclassification/{id}/evidence
GET  /api/v1/dataclassification/{id}/decisions
POST /api/v1/dataclassification/{id}/exceptions
POST /api/v1/dataclassification/{id}/corrections
```
...
|---|---|
| `dataclassification_aggregate` | authoritative subject |
| `dataclassification_version` | immutable submitted, approved, issued, or signed versions |
| `dataclassification_relationship` | governed relationships |
| `dataclassification_decision` | binding Decisions and rationale |
| `dataclassification_evidence_link` | provenance and evidence relationships |
| `dataclassification_event_outbox` | transactional Event publication |
| `dataclassification_idempotency` | duplicate-write protection |
| `dataclassification_exception` | exception, claim, dispute, or hold |
| `dataclassification_correction` | correction and supersession lineage |
| `dataclassification_audit` | privileged action evidence |
