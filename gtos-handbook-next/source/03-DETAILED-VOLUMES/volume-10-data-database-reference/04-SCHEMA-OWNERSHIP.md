...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Schema Ownership**.
...
|---|---|
| `SchemaOwnership` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaOwnershipVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaOwnershipDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaOwnershipEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SchemaOwnershipException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateSchemaOwnership`
- `ValidateSchemaOwnership`
- `ApproveSchemaOwnership`
- `ActivateSchemaOwnership`
- `SuspendSchemaOwnership`
- `CorrectSchemaOwnership`
- `RetireSchemaOwnership`

Reference Events:

- `SchemaOwnershipCreated`
- `SchemaOwnershipValidated`
- `SchemaOwnershipApproved`
- `SchemaOwnershipActivated`
- `SchemaOwnershipSuspended`
- `SchemaOwnershipCorrected`
- `SchemaOwnershipRetired`

Reference queries:

- `GetSchemaOwnership`
- `ListSchemaOwnershipRecords`
- `GetSchemaOwnershipTimeline`
- `GetSchemaOwnershipEvidence`
- `GetSchemaOwnershipDecisionPackage`
- `GetSchemaOwnershipExceptions`
- `GetSchemaOwnershipAuditTrail`

Reference API surface:

```text
POST /api/v1/schemaownership/commands
GET  /api/v1/schemaownership/{id}
GET  /api/v1/schemaownership/{id}/timeline
GET  /api/v1/schemaownership/{id}/evidence
GET  /api/v1/schemaownership/{id}/decisions
POST /api/v1/schemaownership/{id}/exceptions
POST /api/v1/schemaownership/{id}/corrections
```
...
|---|---|
| `schemaownership_aggregate` | authoritative subject |
| `schemaownership_version` | immutable submitted, approved, issued, or signed versions |
| `schemaownership_relationship` | governed relationships |
| `schemaownership_decision` | binding Decisions and rationale |
| `schemaownership_evidence_link` | provenance and evidence relationships |
| `schemaownership_event_outbox` | transactional Event publication |
| `schemaownership_idempotency` | duplicate-write protection |
| `schemaownership_exception` | exception, claim, dispute, or hold |
| `schemaownership_correction` | correction and supersession lineage |
| `schemaownership_audit` | privileged action evidence |
