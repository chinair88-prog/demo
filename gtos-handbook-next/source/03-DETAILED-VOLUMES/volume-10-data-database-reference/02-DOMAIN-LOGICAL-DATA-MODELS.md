# Domain Logical Data Models

| Metadata | Value |
|---|---|
| Volume | `10` |
| Chapter ID | `V10-02` |
| Subject | `DomainLogicalDataModels` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Domain Logical Data Models**.
...
|---|---|
| `DomainLogicalDataModels` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DomainLogicalDataModelsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DomainLogicalDataModelsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DomainLogicalDataModelsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DomainLogicalDataModelsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DomainLogicalDataModels {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDomainLogicalDataModels`
- `ValidateDomainLogicalDataModels`
- `ApproveDomainLogicalDataModels`
- `ActivateDomainLogicalDataModels`
- `SuspendDomainLogicalDataModels`
- `CorrectDomainLogicalDataModels`
- `RetireDomainLogicalDataModels`

Reference Events:

- `DomainLogicalDataModelsCreated`
- `DomainLogicalDataModelsValidated`
- `DomainLogicalDataModelsApproved`
- `DomainLogicalDataModelsActivated`
- `DomainLogicalDataModelsSuspended`
- `DomainLogicalDataModelsCorrected`
- `DomainLogicalDataModelsRetired`

Reference queries:

- `GetDomainLogicalDataModels`
- `ListDomainLogicalDataModelsRecords`
- `GetDomainLogicalDataModelsTimeline`
- `GetDomainLogicalDataModelsEvidence`
- `GetDomainLogicalDataModelsDecisionPackage`
- `GetDomainLogicalDataModelsExceptions`
- `GetDomainLogicalDataModelsAuditTrail`

Reference API surface:

```text
POST /api/v1/domainlogicaldatamodels/commands
GET  /api/v1/domainlogicaldatamodels/{id}
GET  /api/v1/domainlogicaldatamodels/{id}/timeline
GET  /api/v1/domainlogicaldatamodels/{id}/evidence
GET  /api/v1/domainlogicaldatamodels/{id}/decisions
POST /api/v1/domainlogicaldatamodels/{id}/exceptions
POST /api/v1/domainlogicaldatamodels/{id}/corrections
```
...
|---|---|
| `domainlogicaldatamodels_aggregate` | authoritative subject |
| `domainlogicaldatamodels_version` | immutable submitted, approved, issued, or signed versions |
| `domainlogicaldatamodels_relationship` | governed relationships |
| `domainlogicaldatamodels_decision` | binding Decisions and rationale |
| `domainlogicaldatamodels_evidence_link` | provenance and evidence relationships |
| `domainlogicaldatamodels_event_outbox` | transactional Event publication |
| `domainlogicaldatamodels_idempotency` | duplicate-write protection |
| `domainlogicaldatamodels_exception` | exception, claim, dispute, or hold |
| `domainlogicaldatamodels_correction` | correction and supersession lineage |
| `domainlogicaldatamodels_audit` | privileged action evidence |
