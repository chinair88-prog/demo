# Table Family Documentation

| Metadata | Value |
|---|---|
| Volume | `10` |
| Chapter ID | `V10-06` |
| Subject | `TableFamilyDocumentation` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Table Family Documentation**.
...
|---|---|
| `TableFamilyDocumentation` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableFamilyDocumentationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableFamilyDocumentationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableFamilyDocumentationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TableFamilyDocumentationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TableFamilyDocumentation {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTableFamilyDocumentation`
- `ValidateTableFamilyDocumentation`
- `ApproveTableFamilyDocumentation`
- `ActivateTableFamilyDocumentation`
- `SuspendTableFamilyDocumentation`
- `CorrectTableFamilyDocumentation`
- `RetireTableFamilyDocumentation`

Reference Events:

- `TableFamilyDocumentationCreated`
- `TableFamilyDocumentationValidated`
- `TableFamilyDocumentationApproved`
- `TableFamilyDocumentationActivated`
- `TableFamilyDocumentationSuspended`
- `TableFamilyDocumentationCorrected`
- `TableFamilyDocumentationRetired`

Reference queries:

- `GetTableFamilyDocumentation`
- `ListTableFamilyDocumentationRecords`
- `GetTableFamilyDocumentationTimeline`
- `GetTableFamilyDocumentationEvidence`
- `GetTableFamilyDocumentationDecisionPackage`
- `GetTableFamilyDocumentationExceptions`
- `GetTableFamilyDocumentationAuditTrail`

Reference API surface:

```text
POST /api/v1/tablefamilydocumentation/commands
GET  /api/v1/tablefamilydocumentation/{id}
GET  /api/v1/tablefamilydocumentation/{id}/timeline
GET  /api/v1/tablefamilydocumentation/{id}/evidence
GET  /api/v1/tablefamilydocumentation/{id}/decisions
POST /api/v1/tablefamilydocumentation/{id}/exceptions
POST /api/v1/tablefamilydocumentation/{id}/corrections
```
...
|---|---|
| `tablefamilydocumentation_aggregate` | authoritative subject |
| `tablefamilydocumentation_version` | immutable submitted, approved, issued, or signed versions |
| `tablefamilydocumentation_relationship` | governed relationships |
| `tablefamilydocumentation_decision` | binding Decisions and rationale |
| `tablefamilydocumentation_evidence_link` | provenance and evidence relationships |
| `tablefamilydocumentation_event_outbox` | transactional Event publication |
| `tablefamilydocumentation_idempotency` | duplicate-write protection |
| `tablefamilydocumentation_exception` | exception, claim, dispute, or hold |
| `tablefamilydocumentation_correction` | correction and supersession lineage |
| `tablefamilydocumentation_audit` | privileged action evidence |
