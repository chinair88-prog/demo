...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Search Indexes**.
...
|---|---|
| `SearchIndexes` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchIndexesVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchIndexesDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchIndexesEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchIndexesException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveSearchIndexes`
- `ActivateSearchIndexes`
- `SuspendSearchIndexes`
- `CorrectSearchIndexes`
- `RetireSearchIndexes`

Reference Events:

- `SearchIndexesCreated`
- `SearchIndexesValidated`
- `SearchIndexesApproved`
- `SearchIndexesActivated`
- `SearchIndexesSuspended`
- `SearchIndexesCorrected`
- `SearchIndexesRetired`

Reference queries:

- `GetSearchIndexes`
- `ListSearchIndexesRecords`
- `GetSearchIndexesTimeline`
- `GetSearchIndexesEvidence`
- `GetSearchIndexesDecisionPackage`
- `GetSearchIndexesExceptions`
- `GetSearchIndexesAuditTrail`

Reference API surface:

```text
POST /api/v1/searchindexes/commands
GET  /api/v1/searchindexes/{id}
GET  /api/v1/searchindexes/{id}/timeline
GET  /api/v1/searchindexes/{id}/evidence
GET  /api/v1/searchindexes/{id}/decisions
POST /api/v1/searchindexes/{id}/exceptions
POST /api/v1/searchindexes/{id}/corrections
```
...
|---|---|
| `searchindexes_aggregate` | authoritative subject |
| `searchindexes_version` | immutable submitted, approved, issued, or signed versions |
| `searchindexes_relationship` | governed relationships |
| `searchindexes_decision` | binding Decisions and rationale |
| `searchindexes_evidence_link` | provenance and evidence relationships |
| `searchindexes_event_outbox` | transactional Event publication |
| `searchindexes_idempotency` | duplicate-write protection |
| `searchindexes_exception` | exception, claim, dispute, or hold |
| `searchindexes_correction` | correction and supersession lineage |
| `searchindexes_audit` | privileged action evidence |
