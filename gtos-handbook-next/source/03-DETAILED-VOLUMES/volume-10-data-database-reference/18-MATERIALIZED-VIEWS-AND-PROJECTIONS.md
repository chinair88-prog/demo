...
| Volume | `10` |
| Chapter ID | `V10-18` |
| Subject | `MaterializedViewsandProjections` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Materialized Views and Projections**.
...
|---|---|
| `MaterializedViewsandProjections` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MaterializedViewsandProjectionsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MaterializedViewsandProjectionsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MaterializedViewsandProjectionsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MaterializedViewsandProjectionsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
MaterializedViewsandProjections {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateMaterializedViewsandProjections`
- `ValidateMaterializedViewsandProjections`
- `ApproveMaterializedViewsandProjections`
- `ActivateMaterializedViewsandProjections`
- `SuspendMaterializedViewsandProjections`
- `CorrectMaterializedViewsandProjections`
- `RetireMaterializedViewsandProjections`

Reference Events:

- `MaterializedViewsandProjectionsCreated`
- `MaterializedViewsandProjectionsValidated`
- `MaterializedViewsandProjectionsApproved`
- `MaterializedViewsandProjectionsActivated`
- `MaterializedViewsandProjectionsSuspended`
- `MaterializedViewsandProjectionsCorrected`
- `MaterializedViewsandProjectionsRetired`

Reference queries:

- `GetMaterializedViewsandProjections`
- `ListMaterializedViewsandProjectionsRecords`
- `GetMaterializedViewsandProjectionsTimeline`
- `GetMaterializedViewsandProjectionsEvidence`
- `GetMaterializedViewsandProjectionsDecisionPackage`
- `GetMaterializedViewsandProjectionsExceptions`
- `GetMaterializedViewsandProjectionsAuditTrail`

Reference API surface:

```text
POST /api/v1/materializedviewsandprojections/commands
GET  /api/v1/materializedviewsandprojections/{id}
GET  /api/v1/materializedviewsandprojections/{id}/timeline
GET  /api/v1/materializedviewsandprojections/{id}/evidence
GET  /api/v1/materializedviewsandprojections/{id}/decisions
POST /api/v1/materializedviewsandprojections/{id}/exceptions
POST /api/v1/materializedviewsandprojections/{id}/corrections
```
...
|---|---|
| `materializedviewsandprojections_aggregate` | authoritative subject |
| `materializedviewsandprojections_version` | immutable submitted, approved, issued, or signed versions |
| `materializedviewsandprojections_relationship` | governed relationships |
| `materializedviewsandprojections_decision` | binding Decisions and rationale |
| `materializedviewsandprojections_evidence_link` | provenance and evidence relationships |
| `materializedviewsandprojections_event_outbox` | transactional Event publication |
| `materializedviewsandprojections_idempotency` | duplicate-write protection |
| `materializedviewsandprojections_exception` | exception, claim, dispute, or hold |
| `materializedviewsandprojections_correction` | correction and supersession lineage |
| `materializedviewsandprojections_audit` | privileged action evidence |
