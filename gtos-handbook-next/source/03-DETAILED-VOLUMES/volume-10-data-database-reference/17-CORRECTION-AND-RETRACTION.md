...
| Volume | `10` |
| Chapter ID | `V10-17` |
| Subject | `CorrectionandRetraction` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Correction and Retraction**.
...
|---|---|
| `CorrectionandRetraction` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CorrectionandRetractionVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CorrectionandRetractionDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CorrectionandRetractionEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CorrectionandRetractionException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateCorrectionandRetraction`
- `ValidateCorrectionandRetraction`
- `ApproveCorrectionandRetraction`
- `ActivateCorrectionandRetraction`
- `SuspendCorrectionandRetraction`
- `CorrectCorrectionandRetraction`
- `RetireCorrectionandRetraction`

Reference Events:

- `CorrectionandRetractionCreated`
- `CorrectionandRetractionValidated`
- `CorrectionandRetractionApproved`
- `CorrectionandRetractionActivated`
- `CorrectionandRetractionSuspended`
- `CorrectionandRetractionCorrected`
- `CorrectionandRetractionRetired`

Reference queries:

- `GetCorrectionandRetraction`
- `ListCorrectionandRetractionRecords`
- `GetCorrectionandRetractionTimeline`
- `GetCorrectionandRetractionEvidence`
- `GetCorrectionandRetractionDecisionPackage`
- `GetCorrectionandRetractionExceptions`
- `GetCorrectionandRetractionAuditTrail`

Reference API surface:

```text
POST /api/v1/correctionandretraction/commands
GET  /api/v1/correctionandretraction/{id}
GET  /api/v1/correctionandretraction/{id}/timeline
GET  /api/v1/correctionandretraction/{id}/evidence
GET  /api/v1/correctionandretraction/{id}/decisions
POST /api/v1/correctionandretraction/{id}/exceptions
POST /api/v1/correctionandretraction/{id}/corrections
```
...
|---|---|
| `correctionandretraction_aggregate` | authoritative subject |
| `correctionandretraction_version` | immutable submitted, approved, issued, or signed versions |
| `correctionandretraction_relationship` | governed relationships |
| `correctionandretraction_decision` | binding Decisions and rationale |
| `correctionandretraction_evidence_link` | provenance and evidence relationships |
| `correctionandretraction_event_outbox` | transactional Event publication |
| `correctionandretraction_idempotency` | duplicate-write protection |
| `correctionandretraction_exception` | exception, claim, dispute, or hold |
| `correctionandretraction_correction` | correction and supersession lineage |
| `correctionandretraction_audit` | privileged action evidence |
