# Template and Localization — Portals, CRM, AI Assistance, Human Handoff, SLOs, and Tests

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-09-03` |
| Subject | `TemplateandLocalizationOperatingProfile` |
...
| Accountable owner | Engagement Architecture / Template and Localization |
...
This chapter defines how GTOS shall **define Portal experience, CRM linkage, AI drafting, human handoff, security, SLOs, operations, tests and conformance for Template and Localization**.
...
The accountable owner is **Engagement Architecture / Template and Localization**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `TemplateandLocalizationOperatingProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationOperatingProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationOperatingProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationOperatingProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationOperatingProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TemplateandLocalizationOperatingProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTemplateandLocalizationOperatingProfile`
- `ValidateTemplateandLocalizationOperatingProfile`
- `ApproveTemplateandLocalizationOperatingProfile`
- `ActivateTemplateandLocalizationOperatingProfile`
- `SuspendTemplateandLocalizationOperatingProfile`
- `CorrectTemplateandLocalizationOperatingProfile`
- `RetireTemplateandLocalizationOperatingProfile`

Reference Events:

- `TemplateandLocalizationOperatingProfileCreated`
- `TemplateandLocalizationOperatingProfileValidated`
- `TemplateandLocalizationOperatingProfileApproved`
- `TemplateandLocalizationOperatingProfileActivated`
- `TemplateandLocalizationOperatingProfileSuspended`
- `TemplateandLocalizationOperatingProfileCorrected`
- `TemplateandLocalizationOperatingProfileRetired`

Reference queries:

- `GetTemplateandLocalizationOperatingProfile`
- `ListTemplateandLocalizationOperatingProfileRecords`
- `GetTemplateandLocalizationOperatingProfileTimeline`
- `GetTemplateandLocalizationOperatingProfileEvidence`
- `GetTemplateandLocalizationOperatingProfileDecisionPackage`
- `GetTemplateandLocalizationOperatingProfileExceptions`
- `GetTemplateandLocalizationOperatingProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/templateandlocalizationoperatingprofile/commands
GET  /api/v1/templateandlocalizationoperatingprofile/{id}
GET  /api/v1/templateandlocalizationoperatingprofile/{id}/timeline
GET  /api/v1/templateandlocalizationoperatingprofile/{id}/evidence
GET  /api/v1/templateandlocalizationoperatingprofile/{id}/decisions
POST /api/v1/templateandlocalizationoperatingprofile/{id}/exceptions
POST /api/v1/templateandlocalizationoperatingprofile/{id}/corrections
```
...
|---|---|
| `templateandlocalizationoperatingprofile_aggregate` | authoritative subject |
| `templateandlocalizationoperatingprofile_version` | immutable submitted, approved, issued, or signed versions |
| `templateandlocalizationoperatingprofile_relationship` | governed relationships |
| `templateandlocalizationoperatingprofile_decision` | binding Decisions and rationale |
| `templateandlocalizationoperatingprofile_evidence_link` | provenance and evidence relationships |
| `templateandlocalizationoperatingprofile_event_outbox` | transactional Event publication |
| `templateandlocalizationoperatingprofile_idempotency` | duplicate-write protection |
| `templateandlocalizationoperatingprofile_exception` | exception, claim, dispute, or hold |
| `templateandlocalizationoperatingprofile_correction` | correction and supersession lineage |
| `templateandlocalizationoperatingprofile_audit` | privileged action evidence |
