# Consent and Channel Capability — Portals, CRM, AI Assistance, Human Handoff, SLOs, and Tests

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-08-03` |
| Subject | `ConsentandChannelCapabilityOperatingProfile` |
...
| Accountable owner | Engagement Architecture / Consent and Channel Capability |
...
This chapter defines how GTOS shall **define Portal experience, CRM linkage, AI drafting, human handoff, security, SLOs, operations, tests and conformance for Consent and Channel Capability**.
...
The accountable owner is **Engagement Architecture / Consent and Channel Capability**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `ConsentandChannelCapabilityOperatingProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentandChannelCapabilityOperatingProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentandChannelCapabilityOperatingProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentandChannelCapabilityOperatingProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentandChannelCapabilityOperatingProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ConsentandChannelCapabilityOperatingProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateConsentandChannelCapabilityOperatingProfile`
- `ValidateConsentandChannelCapabilityOperatingProfile`
- `ApproveConsentandChannelCapabilityOperatingProfile`
- `ActivateConsentandChannelCapabilityOperatingProfile`
- `SuspendConsentandChannelCapabilityOperatingProfile`
- `CorrectConsentandChannelCapabilityOperatingProfile`
- `RetireConsentandChannelCapabilityOperatingProfile`

Reference Events:

- `ConsentandChannelCapabilityOperatingProfileCreated`
- `ConsentandChannelCapabilityOperatingProfileValidated`
- `ConsentandChannelCapabilityOperatingProfileApproved`
- `ConsentandChannelCapabilityOperatingProfileActivated`
- `ConsentandChannelCapabilityOperatingProfileSuspended`
- `ConsentandChannelCapabilityOperatingProfileCorrected`
- `ConsentandChannelCapabilityOperatingProfileRetired`

Reference queries:

- `GetConsentandChannelCapabilityOperatingProfile`
- `ListConsentandChannelCapabilityOperatingProfileRecords`
- `GetConsentandChannelCapabilityOperatingProfileTimeline`
- `GetConsentandChannelCapabilityOperatingProfileEvidence`
- `GetConsentandChannelCapabilityOperatingProfileDecisionPackage`
- `GetConsentandChannelCapabilityOperatingProfileExceptions`
- `GetConsentandChannelCapabilityOperatingProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/consentandchannelcapabilityoperatingprofile/commands
GET  /api/v1/consentandchannelcapabilityoperatingprofile/{id}
GET  /api/v1/consentandchannelcapabilityoperatingprofile/{id}/timeline
GET  /api/v1/consentandchannelcapabilityoperatingprofile/{id}/evidence
GET  /api/v1/consentandchannelcapabilityoperatingprofile/{id}/decisions
POST /api/v1/consentandchannelcapabilityoperatingprofile/{id}/exceptions
POST /api/v1/consentandchannelcapabilityoperatingprofile/{id}/corrections
```
...
|---|---|
| `consentandchannelcapabilityoperatingprofile_aggregate` | authoritative subject |
| `consentandchannelcapabilityoperatingprofile_version` | immutable submitted, approved, issued, or signed versions |
| `consentandchannelcapabilityoperatingprofile_relationship` | governed relationships |
| `consentandchannelcapabilityoperatingprofile_decision` | binding Decisions and rationale |
| `consentandchannelcapabilityoperatingprofile_evidence_link` | provenance and evidence relationships |
| `consentandchannelcapabilityoperatingprofile_event_outbox` | transactional Event publication |
| `consentandchannelcapabilityoperatingprofile_idempotency` | duplicate-write protection |
| `consentandchannelcapabilityoperatingprofile_exception` | exception, claim, dispute, or hold |
| `consentandchannelcapabilityoperatingprofile_correction` | correction and supersession lineage |
| `consentandchannelcapabilityoperatingprofile_audit` | privileged action evidence |
