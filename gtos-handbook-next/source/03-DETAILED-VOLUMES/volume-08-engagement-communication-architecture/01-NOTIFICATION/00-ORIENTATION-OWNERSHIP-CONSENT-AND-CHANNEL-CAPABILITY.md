# Notification — Orientation, Ownership, Consent, and Channel Capability

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-01-00` |
| Subject | `NotificationChannel` |
...
This chapter defines how GTOS shall **define ownership, participant identity, consent, channel capability, provider boundary, retention, and audit for Notification**.
...
|---|---|
| `NotificationChannel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `NotificationChannelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `NotificationChannelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `NotificationChannelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `NotificationChannelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveNotificationChannel`
- `ActivateNotificationChannel`
- `SuspendNotificationChannel`
- `CorrectNotificationChannel`
- `RetireNotificationChannel`

Reference Events:

- `NotificationChannelCreated`
- `NotificationChannelValidated`
- `NotificationChannelApproved`
- `NotificationChannelActivated`
- `NotificationChannelSuspended`
- `NotificationChannelCorrected`
- `NotificationChannelRetired`

Reference queries:

- `GetNotificationChannel`
- `ListNotificationChannelRecords`
- `GetNotificationChannelTimeline`
- `GetNotificationChannelEvidence`
- `GetNotificationChannelDecisionPackage`
- `GetNotificationChannelExceptions`
- `GetNotificationChannelAuditTrail`

Reference API surface:

```text
POST /api/v1/notificationchannel/commands
GET  /api/v1/notificationchannel/{id}
GET  /api/v1/notificationchannel/{id}/timeline
GET  /api/v1/notificationchannel/{id}/evidence
GET  /api/v1/notificationchannel/{id}/decisions
POST /api/v1/notificationchannel/{id}/exceptions
POST /api/v1/notificationchannel/{id}/corrections
```
...
|---|---|
| `notificationchannel_aggregate` | authoritative subject |
| `notificationchannel_version` | immutable submitted, approved, issued, or signed versions |
| `notificationchannel_relationship` | governed relationships |
| `notificationchannel_decision` | binding Decisions and rationale |
| `notificationchannel_evidence_link` | provenance and evidence relationships |
| `notificationchannel_event_outbox` | transactional Event publication |
| `notificationchannel_idempotency` | duplicate-write protection |
| `notificationchannel_exception` | exception, claim, dispute, or hold |
| `notificationchannel_correction` | correction and supersession lineage |
| `notificationchannel_audit` | privileged action evidence |
