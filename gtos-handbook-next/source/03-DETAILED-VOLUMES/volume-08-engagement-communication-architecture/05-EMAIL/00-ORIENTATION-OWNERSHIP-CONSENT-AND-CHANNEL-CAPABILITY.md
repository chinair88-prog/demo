# Email — Orientation, Ownership, Consent, and Channel Capability

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-05-00` |
| Subject | `EmailChannel` |
...
This chapter defines how GTOS shall **define ownership, participant identity, consent, channel capability, provider boundary, retention, and audit for Email**.
...
|---|---|
| `EmailChannel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EmailChannelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EmailChannelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EmailChannelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EmailChannelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `EmailChannelCreated`
- `EmailChannelValidated`
- `EmailChannelApproved`
- `EmailChannelActivated`
- `EmailChannelSuspended`
- `EmailChannelCorrected`
- `EmailChannelRetired`

Reference queries:

- `GetEmailChannel`
- `ListEmailChannelRecords`
- `GetEmailChannelTimeline`
- `GetEmailChannelEvidence`
- `GetEmailChannelDecisionPackage`
- `GetEmailChannelExceptions`
- `GetEmailChannelAuditTrail`

Reference API surface:

```text
POST /api/v1/emailchannel/commands
GET  /api/v1/emailchannel/{id}
GET  /api/v1/emailchannel/{id}/timeline
GET  /api/v1/emailchannel/{id}/evidence
GET  /api/v1/emailchannel/{id}/decisions
POST /api/v1/emailchannel/{id}/exceptions
POST /api/v1/emailchannel/{id}/corrections
```
...
|---|---|
| `emailchannel_aggregate` | authoritative subject |
| `emailchannel_version` | immutable submitted, approved, issued, or signed versions |
| `emailchannel_relationship` | governed relationships |
| `emailchannel_decision` | binding Decisions and rationale |
| `emailchannel_evidence_link` | provenance and evidence relationships |
| `emailchannel_event_outbox` | transactional Event publication |
| `emailchannel_idempotency` | duplicate-write protection |
| `emailchannel_exception` | exception, claim, dispute, or hold |
| `emailchannel_correction` | correction and supersession lineage |
| `emailchannel_audit` | privileged action evidence |
