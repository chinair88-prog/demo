# WhatsApp — Provider Adapters, Webhooks, Retry, Failure, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-02-02` |
| Subject | `WhatsAppProviderAdapter` |
...
This chapter defines how GTOS shall **define provider request, callback, signature, idempotency, ordering, retry, outage, Outcome Unknown, DLQ and reconciliation for WhatsApp**.
...
|---|---|
| `WhatsAppProviderAdapter` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppProviderAdapterVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppProviderAdapterDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppProviderAdapterEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppProviderAdapterException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateWhatsAppProviderAdapter`
- `ApproveWhatsAppProviderAdapter`
- `ActivateWhatsAppProviderAdapter`
- `SuspendWhatsAppProviderAdapter`
- `CorrectWhatsAppProviderAdapter`
- `RetireWhatsAppProviderAdapter`

Reference Events:

- `WhatsAppProviderAdapterCreated`
- `WhatsAppProviderAdapterValidated`
- `WhatsAppProviderAdapterApproved`
- `WhatsAppProviderAdapterActivated`
- `WhatsAppProviderAdapterSuspended`
- `WhatsAppProviderAdapterCorrected`
- `WhatsAppProviderAdapterRetired`

Reference queries:

- `GetWhatsAppProviderAdapter`
- `ListWhatsAppProviderAdapterRecords`
- `GetWhatsAppProviderAdapterTimeline`
- `GetWhatsAppProviderAdapterEvidence`
- `GetWhatsAppProviderAdapterDecisionPackage`
- `GetWhatsAppProviderAdapterExceptions`
- `GetWhatsAppProviderAdapterAuditTrail`

Reference API surface:

```text
POST /api/v1/whatsappprovideradapter/commands
GET  /api/v1/whatsappprovideradapter/{id}
GET  /api/v1/whatsappprovideradapter/{id}/timeline
GET  /api/v1/whatsappprovideradapter/{id}/evidence
GET  /api/v1/whatsappprovideradapter/{id}/decisions
POST /api/v1/whatsappprovideradapter/{id}/exceptions
POST /api/v1/whatsappprovideradapter/{id}/corrections
```
...
|---|---|
| `whatsappprovideradapter_aggregate` | authoritative subject |
| `whatsappprovideradapter_version` | immutable submitted, approved, issued, or signed versions |
| `whatsappprovideradapter_relationship` | governed relationships |
| `whatsappprovideradapter_decision` | binding Decisions and rationale |
| `whatsappprovideradapter_evidence_link` | provenance and evidence relationships |
| `whatsappprovideradapter_event_outbox` | transactional Event publication |
| `whatsappprovideradapter_idempotency` | duplicate-write protection |
| `whatsappprovideradapter_exception` | exception, claim, dispute, or hold |
| `whatsappprovideradapter_correction` | correction and supersession lineage |
| `whatsappprovideradapter_audit` | privileged action evidence |
