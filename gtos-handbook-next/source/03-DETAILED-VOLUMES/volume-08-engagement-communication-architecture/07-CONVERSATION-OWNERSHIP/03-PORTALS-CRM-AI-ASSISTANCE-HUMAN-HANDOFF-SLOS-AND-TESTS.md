# Conversation Ownership — Portals, CRM, AI Assistance, Human Handoff, SLOs, and Tests

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-07-03` |
| Subject | `ConversationOwnershipOperatingProfile` |
...
| Accountable owner | Engagement Architecture / Conversation Ownership |
...
This chapter defines how GTOS shall **define Portal experience, CRM linkage, AI drafting, human handoff, security, SLOs, operations, tests and conformance for Conversation Ownership**.
...
The accountable owner is **Engagement Architecture / Conversation Ownership**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `ConversationOwnershipOperatingProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipOperatingProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipOperatingProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipOperatingProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipOperatingProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ConversationOwnershipOperatingProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateConversationOwnershipOperatingProfile`
- `ValidateConversationOwnershipOperatingProfile`
- `ApproveConversationOwnershipOperatingProfile`
- `ActivateConversationOwnershipOperatingProfile`
- `SuspendConversationOwnershipOperatingProfile`
- `CorrectConversationOwnershipOperatingProfile`
- `RetireConversationOwnershipOperatingProfile`

Reference Events:

- `ConversationOwnershipOperatingProfileCreated`
- `ConversationOwnershipOperatingProfileValidated`
- `ConversationOwnershipOperatingProfileApproved`
- `ConversationOwnershipOperatingProfileActivated`
- `ConversationOwnershipOperatingProfileSuspended`
- `ConversationOwnershipOperatingProfileCorrected`
- `ConversationOwnershipOperatingProfileRetired`

Reference queries:

- `GetConversationOwnershipOperatingProfile`
- `ListConversationOwnershipOperatingProfileRecords`
- `GetConversationOwnershipOperatingProfileTimeline`
- `GetConversationOwnershipOperatingProfileEvidence`
- `GetConversationOwnershipOperatingProfileDecisionPackage`
- `GetConversationOwnershipOperatingProfileExceptions`
- `GetConversationOwnershipOperatingProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/conversationownershipoperatingprofile/commands
GET  /api/v1/conversationownershipoperatingprofile/{id}
GET  /api/v1/conversationownershipoperatingprofile/{id}/timeline
GET  /api/v1/conversationownershipoperatingprofile/{id}/evidence
GET  /api/v1/conversationownershipoperatingprofile/{id}/decisions
POST /api/v1/conversationownershipoperatingprofile/{id}/exceptions
POST /api/v1/conversationownershipoperatingprofile/{id}/corrections
```
...
|---|---|
| `conversationownershipoperatingprofile_aggregate` | authoritative subject |
| `conversationownershipoperatingprofile_version` | immutable submitted, approved, issued, or signed versions |
| `conversationownershipoperatingprofile_relationship` | governed relationships |
| `conversationownershipoperatingprofile_decision` | binding Decisions and rationale |
| `conversationownershipoperatingprofile_evidence_link` | provenance and evidence relationships |
| `conversationownershipoperatingprofile_event_outbox` | transactional Event publication |
| `conversationownershipoperatingprofile_idempotency` | duplicate-write protection |
| `conversationownershipoperatingprofile_exception` | exception, claim, dispute, or hold |
| `conversationownershipoperatingprofile_correction` | correction and supersession lineage |
| `conversationownershipoperatingprofile_audit` | privileged action evidence |
