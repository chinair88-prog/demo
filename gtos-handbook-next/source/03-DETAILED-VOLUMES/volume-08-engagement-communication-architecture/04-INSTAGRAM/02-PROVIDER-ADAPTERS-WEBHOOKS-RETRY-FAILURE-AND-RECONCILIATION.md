# Instagram — Provider Adapters, Webhooks, Retry, Failure, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-04-02` |
| Subject | `InstagramProviderAdapter` |
...
This chapter defines how GTOS shall **define provider request, callback, signature, idempotency, ordering, retry, outage, Outcome Unknown, DLQ and reconciliation for Instagram**.
...
|---|---|
| `InstagramProviderAdapter` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `InstagramProviderAdapterVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `InstagramProviderAdapterDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `InstagramProviderAdapterEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `InstagramProviderAdapterException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateInstagramProviderAdapter`
- `ValidateInstagramProviderAdapter`
- `ApproveInstagramProviderAdapter`
- `ActivateInstagramProviderAdapter`
- `SuspendInstagramProviderAdapter`
- `CorrectInstagramProviderAdapter`
- `RetireInstagramProviderAdapter`

Reference Events:

- `InstagramProviderAdapterCreated`
- `InstagramProviderAdapterValidated`
- `InstagramProviderAdapterApproved`
- `InstagramProviderAdapterActivated`
- `InstagramProviderAdapterSuspended`
- `InstagramProviderAdapterCorrected`
- `InstagramProviderAdapterRetired`

Reference queries:

- `GetInstagramProviderAdapter`
- `ListInstagramProviderAdapterRecords`
- `GetInstagramProviderAdapterTimeline`
- `GetInstagramProviderAdapterEvidence`
- `GetInstagramProviderAdapterDecisionPackage`
- `GetInstagramProviderAdapterExceptions`
- `GetInstagramProviderAdapterAuditTrail`

Reference API surface:

```text
POST /api/v1/instagramprovideradapter/commands
GET  /api/v1/instagramprovideradapter/{id}
GET  /api/v1/instagramprovideradapter/{id}/timeline
GET  /api/v1/instagramprovideradapter/{id}/evidence
GET  /api/v1/instagramprovideradapter/{id}/decisions
POST /api/v1/instagramprovideradapter/{id}/exceptions
POST /api/v1/instagramprovideradapter/{id}/corrections
```
...
|---|---|
| `instagramprovideradapter_aggregate` | authoritative subject |
| `instagramprovideradapter_version` | immutable submitted, approved, issued, or signed versions |
| `instagramprovideradapter_relationship` | governed relationships |
| `instagramprovideradapter_decision` | binding Decisions and rationale |
| `instagramprovideradapter_evidence_link` | provenance and evidence relationships |
| `instagramprovideradapter_event_outbox` | transactional Event publication |
| `instagramprovideradapter_idempotency` | duplicate-write protection |
| `instagramprovideradapter_exception` | exception, claim, dispute, or hold |
| `instagramprovideradapter_correction` | correction and supersession lineage |
| `instagramprovideradapter_audit` | privileged action evidence |
