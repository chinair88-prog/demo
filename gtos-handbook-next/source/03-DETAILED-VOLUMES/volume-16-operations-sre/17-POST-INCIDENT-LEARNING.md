...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Post-Incident Learning**.
...
|---|---|
| `Post-IncidentLearning` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Post-IncidentLearningVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Post-IncidentLearningDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Post-IncidentLearningEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Post-IncidentLearningException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePost-IncidentLearning`
- `ValidatePost-IncidentLearning`
- `ApprovePost-IncidentLearning`
- `ActivatePost-IncidentLearning`
- `SuspendPost-IncidentLearning`
- `CorrectPost-IncidentLearning`
- `RetirePost-IncidentLearning`

Reference Events:

- `Post-IncidentLearningCreated`
- `Post-IncidentLearningValidated`
- `Post-IncidentLearningApproved`
- `Post-IncidentLearningActivated`
- `Post-IncidentLearningSuspended`
- `Post-IncidentLearningCorrected`
- `Post-IncidentLearningRetired`

Reference queries:

- `GetPost-IncidentLearning`
- `ListPost-IncidentLearningRecords`
- `GetPost-IncidentLearningTimeline`
- `GetPost-IncidentLearningEvidence`
- `GetPost-IncidentLearningDecisionPackage`
- `GetPost-IncidentLearningExceptions`
- `GetPost-IncidentLearningAuditTrail`

Reference API surface:

```text
POST /api/v1/post_incidentlearning/commands
GET  /api/v1/post_incidentlearning/{id}
GET  /api/v1/post_incidentlearning/{id}/timeline
GET  /api/v1/post_incidentlearning/{id}/evidence
GET  /api/v1/post_incidentlearning/{id}/decisions
POST /api/v1/post_incidentlearning/{id}/exceptions
POST /api/v1/post_incidentlearning/{id}/corrections
```
...
|---|---|
| `post_incidentlearning_aggregate` | authoritative subject |
| `post_incidentlearning_version` | immutable submitted, approved, issued, or signed versions |
| `post_incidentlearning_relationship` | governed relationships |
| `post_incidentlearning_decision` | binding Decisions and rationale |
| `post_incidentlearning_evidence_link` | provenance and evidence relationships |
| `post_incidentlearning_event_outbox` | transactional Event publication |
| `post_incidentlearning_idempotency` | duplicate-write protection |
| `post_incidentlearning_exception` | exception, claim, dispute, or hold |
| `post_incidentlearning_correction` | correction and supersession lineage |
| `post_incidentlearning_audit` | privileged action evidence |
...
- `Post-Incident Learning` is part of the target GTOS handbook scope.
