...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for AI Incident Operations**.
...
|---|---|
| `AIIncidentOperations` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIIncidentOperationsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIIncidentOperationsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIIncidentOperationsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIIncidentOperationsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
AIIncidentOperations {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateAIIncidentOperations`
- `ValidateAIIncidentOperations`
- `ApproveAIIncidentOperations`
- `ActivateAIIncidentOperations`
- `SuspendAIIncidentOperations`
- `CorrectAIIncidentOperations`
- `RetireAIIncidentOperations`

Reference Events:

- `AIIncidentOperationsCreated`
- `AIIncidentOperationsValidated`
- `AIIncidentOperationsApproved`
- `AIIncidentOperationsActivated`
- `AIIncidentOperationsSuspended`
- `AIIncidentOperationsCorrected`
- `AIIncidentOperationsRetired`

Reference queries:

- `GetAIIncidentOperations`
- `ListAIIncidentOperationsRecords`
- `GetAIIncidentOperationsTimeline`
- `GetAIIncidentOperationsEvidence`
- `GetAIIncidentOperationsDecisionPackage`
- `GetAIIncidentOperationsExceptions`
- `GetAIIncidentOperationsAuditTrail`

Reference API surface:

```text
POST /api/v1/aiincidentoperations/commands
GET  /api/v1/aiincidentoperations/{id}
GET  /api/v1/aiincidentoperations/{id}/timeline
GET  /api/v1/aiincidentoperations/{id}/evidence
GET  /api/v1/aiincidentoperations/{id}/decisions
POST /api/v1/aiincidentoperations/{id}/exceptions
POST /api/v1/aiincidentoperations/{id}/corrections
```
...
|---|---|
| `aiincidentoperations_aggregate` | authoritative subject |
| `aiincidentoperations_version` | immutable submitted, approved, issued, or signed versions |
| `aiincidentoperations_relationship` | governed relationships |
| `aiincidentoperations_decision` | binding Decisions and rationale |
| `aiincidentoperations_evidence_link` | provenance and evidence relationships |
| `aiincidentoperations_event_outbox` | transactional Event publication |
| `aiincidentoperations_idempotency` | duplicate-write protection |
| `aiincidentoperations_exception` | exception, claim, dispute, or hold |
| `aiincidentoperations_correction` | correction and supersession lineage |
| `aiincidentoperations_audit` | privileged action evidence |
...
- `AI Incident Operations` is part of the target GTOS handbook scope.
