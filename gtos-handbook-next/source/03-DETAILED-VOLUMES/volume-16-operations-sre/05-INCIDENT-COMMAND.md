...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Incident Command**.
...
|---|---|
| `IncidentCommand` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentCommandVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentCommandDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentCommandEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IncidentCommandException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveIncidentCommand`
- `ActivateIncidentCommand`
- `SuspendIncidentCommand`
- `CorrectIncidentCommand`
- `RetireIncidentCommand`

Reference Events:

- `IncidentCommandCreated`
- `IncidentCommandValidated`
- `IncidentCommandApproved`
- `IncidentCommandActivated`
- `IncidentCommandSuspended`
- `IncidentCommandCorrected`
- `IncidentCommandRetired`

Reference queries:

- `GetIncidentCommand`
- `ListIncidentCommandRecords`
- `GetIncidentCommandTimeline`
- `GetIncidentCommandEvidence`
- `GetIncidentCommandDecisionPackage`
- `GetIncidentCommandExceptions`
- `GetIncidentCommandAuditTrail`

Reference API surface:

```text
POST /api/v1/incidentcommand/commands
GET  /api/v1/incidentcommand/{id}
GET  /api/v1/incidentcommand/{id}/timeline
GET  /api/v1/incidentcommand/{id}/evidence
GET  /api/v1/incidentcommand/{id}/decisions
POST /api/v1/incidentcommand/{id}/exceptions
POST /api/v1/incidentcommand/{id}/corrections
```
...
|---|---|
| `incidentcommand_aggregate` | authoritative subject |
| `incidentcommand_version` | immutable submitted, approved, issued, or signed versions |
| `incidentcommand_relationship` | governed relationships |
| `incidentcommand_decision` | binding Decisions and rationale |
| `incidentcommand_evidence_link` | provenance and evidence relationships |
| `incidentcommand_event_outbox` | transactional Event publication |
| `incidentcommand_idempotency` | duplicate-write protection |
| `incidentcommand_exception` | exception, claim, dispute, or hold |
| `incidentcommand_correction` | correction and supersession lineage |
| `incidentcommand_audit` | privileged action evidence |
...
- `Incident Command` is part of the target GTOS handbook scope.
