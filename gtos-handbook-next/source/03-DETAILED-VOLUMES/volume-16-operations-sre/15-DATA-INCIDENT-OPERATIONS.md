# Data Incident Operations

| Metadata | Value |
|---|---|
| Volume | `16` |
| Chapter ID | `V16-15` |
| Subject | `DataIncidentOperations` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Data Incident Operations**.
...
|---|---|
| `DataIncidentOperations` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataIncidentOperationsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataIncidentOperationsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataIncidentOperationsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataIncidentOperationsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DataIncidentOperations {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDataIncidentOperations`
- `ValidateDataIncidentOperations`
- `ApproveDataIncidentOperations`
- `ActivateDataIncidentOperations`
- `SuspendDataIncidentOperations`
- `CorrectDataIncidentOperations`
- `RetireDataIncidentOperations`

Reference Events:

- `DataIncidentOperationsCreated`
- `DataIncidentOperationsValidated`
- `DataIncidentOperationsApproved`
- `DataIncidentOperationsActivated`
- `DataIncidentOperationsSuspended`
- `DataIncidentOperationsCorrected`
- `DataIncidentOperationsRetired`

Reference queries:

- `GetDataIncidentOperations`
- `ListDataIncidentOperationsRecords`
- `GetDataIncidentOperationsTimeline`
- `GetDataIncidentOperationsEvidence`
- `GetDataIncidentOperationsDecisionPackage`
- `GetDataIncidentOperationsExceptions`
- `GetDataIncidentOperationsAuditTrail`

Reference API surface:

```text
POST /api/v1/dataincidentoperations/commands
GET  /api/v1/dataincidentoperations/{id}
GET  /api/v1/dataincidentoperations/{id}/timeline
GET  /api/v1/dataincidentoperations/{id}/evidence
GET  /api/v1/dataincidentoperations/{id}/decisions
POST /api/v1/dataincidentoperations/{id}/exceptions
POST /api/v1/dataincidentoperations/{id}/corrections
```
...
|---|---|
| `dataincidentoperations_aggregate` | authoritative subject |
| `dataincidentoperations_version` | immutable submitted, approved, issued, or signed versions |
| `dataincidentoperations_relationship` | governed relationships |
| `dataincidentoperations_decision` | binding Decisions and rationale |
| `dataincidentoperations_evidence_link` | provenance and evidence relationships |
| `dataincidentoperations_event_outbox` | transactional Event publication |
| `dataincidentoperations_idempotency` | duplicate-write protection |
| `dataincidentoperations_exception` | exception, claim, dispute, or hold |
| `dataincidentoperations_correction` | correction and supersession lineage |
| `dataincidentoperations_audit` | privileged action evidence |
...
- `Data Incident Operations` is part of the target GTOS handbook scope.
