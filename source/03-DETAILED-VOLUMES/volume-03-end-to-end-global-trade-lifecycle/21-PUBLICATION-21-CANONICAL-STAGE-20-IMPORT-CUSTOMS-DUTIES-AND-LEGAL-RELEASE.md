...
|---|---|
| `ImportDeclaration` | independent identified subject or governed subordinate entity; ownership must be declared |
| `ImportDeclarationVersion` | independent identified subject or governed subordinate entity; ownership must be declared |
| `DutyAssessment` | independent identified subject or governed subordinate entity; ownership must be declared |
| `TaxAssessment` | independent identified subject or governed subordinate entity; ownership must be declared |
| `ImportLicense` | independent identified subject or governed subordinate entity; ownership must be declared |
...
| `ImportRelease` | independent identified subject or governed subordinate entity; ownership must be declared |
...
| `DOCUMENT_PENDING` | distinct governed condition; exact entry, exit, timeout, and correction semantics require a Domain specification |
...
| `DUTY_PENDING` | distinct governed condition; exact entry, exit, timeout, and correction semantics require a Domain specification |
...
|---|---|---|
| `PREPARATION` | `DOCUMENT_PENDING` | authorized Command, expected version, applicable Policy, required Evidence, and idempotency guard |
| `DOCUMENT_PENDING` | `SUBMITTED` | authorized Command, expected version, applicable Policy, required Evidence, and idempotency guard |
...
| `ACCEPTED_FOR_PROCESSING` | `DUTY_PENDING` | authorized Command, expected version, applicable Policy, required Evidence, and idempotency guard |
| `DUTY_PENDING` | `PAYMENT_PENDING` | authorized Command, expected version, applicable Policy, required Evidence, and idempotency guard |
| `PAYMENT_PENDING` | `HOLD` | authorized Command, expected version, applicable Policy, required Evidence, and idempotency guard |
...
- `RecordDutyAssessment`
- `RecordDutyPayment`
- `RecordImportHold`
- `AmendImportDeclaration`
- `RecordImportRelease`
...
- `ImportDeclarationSubmitted`
- `DutyAssessed`
- `ImportDutyPaid`
- `ImportHoldRecorded`
- `ImportInspectionRequested`
- `ImportDeclarationAmended`
- `ImportReleased`
...
- `ListImportDeclarationRecords`
- `GetImportDeclarationTimeline`
- `GetImportDeclarationEvidence`
- `GetImportDeclarationDecisionPackage`
- `GetImportDeclarationExceptions`
- `GetImportDeclarationAuditTrail`
- `GetImportDeclarationCurrentPerspective`
