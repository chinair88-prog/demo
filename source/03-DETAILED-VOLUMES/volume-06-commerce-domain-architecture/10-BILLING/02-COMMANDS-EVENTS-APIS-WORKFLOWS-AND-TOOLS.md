# Billing — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-10-02` |
| Subject | `BillingContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Billing**.
...
|---|---|
| `BillingContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `BillingContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateBillingContractModel`
- `ValidateBillingContractModel`
- `ApproveBillingContractModel`
- `ActivateBillingContractModel`
- `SuspendBillingContractModel`
- `CorrectBillingContractModel`
- `RetireBillingContractModel`

Reference Events:

- `BillingContractModelCreated`
- `BillingContractModelValidated`
- `BillingContractModelApproved`
- `BillingContractModelActivated`
- `BillingContractModelSuspended`
- `BillingContractModelCorrected`
- `BillingContractModelRetired`

Reference queries:

- `GetBillingContractModel`
- `ListBillingContractModelRecords`
- `GetBillingContractModelTimeline`
- `GetBillingContractModelEvidence`
- `GetBillingContractModelDecisionPackage`
- `GetBillingContractModelExceptions`
- `GetBillingContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/billingcontractmodel/commands
GET  /api/v1/billingcontractmodel/{id}
GET  /api/v1/billingcontractmodel/{id}/timeline
GET  /api/v1/billingcontractmodel/{id}/evidence
GET  /api/v1/billingcontractmodel/{id}/decisions
POST /api/v1/billingcontractmodel/{id}/exceptions
POST /api/v1/billingcontractmodel/{id}/corrections
```
...
|---|---|
| `billingcontractmodel_aggregate` | authoritative subject |
| `billingcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `billingcontractmodel_relationship` | governed relationships |
| `billingcontractmodel_decision` | binding Decisions and rationale |
| `billingcontractmodel_evidence_link` | provenance and evidence relationships |
| `billingcontractmodel_event_outbox` | transactional Event publication |
| `billingcontractmodel_idempotency` | duplicate-write protection |
| `billingcontractmodel_exception` | exception, claim, dispute, or hold |
| `billingcontractmodel_correction` | correction and supersession lineage |
| `billingcontractmodel_audit` | privileged action evidence |
