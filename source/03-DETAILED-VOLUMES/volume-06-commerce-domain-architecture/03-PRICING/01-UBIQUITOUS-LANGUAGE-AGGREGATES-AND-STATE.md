# Pricing — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-03-01` |
| Subject | `PricingAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Pricing**.
...
|---|---|
| `PricingAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PricingAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePricingAggregateModel`
- `ValidatePricingAggregateModel`
- `ApprovePricingAggregateModel`
- `ActivatePricingAggregateModel`
- `SuspendPricingAggregateModel`
- `CorrectPricingAggregateModel`
- `RetirePricingAggregateModel`

Reference Events:

- `PricingAggregateModelCreated`
- `PricingAggregateModelValidated`
- `PricingAggregateModelApproved`
- `PricingAggregateModelActivated`
- `PricingAggregateModelSuspended`
- `PricingAggregateModelCorrected`
- `PricingAggregateModelRetired`

Reference queries:

- `GetPricingAggregateModel`
- `ListPricingAggregateModelRecords`
- `GetPricingAggregateModelTimeline`
- `GetPricingAggregateModelEvidence`
- `GetPricingAggregateModelDecisionPackage`
- `GetPricingAggregateModelExceptions`
- `GetPricingAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/pricingaggregatemodel/commands
GET  /api/v1/pricingaggregatemodel/{id}
GET  /api/v1/pricingaggregatemodel/{id}/timeline
GET  /api/v1/pricingaggregatemodel/{id}/evidence
GET  /api/v1/pricingaggregatemodel/{id}/decisions
POST /api/v1/pricingaggregatemodel/{id}/exceptions
POST /api/v1/pricingaggregatemodel/{id}/corrections
```
...
|---|---|
| `pricingaggregatemodel_aggregate` | authoritative subject |
| `pricingaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `pricingaggregatemodel_relationship` | governed relationships |
| `pricingaggregatemodel_decision` | binding Decisions and rationale |
| `pricingaggregatemodel_evidence_link` | provenance and evidence relationships |
| `pricingaggregatemodel_event_outbox` | transactional Event publication |
| `pricingaggregatemodel_idempotency` | duplicate-write protection |
| `pricingaggregatemodel_exception` | exception, claim, dispute, or hold |
| `pricingaggregatemodel_correction` | correction and supersession lineage |
| `pricingaggregatemodel_audit` | privileged action evidence |
