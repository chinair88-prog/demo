# Pricing — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-03-02` |
| Subject | `PricingContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Pricing**.
...
|---|---|
| `PricingContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PricingContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PricingContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePricingContractModel`
- `ValidatePricingContractModel`
- `ApprovePricingContractModel`
- `ActivatePricingContractModel`
- `SuspendPricingContractModel`
- `CorrectPricingContractModel`
- `RetirePricingContractModel`

Reference Events:

- `PricingContractModelCreated`
- `PricingContractModelValidated`
- `PricingContractModelApproved`
- `PricingContractModelActivated`
- `PricingContractModelSuspended`
- `PricingContractModelCorrected`
- `PricingContractModelRetired`

Reference queries:

- `GetPricingContractModel`
- `ListPricingContractModelRecords`
- `GetPricingContractModelTimeline`
- `GetPricingContractModelEvidence`
- `GetPricingContractModelDecisionPackage`
- `GetPricingContractModelExceptions`
- `GetPricingContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/pricingcontractmodel/commands
GET  /api/v1/pricingcontractmodel/{id}
GET  /api/v1/pricingcontractmodel/{id}/timeline
GET  /api/v1/pricingcontractmodel/{id}/evidence
GET  /api/v1/pricingcontractmodel/{id}/decisions
POST /api/v1/pricingcontractmodel/{id}/exceptions
POST /api/v1/pricingcontractmodel/{id}/corrections
```
...
|---|---|
| `pricingcontractmodel_aggregate` | authoritative subject |
| `pricingcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `pricingcontractmodel_relationship` | governed relationships |
| `pricingcontractmodel_decision` | binding Decisions and rationale |
| `pricingcontractmodel_evidence_link` | provenance and evidence relationships |
| `pricingcontractmodel_event_outbox` | transactional Event publication |
| `pricingcontractmodel_idempotency` | duplicate-write protection |
| `pricingcontractmodel_exception` | exception, claim, dispute, or hold |
| `pricingcontractmodel_correction` | correction and supersession lineage |
| `pricingcontractmodel_audit` | privileged action evidence |
