# Manufacturing — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-13-00` |
| Subject | `ManufacturingDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Manufacturing**.
...
|---|---|
| `ManufacturingDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateManufacturingDomain`
- `ValidateManufacturingDomain`
- `ApproveManufacturingDomain`
- `ActivateManufacturingDomain`
- `SuspendManufacturingDomain`
- `CorrectManufacturingDomain`
- `RetireManufacturingDomain`

Reference Events:

- `ManufacturingDomainCreated`
- `ManufacturingDomainValidated`
- `ManufacturingDomainApproved`
- `ManufacturingDomainActivated`
- `ManufacturingDomainSuspended`
- `ManufacturingDomainCorrected`
- `ManufacturingDomainRetired`

Reference queries:

- `GetManufacturingDomain`
- `ListManufacturingDomainRecords`
- `GetManufacturingDomainTimeline`
- `GetManufacturingDomainEvidence`
- `GetManufacturingDomainDecisionPackage`
- `GetManufacturingDomainExceptions`
- `GetManufacturingDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/manufacturingdomain/commands
GET  /api/v1/manufacturingdomain/{id}
GET  /api/v1/manufacturingdomain/{id}/timeline
GET  /api/v1/manufacturingdomain/{id}/evidence
GET  /api/v1/manufacturingdomain/{id}/decisions
POST /api/v1/manufacturingdomain/{id}/exceptions
POST /api/v1/manufacturingdomain/{id}/corrections
```
...
|---|---|
| `manufacturingdomain_aggregate` | authoritative subject |
| `manufacturingdomain_version` | immutable submitted, approved, issued, or signed versions |
| `manufacturingdomain_relationship` | governed relationships |
| `manufacturingdomain_decision` | binding Decisions and rationale |
| `manufacturingdomain_evidence_link` | provenance and evidence relationships |
| `manufacturingdomain_event_outbox` | transactional Event publication |
| `manufacturingdomain_idempotency` | duplicate-write protection |
| `manufacturingdomain_exception` | exception, claim, dispute, or hold |
| `manufacturingdomain_correction` | correction and supersession lineage |
| `manufacturingdomain_audit` | privileged action evidence |
