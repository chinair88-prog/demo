# Manufacturing — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-13-02` |
| Subject | `ManufacturingContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Manufacturing**.
...
|---|---|
| `ManufacturingContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ManufacturingContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ManufacturingContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateManufacturingContractModel`
- `ValidateManufacturingContractModel`
- `ApproveManufacturingContractModel`
- `ActivateManufacturingContractModel`
- `SuspendManufacturingContractModel`
- `CorrectManufacturingContractModel`
- `RetireManufacturingContractModel`

Reference Events:

- `ManufacturingContractModelCreated`
- `ManufacturingContractModelValidated`
- `ManufacturingContractModelApproved`
- `ManufacturingContractModelActivated`
- `ManufacturingContractModelSuspended`
- `ManufacturingContractModelCorrected`
- `ManufacturingContractModelRetired`

Reference queries:

- `GetManufacturingContractModel`
- `ListManufacturingContractModelRecords`
- `GetManufacturingContractModelTimeline`
- `GetManufacturingContractModelEvidence`
- `GetManufacturingContractModelDecisionPackage`
- `GetManufacturingContractModelExceptions`
- `GetManufacturingContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/manufacturingcontractmodel/commands
GET  /api/v1/manufacturingcontractmodel/{id}
GET  /api/v1/manufacturingcontractmodel/{id}/timeline
GET  /api/v1/manufacturingcontractmodel/{id}/evidence
GET  /api/v1/manufacturingcontractmodel/{id}/decisions
POST /api/v1/manufacturingcontractmodel/{id}/exceptions
POST /api/v1/manufacturingcontractmodel/{id}/corrections
```
...
|---|---|
| `manufacturingcontractmodel_aggregate` | authoritative subject |
| `manufacturingcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `manufacturingcontractmodel_relationship` | governed relationships |
| `manufacturingcontractmodel_decision` | binding Decisions and rationale |
| `manufacturingcontractmodel_evidence_link` | provenance and evidence relationships |
| `manufacturingcontractmodel_event_outbox` | transactional Event publication |
| `manufacturingcontractmodel_idempotency` | duplicate-write protection |
| `manufacturingcontractmodel_exception` | exception, claim, dispute, or hold |
| `manufacturingcontractmodel_correction` | correction and supersession lineage |
| `manufacturingcontractmodel_audit` | privileged action evidence |
