# Wallet — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-09-00` |
| Subject | `WalletDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Wallet**.
...
|---|---|
| `WalletDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWalletDomain`
- `ValidateWalletDomain`
- `ApproveWalletDomain`
- `ActivateWalletDomain`
- `SuspendWalletDomain`
- `CorrectWalletDomain`
- `RetireWalletDomain`
...
- `WalletDomainCreated`
- `WalletDomainValidated`
- `WalletDomainApproved`
- `WalletDomainActivated`
- `WalletDomainSuspended`
- `WalletDomainCorrected`
- `WalletDomainRetired`

Reference queries:

- `GetWalletDomain`
- `ListWalletDomainRecords`
- `GetWalletDomainTimeline`
- `GetWalletDomainEvidence`
- `GetWalletDomainDecisionPackage`
- `GetWalletDomainExceptions`
- `GetWalletDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/walletdomain/commands
GET  /api/v1/walletdomain/{id}
GET  /api/v1/walletdomain/{id}/timeline
GET  /api/v1/walletdomain/{id}/evidence
GET  /api/v1/walletdomain/{id}/decisions
POST /api/v1/walletdomain/{id}/exceptions
POST /api/v1/walletdomain/{id}/corrections
```
...
|---|---|
| `walletdomain_aggregate` | authoritative subject |
| `walletdomain_version` | immutable submitted, approved, issued, or signed versions |
| `walletdomain_relationship` | governed relationships |
| `walletdomain_decision` | binding Decisions and rationale |
| `walletdomain_evidence_link` | provenance and evidence relationships |
| `walletdomain_event_outbox` | transactional Event publication |
| `walletdomain_idempotency` | duplicate-write protection |
| `walletdomain_exception` | exception, claim, dispute, or hold |
| `walletdomain_correction` | correction and supersession lineage |
| `walletdomain_audit` | privileged action evidence |
