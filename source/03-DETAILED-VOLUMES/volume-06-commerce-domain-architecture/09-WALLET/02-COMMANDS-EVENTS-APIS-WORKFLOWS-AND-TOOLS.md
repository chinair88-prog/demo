# Wallet — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-09-02` |
| Subject | `WalletContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Wallet**.
...
|---|---|
| `WalletContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWalletContractModel`
- `ValidateWalletContractModel`
- `ApproveWalletContractModel`
- `ActivateWalletContractModel`
- `SuspendWalletContractModel`
- `CorrectWalletContractModel`
- `RetireWalletContractModel`

Reference Events:

- `WalletContractModelCreated`
- `WalletContractModelValidated`
- `WalletContractModelApproved`
- `WalletContractModelActivated`
- `WalletContractModelSuspended`
- `WalletContractModelCorrected`
- `WalletContractModelRetired`

Reference queries:

- `GetWalletContractModel`
- `ListWalletContractModelRecords`
- `GetWalletContractModelTimeline`
- `GetWalletContractModelEvidence`
- `GetWalletContractModelDecisionPackage`
- `GetWalletContractModelExceptions`
- `GetWalletContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/walletcontractmodel/commands
GET  /api/v1/walletcontractmodel/{id}
GET  /api/v1/walletcontractmodel/{id}/timeline
GET  /api/v1/walletcontractmodel/{id}/evidence
GET  /api/v1/walletcontractmodel/{id}/decisions
POST /api/v1/walletcontractmodel/{id}/exceptions
POST /api/v1/walletcontractmodel/{id}/corrections
```
...
|---|---|
| `walletcontractmodel_aggregate` | authoritative subject |
| `walletcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `walletcontractmodel_relationship` | governed relationships |
| `walletcontractmodel_decision` | binding Decisions and rationale |
| `walletcontractmodel_evidence_link` | provenance and evidence relationships |
| `walletcontractmodel_event_outbox` | transactional Event publication |
| `walletcontractmodel_idempotency` | duplicate-write protection |
| `walletcontractmodel_exception` | exception, claim, dispute, or hold |
| `walletcontractmodel_correction` | correction and supersession lineage |
| `walletcontractmodel_audit` | privileged action evidence |
