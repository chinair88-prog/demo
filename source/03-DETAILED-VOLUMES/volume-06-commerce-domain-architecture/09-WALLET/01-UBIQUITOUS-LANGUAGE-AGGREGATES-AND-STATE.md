# Wallet — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-09-01` |
| Subject | `WalletAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Wallet**.
...
|---|---|
| `WalletAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WalletAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWalletAggregateModel`
- `ValidateWalletAggregateModel`
- `ApproveWalletAggregateModel`
- `ActivateWalletAggregateModel`
- `SuspendWalletAggregateModel`
- `CorrectWalletAggregateModel`
- `RetireWalletAggregateModel`

Reference Events:

- `WalletAggregateModelCreated`
- `WalletAggregateModelValidated`
- `WalletAggregateModelApproved`
- `WalletAggregateModelActivated`
- `WalletAggregateModelSuspended`
- `WalletAggregateModelCorrected`
- `WalletAggregateModelRetired`

Reference queries:

- `GetWalletAggregateModel`
- `ListWalletAggregateModelRecords`
- `GetWalletAggregateModelTimeline`
- `GetWalletAggregateModelEvidence`
- `GetWalletAggregateModelDecisionPackage`
- `GetWalletAggregateModelExceptions`
- `GetWalletAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/walletaggregatemodel/commands
GET  /api/v1/walletaggregatemodel/{id}
GET  /api/v1/walletaggregatemodel/{id}/timeline
GET  /api/v1/walletaggregatemodel/{id}/evidence
GET  /api/v1/walletaggregatemodel/{id}/decisions
POST /api/v1/walletaggregatemodel/{id}/exceptions
POST /api/v1/walletaggregatemodel/{id}/corrections
```
...
|---|---|
| `walletaggregatemodel_aggregate` | authoritative subject |
| `walletaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `walletaggregatemodel_relationship` | governed relationships |
| `walletaggregatemodel_decision` | binding Decisions and rationale |
| `walletaggregatemodel_evidence_link` | provenance and evidence relationships |
| `walletaggregatemodel_event_outbox` | transactional Event publication |
| `walletaggregatemodel_idempotency` | duplicate-write protection |
| `walletaggregatemodel_exception` | exception, claim, dispute, or hold |
| `walletaggregatemodel_correction` | correction and supersession lineage |
| `walletaggregatemodel_audit` | privileged action evidence |
