# Wallet — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-09-03` |
| Subject | `WalletDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Wallet**.
...
|---|---|
| `WalletDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WalletDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWalletDataModel`
- `ValidateWalletDataModel`
- `ApproveWalletDataModel`
- `ActivateWalletDataModel`
- `SuspendWalletDataModel`
- `CorrectWalletDataModel`
- `RetireWalletDataModel`

Reference Events:

- `WalletDataModelCreated`
- `WalletDataModelValidated`
- `WalletDataModelApproved`
- `WalletDataModelActivated`
- `WalletDataModelSuspended`
- `WalletDataModelCorrected`
- `WalletDataModelRetired`

Reference queries:

- `GetWalletDataModel`
- `ListWalletDataModelRecords`
- `GetWalletDataModelTimeline`
- `GetWalletDataModelEvidence`
- `GetWalletDataModelDecisionPackage`
- `GetWalletDataModelExceptions`
- `GetWalletDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/walletdatamodel/commands
GET  /api/v1/walletdatamodel/{id}
GET  /api/v1/walletdatamodel/{id}/timeline
GET  /api/v1/walletdatamodel/{id}/evidence
GET  /api/v1/walletdatamodel/{id}/decisions
POST /api/v1/walletdatamodel/{id}/exceptions
POST /api/v1/walletdatamodel/{id}/corrections
```
...
|---|---|
| `walletdatamodel_aggregate` | authoritative subject |
| `walletdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `walletdatamodel_relationship` | governed relationships |
| `walletdatamodel_decision` | binding Decisions and rationale |
| `walletdatamodel_evidence_link` | provenance and evidence relationships |
| `walletdatamodel_event_outbox` | transactional Event publication |
| `walletdatamodel_idempotency` | duplicate-write protection |
| `walletdatamodel_exception` | exception, claim, dispute, or hold |
| `walletdatamodel_correction` | correction and supersession lineage |
| `walletdatamodel_audit` | privileged action evidence |
