# Quotation — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-05-03` |
| Subject | `QuotationDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Quotation**.
...
|---|---|
| `QuotationDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateQuotationDataModel`
- `ValidateQuotationDataModel`
- `ApproveQuotationDataModel`
- `ActivateQuotationDataModel`
- `SuspendQuotationDataModel`
- `CorrectQuotationDataModel`
- `RetireQuotationDataModel`

Reference Events:

- `QuotationDataModelCreated`
- `QuotationDataModelValidated`
- `QuotationDataModelApproved`
- `QuotationDataModelActivated`
- `QuotationDataModelSuspended`
- `QuotationDataModelCorrected`
- `QuotationDataModelRetired`

Reference queries:

- `GetQuotationDataModel`
- `ListQuotationDataModelRecords`
- `GetQuotationDataModelTimeline`
- `GetQuotationDataModelEvidence`
- `GetQuotationDataModelDecisionPackage`
- `GetQuotationDataModelExceptions`
- `GetQuotationDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/quotationdatamodel/commands
GET  /api/v1/quotationdatamodel/{id}
GET  /api/v1/quotationdatamodel/{id}/timeline
GET  /api/v1/quotationdatamodel/{id}/evidence
GET  /api/v1/quotationdatamodel/{id}/decisions
POST /api/v1/quotationdatamodel/{id}/exceptions
POST /api/v1/quotationdatamodel/{id}/corrections
```
...
|---|---|
| `quotationdatamodel_aggregate` | authoritative subject |
| `quotationdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `quotationdatamodel_relationship` | governed relationships |
| `quotationdatamodel_decision` | binding Decisions and rationale |
| `quotationdatamodel_evidence_link` | provenance and evidence relationships |
| `quotationdatamodel_event_outbox` | transactional Event publication |
| `quotationdatamodel_idempotency` | duplicate-write protection |
| `quotationdatamodel_exception` | exception, claim, dispute, or hold |
| `quotationdatamodel_correction` | correction and supersession lineage |
| `quotationdatamodel_audit` | privileged action evidence |
