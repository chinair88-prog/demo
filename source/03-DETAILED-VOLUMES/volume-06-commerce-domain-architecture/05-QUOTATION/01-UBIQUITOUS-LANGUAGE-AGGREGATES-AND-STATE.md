# Quotation — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-05-01` |
| Subject | `QuotationAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Quotation**.
...
|---|---|
| `QuotationAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QuotationAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
QuotationAggregateModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateQuotationAggregateModel`
- `ValidateQuotationAggregateModel`
- `ApproveQuotationAggregateModel`
- `ActivateQuotationAggregateModel`
- `SuspendQuotationAggregateModel`
- `CorrectQuotationAggregateModel`
- `RetireQuotationAggregateModel`

Reference Events:

- `QuotationAggregateModelCreated`
- `QuotationAggregateModelValidated`
- `QuotationAggregateModelApproved`
- `QuotationAggregateModelActivated`
- `QuotationAggregateModelSuspended`
- `QuotationAggregateModelCorrected`
- `QuotationAggregateModelRetired`

Reference queries:

- `GetQuotationAggregateModel`
- `ListQuotationAggregateModelRecords`
- `GetQuotationAggregateModelTimeline`
- `GetQuotationAggregateModelEvidence`
- `GetQuotationAggregateModelDecisionPackage`
- `GetQuotationAggregateModelExceptions`
- `GetQuotationAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/quotationaggregatemodel/commands
GET  /api/v1/quotationaggregatemodel/{id}
GET  /api/v1/quotationaggregatemodel/{id}/timeline
GET  /api/v1/quotationaggregatemodel/{id}/evidence
GET  /api/v1/quotationaggregatemodel/{id}/decisions
POST /api/v1/quotationaggregatemodel/{id}/exceptions
POST /api/v1/quotationaggregatemodel/{id}/corrections
```
...
|---|---|
| `quotationaggregatemodel_aggregate` | authoritative subject |
| `quotationaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `quotationaggregatemodel_relationship` | governed relationships |
| `quotationaggregatemodel_decision` | binding Decisions and rationale |
| `quotationaggregatemodel_evidence_link` | provenance and evidence relationships |
| `quotationaggregatemodel_event_outbox` | transactional Event publication |
| `quotationaggregatemodel_idempotency` | duplicate-write protection |
| `quotationaggregatemodel_exception` | exception, claim, dispute, or hold |
| `quotationaggregatemodel_correction` | correction and supersession lineage |
| `quotationaggregatemodel_audit` | privileged action evidence |
