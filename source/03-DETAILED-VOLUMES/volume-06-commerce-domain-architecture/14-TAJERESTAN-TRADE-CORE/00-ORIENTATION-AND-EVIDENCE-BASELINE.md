# Tajerestan Trade Core — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-14-00` |
| Subject | `TajerestanTradeCoreDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Tajerestan Trade Core**.
...
|---|---|
| `TajerestanTradeCoreDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TajerestanTradeCoreDomain {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTajerestanTradeCoreDomain`
- `ValidateTajerestanTradeCoreDomain`
- `ApproveTajerestanTradeCoreDomain`
- `ActivateTajerestanTradeCoreDomain`
- `SuspendTajerestanTradeCoreDomain`
- `CorrectTajerestanTradeCoreDomain`
- `RetireTajerestanTradeCoreDomain`

Reference Events:

- `TajerestanTradeCoreDomainCreated`
- `TajerestanTradeCoreDomainValidated`
- `TajerestanTradeCoreDomainApproved`
- `TajerestanTradeCoreDomainActivated`
- `TajerestanTradeCoreDomainSuspended`
- `TajerestanTradeCoreDomainCorrected`
- `TajerestanTradeCoreDomainRetired`

Reference queries:

- `GetTajerestanTradeCoreDomain`
- `ListTajerestanTradeCoreDomainRecords`
- `GetTajerestanTradeCoreDomainTimeline`
- `GetTajerestanTradeCoreDomainEvidence`
- `GetTajerestanTradeCoreDomainDecisionPackage`
- `GetTajerestanTradeCoreDomainExceptions`
- `GetTajerestanTradeCoreDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/tajerestantradecoredomain/commands
GET  /api/v1/tajerestantradecoredomain/{id}
GET  /api/v1/tajerestantradecoredomain/{id}/timeline
GET  /api/v1/tajerestantradecoredomain/{id}/evidence
GET  /api/v1/tajerestantradecoredomain/{id}/decisions
POST /api/v1/tajerestantradecoredomain/{id}/exceptions
POST /api/v1/tajerestantradecoredomain/{id}/corrections
```
...
|---|---|
| `tajerestantradecoredomain_aggregate` | authoritative subject |
| `tajerestantradecoredomain_version` | immutable submitted, approved, issued, or signed versions |
| `tajerestantradecoredomain_relationship` | governed relationships |
| `tajerestantradecoredomain_decision` | binding Decisions and rationale |
| `tajerestantradecoredomain_evidence_link` | provenance and evidence relationships |
| `tajerestantradecoredomain_event_outbox` | transactional Event publication |
| `tajerestantradecoredomain_idempotency` | duplicate-write protection |
| `tajerestantradecoredomain_exception` | exception, claim, dispute, or hold |
| `tajerestantradecoredomain_correction` | correction and supersession lineage |
| `tajerestantradecoredomain_audit` | privileged action evidence |
