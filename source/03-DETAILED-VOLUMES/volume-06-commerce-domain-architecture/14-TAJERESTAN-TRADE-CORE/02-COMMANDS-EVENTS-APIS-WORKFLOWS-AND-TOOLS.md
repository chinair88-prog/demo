# Tajerestan Trade Core — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-14-02` |
| Subject | `TajerestanTradeCoreContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Tajerestan Trade Core**.
...
|---|---|
| `TajerestanTradeCoreContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TajerestanTradeCoreContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTajerestanTradeCoreContractModel`
- `ValidateTajerestanTradeCoreContractModel`
- `ApproveTajerestanTradeCoreContractModel`
- `ActivateTajerestanTradeCoreContractModel`
- `SuspendTajerestanTradeCoreContractModel`
- `CorrectTajerestanTradeCoreContractModel`
- `RetireTajerestanTradeCoreContractModel`

Reference Events:

- `TajerestanTradeCoreContractModelCreated`
- `TajerestanTradeCoreContractModelValidated`
- `TajerestanTradeCoreContractModelApproved`
- `TajerestanTradeCoreContractModelActivated`
- `TajerestanTradeCoreContractModelSuspended`
- `TajerestanTradeCoreContractModelCorrected`
- `TajerestanTradeCoreContractModelRetired`

Reference queries:

- `GetTajerestanTradeCoreContractModel`
- `ListTajerestanTradeCoreContractModelRecords`
- `GetTajerestanTradeCoreContractModelTimeline`
- `GetTajerestanTradeCoreContractModelEvidence`
- `GetTajerestanTradeCoreContractModelDecisionPackage`
- `GetTajerestanTradeCoreContractModelExceptions`
- `GetTajerestanTradeCoreContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/tajerestantradecorecontractmodel/commands
GET  /api/v1/tajerestantradecorecontractmodel/{id}
GET  /api/v1/tajerestantradecorecontractmodel/{id}/timeline
GET  /api/v1/tajerestantradecorecontractmodel/{id}/evidence
GET  /api/v1/tajerestantradecorecontractmodel/{id}/decisions
POST /api/v1/tajerestantradecorecontractmodel/{id}/exceptions
POST /api/v1/tajerestantradecorecontractmodel/{id}/corrections
```
...
|---|---|
| `tajerestantradecorecontractmodel_aggregate` | authoritative subject |
| `tajerestantradecorecontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `tajerestantradecorecontractmodel_relationship` | governed relationships |
| `tajerestantradecorecontractmodel_decision` | binding Decisions and rationale |
| `tajerestantradecorecontractmodel_evidence_link` | provenance and evidence relationships |
| `tajerestantradecorecontractmodel_event_outbox` | transactional Event publication |
| `tajerestantradecorecontractmodel_idempotency` | duplicate-write protection |
| `tajerestantradecorecontractmodel_exception` | exception, claim, dispute, or hold |
| `tajerestantradecorecontractmodel_correction` | correction and supersession lineage |
| `tajerestantradecorecontractmodel_audit` | privileged action evidence |
