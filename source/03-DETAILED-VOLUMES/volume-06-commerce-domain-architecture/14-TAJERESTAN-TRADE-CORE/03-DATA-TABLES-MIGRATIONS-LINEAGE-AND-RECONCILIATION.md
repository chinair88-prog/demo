# Tajerestan Trade Core — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-14-03` |
| Subject | `TajerestanTradeCoreDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Tajerestan Trade Core**.
...
|---|---|
| `TajerestanTradeCoreDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TajerestanTradeCoreDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TajerestanTradeCoreDataModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTajerestanTradeCoreDataModel`
- `ValidateTajerestanTradeCoreDataModel`
- `ApproveTajerestanTradeCoreDataModel`
- `ActivateTajerestanTradeCoreDataModel`
- `SuspendTajerestanTradeCoreDataModel`
- `CorrectTajerestanTradeCoreDataModel`
- `RetireTajerestanTradeCoreDataModel`

Reference Events:

- `TajerestanTradeCoreDataModelCreated`
- `TajerestanTradeCoreDataModelValidated`
- `TajerestanTradeCoreDataModelApproved`
- `TajerestanTradeCoreDataModelActivated`
- `TajerestanTradeCoreDataModelSuspended`
- `TajerestanTradeCoreDataModelCorrected`
- `TajerestanTradeCoreDataModelRetired`

Reference queries:

- `GetTajerestanTradeCoreDataModel`
- `ListTajerestanTradeCoreDataModelRecords`
- `GetTajerestanTradeCoreDataModelTimeline`
- `GetTajerestanTradeCoreDataModelEvidence`
- `GetTajerestanTradeCoreDataModelDecisionPackage`
- `GetTajerestanTradeCoreDataModelExceptions`
- `GetTajerestanTradeCoreDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/tajerestantradecoredatamodel/commands
GET  /api/v1/tajerestantradecoredatamodel/{id}
GET  /api/v1/tajerestantradecoredatamodel/{id}/timeline
GET  /api/v1/tajerestantradecoredatamodel/{id}/evidence
GET  /api/v1/tajerestantradecoredatamodel/{id}/decisions
POST /api/v1/tajerestantradecoredatamodel/{id}/exceptions
POST /api/v1/tajerestantradecoredatamodel/{id}/corrections
```
...
|---|---|
| `tajerestantradecoredatamodel_aggregate` | authoritative subject |
| `tajerestantradecoredatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `tajerestantradecoredatamodel_relationship` | governed relationships |
| `tajerestantradecoredatamodel_decision` | binding Decisions and rationale |
| `tajerestantradecoredatamodel_evidence_link` | provenance and evidence relationships |
| `tajerestantradecoredatamodel_event_outbox` | transactional Event publication |
| `tajerestantradecoredatamodel_idempotency` | duplicate-write protection |
| `tajerestantradecoredatamodel_exception` | exception, claim, dispute, or hold |
| `tajerestantradecoredatamodel_correction` | correction and supersession lineage |
| `tajerestantradecoredatamodel_audit` | privileged action evidence |
