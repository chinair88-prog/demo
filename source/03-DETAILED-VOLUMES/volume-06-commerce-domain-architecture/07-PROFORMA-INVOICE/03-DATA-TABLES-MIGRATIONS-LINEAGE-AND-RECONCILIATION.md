# Proforma Invoice — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-07-03` |
| Subject | `ProformaInvoiceDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Proforma Invoice**.
...
|---|---|
| `ProformaInvoiceDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ProformaInvoiceDataModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateProformaInvoiceDataModel`
- `ValidateProformaInvoiceDataModel`
- `ApproveProformaInvoiceDataModel`
- `ActivateProformaInvoiceDataModel`
- `SuspendProformaInvoiceDataModel`
- `CorrectProformaInvoiceDataModel`
- `RetireProformaInvoiceDataModel`

Reference Events:

- `ProformaInvoiceDataModelCreated`
- `ProformaInvoiceDataModelValidated`
- `ProformaInvoiceDataModelApproved`
- `ProformaInvoiceDataModelActivated`
- `ProformaInvoiceDataModelSuspended`
- `ProformaInvoiceDataModelCorrected`
- `ProformaInvoiceDataModelRetired`

Reference queries:

- `GetProformaInvoiceDataModel`
- `ListProformaInvoiceDataModelRecords`
- `GetProformaInvoiceDataModelTimeline`
- `GetProformaInvoiceDataModelEvidence`
- `GetProformaInvoiceDataModelDecisionPackage`
- `GetProformaInvoiceDataModelExceptions`
- `GetProformaInvoiceDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/proformainvoicedatamodel/commands
GET  /api/v1/proformainvoicedatamodel/{id}
GET  /api/v1/proformainvoicedatamodel/{id}/timeline
GET  /api/v1/proformainvoicedatamodel/{id}/evidence
GET  /api/v1/proformainvoicedatamodel/{id}/decisions
POST /api/v1/proformainvoicedatamodel/{id}/exceptions
POST /api/v1/proformainvoicedatamodel/{id}/corrections
```
...
|---|---|
| `proformainvoicedatamodel_aggregate` | authoritative subject |
| `proformainvoicedatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `proformainvoicedatamodel_relationship` | governed relationships |
| `proformainvoicedatamodel_decision` | binding Decisions and rationale |
| `proformainvoicedatamodel_evidence_link` | provenance and evidence relationships |
| `proformainvoicedatamodel_event_outbox` | transactional Event publication |
| `proformainvoicedatamodel_idempotency` | duplicate-write protection |
| `proformainvoicedatamodel_exception` | exception, claim, dispute, or hold |
| `proformainvoicedatamodel_correction` | correction and supersession lineage |
| `proformainvoicedatamodel_audit` | privileged action evidence |
