# Proforma Invoice — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-07-02` |
| Subject | `ProformaInvoiceContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Proforma Invoice**.
...
|---|---|
| `ProformaInvoiceContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ProformaInvoiceContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateProformaInvoiceContractModel`
- `ValidateProformaInvoiceContractModel`
- `ApproveProformaInvoiceContractModel`
- `ActivateProformaInvoiceContractModel`
- `SuspendProformaInvoiceContractModel`
- `CorrectProformaInvoiceContractModel`
- `RetireProformaInvoiceContractModel`

Reference Events:

- `ProformaInvoiceContractModelCreated`
- `ProformaInvoiceContractModelValidated`
- `ProformaInvoiceContractModelApproved`
- `ProformaInvoiceContractModelActivated`
- `ProformaInvoiceContractModelSuspended`
- `ProformaInvoiceContractModelCorrected`
- `ProformaInvoiceContractModelRetired`

Reference queries:

- `GetProformaInvoiceContractModel`
- `ListProformaInvoiceContractModelRecords`
- `GetProformaInvoiceContractModelTimeline`
- `GetProformaInvoiceContractModelEvidence`
- `GetProformaInvoiceContractModelDecisionPackage`
- `GetProformaInvoiceContractModelExceptions`
- `GetProformaInvoiceContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/proformainvoicecontractmodel/commands
GET  /api/v1/proformainvoicecontractmodel/{id}
GET  /api/v1/proformainvoicecontractmodel/{id}/timeline
GET  /api/v1/proformainvoicecontractmodel/{id}/evidence
GET  /api/v1/proformainvoicecontractmodel/{id}/decisions
POST /api/v1/proformainvoicecontractmodel/{id}/exceptions
POST /api/v1/proformainvoicecontractmodel/{id}/corrections
```
...
|---|---|
| `proformainvoicecontractmodel_aggregate` | authoritative subject |
| `proformainvoicecontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `proformainvoicecontractmodel_relationship` | governed relationships |
| `proformainvoicecontractmodel_decision` | binding Decisions and rationale |
| `proformainvoicecontractmodel_evidence_link` | provenance and evidence relationships |
| `proformainvoicecontractmodel_event_outbox` | transactional Event publication |
| `proformainvoicecontractmodel_idempotency` | duplicate-write protection |
| `proformainvoicecontractmodel_exception` | exception, claim, dispute, or hold |
| `proformainvoicecontractmodel_correction` | correction and supersession lineage |
| `proformainvoicecontractmodel_audit` | privileged action evidence |
