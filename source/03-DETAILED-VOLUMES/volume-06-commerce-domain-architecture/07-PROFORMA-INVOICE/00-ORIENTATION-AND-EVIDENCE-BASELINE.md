# Proforma Invoice — Orientation and Evidence Baseline

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-07-00` |
| Subject | `ProformaInvoiceDomain` |
...
This chapter defines how GTOS shall **define the scope, non-goals, module and database evidence requirements, ownership boundaries, current status, and target responsibilities of Proforma Invoice**.
...
|---|---|
| `ProformaInvoiceDomain` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDomainVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDomainDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDomainEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProformaInvoiceDomainException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ProformaInvoiceDomain {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateProformaInvoiceDomain`
- `ValidateProformaInvoiceDomain`
- `ApproveProformaInvoiceDomain`
- `ActivateProformaInvoiceDomain`
- `SuspendProformaInvoiceDomain`
- `CorrectProformaInvoiceDomain`
- `RetireProformaInvoiceDomain`

Reference Events:

- `ProformaInvoiceDomainCreated`
- `ProformaInvoiceDomainValidated`
- `ProformaInvoiceDomainApproved`
- `ProformaInvoiceDomainActivated`
- `ProformaInvoiceDomainSuspended`
- `ProformaInvoiceDomainCorrected`
- `ProformaInvoiceDomainRetired`

Reference queries:

- `GetProformaInvoiceDomain`
- `ListProformaInvoiceDomainRecords`
- `GetProformaInvoiceDomainTimeline`
- `GetProformaInvoiceDomainEvidence`
- `GetProformaInvoiceDomainDecisionPackage`
- `GetProformaInvoiceDomainExceptions`
- `GetProformaInvoiceDomainAuditTrail`

Reference API surface:

```text
POST /api/v1/proformainvoicedomain/commands
GET  /api/v1/proformainvoicedomain/{id}
GET  /api/v1/proformainvoicedomain/{id}/timeline
GET  /api/v1/proformainvoicedomain/{id}/evidence
GET  /api/v1/proformainvoicedomain/{id}/decisions
POST /api/v1/proformainvoicedomain/{id}/exceptions
POST /api/v1/proformainvoicedomain/{id}/corrections
```
...
|---|---|
| `proformainvoicedomain_aggregate` | authoritative subject |
| `proformainvoicedomain_version` | immutable submitted, approved, issued, or signed versions |
| `proformainvoicedomain_relationship` | governed relationships |
| `proformainvoicedomain_decision` | binding Decisions and rationale |
| `proformainvoicedomain_evidence_link` | provenance and evidence relationships |
| `proformainvoicedomain_event_outbox` | transactional Event publication |
| `proformainvoicedomain_idempotency` | duplicate-write protection |
| `proformainvoicedomain_exception` | exception, claim, dispute, or hold |
| `proformainvoicedomain_correction` | correction and supersession lineage |
| `proformainvoicedomain_audit` | privileged action evidence |
