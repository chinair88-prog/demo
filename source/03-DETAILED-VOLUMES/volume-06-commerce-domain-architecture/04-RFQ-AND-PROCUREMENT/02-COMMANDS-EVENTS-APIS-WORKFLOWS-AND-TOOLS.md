# RFQ and Procurement — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-04-02` |
| Subject | `RFQandProcurementContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for RFQ and Procurement**.
...
|---|---|
| `RFQandProcurementContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RFQandProcurementContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RFQandProcurementContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RFQandProcurementContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RFQandProcurementContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
RFQandProcurementContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateRFQandProcurementContractModel`
- `ValidateRFQandProcurementContractModel`
- `ApproveRFQandProcurementContractModel`
- `ActivateRFQandProcurementContractModel`
- `SuspendRFQandProcurementContractModel`
- `CorrectRFQandProcurementContractModel`
- `RetireRFQandProcurementContractModel`

Reference Events:

- `RFQandProcurementContractModelCreated`
- `RFQandProcurementContractModelValidated`
- `RFQandProcurementContractModelApproved`
- `RFQandProcurementContractModelActivated`
- `RFQandProcurementContractModelSuspended`
- `RFQandProcurementContractModelCorrected`
- `RFQandProcurementContractModelRetired`

Reference queries:

- `GetRFQandProcurementContractModel`
- `ListRFQandProcurementContractModelRecords`
- `GetRFQandProcurementContractModelTimeline`
- `GetRFQandProcurementContractModelEvidence`
- `GetRFQandProcurementContractModelDecisionPackage`
- `GetRFQandProcurementContractModelExceptions`
- `GetRFQandProcurementContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/rfqandprocurementcontractmodel/commands
GET  /api/v1/rfqandprocurementcontractmodel/{id}
GET  /api/v1/rfqandprocurementcontractmodel/{id}/timeline
GET  /api/v1/rfqandprocurementcontractmodel/{id}/evidence
GET  /api/v1/rfqandprocurementcontractmodel/{id}/decisions
POST /api/v1/rfqandprocurementcontractmodel/{id}/exceptions
POST /api/v1/rfqandprocurementcontractmodel/{id}/corrections
```
...
|---|---|
| `rfqandprocurementcontractmodel_aggregate` | authoritative subject |
| `rfqandprocurementcontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `rfqandprocurementcontractmodel_relationship` | governed relationships |
| `rfqandprocurementcontractmodel_decision` | binding Decisions and rationale |
| `rfqandprocurementcontractmodel_evidence_link` | provenance and evidence relationships |
| `rfqandprocurementcontractmodel_event_outbox` | transactional Event publication |
| `rfqandprocurementcontractmodel_idempotency` | duplicate-write protection |
| `rfqandprocurementcontractmodel_exception` | exception, claim, dispute, or hold |
| `rfqandprocurementcontractmodel_correction` | correction and supersession lineage |
| `rfqandprocurementcontractmodel_audit` | privileged action evidence |
