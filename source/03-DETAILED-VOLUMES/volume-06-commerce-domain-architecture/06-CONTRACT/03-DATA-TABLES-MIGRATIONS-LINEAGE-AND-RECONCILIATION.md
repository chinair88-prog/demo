# Contract — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-06-03` |
| Subject | `ContractDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Contract**.
...
|---|---|
| `ContractDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateContractDataModel`
- `ValidateContractDataModel`
- `ApproveContractDataModel`
- `ActivateContractDataModel`
- `SuspendContractDataModel`
- `CorrectContractDataModel`
- `RetireContractDataModel`

Reference Events:

- `ContractDataModelCreated`
- `ContractDataModelValidated`
- `ContractDataModelApproved`
- `ContractDataModelActivated`
- `ContractDataModelSuspended`
- `ContractDataModelCorrected`
- `ContractDataModelRetired`

Reference queries:

- `GetContractDataModel`
- `ListContractDataModelRecords`
- `GetContractDataModelTimeline`
- `GetContractDataModelEvidence`
- `GetContractDataModelDecisionPackage`
- `GetContractDataModelExceptions`
- `GetContractDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/contractdatamodel/commands
GET  /api/v1/contractdatamodel/{id}
GET  /api/v1/contractdatamodel/{id}/timeline
GET  /api/v1/contractdatamodel/{id}/evidence
GET  /api/v1/contractdatamodel/{id}/decisions
POST /api/v1/contractdatamodel/{id}/exceptions
POST /api/v1/contractdatamodel/{id}/corrections
```
...
|---|---|
| `contractdatamodel_aggregate` | authoritative subject |
| `contractdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `contractdatamodel_relationship` | governed relationships |
| `contractdatamodel_decision` | binding Decisions and rationale |
| `contractdatamodel_evidence_link` | provenance and evidence relationships |
| `contractdatamodel_event_outbox` | transactional Event publication |
| `contractdatamodel_idempotency` | duplicate-write protection |
| `contractdatamodel_exception` | exception, claim, dispute, or hold |
| `contractdatamodel_correction` | correction and supersession lineage |
| `contractdatamodel_audit` | privileged action evidence |
