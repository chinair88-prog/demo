# Contract — Ubiquitous Language, Aggregates, and State

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-06-01` |
| Subject | `ContractAggregateModel` |
...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for Contract**.
...
|---|---|
| `ContractAggregateModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractAggregateModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractAggregateModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractAggregateModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContractAggregateModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateContractAggregateModel`
- `ValidateContractAggregateModel`
- `ApproveContractAggregateModel`
- `ActivateContractAggregateModel`
- `SuspendContractAggregateModel`
- `CorrectContractAggregateModel`
- `RetireContractAggregateModel`

Reference Events:

- `ContractAggregateModelCreated`
- `ContractAggregateModelValidated`
- `ContractAggregateModelApproved`
- `ContractAggregateModelActivated`
- `ContractAggregateModelSuspended`
- `ContractAggregateModelCorrected`
- `ContractAggregateModelRetired`

Reference queries:

- `GetContractAggregateModel`
- `ListContractAggregateModelRecords`
- `GetContractAggregateModelTimeline`
- `GetContractAggregateModelEvidence`
- `GetContractAggregateModelDecisionPackage`
- `GetContractAggregateModelExceptions`
- `GetContractAggregateModelAuditTrail`

Reference API surface:

```text
POST /api/v1/contractaggregatemodel/commands
GET  /api/v1/contractaggregatemodel/{id}
GET  /api/v1/contractaggregatemodel/{id}/timeline
GET  /api/v1/contractaggregatemodel/{id}/evidence
GET  /api/v1/contractaggregatemodel/{id}/decisions
POST /api/v1/contractaggregatemodel/{id}/exceptions
POST /api/v1/contractaggregatemodel/{id}/corrections
```
...
|---|---|
| `contractaggregatemodel_aggregate` | authoritative subject |
| `contractaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `contractaggregatemodel_relationship` | governed relationships |
| `contractaggregatemodel_decision` | binding Decisions and rationale |
| `contractaggregatemodel_evidence_link` | provenance and evidence relationships |
| `contractaggregatemodel_event_outbox` | transactional Event publication |
| `contractaggregatemodel_idempotency` | duplicate-write protection |
| `contractaggregatemodel_exception` | exception, claim, dispute, or hold |
| `contractaggregatemodel_correction` | correction and supersession lineage |
| `contractaggregatemodel_audit` | privileged action evidence |
