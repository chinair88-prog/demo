# Marketplace — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-02-02` |
| Subject | `MarketplaceContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Marketplace**.
...
|---|---|
| `MarketplaceContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MarketplaceContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
MarketplaceContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateMarketplaceContractModel`
- `ValidateMarketplaceContractModel`
- `ApproveMarketplaceContractModel`
- `ActivateMarketplaceContractModel`
- `SuspendMarketplaceContractModel`
- `CorrectMarketplaceContractModel`
- `RetireMarketplaceContractModel`

Reference Events:

- `MarketplaceContractModelCreated`
- `MarketplaceContractModelValidated`
- `MarketplaceContractModelApproved`
- `MarketplaceContractModelActivated`
- `MarketplaceContractModelSuspended`
- `MarketplaceContractModelCorrected`
- `MarketplaceContractModelRetired`

Reference queries:

- `GetMarketplaceContractModel`
- `ListMarketplaceContractModelRecords`
- `GetMarketplaceContractModelTimeline`
- `GetMarketplaceContractModelEvidence`
- `GetMarketplaceContractModelDecisionPackage`
- `GetMarketplaceContractModelExceptions`
- `GetMarketplaceContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/marketplacecontractmodel/commands
GET  /api/v1/marketplacecontractmodel/{id}
GET  /api/v1/marketplacecontractmodel/{id}/timeline
GET  /api/v1/marketplacecontractmodel/{id}/evidence
GET  /api/v1/marketplacecontractmodel/{id}/decisions
POST /api/v1/marketplacecontractmodel/{id}/exceptions
POST /api/v1/marketplacecontractmodel/{id}/corrections
```
...
|---|---|
| `marketplacecontractmodel_aggregate` | authoritative subject |
| `marketplacecontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `marketplacecontractmodel_relationship` | governed relationships |
| `marketplacecontractmodel_decision` | binding Decisions and rationale |
| `marketplacecontractmodel_evidence_link` | provenance and evidence relationships |
| `marketplacecontractmodel_event_outbox` | transactional Event publication |
| `marketplacecontractmodel_idempotency` | duplicate-write protection |
| `marketplacecontractmodel_exception` | exception, claim, dispute, or hold |
| `marketplacecontractmodel_correction` | correction and supersession lineage |
| `marketplacecontractmodel_audit` | privileged action evidence |
