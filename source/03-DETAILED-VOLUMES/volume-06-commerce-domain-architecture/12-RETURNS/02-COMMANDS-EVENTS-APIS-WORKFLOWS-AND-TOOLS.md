# Returns — Commands, Events, APIs, Workflows, and Tools

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-12-02` |
| Subject | `ReturnsContractModel` |
...
This chapter defines how GTOS shall **define typed Commands, completed-fact Events, REST/gRPC/BFF contracts, long-running workflows, compensations, provider adapters, and AI Tools for Returns**.
...
|---|---|
| `ReturnsContractModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsContractModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsContractModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsContractModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsContractModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ReturnsContractModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateReturnsContractModel`
- `ValidateReturnsContractModel`
- `ApproveReturnsContractModel`
- `ActivateReturnsContractModel`
- `SuspendReturnsContractModel`
- `CorrectReturnsContractModel`
- `RetireReturnsContractModel`

Reference Events:

- `ReturnsContractModelCreated`
- `ReturnsContractModelValidated`
- `ReturnsContractModelApproved`
- `ReturnsContractModelActivated`
- `ReturnsContractModelSuspended`
- `ReturnsContractModelCorrected`
- `ReturnsContractModelRetired`

Reference queries:

- `GetReturnsContractModel`
- `ListReturnsContractModelRecords`
- `GetReturnsContractModelTimeline`
- `GetReturnsContractModelEvidence`
- `GetReturnsContractModelDecisionPackage`
- `GetReturnsContractModelExceptions`
- `GetReturnsContractModelAuditTrail`

Reference API surface:

```text
POST /api/v1/returnscontractmodel/commands
GET  /api/v1/returnscontractmodel/{id}
GET  /api/v1/returnscontractmodel/{id}/timeline
GET  /api/v1/returnscontractmodel/{id}/evidence
GET  /api/v1/returnscontractmodel/{id}/decisions
POST /api/v1/returnscontractmodel/{id}/exceptions
POST /api/v1/returnscontractmodel/{id}/corrections
```
...
|---|---|
| `returnscontractmodel_aggregate` | authoritative subject |
| `returnscontractmodel_version` | immutable submitted, approved, issued, or signed versions |
| `returnscontractmodel_relationship` | governed relationships |
| `returnscontractmodel_decision` | binding Decisions and rationale |
| `returnscontractmodel_evidence_link` | provenance and evidence relationships |
| `returnscontractmodel_event_outbox` | transactional Event publication |
| `returnscontractmodel_idempotency` | duplicate-write protection |
| `returnscontractmodel_exception` | exception, claim, dispute, or hold |
| `returnscontractmodel_correction` | correction and supersession lineage |
| `returnscontractmodel_audit` | privileged action evidence |
