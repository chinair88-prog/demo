# Returns — Data, Tables, Migrations, Lineage, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `6` |
| Chapter ID | `V06-12-03` |
| Subject | `ReturnsDataModel` |
...
This chapter defines how GTOS shall **define database ownership, schemas, table families, keys, constraints, indexes, migrations, lineage, projections, reconciliation, retention, backup, and correction for Returns**.
...
|---|---|
| `ReturnsDataModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDataModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDataModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDataModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ReturnsDataModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateReturnsDataModel`
- `ValidateReturnsDataModel`
- `ApproveReturnsDataModel`
- `ActivateReturnsDataModel`
- `SuspendReturnsDataModel`
- `CorrectReturnsDataModel`
- `RetireReturnsDataModel`

Reference Events:

- `ReturnsDataModelCreated`
- `ReturnsDataModelValidated`
- `ReturnsDataModelApproved`
- `ReturnsDataModelActivated`
- `ReturnsDataModelSuspended`
- `ReturnsDataModelCorrected`
- `ReturnsDataModelRetired`

Reference queries:

- `GetReturnsDataModel`
- `ListReturnsDataModelRecords`
- `GetReturnsDataModelTimeline`
- `GetReturnsDataModelEvidence`
- `GetReturnsDataModelDecisionPackage`
- `GetReturnsDataModelExceptions`
- `GetReturnsDataModelAuditTrail`

Reference API surface:

```text
POST /api/v1/returnsdatamodel/commands
GET  /api/v1/returnsdatamodel/{id}
GET  /api/v1/returnsdatamodel/{id}/timeline
GET  /api/v1/returnsdatamodel/{id}/evidence
GET  /api/v1/returnsdatamodel/{id}/decisions
POST /api/v1/returnsdatamodel/{id}/exceptions
POST /api/v1/returnsdatamodel/{id}/corrections
```
...
|---|---|
| `returnsdatamodel_aggregate` | authoritative subject |
| `returnsdatamodel_version` | immutable submitted, approved, issued, or signed versions |
| `returnsdatamodel_relationship` | governed relationships |
| `returnsdatamodel_decision` | binding Decisions and rationale |
| `returnsdatamodel_evidence_link` | provenance and evidence relationships |
| `returnsdatamodel_event_outbox` | transactional Event publication |
| `returnsdatamodel_idempotency` | duplicate-write protection |
| `returnsdatamodel_exception` | exception, claim, dispute, or hold |
| `returnsdatamodel_correction` | correction and supersession lineage |
| `returnsdatamodel_audit` | privileged action evidence |
