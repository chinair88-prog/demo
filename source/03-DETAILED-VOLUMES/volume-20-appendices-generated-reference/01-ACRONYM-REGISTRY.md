...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Acronym Registry**.
...
|---|---|
| `AcronymRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AcronymRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AcronymRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AcronymRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AcronymRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAcronymRegistry`
- `ValidateAcronymRegistry`
- `ApproveAcronymRegistry`
- `ActivateAcronymRegistry`
- `SuspendAcronymRegistry`
- `CorrectAcronymRegistry`
- `RetireAcronymRegistry`

Reference Events:

- `AcronymRegistryCreated`
- `AcronymRegistryValidated`
- `AcronymRegistryApproved`
- `AcronymRegistryActivated`
- `AcronymRegistrySuspended`
- `AcronymRegistryCorrected`
- `AcronymRegistryRetired`

Reference queries:

- `GetAcronymRegistry`
- `ListAcronymRegistryRecords`
- `GetAcronymRegistryTimeline`
- `GetAcronymRegistryEvidence`
- `GetAcronymRegistryDecisionPackage`
- `GetAcronymRegistryExceptions`
- `GetAcronymRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/acronymregistry/commands
GET  /api/v1/acronymregistry/{id}
GET  /api/v1/acronymregistry/{id}/timeline
GET  /api/v1/acronymregistry/{id}/evidence
GET  /api/v1/acronymregistry/{id}/decisions
POST /api/v1/acronymregistry/{id}/exceptions
POST /api/v1/acronymregistry/{id}/corrections
```
...
|---|---|
| `acronymregistry_aggregate` | authoritative subject |
| `acronymregistry_version` | immutable submitted, approved, issued, or signed versions |
| `acronymregistry_relationship` | governed relationships |
| `acronymregistry_decision` | binding Decisions and rationale |
| `acronymregistry_evidence_link` | provenance and evidence relationships |
| `acronymregistry_event_outbox` | transactional Event publication |
| `acronymregistry_idempotency` | duplicate-write protection |
| `acronymregistry_exception` | exception, claim, dispute, or hold |
| `acronymregistry_correction` | correction and supersession lineage |
| `acronymregistry_audit` | privileged action evidence |
