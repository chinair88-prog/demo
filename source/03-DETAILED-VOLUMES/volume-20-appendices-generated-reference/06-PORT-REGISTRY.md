...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Port Registry**.
...
|---|---|
| `PortRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `PortRegistryCreated`
- `PortRegistryValidated`
- `PortRegistryApproved`
- `PortRegistryActivated`
- `PortRegistrySuspended`
- `PortRegistryCorrected`
- `PortRegistryRetired`

Reference queries:

- `GetPortRegistry`
- `ListPortRegistryRecords`
- `GetPortRegistryTimeline`
- `GetPortRegistryEvidence`
- `GetPortRegistryDecisionPackage`
- `GetPortRegistryExceptions`
- `GetPortRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/portregistry/commands
GET  /api/v1/portregistry/{id}
GET  /api/v1/portregistry/{id}/timeline
GET  /api/v1/portregistry/{id}/evidence
GET  /api/v1/portregistry/{id}/decisions
POST /api/v1/portregistry/{id}/exceptions
POST /api/v1/portregistry/{id}/corrections
```
...
|---|---|
| `portregistry_aggregate` | authoritative subject |
| `portregistry_version` | immutable submitted, approved, issued, or signed versions |
| `portregistry_relationship` | governed relationships |
| `portregistry_decision` | binding Decisions and rationale |
| `portregistry_evidence_link` | provenance and evidence relationships |
| `portregistry_event_outbox` | transactional Event publication |
| `portregistry_idempotency` | duplicate-write protection |
| `portregistry_exception` | exception, claim, dispute, or hold |
| `portregistry_correction` | correction and supersession lineage |
| `portregistry_audit` | privileged action evidence |
