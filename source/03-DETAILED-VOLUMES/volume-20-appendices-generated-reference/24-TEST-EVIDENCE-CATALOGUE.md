# Test Evidence Catalogue

| Metadata | Value |
|---|---|
| Volume | `20` |
| Chapter ID | `V20-24` |
| Subject | `TestEvidenceCatalogue` |
...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Test Evidence Catalogue**.
...
|---|---|
| `TestEvidenceCatalogue` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestEvidenceCatalogueVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestEvidenceCatalogueDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestEvidenceCatalogueEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestEvidenceCatalogueException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TestEvidenceCatalogue {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTestEvidenceCatalogue`
- `ValidateTestEvidenceCatalogue`
- `ApproveTestEvidenceCatalogue`
- `ActivateTestEvidenceCatalogue`
- `SuspendTestEvidenceCatalogue`
- `CorrectTestEvidenceCatalogue`
- `RetireTestEvidenceCatalogue`

Reference Events:

- `TestEvidenceCatalogueCreated`
- `TestEvidenceCatalogueValidated`
- `TestEvidenceCatalogueApproved`
- `TestEvidenceCatalogueActivated`
- `TestEvidenceCatalogueSuspended`
- `TestEvidenceCatalogueCorrected`
- `TestEvidenceCatalogueRetired`

Reference queries:

- `GetTestEvidenceCatalogue`
- `ListTestEvidenceCatalogueRecords`
- `GetTestEvidenceCatalogueTimeline`
- `GetTestEvidenceCatalogueEvidence`
- `GetTestEvidenceCatalogueDecisionPackage`
- `GetTestEvidenceCatalogueExceptions`
- `GetTestEvidenceCatalogueAuditTrail`

Reference API surface:

```text
POST /api/v1/testevidencecatalogue/commands
GET  /api/v1/testevidencecatalogue/{id}
GET  /api/v1/testevidencecatalogue/{id}/timeline
GET  /api/v1/testevidencecatalogue/{id}/evidence
GET  /api/v1/testevidencecatalogue/{id}/decisions
POST /api/v1/testevidencecatalogue/{id}/exceptions
POST /api/v1/testevidencecatalogue/{id}/corrections
```
...
|---|---|
| `testevidencecatalogue_aggregate` | authoritative subject |
| `testevidencecatalogue_version` | immutable submitted, approved, issued, or signed versions |
| `testevidencecatalogue_relationship` | governed relationships |
| `testevidencecatalogue_decision` | binding Decisions and rationale |
| `testevidencecatalogue_evidence_link` | provenance and evidence relationships |
| `testevidencecatalogue_event_outbox` | transactional Event publication |
| `testevidencecatalogue_idempotency` | duplicate-write protection |
| `testevidencecatalogue_exception` | exception, claim, dispute, or hold |
| `testevidencecatalogue_correction` | correction and supersession lineage |
| `testevidencecatalogue_audit` | privileged action evidence |
