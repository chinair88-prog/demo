...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Exception Register**.
...
|---|---|
| `ExceptionRegister` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExceptionRegisterVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExceptionRegisterDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExceptionRegisterEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExceptionRegisterException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateExceptionRegister`
- `ValidateExceptionRegister`
- `ApproveExceptionRegister`
- `ActivateExceptionRegister`
- `SuspendExceptionRegister`
- `CorrectExceptionRegister`
- `RetireExceptionRegister`

Reference Events:

- `ExceptionRegisterCreated`
- `ExceptionRegisterValidated`
- `ExceptionRegisterApproved`
- `ExceptionRegisterActivated`
- `ExceptionRegisterSuspended`
- `ExceptionRegisterCorrected`
- `ExceptionRegisterRetired`

Reference queries:

- `GetExceptionRegister`
- `ListExceptionRegisterRecords`
- `GetExceptionRegisterTimeline`
- `GetExceptionRegisterEvidence`
- `GetExceptionRegisterDecisionPackage`
- `GetExceptionRegisterExceptions`
- `GetExceptionRegisterAuditTrail`

Reference API surface:

```text
POST /api/v1/exceptionregister/commands
GET  /api/v1/exceptionregister/{id}
GET  /api/v1/exceptionregister/{id}/timeline
GET  /api/v1/exceptionregister/{id}/evidence
GET  /api/v1/exceptionregister/{id}/decisions
POST /api/v1/exceptionregister/{id}/exceptions
POST /api/v1/exceptionregister/{id}/corrections
```
...
|---|---|
| `exceptionregister_aggregate` | authoritative subject |
| `exceptionregister_version` | immutable submitted, approved, issued, or signed versions |
| `exceptionregister_relationship` | governed relationships |
| `exceptionregister_decision` | binding Decisions and rationale |
| `exceptionregister_evidence_link` | provenance and evidence relationships |
| `exceptionregister_event_outbox` | transactional Event publication |
| `exceptionregister_idempotency` | duplicate-write protection |
| `exceptionregister_exception` | exception, claim, dispute, or hold |
| `exceptionregister_correction` | correction and supersession lineage |
| `exceptionregister_audit` | privileged action evidence |
