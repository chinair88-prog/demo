...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Workflow Catalogue**.
...
|---|---|
| `WorkflowCatalogue` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowCatalogueVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowCatalogueDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowCatalogueEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowCatalogueException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWorkflowCatalogue`
- `ValidateWorkflowCatalogue`
- `ApproveWorkflowCatalogue`
- `ActivateWorkflowCatalogue`
- `SuspendWorkflowCatalogue`
- `CorrectWorkflowCatalogue`
- `RetireWorkflowCatalogue`

Reference Events:

- `WorkflowCatalogueCreated`
- `WorkflowCatalogueValidated`
- `WorkflowCatalogueApproved`
- `WorkflowCatalogueActivated`
- `WorkflowCatalogueSuspended`
- `WorkflowCatalogueCorrected`
- `WorkflowCatalogueRetired`

Reference queries:

- `GetWorkflowCatalogue`
- `ListWorkflowCatalogueRecords`
- `GetWorkflowCatalogueTimeline`
- `GetWorkflowCatalogueEvidence`
- `GetWorkflowCatalogueDecisionPackage`
- `GetWorkflowCatalogueExceptions`
- `GetWorkflowCatalogueAuditTrail`

Reference API surface:

```text
POST /api/v1/workflowcatalogue/commands
GET  /api/v1/workflowcatalogue/{id}
GET  /api/v1/workflowcatalogue/{id}/timeline
GET  /api/v1/workflowcatalogue/{id}/evidence
GET  /api/v1/workflowcatalogue/{id}/decisions
POST /api/v1/workflowcatalogue/{id}/exceptions
POST /api/v1/workflowcatalogue/{id}/corrections
```
...
|---|---|
| `workflowcatalogue_aggregate` | authoritative subject |
| `workflowcatalogue_version` | immutable submitted, approved, issued, or signed versions |
| `workflowcatalogue_relationship` | governed relationships |
| `workflowcatalogue_decision` | binding Decisions and rationale |
| `workflowcatalogue_evidence_link` | provenance and evidence relationships |
| `workflowcatalogue_event_outbox` | transactional Event publication |
| `workflowcatalogue_idempotency` | duplicate-write protection |
| `workflowcatalogue_exception` | exception, claim, dispute, or hold |
| `workflowcatalogue_correction` | correction and supersession lineage |
| `workflowcatalogue_audit` | privileged action evidence |
