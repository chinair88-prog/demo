...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Risk Register**.
...
|---|---|
| `RiskRegister` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RiskRegisterVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RiskRegisterDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RiskRegisterEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RiskRegisterException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `RiskRegisterCreated`
- `RiskRegisterValidated`
- `RiskRegisterApproved`
- `RiskRegisterActivated`
- `RiskRegisterSuspended`
- `RiskRegisterCorrected`
- `RiskRegisterRetired`
...
- `GetRiskRegisterTimeline`
- `GetRiskRegisterEvidence`
- `GetRiskRegisterDecisionPackage`
- `GetRiskRegisterExceptions`
- `GetRiskRegisterAuditTrail`

Reference API surface:

```text
POST /api/v1/riskregister/commands
GET  /api/v1/riskregister/{id}
GET  /api/v1/riskregister/{id}/timeline
GET  /api/v1/riskregister/{id}/evidence
GET  /api/v1/riskregister/{id}/decisions
POST /api/v1/riskregister/{id}/exceptions
POST /api/v1/riskregister/{id}/corrections
```
...
|---|---|
| `riskregister_aggregate` | authoritative subject |
| `riskregister_version` | immutable submitted, approved, issued, or signed versions |
| `riskregister_relationship` | governed relationships |
| `riskregister_decision` | binding Decisions and rationale |
| `riskregister_evidence_link` | provenance and evidence relationships |
| `riskregister_event_outbox` | transactional Event publication |
| `riskregister_idempotency` | duplicate-write protection |
| `riskregister_exception` | exception, claim, dispute, or hold |
| `riskregister_correction` | correction and supersession lineage |
| `riskregister_audit` | privileged action evidence |
