...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Capability Registry**.
...
|---|---|
| `CapabilityRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapabilityRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapabilityRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapabilityRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapabilityRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveCapabilityRegistry`
- `ActivateCapabilityRegistry`
- `SuspendCapabilityRegistry`
- `CorrectCapabilityRegistry`
- `RetireCapabilityRegistry`

Reference Events:

- `CapabilityRegistryCreated`
- `CapabilityRegistryValidated`
- `CapabilityRegistryApproved`
- `CapabilityRegistryActivated`
- `CapabilityRegistrySuspended`
- `CapabilityRegistryCorrected`
- `CapabilityRegistryRetired`

Reference queries:

- `GetCapabilityRegistry`
- `ListCapabilityRegistryRecords`
- `GetCapabilityRegistryTimeline`
- `GetCapabilityRegistryEvidence`
- `GetCapabilityRegistryDecisionPackage`
- `GetCapabilityRegistryExceptions`
- `GetCapabilityRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/capabilityregistry/commands
GET  /api/v1/capabilityregistry/{id}
GET  /api/v1/capabilityregistry/{id}/timeline
GET  /api/v1/capabilityregistry/{id}/evidence
GET  /api/v1/capabilityregistry/{id}/decisions
POST /api/v1/capabilityregistry/{id}/exceptions
POST /api/v1/capabilityregistry/{id}/corrections
```
...
|---|---|
| `capabilityregistry_aggregate` | authoritative subject |
| `capabilityregistry_version` | immutable submitted, approved, issued, or signed versions |
| `capabilityregistry_relationship` | governed relationships |
| `capabilityregistry_decision` | binding Decisions and rationale |
| `capabilityregistry_evidence_link` | provenance and evidence relationships |
| `capabilityregistry_event_outbox` | transactional Event publication |
| `capabilityregistry_idempotency` | duplicate-write protection |
| `capabilityregistry_exception` | exception, claim, dispute, or hold |
| `capabilityregistry_correction` | correction and supersession lineage |
| `capabilityregistry_audit` | privileged action evidence |
