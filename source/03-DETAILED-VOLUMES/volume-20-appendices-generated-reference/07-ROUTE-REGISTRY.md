...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Route Registry**.
...
|---|---|
| `routeregistry_aggregate` | authoritative subject |
| `routeregistry_version` | immutable submitted, approved, issued, or signed versions |
| `routeregistry_relationship` | governed relationships |
| `routeregistry_decision` | binding Decisions and rationale |
| `routeregistry_evidence_link` | provenance and evidence relationships |
| `routeregistry_event_outbox` | transactional Event publication |
| `routeregistry_idempotency` | duplicate-write protection |
| `routeregistry_exception` | exception, claim, dispute, or hold |
| `routeregistry_correction` | correction and supersession lineage |
| `routeregistry_audit` | privileged action evidence |
