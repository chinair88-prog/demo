...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Canon Traceability**.
...
|---|---|
| `CanonTraceability` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CanonTraceabilityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CanonTraceabilityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CanonTraceabilityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CanonTraceabilityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateCanonTraceability`
- `ValidateCanonTraceability`
- `ApproveCanonTraceability`
- `ActivateCanonTraceability`
- `SuspendCanonTraceability`
- `CorrectCanonTraceability`
- `RetireCanonTraceability`

Reference Events:

- `CanonTraceabilityCreated`
- `CanonTraceabilityValidated`
- `CanonTraceabilityApproved`
- `CanonTraceabilityActivated`
- `CanonTraceabilitySuspended`
- `CanonTraceabilityCorrected`
- `CanonTraceabilityRetired`

Reference queries:

- `GetCanonTraceability`
- `ListCanonTraceabilityRecords`
- `GetCanonTraceabilityTimeline`
- `GetCanonTraceabilityEvidence`
- `GetCanonTraceabilityDecisionPackage`
- `GetCanonTraceabilityExceptions`
- `GetCanonTraceabilityAuditTrail`

Reference API surface:

```text
POST /api/v1/canontraceability/commands
GET  /api/v1/canontraceability/{id}
GET  /api/v1/canontraceability/{id}/timeline
GET  /api/v1/canontraceability/{id}/evidence
GET  /api/v1/canontraceability/{id}/decisions
POST /api/v1/canontraceability/{id}/exceptions
POST /api/v1/canontraceability/{id}/corrections
```
...
|---|---|
| `canontraceability_aggregate` | authoritative subject |
| `canontraceability_version` | immutable submitted, approved, issued, or signed versions |
| `canontraceability_relationship` | governed relationships |
| `canontraceability_decision` | binding Decisions and rationale |
| `canontraceability_evidence_link` | provenance and evidence relationships |
| `canontraceability_event_outbox` | transactional Event publication |
| `canontraceability_idempotency` | duplicate-write protection |
| `canontraceability_exception` | exception, claim, dispute, or hold |
| `canontraceability_correction` | correction and supersession lineage |
| `canontraceability_audit` | privileged action evidence |
