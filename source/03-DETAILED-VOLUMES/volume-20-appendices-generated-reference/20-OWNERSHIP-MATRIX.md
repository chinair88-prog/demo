...
This chapter defines how GTOS shall **define the generation source, schema, owner, evidence level, update cadence, validation, publication, retention, and use of the Ownership Matrix**.
...
|---|---|
| `OwnershipMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OwnershipMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OwnershipMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OwnershipMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OwnershipMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveOwnershipMatrix`
- `ActivateOwnershipMatrix`
- `SuspendOwnershipMatrix`
- `CorrectOwnershipMatrix`
- `RetireOwnershipMatrix`

Reference Events:

- `OwnershipMatrixCreated`
- `OwnershipMatrixValidated`
- `OwnershipMatrixApproved`
- `OwnershipMatrixActivated`
- `OwnershipMatrixSuspended`
- `OwnershipMatrixCorrected`
- `OwnershipMatrixRetired`

Reference queries:

- `GetOwnershipMatrix`
- `ListOwnershipMatrixRecords`
- `GetOwnershipMatrixTimeline`
- `GetOwnershipMatrixEvidence`
- `GetOwnershipMatrixDecisionPackage`
- `GetOwnershipMatrixExceptions`
- `GetOwnershipMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/ownershipmatrix/commands
GET  /api/v1/ownershipmatrix/{id}
GET  /api/v1/ownershipmatrix/{id}/timeline
GET  /api/v1/ownershipmatrix/{id}/evidence
GET  /api/v1/ownershipmatrix/{id}/decisions
POST /api/v1/ownershipmatrix/{id}/exceptions
POST /api/v1/ownershipmatrix/{id}/corrections
```
...
|---|---|
| `ownershipmatrix_aggregate` | authoritative subject |
| `ownershipmatrix_version` | immutable submitted, approved, issued, or signed versions |
| `ownershipmatrix_relationship` | governed relationships |
| `ownershipmatrix_decision` | binding Decisions and rationale |
| `ownershipmatrix_evidence_link` | provenance and evidence relationships |
| `ownershipmatrix_event_outbox` | transactional Event publication |
| `ownershipmatrix_idempotency` | duplicate-write protection |
| `ownershipmatrix_exception` | exception, claim, dispute, or hold |
| `ownershipmatrix_correction` | correction and supersession lineage |
| `ownershipmatrix_audit` | privileged action evidence |
