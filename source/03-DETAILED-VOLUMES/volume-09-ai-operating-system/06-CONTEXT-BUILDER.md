...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Context Builder**.
...
|---|---|
| `ContextBuilder` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContextBuilderVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContextBuilderDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContextBuilderEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ContextBuilderException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateContextBuilder`
- `ApproveContextBuilder`
- `ActivateContextBuilder`
- `SuspendContextBuilder`
- `CorrectContextBuilder`
- `RetireContextBuilder`

Reference Events:

- `ContextBuilderCreated`
- `ContextBuilderValidated`
- `ContextBuilderApproved`
- `ContextBuilderActivated`
- `ContextBuilderSuspended`
- `ContextBuilderCorrected`
- `ContextBuilderRetired`

Reference queries:

- `GetContextBuilder`
- `ListContextBuilderRecords`
- `GetContextBuilderTimeline`
- `GetContextBuilderEvidence`
- `GetContextBuilderDecisionPackage`
- `GetContextBuilderExceptions`
- `GetContextBuilderAuditTrail`

Reference API surface:

```text
POST /api/v1/contextbuilder/commands
GET  /api/v1/contextbuilder/{id}
GET  /api/v1/contextbuilder/{id}/timeline
GET  /api/v1/contextbuilder/{id}/evidence
GET  /api/v1/contextbuilder/{id}/decisions
POST /api/v1/contextbuilder/{id}/exceptions
POST /api/v1/contextbuilder/{id}/corrections
```
...
|---|---|
| `contextbuilder_aggregate` | authoritative subject |
| `contextbuilder_version` | immutable submitted, approved, issued, or signed versions |
| `contextbuilder_relationship` | governed relationships |
| `contextbuilder_decision` | binding Decisions and rationale |
| `contextbuilder_evidence_link` | provenance and evidence relationships |
| `contextbuilder_event_outbox` | transactional Event publication |
| `contextbuilder_idempotency` | duplicate-write protection |
| `contextbuilder_exception` | exception, claim, dispute, or hold |
| `contextbuilder_correction` | correction and supersession lineage |
| `contextbuilder_audit` | privileged action evidence |
