...
| Volume | `9` |
| Chapter ID | `V09-19` |
| Subject | `PromptandTemplateGovernance` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Prompt and Template Governance**.
...
|---|---|
| `PromptandTemplateGovernance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PromptandTemplateGovernanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PromptandTemplateGovernanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PromptandTemplateGovernanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PromptandTemplateGovernanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PromptandTemplateGovernance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePromptandTemplateGovernance`
- `ValidatePromptandTemplateGovernance`
- `ApprovePromptandTemplateGovernance`
- `ActivatePromptandTemplateGovernance`
- `SuspendPromptandTemplateGovernance`
- `CorrectPromptandTemplateGovernance`
- `RetirePromptandTemplateGovernance`

Reference Events:

- `PromptandTemplateGovernanceCreated`
- `PromptandTemplateGovernanceValidated`
- `PromptandTemplateGovernanceApproved`
- `PromptandTemplateGovernanceActivated`
- `PromptandTemplateGovernanceSuspended`
- `PromptandTemplateGovernanceCorrected`
- `PromptandTemplateGovernanceRetired`

Reference queries:

- `GetPromptandTemplateGovernance`
- `ListPromptandTemplateGovernanceRecords`
- `GetPromptandTemplateGovernanceTimeline`
- `GetPromptandTemplateGovernanceEvidence`
- `GetPromptandTemplateGovernanceDecisionPackage`
- `GetPromptandTemplateGovernanceExceptions`
- `GetPromptandTemplateGovernanceAuditTrail`

Reference API surface:

```text
POST /api/v1/promptandtemplategovernance/commands
GET  /api/v1/promptandtemplategovernance/{id}
GET  /api/v1/promptandtemplategovernance/{id}/timeline
GET  /api/v1/promptandtemplategovernance/{id}/evidence
GET  /api/v1/promptandtemplategovernance/{id}/decisions
POST /api/v1/promptandtemplategovernance/{id}/exceptions
POST /api/v1/promptandtemplategovernance/{id}/corrections
```
...
|---|---|
| `promptandtemplategovernance_aggregate` | authoritative subject |
| `promptandtemplategovernance_version` | immutable submitted, approved, issued, or signed versions |
| `promptandtemplategovernance_relationship` | governed relationships |
| `promptandtemplategovernance_decision` | binding Decisions and rationale |
| `promptandtemplategovernance_evidence_link` | provenance and evidence relationships |
| `promptandtemplategovernance_event_outbox` | transactional Event publication |
| `promptandtemplategovernance_idempotency` | duplicate-write protection |
| `promptandtemplategovernance_exception` | exception, claim, dispute, or hold |
| `promptandtemplategovernance_correction` | correction and supersession lineage |
| `promptandtemplategovernance_audit` | privileged action evidence |
