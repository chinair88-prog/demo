...
| Volume | `9` |
| Chapter ID | `V09-25` |
| Subject | `EvaluationandPromotion` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Evaluation and Promotion**.
...
|---|---|
| `EvaluationandPromotion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EvaluationandPromotionVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EvaluationandPromotionDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EvaluationandPromotionEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EvaluationandPromotionException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateEvaluationandPromotion`
- `ValidateEvaluationandPromotion`
- `ApproveEvaluationandPromotion`
- `ActivateEvaluationandPromotion`
- `SuspendEvaluationandPromotion`
- `CorrectEvaluationandPromotion`
- `RetireEvaluationandPromotion`

Reference Events:

- `EvaluationandPromotionCreated`
- `EvaluationandPromotionValidated`
- `EvaluationandPromotionApproved`
- `EvaluationandPromotionActivated`
- `EvaluationandPromotionSuspended`
- `EvaluationandPromotionCorrected`
- `EvaluationandPromotionRetired`

Reference queries:

- `GetEvaluationandPromotion`
- `ListEvaluationandPromotionRecords`
- `GetEvaluationandPromotionTimeline`
- `GetEvaluationandPromotionEvidence`
- `GetEvaluationandPromotionDecisionPackage`
- `GetEvaluationandPromotionExceptions`
- `GetEvaluationandPromotionAuditTrail`

Reference API surface:

```text
POST /api/v1/evaluationandpromotion/commands
GET  /api/v1/evaluationandpromotion/{id}
GET  /api/v1/evaluationandpromotion/{id}/timeline
GET  /api/v1/evaluationandpromotion/{id}/evidence
GET  /api/v1/evaluationandpromotion/{id}/decisions
POST /api/v1/evaluationandpromotion/{id}/exceptions
POST /api/v1/evaluationandpromotion/{id}/corrections
```
...
|---|---|
| `evaluationandpromotion_aggregate` | authoritative subject |
| `evaluationandpromotion_version` | immutable submitted, approved, issued, or signed versions |
| `evaluationandpromotion_relationship` | governed relationships |
| `evaluationandpromotion_decision` | binding Decisions and rationale |
| `evaluationandpromotion_evidence_link` | provenance and evidence relationships |
| `evaluationandpromotion_event_outbox` | transactional Event publication |
| `evaluationandpromotion_idempotency` | duplicate-write protection |
| `evaluationandpromotion_exception` | exception, claim, dispute, or hold |
| `evaluationandpromotion_correction` | correction and supersession lineage |
| `evaluationandpromotion_audit` | privileged action evidence |
