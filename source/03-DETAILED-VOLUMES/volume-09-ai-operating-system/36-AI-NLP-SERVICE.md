...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for AI NLP Service**.
...
|---|---|
| `AINLPService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AINLPServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AINLPServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AINLPServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AINLPServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAINLPService`
- `ValidateAINLPService`
- `ApproveAINLPService`
- `ActivateAINLPService`
- `SuspendAINLPService`
- `CorrectAINLPService`
- `RetireAINLPService`
...
- `AINLPServiceCreated`
- `AINLPServiceValidated`
- `AINLPServiceApproved`
- `AINLPServiceActivated`
- `AINLPServiceSuspended`
- `AINLPServiceCorrected`
- `AINLPServiceRetired`

Reference queries:

- `GetAINLPService`
- `ListAINLPServiceRecords`
- `GetAINLPServiceTimeline`
- `GetAINLPServiceEvidence`
- `GetAINLPServiceDecisionPackage`
- `GetAINLPServiceExceptions`
- `GetAINLPServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/ainlpservice/commands
GET  /api/v1/ainlpservice/{id}
GET  /api/v1/ainlpservice/{id}/timeline
GET  /api/v1/ainlpservice/{id}/evidence
GET  /api/v1/ainlpservice/{id}/decisions
POST /api/v1/ainlpservice/{id}/exceptions
POST /api/v1/ainlpservice/{id}/corrections
```
...
|---|---|
| `ainlpservice_aggregate` | authoritative subject |
| `ainlpservice_version` | immutable submitted, approved, issued, or signed versions |
| `ainlpservice_relationship` | governed relationships |
| `ainlpservice_decision` | binding Decisions and rationale |
| `ainlpservice_evidence_link` | provenance and evidence relationships |
| `ainlpservice_event_outbox` | transactional Event publication |
| `ainlpservice_idempotency` | duplicate-write protection |
| `ainlpservice_exception` | exception, claim, dispute, or hold |
| `ainlpservice_correction` | correction and supersession lineage |
| `ainlpservice_audit` | privileged action evidence |
