...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Event Bus Integration**.
...
|---|---|
| `EventBusIntegration` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventBusIntegrationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventBusIntegrationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventBusIntegrationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EventBusIntegrationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveEventBusIntegration`
- `ActivateEventBusIntegration`
- `SuspendEventBusIntegration`
- `CorrectEventBusIntegration`
- `RetireEventBusIntegration`

Reference Events:

- `EventBusIntegrationCreated`
- `EventBusIntegrationValidated`
- `EventBusIntegrationApproved`
- `EventBusIntegrationActivated`
- `EventBusIntegrationSuspended`
- `EventBusIntegrationCorrected`
- `EventBusIntegrationRetired`

Reference queries:

- `GetEventBusIntegration`
- `ListEventBusIntegrationRecords`
- `GetEventBusIntegrationTimeline`
- `GetEventBusIntegrationEvidence`
- `GetEventBusIntegrationDecisionPackage`
- `GetEventBusIntegrationExceptions`
- `GetEventBusIntegrationAuditTrail`

Reference API surface:

```text
POST /api/v1/eventbusintegration/commands
GET  /api/v1/eventbusintegration/{id}
GET  /api/v1/eventbusintegration/{id}/timeline
GET  /api/v1/eventbusintegration/{id}/evidence
GET  /api/v1/eventbusintegration/{id}/decisions
POST /api/v1/eventbusintegration/{id}/exceptions
POST /api/v1/eventbusintegration/{id}/corrections
```
...
|---|---|
| `eventbusintegration_aggregate` | authoritative subject |
| `eventbusintegration_version` | immutable submitted, approved, issued, or signed versions |
| `eventbusintegration_relationship` | governed relationships |
| `eventbusintegration_decision` | binding Decisions and rationale |
| `eventbusintegration_evidence_link` | provenance and evidence relationships |
| `eventbusintegration_event_outbox` | transactional Event publication |
| `eventbusintegration_idempotency` | duplicate-write protection |
| `eventbusintegration_exception` | exception, claim, dispute, or hold |
| `eventbusintegration_correction` | correction and supersession lineage |
| `eventbusintegration_audit` | privileged action evidence |
