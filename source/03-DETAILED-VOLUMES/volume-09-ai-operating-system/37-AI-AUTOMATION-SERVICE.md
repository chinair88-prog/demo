...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for AI Automation Service**.
...
|---|---|
| `AIAutomationService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAutomationServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAutomationServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAutomationServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAutomationServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateAIAutomationService`
- `ValidateAIAutomationService`
- `ApproveAIAutomationService`
- `ActivateAIAutomationService`
- `SuspendAIAutomationService`
- `CorrectAIAutomationService`
- `RetireAIAutomationService`

Reference Events:

- `AIAutomationServiceCreated`
- `AIAutomationServiceValidated`
- `AIAutomationServiceApproved`
- `AIAutomationServiceActivated`
- `AIAutomationServiceSuspended`
- `AIAutomationServiceCorrected`
- `AIAutomationServiceRetired`

Reference queries:

- `GetAIAutomationService`
- `ListAIAutomationServiceRecords`
- `GetAIAutomationServiceTimeline`
- `GetAIAutomationServiceEvidence`
- `GetAIAutomationServiceDecisionPackage`
- `GetAIAutomationServiceExceptions`
- `GetAIAutomationServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/aiautomationservice/commands
GET  /api/v1/aiautomationservice/{id}
GET  /api/v1/aiautomationservice/{id}/timeline
GET  /api/v1/aiautomationservice/{id}/evidence
GET  /api/v1/aiautomationservice/{id}/decisions
POST /api/v1/aiautomationservice/{id}/exceptions
POST /api/v1/aiautomationservice/{id}/corrections
```
...
|---|---|
| `aiautomationservice_aggregate` | authoritative subject |
| `aiautomationservice_version` | immutable submitted, approved, issued, or signed versions |
| `aiautomationservice_relationship` | governed relationships |
| `aiautomationservice_decision` | binding Decisions and rationale |
| `aiautomationservice_evidence_link` | provenance and evidence relationships |
| `aiautomationservice_event_outbox` | transactional Event publication |
| `aiautomationservice_idempotency` | duplicate-write protection |
| `aiautomationservice_exception` | exception, claim, dispute, or hold |
| `aiautomationservice_correction` | correction and supersession lineage |
| `aiautomationservice_audit` | privileged action evidence |
