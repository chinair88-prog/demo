...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Search and Ranking**.
...
|---|---|
| `SearchandRanking` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchandRankingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchandRankingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchandRankingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `SearchandRankingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateSearchandRanking`
- `ValidateSearchandRanking`
- `ApproveSearchandRanking`
- `ActivateSearchandRanking`
- `SuspendSearchandRanking`
- `CorrectSearchandRanking`
- `RetireSearchandRanking`

Reference Events:

- `SearchandRankingCreated`
- `SearchandRankingValidated`
- `SearchandRankingApproved`
- `SearchandRankingActivated`
- `SearchandRankingSuspended`
- `SearchandRankingCorrected`
- `SearchandRankingRetired`

Reference queries:

- `GetSearchandRanking`
- `ListSearchandRankingRecords`
- `GetSearchandRankingTimeline`
- `GetSearchandRankingEvidence`
- `GetSearchandRankingDecisionPackage`
- `GetSearchandRankingExceptions`
- `GetSearchandRankingAuditTrail`

Reference API surface:

```text
POST /api/v1/searchandranking/commands
GET  /api/v1/searchandranking/{id}
GET  /api/v1/searchandranking/{id}/timeline
GET  /api/v1/searchandranking/{id}/evidence
GET  /api/v1/searchandranking/{id}/decisions
POST /api/v1/searchandranking/{id}/exceptions
POST /api/v1/searchandranking/{id}/corrections
```
...
|---|---|
| `searchandranking_aggregate` | authoritative subject |
| `searchandranking_version` | immutable submitted, approved, issued, or signed versions |
| `searchandranking_relationship` | governed relationships |
| `searchandranking_decision` | binding Decisions and rationale |
| `searchandranking_evidence_link` | provenance and evidence relationships |
| `searchandranking_event_outbox` | transactional Event publication |
| `searchandranking_idempotency` | duplicate-write protection |
| `searchandranking_exception` | exception, claim, dispute, or hold |
| `searchandranking_correction` | correction and supersession lineage |
| `searchandranking_audit` | privileged action evidence |
