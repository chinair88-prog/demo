...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for AI Vision Service**.
...
|---|---|
| `AIVisionService` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVisionServiceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVisionServiceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVisionServiceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIVisionServiceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateAIVisionService`
- `ApproveAIVisionService`
- `ActivateAIVisionService`
- `SuspendAIVisionService`
- `CorrectAIVisionService`
- `RetireAIVisionService`

Reference Events:

- `AIVisionServiceCreated`
- `AIVisionServiceValidated`
- `AIVisionServiceApproved`
- `AIVisionServiceActivated`
- `AIVisionServiceSuspended`
- `AIVisionServiceCorrected`
- `AIVisionServiceRetired`

Reference queries:

- `GetAIVisionService`
- `ListAIVisionServiceRecords`
- `GetAIVisionServiceTimeline`
- `GetAIVisionServiceEvidence`
- `GetAIVisionServiceDecisionPackage`
- `GetAIVisionServiceExceptions`
- `GetAIVisionServiceAuditTrail`

Reference API surface:

```text
POST /api/v1/aivisionservice/commands
GET  /api/v1/aivisionservice/{id}
GET  /api/v1/aivisionservice/{id}/timeline
GET  /api/v1/aivisionservice/{id}/evidence
GET  /api/v1/aivisionservice/{id}/decisions
POST /api/v1/aivisionservice/{id}/exceptions
POST /api/v1/aivisionservice/{id}/corrections
```
...
|---|---|
| `aivisionservice_aggregate` | authoritative subject |
| `aivisionservice_version` | immutable submitted, approved, issued, or signed versions |
| `aivisionservice_relationship` | governed relationships |
| `aivisionservice_decision` | binding Decisions and rationale |
| `aivisionservice_evidence_link` | provenance and evidence relationships |
| `aivisionservice_event_outbox` | transactional Event publication |
| `aivisionservice_idempotency` | duplicate-write protection |
| `aivisionservice_exception` | exception, claim, dispute, or hold |
| `aivisionservice_correction` | correction and supersession lineage |
| `aivisionservice_audit` | privileged action evidence |
