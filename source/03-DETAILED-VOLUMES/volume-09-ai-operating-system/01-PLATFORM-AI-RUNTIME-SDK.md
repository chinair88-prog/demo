# Platform AI Runtime SDK

| Metadata | Value |
|---|---|
| Volume | `9` |
| Chapter ID | `V09-01` |
| Subject | `PlatformAIRuntimeSDK` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Platform AI Runtime SDK**.
...
|---|---|
| `PlatformAIRuntimeSDK` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlatformAIRuntimeSDKVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlatformAIRuntimeSDKDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlatformAIRuntimeSDKEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PlatformAIRuntimeSDKException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PlatformAIRuntimeSDK {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePlatformAIRuntimeSDK`
- `ValidatePlatformAIRuntimeSDK`
- `ApprovePlatformAIRuntimeSDK`
- `ActivatePlatformAIRuntimeSDK`
- `SuspendPlatformAIRuntimeSDK`
- `CorrectPlatformAIRuntimeSDK`
- `RetirePlatformAIRuntimeSDK`

Reference Events:

- `PlatformAIRuntimeSDKCreated`
- `PlatformAIRuntimeSDKValidated`
- `PlatformAIRuntimeSDKApproved`
- `PlatformAIRuntimeSDKActivated`
- `PlatformAIRuntimeSDKSuspended`
- `PlatformAIRuntimeSDKCorrected`
- `PlatformAIRuntimeSDKRetired`

Reference queries:

- `GetPlatformAIRuntimeSDK`
- `ListPlatformAIRuntimeSDKRecords`
- `GetPlatformAIRuntimeSDKTimeline`
- `GetPlatformAIRuntimeSDKEvidence`
- `GetPlatformAIRuntimeSDKDecisionPackage`
- `GetPlatformAIRuntimeSDKExceptions`
- `GetPlatformAIRuntimeSDKAuditTrail`

Reference API surface:

```text
POST /api/v1/platformairuntimesdk/commands
GET  /api/v1/platformairuntimesdk/{id}
GET  /api/v1/platformairuntimesdk/{id}/timeline
GET  /api/v1/platformairuntimesdk/{id}/evidence
GET  /api/v1/platformairuntimesdk/{id}/decisions
POST /api/v1/platformairuntimesdk/{id}/exceptions
POST /api/v1/platformairuntimesdk/{id}/corrections
```
...
|---|---|
| `platformairuntimesdk_aggregate` | authoritative subject |
| `platformairuntimesdk_version` | immutable submitted, approved, issued, or signed versions |
| `platformairuntimesdk_relationship` | governed relationships |
| `platformairuntimesdk_decision` | binding Decisions and rationale |
| `platformairuntimesdk_evidence_link` | provenance and evidence relationships |
| `platformairuntimesdk_event_outbox` | transactional Event publication |
| `platformairuntimesdk_idempotency` | duplicate-write protection |
| `platformairuntimesdk_exception` | exception, claim, dispute, or hold |
| `platformairuntimesdk_correction` | correction and supersession lineage |
| `platformairuntimesdk_audit` | privileged action evidence |
