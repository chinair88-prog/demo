...
| Volume | `9` |
| Chapter ID | `V09-26` |
| Subject | `OnlineMonitoringandDrift` |
...
This chapter defines how GTOS shall **define the ownership, lifecycle, policy, evidence, Tools, security, evaluation, failure, recovery, and repository verification requirements for Online Monitoring and Drift**.
...
|---|---|
| `OnlineMonitoringandDrift` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OnlineMonitoringandDriftVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OnlineMonitoringandDriftDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OnlineMonitoringandDriftEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `OnlineMonitoringandDriftException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
OnlineMonitoringandDrift {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateOnlineMonitoringandDrift`
- `ValidateOnlineMonitoringandDrift`
- `ApproveOnlineMonitoringandDrift`
- `ActivateOnlineMonitoringandDrift`
- `SuspendOnlineMonitoringandDrift`
- `CorrectOnlineMonitoringandDrift`
- `RetireOnlineMonitoringandDrift`

Reference Events:

- `OnlineMonitoringandDriftCreated`
- `OnlineMonitoringandDriftValidated`
- `OnlineMonitoringandDriftApproved`
- `OnlineMonitoringandDriftActivated`
- `OnlineMonitoringandDriftSuspended`
- `OnlineMonitoringandDriftCorrected`
- `OnlineMonitoringandDriftRetired`

Reference queries:

- `GetOnlineMonitoringandDrift`
- `ListOnlineMonitoringandDriftRecords`
- `GetOnlineMonitoringandDriftTimeline`
- `GetOnlineMonitoringandDriftEvidence`
- `GetOnlineMonitoringandDriftDecisionPackage`
- `GetOnlineMonitoringandDriftExceptions`
- `GetOnlineMonitoringandDriftAuditTrail`

Reference API surface:

```text
POST /api/v1/onlinemonitoringanddrift/commands
GET  /api/v1/onlinemonitoringanddrift/{id}
GET  /api/v1/onlinemonitoringanddrift/{id}/timeline
GET  /api/v1/onlinemonitoringanddrift/{id}/evidence
GET  /api/v1/onlinemonitoringanddrift/{id}/decisions
POST /api/v1/onlinemonitoringanddrift/{id}/exceptions
POST /api/v1/onlinemonitoringanddrift/{id}/corrections
```
...
|---|---|
| `onlinemonitoringanddrift_aggregate` | authoritative subject |
| `onlinemonitoringanddrift_version` | immutable submitted, approved, issued, or signed versions |
| `onlinemonitoringanddrift_relationship` | governed relationships |
| `onlinemonitoringanddrift_decision` | binding Decisions and rationale |
| `onlinemonitoringanddrift_evidence_link` | provenance and evidence relationships |
| `onlinemonitoringanddrift_event_outbox` | transactional Event publication |
| `onlinemonitoringanddrift_idempotency` | duplicate-write protection |
| `onlinemonitoringanddrift_exception` | exception, claim, dispute, or hold |
| `onlinemonitoringanddrift_correction` | correction and supersession lineage |
| `onlinemonitoringanddrift_audit` | privileged action evidence |
