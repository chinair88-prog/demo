# Error and Problem Details

| Metadata | Value |
|---|---|
| Volume | `11` |
| Chapter ID | `V11-21` |
| Subject | `ErrorandProblemDetails` |
...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Error and Problem Details**.
...
|---|---|
| `ErrorandProblemDetails` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ErrorandProblemDetailsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ErrorandProblemDetailsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ErrorandProblemDetailsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ErrorandProblemDetailsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ErrorandProblemDetails {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateErrorandProblemDetails`
- `ValidateErrorandProblemDetails`
- `ApproveErrorandProblemDetails`
- `ActivateErrorandProblemDetails`
- `SuspendErrorandProblemDetails`
- `CorrectErrorandProblemDetails`
- `RetireErrorandProblemDetails`

Reference Events:

- `ErrorandProblemDetailsCreated`
- `ErrorandProblemDetailsValidated`
- `ErrorandProblemDetailsApproved`
- `ErrorandProblemDetailsActivated`
- `ErrorandProblemDetailsSuspended`
- `ErrorandProblemDetailsCorrected`
- `ErrorandProblemDetailsRetired`

Reference queries:

- `GetErrorandProblemDetails`
- `ListErrorandProblemDetailsRecords`
- `GetErrorandProblemDetailsTimeline`
- `GetErrorandProblemDetailsEvidence`
- `GetErrorandProblemDetailsDecisionPackage`
- `GetErrorandProblemDetailsExceptions`
- `GetErrorandProblemDetailsAuditTrail`

Reference API surface:

```text
POST /api/v1/errorandproblemdetails/commands
GET  /api/v1/errorandproblemdetails/{id}
GET  /api/v1/errorandproblemdetails/{id}/timeline
GET  /api/v1/errorandproblemdetails/{id}/evidence
GET  /api/v1/errorandproblemdetails/{id}/decisions
POST /api/v1/errorandproblemdetails/{id}/exceptions
POST /api/v1/errorandproblemdetails/{id}/corrections
```
...
|---|---|
| `errorandproblemdetails_aggregate` | authoritative subject |
| `errorandproblemdetails_version` | immutable submitted, approved, issued, or signed versions |
| `errorandproblemdetails_relationship` | governed relationships |
| `errorandproblemdetails_decision` | binding Decisions and rationale |
| `errorandproblemdetails_evidence_link` | provenance and evidence relationships |
| `errorandproblemdetails_event_outbox` | transactional Event publication |
| `errorandproblemdetails_idempotency` | duplicate-write protection |
| `errorandproblemdetails_exception` | exception, claim, dispute, or hold |
| `errorandproblemdetails_correction` | correction and supersession lineage |
| `errorandproblemdetails_audit` | privileged action evidence |
