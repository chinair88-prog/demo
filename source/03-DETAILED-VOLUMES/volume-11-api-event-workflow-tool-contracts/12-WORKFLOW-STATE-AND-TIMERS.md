# Workflow State and Timers

| Metadata | Value |
|---|---|
| Volume | `11` |
| Chapter ID | `V11-12` |
| Subject | `WorkflowStateandTimers` |
...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Workflow State and Timers**.
...
|---|---|
| `WorkflowStateandTimers` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowStateandTimersVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowStateandTimersDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowStateandTimersEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WorkflowStateandTimersException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WorkflowStateandTimers {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWorkflowStateandTimers`
- `ValidateWorkflowStateandTimers`
- `ApproveWorkflowStateandTimers`
- `ActivateWorkflowStateandTimers`
- `SuspendWorkflowStateandTimers`
- `CorrectWorkflowStateandTimers`
- `RetireWorkflowStateandTimers`

Reference Events:

- `WorkflowStateandTimersCreated`
- `WorkflowStateandTimersValidated`
- `WorkflowStateandTimersApproved`
- `WorkflowStateandTimersActivated`
- `WorkflowStateandTimersSuspended`
- `WorkflowStateandTimersCorrected`
- `WorkflowStateandTimersRetired`

Reference queries:

- `GetWorkflowStateandTimers`
- `ListWorkflowStateandTimersRecords`
- `GetWorkflowStateandTimersTimeline`
- `GetWorkflowStateandTimersEvidence`
- `GetWorkflowStateandTimersDecisionPackage`
- `GetWorkflowStateandTimersExceptions`
- `GetWorkflowStateandTimersAuditTrail`

Reference API surface:

```text
POST /api/v1/workflowstateandtimers/commands
GET  /api/v1/workflowstateandtimers/{id}
GET  /api/v1/workflowstateandtimers/{id}/timeline
GET  /api/v1/workflowstateandtimers/{id}/evidence
GET  /api/v1/workflowstateandtimers/{id}/decisions
POST /api/v1/workflowstateandtimers/{id}/exceptions
POST /api/v1/workflowstateandtimers/{id}/corrections
```
...
|---|---|
| `workflowstateandtimers_aggregate` | authoritative subject |
| `workflowstateandtimers_version` | immutable submitted, approved, issued, or signed versions |
| `workflowstateandtimers_relationship` | governed relationships |
| `workflowstateandtimers_decision` | binding Decisions and rationale |
| `workflowstateandtimers_evidence_link` | provenance and evidence relationships |
| `workflowstateandtimers_event_outbox` | transactional Event publication |
| `workflowstateandtimers_idempotency` | duplicate-write protection |
| `workflowstateandtimers_exception` | exception, claim, dispute, or hold |
| `workflowstateandtimers_correction` | correction and supersession lineage |
| `workflowstateandtimers_audit` | privileged action evidence |
