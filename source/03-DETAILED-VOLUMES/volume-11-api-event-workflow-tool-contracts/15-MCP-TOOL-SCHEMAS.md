...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for MCP Tool Schemas**.
...
|---|---|
| `MCPToolSchemas` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolSchemasVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolSchemasDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolSchemasEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MCPToolSchemasException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveMCPToolSchemas`
- `ActivateMCPToolSchemas`
- `SuspendMCPToolSchemas`
- `CorrectMCPToolSchemas`
- `RetireMCPToolSchemas`

Reference Events:

- `MCPToolSchemasCreated`
- `MCPToolSchemasValidated`
- `MCPToolSchemasApproved`
- `MCPToolSchemasActivated`
- `MCPToolSchemasSuspended`
- `MCPToolSchemasCorrected`
- `MCPToolSchemasRetired`

Reference queries:

- `GetMCPToolSchemas`
- `ListMCPToolSchemasRecords`
- `GetMCPToolSchemasTimeline`
- `GetMCPToolSchemasEvidence`
- `GetMCPToolSchemasDecisionPackage`
- `GetMCPToolSchemasExceptions`
- `GetMCPToolSchemasAuditTrail`

Reference API surface:

```text
POST /api/v1/mcptoolschemas/commands
GET  /api/v1/mcptoolschemas/{id}
GET  /api/v1/mcptoolschemas/{id}/timeline
GET  /api/v1/mcptoolschemas/{id}/evidence
GET  /api/v1/mcptoolschemas/{id}/decisions
POST /api/v1/mcptoolschemas/{id}/exceptions
POST /api/v1/mcptoolschemas/{id}/corrections
```
...
|---|---|
| `mcptoolschemas_aggregate` | authoritative subject |
| `mcptoolschemas_version` | immutable submitted, approved, issued, or signed versions |
| `mcptoolschemas_relationship` | governed relationships |
| `mcptoolschemas_decision` | binding Decisions and rationale |
| `mcptoolschemas_evidence_link` | provenance and evidence relationships |
| `mcptoolschemas_event_outbox` | transactional Event publication |
| `mcptoolschemas_idempotency` | duplicate-write protection |
| `mcptoolschemas_exception` | exception, claim, dispute, or hold |
| `mcptoolschemas_correction` | correction and supersession lineage |
| `mcptoolschemas_audit` | privileged action evidence |
