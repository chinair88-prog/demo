...
| Volume | `11` |
| Chapter ID | `V11-20` |
| Subject | `ExternalProviderAdapters` |
...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for External Provider Adapters**.
...
|---|---|
| `ExternalProviderAdapters` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExternalProviderAdaptersVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExternalProviderAdaptersDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExternalProviderAdaptersEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ExternalProviderAdaptersException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateExternalProviderAdapters`
- `ApproveExternalProviderAdapters`
- `ActivateExternalProviderAdapters`
- `SuspendExternalProviderAdapters`
- `CorrectExternalProviderAdapters`
- `RetireExternalProviderAdapters`

Reference Events:

- `ExternalProviderAdaptersCreated`
- `ExternalProviderAdaptersValidated`
- `ExternalProviderAdaptersApproved`
- `ExternalProviderAdaptersActivated`
- `ExternalProviderAdaptersSuspended`
- `ExternalProviderAdaptersCorrected`
- `ExternalProviderAdaptersRetired`

Reference queries:

- `GetExternalProviderAdapters`
- `ListExternalProviderAdaptersRecords`
- `GetExternalProviderAdaptersTimeline`
- `GetExternalProviderAdaptersEvidence`
- `GetExternalProviderAdaptersDecisionPackage`
- `GetExternalProviderAdaptersExceptions`
- `GetExternalProviderAdaptersAuditTrail`

Reference API surface:

```text
POST /api/v1/externalprovideradapters/commands
GET  /api/v1/externalprovideradapters/{id}
GET  /api/v1/externalprovideradapters/{id}/timeline
GET  /api/v1/externalprovideradapters/{id}/evidence
GET  /api/v1/externalprovideradapters/{id}/decisions
POST /api/v1/externalprovideradapters/{id}/exceptions
POST /api/v1/externalprovideradapters/{id}/corrections
```
...
|---|---|
| `externalprovideradapters_aggregate` | authoritative subject |
| `externalprovideradapters_version` | immutable submitted, approved, issued, or signed versions |
| `externalprovideradapters_relationship` | governed relationships |
| `externalprovideradapters_decision` | binding Decisions and rationale |
| `externalprovideradapters_evidence_link` | provenance and evidence relationships |
| `externalprovideradapters_event_outbox` | transactional Event publication |
| `externalprovideradapters_idempotency` | duplicate-write protection |
| `externalprovideradapters_exception` | exception, claim, dispute, or hold |
| `externalprovideradapters_correction` | correction and supersession lineage |
| `externalprovideradapters_audit` | privileged action evidence |
