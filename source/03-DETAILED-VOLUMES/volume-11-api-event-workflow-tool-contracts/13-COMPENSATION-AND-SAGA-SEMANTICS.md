# Compensation and Saga Semantics

| Metadata | Value |
|---|---|
| Volume | `11` |
| Chapter ID | `V11-13` |
| Subject | `CompensationandSagaSemantics` |
...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Compensation and Saga Semantics**.
...
|---|---|
| `CompensationandSagaSemantics` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CompensationandSagaSemanticsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CompensationandSagaSemanticsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CompensationandSagaSemanticsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CompensationandSagaSemanticsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
CompensationandSagaSemantics {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateCompensationandSagaSemantics`
- `ValidateCompensationandSagaSemantics`
- `ApproveCompensationandSagaSemantics`
- `ActivateCompensationandSagaSemantics`
- `SuspendCompensationandSagaSemantics`
- `CorrectCompensationandSagaSemantics`
- `RetireCompensationandSagaSemantics`

Reference Events:

- `CompensationandSagaSemanticsCreated`
- `CompensationandSagaSemanticsValidated`
- `CompensationandSagaSemanticsApproved`
- `CompensationandSagaSemanticsActivated`
- `CompensationandSagaSemanticsSuspended`
- `CompensationandSagaSemanticsCorrected`
- `CompensationandSagaSemanticsRetired`

Reference queries:

- `GetCompensationandSagaSemantics`
- `ListCompensationandSagaSemanticsRecords`
- `GetCompensationandSagaSemanticsTimeline`
- `GetCompensationandSagaSemanticsEvidence`
- `GetCompensationandSagaSemanticsDecisionPackage`
- `GetCompensationandSagaSemanticsExceptions`
- `GetCompensationandSagaSemanticsAuditTrail`

Reference API surface:

```text
POST /api/v1/compensationandsagasemantics/commands
GET  /api/v1/compensationandsagasemantics/{id}
GET  /api/v1/compensationandsagasemantics/{id}/timeline
GET  /api/v1/compensationandsagasemantics/{id}/evidence
GET  /api/v1/compensationandsagasemantics/{id}/decisions
POST /api/v1/compensationandsagasemantics/{id}/exceptions
POST /api/v1/compensationandsagasemantics/{id}/corrections
```
...
|---|---|
| `compensationandsagasemantics_aggregate` | authoritative subject |
| `compensationandsagasemantics_version` | immutable submitted, approved, issued, or signed versions |
| `compensationandsagasemantics_relationship` | governed relationships |
| `compensationandsagasemantics_decision` | binding Decisions and rationale |
| `compensationandsagasemantics_evidence_link` | provenance and evidence relationships |
| `compensationandsagasemantics_event_outbox` | transactional Event publication |
| `compensationandsagasemantics_idempotency` | duplicate-write protection |
| `compensationandsagasemantics_exception` | exception, claim, dispute, or hold |
| `compensationandsagasemantics_correction` | correction and supersession lineage |
| `compensationandsagasemantics_audit` | privileged action evidence |
