...
| Volume | `11` |
| Chapter ID | `V11-24` |
| Subject | `DeprecationandRetirement` |
...
This chapter defines how GTOS shall **define interoperable semantics, schemas, compatibility, security, failure, testing, and lifecycle governance for Deprecation and Retirement**.
...
|---|---|
| `DeprecationandRetirement` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationandRetirementVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationandRetirementDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationandRetirementEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DeprecationandRetirementException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DeprecationandRetirement {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDeprecationandRetirement`
- `ValidateDeprecationandRetirement`
- `ApproveDeprecationandRetirement`
- `ActivateDeprecationandRetirement`
- `SuspendDeprecationandRetirement`
- `CorrectDeprecationandRetirement`
- `RetireDeprecationandRetirement`

Reference Events:

- `DeprecationandRetirementCreated`
- `DeprecationandRetirementValidated`
- `DeprecationandRetirementApproved`
- `DeprecationandRetirementActivated`
- `DeprecationandRetirementSuspended`
- `DeprecationandRetirementCorrected`
- `DeprecationandRetirementRetired`

Reference queries:

- `GetDeprecationandRetirement`
- `ListDeprecationandRetirementRecords`
- `GetDeprecationandRetirementTimeline`
- `GetDeprecationandRetirementEvidence`
- `GetDeprecationandRetirementDecisionPackage`
- `GetDeprecationandRetirementExceptions`
- `GetDeprecationandRetirementAuditTrail`

Reference API surface:

```text
POST /api/v1/deprecationandretirement/commands
GET  /api/v1/deprecationandretirement/{id}
GET  /api/v1/deprecationandretirement/{id}/timeline
GET  /api/v1/deprecationandretirement/{id}/evidence
GET  /api/v1/deprecationandretirement/{id}/decisions
POST /api/v1/deprecationandretirement/{id}/exceptions
POST /api/v1/deprecationandretirement/{id}/corrections
```
...
|---|---|
| `deprecationandretirement_aggregate` | authoritative subject |
| `deprecationandretirement_version` | immutable submitted, approved, issued, or signed versions |
| `deprecationandretirement_relationship` | governed relationships |
| `deprecationandretirement_decision` | binding Decisions and rationale |
| `deprecationandretirement_evidence_link` | provenance and evidence relationships |
| `deprecationandretirement_event_outbox` | transactional Event publication |
| `deprecationandretirement_idempotency` | duplicate-write protection |
| `deprecationandretirement_exception` | exception, claim, dispute, or hold |
| `deprecationandretirement_correction` | correction and supersession lineage |
| `deprecationandretirement_audit` | privileged action evidence |
