...
This chapter defines how GTOS shall **define entities, value objects, relationships, aggregates, invariants, lifecycle state, effective time, correction, and concurrency for CRM**.
...
|---|---|
| `crmaggregatemodel_aggregate` | authoritative subject |
| `crmaggregatemodel_version` | immutable submitted, approved, issued, or signed versions |
| `crmaggregatemodel_relationship` | governed relationships |
| `crmaggregatemodel_decision` | binding Decisions and rationale |
| `crmaggregatemodel_evidence_link` | provenance and evidence relationships |
| `crmaggregatemodel_event_outbox` | transactional Event publication |
| `crmaggregatemodel_idempotency` | duplicate-write protection |
| `crmaggregatemodel_exception` | exception, claim, dispute, or hold |
| `crmaggregatemodel_correction` | correction and supersession lineage |
| `crmaggregatemodel_audit` | privileged action evidence |
