...
|---|---|
| `volume18conformancematrix_aggregate` | authoritative subject |
| `volume18conformancematrix_version` | immutable submitted, approved, issued, or signed versions |
| `volume18conformancematrix_relationship` | governed relationships |
| `volume18conformancematrix_decision` | binding Decisions and rationale |
| `volume18conformancematrix_evidence_link` | provenance and evidence relationships |
| `volume18conformancematrix_event_outbox` | transactional Event publication |
| `volume18conformancematrix_idempotency` | duplicate-write protection |
| `volume18conformancematrix_exception` | exception, claim, dispute, or hold |
| `volume18conformancematrix_correction` | correction and supersession lineage |
| `volume18conformancematrix_audit` | privileged action evidence |
