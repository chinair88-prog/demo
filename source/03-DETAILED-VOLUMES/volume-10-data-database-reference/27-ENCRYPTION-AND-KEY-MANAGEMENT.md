...
| Volume | `10` |
| Chapter ID | `V10-27` |
| Subject | `EncryptionandKeyManagement` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Encryption and Key Management**.
...
|---|---|
| `EncryptionandKeyManagement` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EncryptionandKeyManagementVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EncryptionandKeyManagementDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EncryptionandKeyManagementEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EncryptionandKeyManagementException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateEncryptionandKeyManagement`
- `ValidateEncryptionandKeyManagement`
- `ApproveEncryptionandKeyManagement`
- `ActivateEncryptionandKeyManagement`
- `SuspendEncryptionandKeyManagement`
- `CorrectEncryptionandKeyManagement`
- `RetireEncryptionandKeyManagement`

Reference Events:

- `EncryptionandKeyManagementCreated`
- `EncryptionandKeyManagementValidated`
- `EncryptionandKeyManagementApproved`
- `EncryptionandKeyManagementActivated`
- `EncryptionandKeyManagementSuspended`
- `EncryptionandKeyManagementCorrected`
- `EncryptionandKeyManagementRetired`

Reference queries:

- `GetEncryptionandKeyManagement`
- `ListEncryptionandKeyManagementRecords`
- `GetEncryptionandKeyManagementTimeline`
- `GetEncryptionandKeyManagementEvidence`
- `GetEncryptionandKeyManagementDecisionPackage`
- `GetEncryptionandKeyManagementExceptions`
- `GetEncryptionandKeyManagementAuditTrail`

Reference API surface:

```text
POST /api/v1/encryptionandkeymanagement/commands
GET  /api/v1/encryptionandkeymanagement/{id}
GET  /api/v1/encryptionandkeymanagement/{id}/timeline
GET  /api/v1/encryptionandkeymanagement/{id}/evidence
GET  /api/v1/encryptionandkeymanagement/{id}/decisions
POST /api/v1/encryptionandkeymanagement/{id}/exceptions
POST /api/v1/encryptionandkeymanagement/{id}/corrections
```
...
|---|---|
| `encryptionandkeymanagement_aggregate` | authoritative subject |
| `encryptionandkeymanagement_version` | immutable submitted, approved, issued, or signed versions |
| `encryptionandkeymanagement_relationship` | governed relationships |
| `encryptionandkeymanagement_decision` | binding Decisions and rationale |
| `encryptionandkeymanagement_evidence_link` | provenance and evidence relationships |
| `encryptionandkeymanagement_event_outbox` | transactional Event publication |
| `encryptionandkeymanagement_idempotency` | duplicate-write protection |
| `encryptionandkeymanagement_exception` | exception, claim, dispute, or hold |
| `encryptionandkeymanagement_correction` | correction and supersession lineage |
| `encryptionandkeymanagement_audit` | privileged action evidence |
