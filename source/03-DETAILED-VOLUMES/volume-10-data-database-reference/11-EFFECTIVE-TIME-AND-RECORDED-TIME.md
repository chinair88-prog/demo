...
| Volume | `10` |
| Chapter ID | `V10-11` |
| Subject | `EffectiveTimeandRecordedTime` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Effective Time and Recorded Time**.
...
|---|---|
| `EffectiveTimeandRecordedTime` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EffectiveTimeandRecordedTimeVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EffectiveTimeandRecordedTimeDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EffectiveTimeandRecordedTimeEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EffectiveTimeandRecordedTimeException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
EffectiveTimeandRecordedTime {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateEffectiveTimeandRecordedTime`
- `ValidateEffectiveTimeandRecordedTime`
- `ApproveEffectiveTimeandRecordedTime`
- `ActivateEffectiveTimeandRecordedTime`
- `SuspendEffectiveTimeandRecordedTime`
- `CorrectEffectiveTimeandRecordedTime`
- `RetireEffectiveTimeandRecordedTime`

Reference Events:

- `EffectiveTimeandRecordedTimeCreated`
- `EffectiveTimeandRecordedTimeValidated`
- `EffectiveTimeandRecordedTimeApproved`
- `EffectiveTimeandRecordedTimeActivated`
- `EffectiveTimeandRecordedTimeSuspended`
- `EffectiveTimeandRecordedTimeCorrected`
- `EffectiveTimeandRecordedTimeRetired`

Reference queries:

- `GetEffectiveTimeandRecordedTime`
- `ListEffectiveTimeandRecordedTimeRecords`
- `GetEffectiveTimeandRecordedTimeTimeline`
- `GetEffectiveTimeandRecordedTimeEvidence`
- `GetEffectiveTimeandRecordedTimeDecisionPackage`
- `GetEffectiveTimeandRecordedTimeExceptions`
- `GetEffectiveTimeandRecordedTimeAuditTrail`

Reference API surface:

```text
POST /api/v1/effectivetimeandrecordedtime/commands
GET  /api/v1/effectivetimeandrecordedtime/{id}
GET  /api/v1/effectivetimeandrecordedtime/{id}/timeline
GET  /api/v1/effectivetimeandrecordedtime/{id}/evidence
GET  /api/v1/effectivetimeandrecordedtime/{id}/decisions
POST /api/v1/effectivetimeandrecordedtime/{id}/exceptions
POST /api/v1/effectivetimeandrecordedtime/{id}/corrections
```
...
|---|---|
| `effectivetimeandrecordedtime_aggregate` | authoritative subject |
| `effectivetimeandrecordedtime_version` | immutable submitted, approved, issued, or signed versions |
| `effectivetimeandrecordedtime_relationship` | governed relationships |
| `effectivetimeandrecordedtime_decision` | binding Decisions and rationale |
| `effectivetimeandrecordedtime_evidence_link` | provenance and evidence relationships |
| `effectivetimeandrecordedtime_event_outbox` | transactional Event publication |
| `effectivetimeandrecordedtime_idempotency` | duplicate-write protection |
| `effectivetimeandrecordedtime_exception` | exception, claim, dispute, or hold |
| `effectivetimeandrecordedtime_correction` | correction and supersession lineage |
| `effectivetimeandrecordedtime_audit` | privileged action evidence |
