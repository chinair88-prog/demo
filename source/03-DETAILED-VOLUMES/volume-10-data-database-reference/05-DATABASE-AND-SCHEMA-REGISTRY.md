...
| Volume | `10` |
| Chapter ID | `V10-05` |
| Subject | `DatabaseandSchemaRegistry` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Database and Schema Registry**.
...
|---|---|
| `DatabaseandSchemaRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseandSchemaRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseandSchemaRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseandSchemaRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseandSchemaRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DatabaseandSchemaRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDatabaseandSchemaRegistry`
- `ValidateDatabaseandSchemaRegistry`
- `ApproveDatabaseandSchemaRegistry`
- `ActivateDatabaseandSchemaRegistry`
- `SuspendDatabaseandSchemaRegistry`
- `CorrectDatabaseandSchemaRegistry`
- `RetireDatabaseandSchemaRegistry`

Reference Events:

- `DatabaseandSchemaRegistryCreated`
- `DatabaseandSchemaRegistryValidated`
- `DatabaseandSchemaRegistryApproved`
- `DatabaseandSchemaRegistryActivated`
- `DatabaseandSchemaRegistrySuspended`
- `DatabaseandSchemaRegistryCorrected`
- `DatabaseandSchemaRegistryRetired`

Reference queries:

- `GetDatabaseandSchemaRegistry`
- `ListDatabaseandSchemaRegistryRecords`
- `GetDatabaseandSchemaRegistryTimeline`
- `GetDatabaseandSchemaRegistryEvidence`
- `GetDatabaseandSchemaRegistryDecisionPackage`
- `GetDatabaseandSchemaRegistryExceptions`
- `GetDatabaseandSchemaRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/databaseandschemaregistry/commands
GET  /api/v1/databaseandschemaregistry/{id}
GET  /api/v1/databaseandschemaregistry/{id}/timeline
GET  /api/v1/databaseandschemaregistry/{id}/evidence
GET  /api/v1/databaseandschemaregistry/{id}/decisions
POST /api/v1/databaseandschemaregistry/{id}/exceptions
POST /api/v1/databaseandschemaregistry/{id}/corrections
```
...
|---|---|
| `databaseandschemaregistry_aggregate` | authoritative subject |
| `databaseandschemaregistry_version` | immutable submitted, approved, issued, or signed versions |
| `databaseandschemaregistry_relationship` | governed relationships |
| `databaseandschemaregistry_decision` | binding Decisions and rationale |
| `databaseandschemaregistry_evidence_link` | provenance and evidence relationships |
| `databaseandschemaregistry_event_outbox` | transactional Event publication |
| `databaseandschemaregistry_idempotency` | duplicate-write protection |
| `databaseandschemaregistry_exception` | exception, claim, dispute, or hold |
| `databaseandschemaregistry_correction` | correction and supersession lineage |
| `databaseandschemaregistry_audit` | privileged action evidence |
