...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Data Lineage**.
...
|---|---|
| `DataLineage` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataLineageVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataLineageDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataLineageEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DataLineageException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `DataLineageCreated`
- `DataLineageValidated`
- `DataLineageApproved`
- `DataLineageActivated`
- `DataLineageSuspended`
- `DataLineageCorrected`
- `DataLineageRetired`

Reference queries:

- `GetDataLineage`
- `ListDataLineageRecords`
- `GetDataLineageTimeline`
- `GetDataLineageEvidence`
- `GetDataLineageDecisionPackage`
- `GetDataLineageExceptions`
- `GetDataLineageAuditTrail`

Reference API surface:

```text
POST /api/v1/datalineage/commands
GET  /api/v1/datalineage/{id}
GET  /api/v1/datalineage/{id}/timeline
GET  /api/v1/datalineage/{id}/evidence
GET  /api/v1/datalineage/{id}/decisions
POST /api/v1/datalineage/{id}/exceptions
POST /api/v1/datalineage/{id}/corrections
```
...
|---|---|
| `datalineage_aggregate` | authoritative subject |
| `datalineage_version` | immutable submitted, approved, issued, or signed versions |
| `datalineage_relationship` | governed relationships |
| `datalineage_decision` | binding Decisions and rationale |
| `datalineage_evidence_link` | provenance and evidence relationships |
| `datalineage_event_outbox` | transactional Event publication |
| `datalineage_idempotency` | duplicate-write protection |
| `datalineage_exception` | exception, claim, dispute, or hold |
| `datalineage_correction` | correction and supersession lineage |
| `datalineage_audit` | privileged action evidence |
