...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Identity and Keys**.
...
|---|---|
| `IdentityandKeys` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityandKeysVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityandKeysDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityandKeysEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityandKeysException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateIdentityandKeys`
- `ValidateIdentityandKeys`
- `ApproveIdentityandKeys`
- `ActivateIdentityandKeys`
- `SuspendIdentityandKeys`
- `CorrectIdentityandKeys`
- `RetireIdentityandKeys`

Reference Events:

- `IdentityandKeysCreated`
- `IdentityandKeysValidated`
- `IdentityandKeysApproved`
- `IdentityandKeysActivated`
- `IdentityandKeysSuspended`
- `IdentityandKeysCorrected`
- `IdentityandKeysRetired`

Reference queries:

- `GetIdentityandKeys`
- `ListIdentityandKeysRecords`
- `GetIdentityandKeysTimeline`
- `GetIdentityandKeysEvidence`
- `GetIdentityandKeysDecisionPackage`
- `GetIdentityandKeysExceptions`
- `GetIdentityandKeysAuditTrail`

Reference API surface:

```text
POST /api/v1/identityandkeys/commands
GET  /api/v1/identityandkeys/{id}
GET  /api/v1/identityandkeys/{id}/timeline
GET  /api/v1/identityandkeys/{id}/evidence
GET  /api/v1/identityandkeys/{id}/decisions
POST /api/v1/identityandkeys/{id}/exceptions
POST /api/v1/identityandkeys/{id}/corrections
```
...
|---|---|
| `identityandkeys_aggregate` | authoritative subject |
| `identityandkeys_version` | immutable submitted, approved, issued, or signed versions |
| `identityandkeys_relationship` | governed relationships |
| `identityandkeys_decision` | binding Decisions and rationale |
| `identityandkeys_evidence_link` | provenance and evidence relationships |
| `identityandkeys_event_outbox` | transactional Event publication |
| `identityandkeys_idempotency` | duplicate-write protection |
| `identityandkeys_exception` | exception, claim, dispute, or hold |
| `identityandkeys_correction` | correction and supersession lineage |
| `identityandkeys_audit` | privileged action evidence |
