# Database Ownership and Data Lineage Matrix

| Metadata | Value |
|---|---|
| Volume | `10` |
| Chapter ID | `V10-SYNTH` |
| Subject | `DatabaseOwnershipMatrix` |
...
This chapter defines how GTOS shall **trace every database, schema, table family, service owner, migration, Event, projection, report, AI store, backup, retention, and decommissioning state**.
...
|---|---|
| `DatabaseOwnershipMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseOwnershipMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseOwnershipMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseOwnershipMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DatabaseOwnershipMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DatabaseOwnershipMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDatabaseOwnershipMatrix`
- `ValidateDatabaseOwnershipMatrix`
- `ApproveDatabaseOwnershipMatrix`
- `ActivateDatabaseOwnershipMatrix`
- `SuspendDatabaseOwnershipMatrix`
- `CorrectDatabaseOwnershipMatrix`
- `RetireDatabaseOwnershipMatrix`

Reference Events:

- `DatabaseOwnershipMatrixCreated`
- `DatabaseOwnershipMatrixValidated`
- `DatabaseOwnershipMatrixApproved`
- `DatabaseOwnershipMatrixActivated`
- `DatabaseOwnershipMatrixSuspended`
- `DatabaseOwnershipMatrixCorrected`
- `DatabaseOwnershipMatrixRetired`

Reference queries:

- `GetDatabaseOwnershipMatrix`
- `ListDatabaseOwnershipMatrixRecords`
- `GetDatabaseOwnershipMatrixTimeline`
- `GetDatabaseOwnershipMatrixEvidence`
- `GetDatabaseOwnershipMatrixDecisionPackage`
- `GetDatabaseOwnershipMatrixExceptions`
- `GetDatabaseOwnershipMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/databaseownershipmatrix/commands
GET  /api/v1/databaseownershipmatrix/{id}
GET  /api/v1/databaseownershipmatrix/{id}/timeline
GET  /api/v1/databaseownershipmatrix/{id}/evidence
GET  /api/v1/databaseownershipmatrix/{id}/decisions
POST /api/v1/databaseownershipmatrix/{id}/exceptions
POST /api/v1/databaseownershipmatrix/{id}/corrections
```
...
|---|---|
| `databaseownershipmatrix_aggregate` | authoritative subject |
| `databaseownershipmatrix_version` | immutable submitted, approved, issued, or signed versions |
| `databaseownershipmatrix_relationship` | governed relationships |
| `databaseownershipmatrix_decision` | binding Decisions and rationale |
| `databaseownershipmatrix_evidence_link` | provenance and evidence relationships |
| `databaseownershipmatrix_event_outbox` | transactional Event publication |
| `databaseownershipmatrix_idempotency` | duplicate-write protection |
| `databaseownershipmatrix_exception` | exception, claim, dispute, or hold |
| `databaseownershipmatrix_correction` | correction and supersession lineage |
| `databaseownershipmatrix_audit` | privileged action evidence |
