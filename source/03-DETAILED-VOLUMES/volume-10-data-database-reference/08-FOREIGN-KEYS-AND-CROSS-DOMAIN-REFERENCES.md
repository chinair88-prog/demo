# Foreign Keys and Cross-Domain References

| Metadata | Value |
|---|---|
| Volume | `10` |
| Chapter ID | `V10-08` |
| Subject | `ForeignKeysandCross-DomainReferences` |
...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Foreign Keys and Cross-Domain References**.
...
|---|---|
| `ForeignKeysandCross-DomainReferences` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ForeignKeysandCross-DomainReferencesVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ForeignKeysandCross-DomainReferencesDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ForeignKeysandCross-DomainReferencesEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ForeignKeysandCross-DomainReferencesException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ForeignKeysandCross-DomainReferences {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateForeignKeysandCross-DomainReferences`
- `ValidateForeignKeysandCross-DomainReferences`
- `ApproveForeignKeysandCross-DomainReferences`
- `ActivateForeignKeysandCross-DomainReferences`
- `SuspendForeignKeysandCross-DomainReferences`
- `CorrectForeignKeysandCross-DomainReferences`
- `RetireForeignKeysandCross-DomainReferences`

Reference Events:

- `ForeignKeysandCross-DomainReferencesCreated`
- `ForeignKeysandCross-DomainReferencesValidated`
- `ForeignKeysandCross-DomainReferencesApproved`
- `ForeignKeysandCross-DomainReferencesActivated`
- `ForeignKeysandCross-DomainReferencesSuspended`
- `ForeignKeysandCross-DomainReferencesCorrected`
- `ForeignKeysandCross-DomainReferencesRetired`

Reference queries:

- `GetForeignKeysandCross-DomainReferences`
- `ListForeignKeysandCross-DomainReferencesRecords`
- `GetForeignKeysandCross-DomainReferencesTimeline`
- `GetForeignKeysandCross-DomainReferencesEvidence`
- `GetForeignKeysandCross-DomainReferencesDecisionPackage`
- `GetForeignKeysandCross-DomainReferencesExceptions`
- `GetForeignKeysandCross-DomainReferencesAuditTrail`

Reference API surface:

```text
POST /api/v1/foreignkeysandcross_domainreferences/commands
GET  /api/v1/foreignkeysandcross_domainreferences/{id}
GET  /api/v1/foreignkeysandcross_domainreferences/{id}/timeline
GET  /api/v1/foreignkeysandcross_domainreferences/{id}/evidence
GET  /api/v1/foreignkeysandcross_domainreferences/{id}/decisions
POST /api/v1/foreignkeysandcross_domainreferences/{id}/exceptions
POST /api/v1/foreignkeysandcross_domainreferences/{id}/corrections
```
...
|---|---|
| `foreignkeysandcross_domainreferences_aggregate` | authoritative subject |
| `foreignkeysandcross_domainreferences_version` | immutable submitted, approved, issued, or signed versions |
| `foreignkeysandcross_domainreferences_relationship` | governed relationships |
| `foreignkeysandcross_domainreferences_decision` | binding Decisions and rationale |
| `foreignkeysandcross_domainreferences_evidence_link` | provenance and evidence relationships |
| `foreignkeysandcross_domainreferences_event_outbox` | transactional Event publication |
| `foreignkeysandcross_domainreferences_idempotency` | duplicate-write protection |
| `foreignkeysandcross_domainreferences_exception` | exception, claim, dispute, or hold |
| `foreignkeysandcross_domainreferences_correction` | correction and supersession lineage |
| `foreignkeysandcross_domainreferences_audit` | privileged action evidence |
...
- assist schema and lineage analysis
- detect data-quality anomalies
- summarize migration and reconciliation risk
- never mutate authoritative data outside typed Domain Tools
