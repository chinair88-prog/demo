...
This chapter defines how GTOS shall **define enterprise and Domain data ownership, semantics, persistence, quality, lineage, correction, protection, operations, and verification for Row-Level Security**.
...
|---|---|
| `Row-LevelSecurity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Row-LevelSecurityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Row-LevelSecurityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Row-LevelSecurityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Row-LevelSecurityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateRow-LevelSecurity`
- `ValidateRow-LevelSecurity`
- `ApproveRow-LevelSecurity`
- `ActivateRow-LevelSecurity`
- `SuspendRow-LevelSecurity`
- `CorrectRow-LevelSecurity`
- `RetireRow-LevelSecurity`

Reference Events:

- `Row-LevelSecurityCreated`
- `Row-LevelSecurityValidated`
- `Row-LevelSecurityApproved`
- `Row-LevelSecurityActivated`
- `Row-LevelSecuritySuspended`
- `Row-LevelSecurityCorrected`
- `Row-LevelSecurityRetired`

Reference queries:

- `GetRow-LevelSecurity`
- `ListRow-LevelSecurityRecords`
- `GetRow-LevelSecurityTimeline`
- `GetRow-LevelSecurityEvidence`
- `GetRow-LevelSecurityDecisionPackage`
- `GetRow-LevelSecurityExceptions`
- `GetRow-LevelSecurityAuditTrail`

Reference API surface:

```text
POST /api/v1/row_levelsecurity/commands
GET  /api/v1/row_levelsecurity/{id}
GET  /api/v1/row_levelsecurity/{id}/timeline
GET  /api/v1/row_levelsecurity/{id}/evidence
GET  /api/v1/row_levelsecurity/{id}/decisions
POST /api/v1/row_levelsecurity/{id}/exceptions
POST /api/v1/row_levelsecurity/{id}/corrections
```
...
|---|---|
| `row_levelsecurity_aggregate` | authoritative subject |
| `row_levelsecurity_version` | immutable submitted, approved, issued, or signed versions |
| `row_levelsecurity_relationship` | governed relationships |
| `row_levelsecurity_decision` | binding Decisions and rationale |
| `row_levelsecurity_evidence_link` | provenance and evidence relationships |
| `row_levelsecurity_event_outbox` | transactional Event publication |
| `row_levelsecurity_idempotency` | duplicate-write protection |
| `row_levelsecurity_exception` | exception, claim, dispute, or hold |
| `row_levelsecurity_correction` | correction and supersession lineage |
| `row_levelsecurity_audit` | privileged action evidence |
