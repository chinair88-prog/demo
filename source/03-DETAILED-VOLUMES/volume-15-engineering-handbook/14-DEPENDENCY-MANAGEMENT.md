...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Dependency Management**.
...
|---|---|
| `DependencyManagement` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DependencyManagementVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DependencyManagementDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DependencyManagementEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DependencyManagementException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveDependencyManagement`
- `ActivateDependencyManagement`
- `SuspendDependencyManagement`
- `CorrectDependencyManagement`
- `RetireDependencyManagement`

Reference Events:

- `DependencyManagementCreated`
- `DependencyManagementValidated`
- `DependencyManagementApproved`
- `DependencyManagementActivated`
- `DependencyManagementSuspended`
- `DependencyManagementCorrected`
- `DependencyManagementRetired`

Reference queries:

- `GetDependencyManagement`
- `ListDependencyManagementRecords`
- `GetDependencyManagementTimeline`
- `GetDependencyManagementEvidence`
- `GetDependencyManagementDecisionPackage`
- `GetDependencyManagementExceptions`
- `GetDependencyManagementAuditTrail`

Reference API surface:

```text
POST /api/v1/dependencymanagement/commands
GET  /api/v1/dependencymanagement/{id}
GET  /api/v1/dependencymanagement/{id}/timeline
GET  /api/v1/dependencymanagement/{id}/evidence
GET  /api/v1/dependencymanagement/{id}/decisions
POST /api/v1/dependencymanagement/{id}/exceptions
POST /api/v1/dependencymanagement/{id}/corrections
```
...
|---|---|
| `dependencymanagement_aggregate` | authoritative subject |
| `dependencymanagement_version` | immutable submitted, approved, issued, or signed versions |
| `dependencymanagement_relationship` | governed relationships |
| `dependencymanagement_decision` | binding Decisions and rationale |
| `dependencymanagement_evidence_link` | provenance and evidence relationships |
| `dependencymanagement_event_outbox` | transactional Event publication |
| `dependencymanagement_idempotency` | duplicate-write protection |
| `dependencymanagement_exception` | exception, claim, dispute, or hold |
| `dependencymanagement_correction` | correction and supersession lineage |
| `dependencymanagement_audit` | privileged action evidence |
...
- `Dependency Management` is part of the target GTOS handbook scope.
