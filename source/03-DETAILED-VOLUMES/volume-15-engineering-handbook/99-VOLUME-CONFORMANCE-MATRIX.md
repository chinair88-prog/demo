# Volume 15 Conformance and Evidence Matrix

| Metadata | Value |
|---|---|
| Volume | `15` |
| Chapter ID | `V15-SYNTH` |
| Subject | `Volume15ConformanceMatrix` |
...
This chapter defines how GTOS shall **trace every requirement in Volume 15 to owner, repository source, configuration, deployment, runtime evidence, tests, runbooks, exceptions and review status**.
...
|---|---|
| `Volume15ConformanceMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume15ConformanceMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume15ConformanceMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume15ConformanceMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume15ConformanceMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Volume15ConformanceMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateVolume15ConformanceMatrix`
- `ValidateVolume15ConformanceMatrix`
- `ApproveVolume15ConformanceMatrix`
- `ActivateVolume15ConformanceMatrix`
- `SuspendVolume15ConformanceMatrix`
- `CorrectVolume15ConformanceMatrix`
- `RetireVolume15ConformanceMatrix`

Reference Events:

- `Volume15ConformanceMatrixCreated`
- `Volume15ConformanceMatrixValidated`
- `Volume15ConformanceMatrixApproved`
- `Volume15ConformanceMatrixActivated`
- `Volume15ConformanceMatrixSuspended`
- `Volume15ConformanceMatrixCorrected`
- `Volume15ConformanceMatrixRetired`

Reference queries:

- `GetVolume15ConformanceMatrix`
- `ListVolume15ConformanceMatrixRecords`
- `GetVolume15ConformanceMatrixTimeline`
- `GetVolume15ConformanceMatrixEvidence`
- `GetVolume15ConformanceMatrixDecisionPackage`
- `GetVolume15ConformanceMatrixExceptions`
- `GetVolume15ConformanceMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/volume15conformancematrix/commands
GET  /api/v1/volume15conformancematrix/{id}
GET  /api/v1/volume15conformancematrix/{id}/timeline
GET  /api/v1/volume15conformancematrix/{id}/evidence
GET  /api/v1/volume15conformancematrix/{id}/decisions
POST /api/v1/volume15conformancematrix/{id}/exceptions
POST /api/v1/volume15conformancematrix/{id}/corrections
```
...
|---|---|
| `volume15conformancematrix_aggregate` | authoritative subject |
| `volume15conformancematrix_version` | immutable submitted, approved, issued, or signed versions |
| `volume15conformancematrix_relationship` | governed relationships |
| `volume15conformancematrix_decision` | binding Decisions and rationale |
| `volume15conformancematrix_evidence_link` | provenance and evidence relationships |
| `volume15conformancematrix_event_outbox` | transactional Event publication |
| `volume15conformancematrix_idempotency` | duplicate-write protection |
| `volume15conformancematrix_exception` | exception, claim, dispute, or hold |
| `volume15conformancematrix_correction` | correction and supersession lineage |
| `volume15conformancematrix_audit` | privileged action evidence |
