...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Repository Standards**.
...
|---|---|
| `RepositoryStandards` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RepositoryStandardsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RepositoryStandardsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RepositoryStandardsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `RepositoryStandardsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateRepositoryStandards`
- `ValidateRepositoryStandards`
- `ApproveRepositoryStandards`
- `ActivateRepositoryStandards`
- `SuspendRepositoryStandards`
- `CorrectRepositoryStandards`
- `RetireRepositoryStandards`

Reference Events:

- `RepositoryStandardsCreated`
- `RepositoryStandardsValidated`
- `RepositoryStandardsApproved`
- `RepositoryStandardsActivated`
- `RepositoryStandardsSuspended`
- `RepositoryStandardsCorrected`
- `RepositoryStandardsRetired`

Reference queries:

- `GetRepositoryStandards`
- `ListRepositoryStandardsRecords`
- `GetRepositoryStandardsTimeline`
- `GetRepositoryStandardsEvidence`
- `GetRepositoryStandardsDecisionPackage`
- `GetRepositoryStandardsExceptions`
- `GetRepositoryStandardsAuditTrail`

Reference API surface:

```text
POST /api/v1/repositorystandards/commands
GET  /api/v1/repositorystandards/{id}
GET  /api/v1/repositorystandards/{id}/timeline
GET  /api/v1/repositorystandards/{id}/evidence
GET  /api/v1/repositorystandards/{id}/decisions
POST /api/v1/repositorystandards/{id}/exceptions
POST /api/v1/repositorystandards/{id}/corrections
```
...
|---|---|
| `repositorystandards_aggregate` | authoritative subject |
| `repositorystandards_version` | immutable submitted, approved, issued, or signed versions |
| `repositorystandards_relationship` | governed relationships |
| `repositorystandards_decision` | binding Decisions and rationale |
| `repositorystandards_evidence_link` | provenance and evidence relationships |
| `repositorystandards_event_outbox` | transactional Event publication |
| `repositorystandards_idempotency` | duplicate-write protection |
| `repositorystandards_exception` | exception, claim, dispute, or hold |
| `repositorystandards_correction` | correction and supersession lineage |
| `repositorystandards_audit` | privileged action evidence |
...
- `Repository Standards` is part of the target GTOS handbook scope.
