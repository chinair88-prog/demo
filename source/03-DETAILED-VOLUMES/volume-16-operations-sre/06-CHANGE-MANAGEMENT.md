...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Change Management**.
...
|---|---|
| `ChangeManagement` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChangeManagementVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChangeManagementDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChangeManagementEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChangeManagementException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveChangeManagement`
- `ActivateChangeManagement`
- `SuspendChangeManagement`
- `CorrectChangeManagement`
- `RetireChangeManagement`

Reference Events:

- `ChangeManagementCreated`
- `ChangeManagementValidated`
- `ChangeManagementApproved`
- `ChangeManagementActivated`
- `ChangeManagementSuspended`
- `ChangeManagementCorrected`
- `ChangeManagementRetired`

Reference queries:

- `GetChangeManagement`
- `ListChangeManagementRecords`
- `GetChangeManagementTimeline`
- `GetChangeManagementEvidence`
- `GetChangeManagementDecisionPackage`
- `GetChangeManagementExceptions`
- `GetChangeManagementAuditTrail`

Reference API surface:

```text
POST /api/v1/changemanagement/commands
GET  /api/v1/changemanagement/{id}
GET  /api/v1/changemanagement/{id}/timeline
GET  /api/v1/changemanagement/{id}/evidence
GET  /api/v1/changemanagement/{id}/decisions
POST /api/v1/changemanagement/{id}/exceptions
POST /api/v1/changemanagement/{id}/corrections
```
...
|---|---|
| `changemanagement_aggregate` | authoritative subject |
| `changemanagement_version` | immutable submitted, approved, issued, or signed versions |
| `changemanagement_relationship` | governed relationships |
| `changemanagement_decision` | binding Decisions and rationale |
| `changemanagement_evidence_link` | provenance and evidence relationships |
| `changemanagement_event_outbox` | transactional Event publication |
| `changemanagement_idempotency` | duplicate-write protection |
| `changemanagement_exception` | exception, claim, dispute, or hold |
| `changemanagement_correction` | correction and supersession lineage |
| `changemanagement_audit` | privileged action evidence |
...
- `Change Management` is part of the target GTOS handbook scope.
