...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Capacity Management**.
...
|---|---|
| `CapacityManagement` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapacityManagementVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapacityManagementDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapacityManagementEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CapacityManagementException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateCapacityManagement`
- `ValidateCapacityManagement`
- `ApproveCapacityManagement`
- `ActivateCapacityManagement`
- `SuspendCapacityManagement`
- `CorrectCapacityManagement`
- `RetireCapacityManagement`

Reference Events:

- `CapacityManagementCreated`
- `CapacityManagementValidated`
- `CapacityManagementApproved`
- `CapacityManagementActivated`
- `CapacityManagementSuspended`
- `CapacityManagementCorrected`
- `CapacityManagementRetired`

Reference queries:

- `GetCapacityManagement`
- `ListCapacityManagementRecords`
- `GetCapacityManagementTimeline`
- `GetCapacityManagementEvidence`
- `GetCapacityManagementDecisionPackage`
- `GetCapacityManagementExceptions`
- `GetCapacityManagementAuditTrail`

Reference API surface:

```text
POST /api/v1/capacitymanagement/commands
GET  /api/v1/capacitymanagement/{id}
GET  /api/v1/capacitymanagement/{id}/timeline
GET  /api/v1/capacitymanagement/{id}/evidence
GET  /api/v1/capacitymanagement/{id}/decisions
POST /api/v1/capacitymanagement/{id}/exceptions
POST /api/v1/capacitymanagement/{id}/corrections
```
...
|---|---|
| `capacitymanagement_aggregate` | authoritative subject |
| `capacitymanagement_version` | immutable submitted, approved, issued, or signed versions |
| `capacitymanagement_relationship` | governed relationships |
| `capacitymanagement_decision` | binding Decisions and rationale |
| `capacitymanagement_evidence_link` | provenance and evidence relationships |
| `capacitymanagement_event_outbox` | transactional Event publication |
| `capacitymanagement_idempotency` | duplicate-write protection |
| `capacitymanagement_exception` | exception, claim, dispute, or hold |
| `capacitymanagement_correction` | correction and supersession lineage |
| `capacitymanagement_audit` | privileged action evidence |
...
- `Capacity Management` is part of the target GTOS handbook scope.
