...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Service Ownership**.
...
|---|---|
| `ServiceOwnership` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceOwnershipVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceOwnershipDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceOwnershipEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceOwnershipException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ActivateServiceOwnership`
- `SuspendServiceOwnership`
- `CorrectServiceOwnership`
- `RetireServiceOwnership`

Reference Events:

- `ServiceOwnershipCreated`
- `ServiceOwnershipValidated`
- `ServiceOwnershipApproved`
- `ServiceOwnershipActivated`
- `ServiceOwnershipSuspended`
- `ServiceOwnershipCorrected`
- `ServiceOwnershipRetired`

Reference queries:

- `GetServiceOwnership`
- `ListServiceOwnershipRecords`
- `GetServiceOwnershipTimeline`
- `GetServiceOwnershipEvidence`
- `GetServiceOwnershipDecisionPackage`
- `GetServiceOwnershipExceptions`
- `GetServiceOwnershipAuditTrail`

Reference API surface:

```text
POST /api/v1/serviceownership/commands
GET  /api/v1/serviceownership/{id}
GET  /api/v1/serviceownership/{id}/timeline
GET  /api/v1/serviceownership/{id}/evidence
GET  /api/v1/serviceownership/{id}/decisions
POST /api/v1/serviceownership/{id}/exceptions
POST /api/v1/serviceownership/{id}/corrections
```
...
|---|---|
| `serviceownership_aggregate` | authoritative subject |
| `serviceownership_version` | immutable submitted, approved, issued, or signed versions |
| `serviceownership_relationship` | governed relationships |
| `serviceownership_decision` | binding Decisions and rationale |
| `serviceownership_evidence_link` | provenance and evidence relationships |
| `serviceownership_event_outbox` | transactional Event publication |
| `serviceownership_idempotency` | duplicate-write protection |
| `serviceownership_exception` | exception, claim, dispute, or hold |
| `serviceownership_correction` | correction and supersession lineage |
| `serviceownership_audit` | privileged action evidence |
...
- `Service Ownership` is part of the target GTOS handbook scope.
