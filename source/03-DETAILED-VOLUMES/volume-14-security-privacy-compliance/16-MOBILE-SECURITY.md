...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Mobile Security**.
...
|---|---|
| `MobileSecurity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MobileSecurityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MobileSecurityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MobileSecurityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `MobileSecurityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveMobileSecurity`
- `ActivateMobileSecurity`
- `SuspendMobileSecurity`
- `CorrectMobileSecurity`
- `RetireMobileSecurity`

Reference Events:

- `MobileSecurityCreated`
- `MobileSecurityValidated`
- `MobileSecurityApproved`
- `MobileSecurityActivated`
- `MobileSecuritySuspended`
- `MobileSecurityCorrected`
- `MobileSecurityRetired`

Reference queries:

- `GetMobileSecurity`
- `ListMobileSecurityRecords`
- `GetMobileSecurityTimeline`
- `GetMobileSecurityEvidence`
- `GetMobileSecurityDecisionPackage`
- `GetMobileSecurityExceptions`
- `GetMobileSecurityAuditTrail`

Reference API surface:

```text
POST /api/v1/mobilesecurity/commands
GET  /api/v1/mobilesecurity/{id}
GET  /api/v1/mobilesecurity/{id}/timeline
GET  /api/v1/mobilesecurity/{id}/evidence
GET  /api/v1/mobilesecurity/{id}/decisions
POST /api/v1/mobilesecurity/{id}/exceptions
POST /api/v1/mobilesecurity/{id}/corrections
```
...
|---|---|
| `mobilesecurity_aggregate` | authoritative subject |
| `mobilesecurity_version` | immutable submitted, approved, issued, or signed versions |
| `mobilesecurity_relationship` | governed relationships |
| `mobilesecurity_decision` | binding Decisions and rationale |
| `mobilesecurity_evidence_link` | provenance and evidence relationships |
| `mobilesecurity_event_outbox` | transactional Event publication |
| `mobilesecurity_idempotency` | duplicate-write protection |
| `mobilesecurity_exception` | exception, claim, dispute, or hold |
| `mobilesecurity_correction` | correction and supersession lineage |
| `mobilesecurity_audit` | privileged action evidence |
...
- `Mobile Security` is part of the target GTOS handbook scope.
