...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Privacy and Purpose**.
...
|---|---|
| `PrivacyandPurpose` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PrivacyandPurposeVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PrivacyandPurposeDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PrivacyandPurposeEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PrivacyandPurposeException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePrivacyandPurpose`
- `ValidatePrivacyandPurpose`
- `ApprovePrivacyandPurpose`
- `ActivatePrivacyandPurpose`
- `SuspendPrivacyandPurpose`
- `CorrectPrivacyandPurpose`
- `RetirePrivacyandPurpose`

Reference Events:

- `PrivacyandPurposeCreated`
- `PrivacyandPurposeValidated`
- `PrivacyandPurposeApproved`
- `PrivacyandPurposeActivated`
- `PrivacyandPurposeSuspended`
- `PrivacyandPurposeCorrected`
- `PrivacyandPurposeRetired`

Reference queries:

- `GetPrivacyandPurpose`
- `ListPrivacyandPurposeRecords`
- `GetPrivacyandPurposeTimeline`
- `GetPrivacyandPurposeEvidence`
- `GetPrivacyandPurposeDecisionPackage`
- `GetPrivacyandPurposeExceptions`
- `GetPrivacyandPurposeAuditTrail`

Reference API surface:

```text
POST /api/v1/privacyandpurpose/commands
GET  /api/v1/privacyandpurpose/{id}
GET  /api/v1/privacyandpurpose/{id}/timeline
GET  /api/v1/privacyandpurpose/{id}/evidence
GET  /api/v1/privacyandpurpose/{id}/decisions
POST /api/v1/privacyandpurpose/{id}/exceptions
POST /api/v1/privacyandpurpose/{id}/corrections
```
...
|---|---|
| `privacyandpurpose_aggregate` | authoritative subject |
| `privacyandpurpose_version` | immutable submitted, approved, issued, or signed versions |
| `privacyandpurpose_relationship` | governed relationships |
| `privacyandpurpose_decision` | binding Decisions and rationale |
| `privacyandpurpose_evidence_link` | provenance and evidence relationships |
| `privacyandpurpose_event_outbox` | transactional Event publication |
| `privacyandpurpose_idempotency` | duplicate-write protection |
| `privacyandpurpose_exception` | exception, claim, dispute, or hold |
| `privacyandpurpose_correction` | correction and supersession lineage |
| `privacyandpurpose_audit` | privileged action evidence |
...
- `Privacy and Purpose` is part of the target GTOS handbook scope.
