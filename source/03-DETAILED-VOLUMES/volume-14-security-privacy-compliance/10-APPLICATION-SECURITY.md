...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Application Security**.
...
|---|---|
| `ApplicationSecurity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ApplicationSecurityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ApplicationSecurityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ApplicationSecurityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ApplicationSecurityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateApplicationSecurity`
- `ValidateApplicationSecurity`
- `ApproveApplicationSecurity`
- `ActivateApplicationSecurity`
- `SuspendApplicationSecurity`
- `CorrectApplicationSecurity`
- `RetireApplicationSecurity`

Reference Events:

- `ApplicationSecurityCreated`
- `ApplicationSecurityValidated`
- `ApplicationSecurityApproved`
- `ApplicationSecurityActivated`
- `ApplicationSecuritySuspended`
- `ApplicationSecurityCorrected`
- `ApplicationSecurityRetired`

Reference queries:

- `GetApplicationSecurity`
- `ListApplicationSecurityRecords`
- `GetApplicationSecurityTimeline`
- `GetApplicationSecurityEvidence`
- `GetApplicationSecurityDecisionPackage`
- `GetApplicationSecurityExceptions`
- `GetApplicationSecurityAuditTrail`

Reference API surface:

```text
POST /api/v1/applicationsecurity/commands
GET  /api/v1/applicationsecurity/{id}
GET  /api/v1/applicationsecurity/{id}/timeline
GET  /api/v1/applicationsecurity/{id}/evidence
GET  /api/v1/applicationsecurity/{id}/decisions
POST /api/v1/applicationsecurity/{id}/exceptions
POST /api/v1/applicationsecurity/{id}/corrections
```
...
|---|---|
| `applicationsecurity_aggregate` | authoritative subject |
| `applicationsecurity_version` | immutable submitted, approved, issued, or signed versions |
| `applicationsecurity_relationship` | governed relationships |
| `applicationsecurity_decision` | binding Decisions and rationale |
| `applicationsecurity_evidence_link` | provenance and evidence relationships |
| `applicationsecurity_event_outbox` | transactional Event publication |
| `applicationsecurity_idempotency` | duplicate-write protection |
| `applicationsecurity_exception` | exception, claim, dispute, or hold |
| `applicationsecurity_correction` | correction and supersession lineage |
| `applicationsecurity_audit` | privileged action evidence |
...
- `Application Security` is part of the target GTOS handbook scope.
