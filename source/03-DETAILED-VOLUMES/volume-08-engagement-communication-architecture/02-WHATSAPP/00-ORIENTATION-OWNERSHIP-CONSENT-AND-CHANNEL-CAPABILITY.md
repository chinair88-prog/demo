# WhatsApp — Orientation, Ownership, Consent, and Channel Capability

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-02-00` |
| Subject | `WhatsAppChannel` |
...
This chapter defines how GTOS shall **define ownership, participant identity, consent, channel capability, provider boundary, retention, and audit for WhatsApp**.
...
|---|---|
| `WhatsAppChannel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppChannelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppChannelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppChannelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppChannelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveWhatsAppChannel`
- `ActivateWhatsAppChannel`
- `SuspendWhatsAppChannel`
- `CorrectWhatsAppChannel`
- `RetireWhatsAppChannel`

Reference Events:

- `WhatsAppChannelCreated`
- `WhatsAppChannelValidated`
- `WhatsAppChannelApproved`
- `WhatsAppChannelActivated`
- `WhatsAppChannelSuspended`
- `WhatsAppChannelCorrected`
- `WhatsAppChannelRetired`

Reference queries:

- `GetWhatsAppChannel`
- `ListWhatsAppChannelRecords`
- `GetWhatsAppChannelTimeline`
- `GetWhatsAppChannelEvidence`
- `GetWhatsAppChannelDecisionPackage`
- `GetWhatsAppChannelExceptions`
- `GetWhatsAppChannelAuditTrail`

Reference API surface:

```text
POST /api/v1/whatsappchannel/commands
GET  /api/v1/whatsappchannel/{id}
GET  /api/v1/whatsappchannel/{id}/timeline
GET  /api/v1/whatsappchannel/{id}/evidence
GET  /api/v1/whatsappchannel/{id}/decisions
POST /api/v1/whatsappchannel/{id}/exceptions
POST /api/v1/whatsappchannel/{id}/corrections
```
...
|---|---|
| `whatsappchannel_aggregate` | authoritative subject |
| `whatsappchannel_version` | immutable submitted, approved, issued, or signed versions |
| `whatsappchannel_relationship` | governed relationships |
| `whatsappchannel_decision` | binding Decisions and rationale |
| `whatsappchannel_evidence_link` | provenance and evidence relationships |
| `whatsappchannel_event_outbox` | transactional Event publication |
| `whatsappchannel_idempotency` | duplicate-write protection |
| `whatsappchannel_exception` | exception, claim, dispute, or hold |
| `whatsappchannel_correction` | correction and supersession lineage |
| `whatsappchannel_audit` | privileged action evidence |
