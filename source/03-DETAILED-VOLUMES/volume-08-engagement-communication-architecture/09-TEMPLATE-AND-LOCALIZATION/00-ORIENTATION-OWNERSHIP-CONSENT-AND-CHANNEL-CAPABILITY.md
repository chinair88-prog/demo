# Template and Localization — Orientation, Ownership, Consent, and Channel Capability

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-09-00` |
| Subject | `TemplateandLocalizationChannel` |
...
This chapter defines how GTOS shall **define ownership, participant identity, consent, channel capability, provider boundary, retention, and audit for Template and Localization**.
...
|---|---|
| `TemplateandLocalizationChannel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationChannelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationChannelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationChannelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TemplateandLocalizationChannelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
TemplateandLocalizationChannel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateTemplateandLocalizationChannel`
- `ValidateTemplateandLocalizationChannel`
- `ApproveTemplateandLocalizationChannel`
- `ActivateTemplateandLocalizationChannel`
- `SuspendTemplateandLocalizationChannel`
- `CorrectTemplateandLocalizationChannel`
- `RetireTemplateandLocalizationChannel`

Reference Events:

- `TemplateandLocalizationChannelCreated`
- `TemplateandLocalizationChannelValidated`
- `TemplateandLocalizationChannelApproved`
- `TemplateandLocalizationChannelActivated`
- `TemplateandLocalizationChannelSuspended`
- `TemplateandLocalizationChannelCorrected`
- `TemplateandLocalizationChannelRetired`

Reference queries:

- `GetTemplateandLocalizationChannel`
- `ListTemplateandLocalizationChannelRecords`
- `GetTemplateandLocalizationChannelTimeline`
- `GetTemplateandLocalizationChannelEvidence`
- `GetTemplateandLocalizationChannelDecisionPackage`
- `GetTemplateandLocalizationChannelExceptions`
- `GetTemplateandLocalizationChannelAuditTrail`

Reference API surface:

```text
POST /api/v1/templateandlocalizationchannel/commands
GET  /api/v1/templateandlocalizationchannel/{id}
GET  /api/v1/templateandlocalizationchannel/{id}/timeline
GET  /api/v1/templateandlocalizationchannel/{id}/evidence
GET  /api/v1/templateandlocalizationchannel/{id}/decisions
POST /api/v1/templateandlocalizationchannel/{id}/exceptions
POST /api/v1/templateandlocalizationchannel/{id}/corrections
```
...
|---|---|
| `templateandlocalizationchannel_aggregate` | authoritative subject |
| `templateandlocalizationchannel_version` | immutable submitted, approved, issued, or signed versions |
| `templateandlocalizationchannel_relationship` | governed relationships |
| `templateandlocalizationchannel_decision` | binding Decisions and rationale |
| `templateandlocalizationchannel_evidence_link` | provenance and evidence relationships |
| `templateandlocalizationchannel_event_outbox` | transactional Event publication |
| `templateandlocalizationchannel_idempotency` | duplicate-write protection |
| `templateandlocalizationchannel_exception` | exception, claim, dispute, or hold |
| `templateandlocalizationchannel_correction` | correction and supersession lineage |
| `templateandlocalizationchannel_audit` | privileged action evidence |
