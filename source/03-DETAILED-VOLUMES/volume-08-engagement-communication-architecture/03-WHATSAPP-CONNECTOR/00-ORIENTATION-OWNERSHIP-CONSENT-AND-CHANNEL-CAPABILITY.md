# WhatsApp Connector — Orientation, Ownership, Consent, and Channel Capability

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-03-00` |
| Subject | `WhatsAppConnectorChannel` |
...
This chapter defines how GTOS shall **define ownership, participant identity, consent, channel capability, provider boundary, retention, and audit for WhatsApp Connector**.
...
|---|---|
| `WhatsAppConnectorChannel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppConnectorChannelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppConnectorChannelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppConnectorChannelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppConnectorChannelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WhatsAppConnectorChannel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWhatsAppConnectorChannel`
- `ValidateWhatsAppConnectorChannel`
- `ApproveWhatsAppConnectorChannel`
- `ActivateWhatsAppConnectorChannel`
- `SuspendWhatsAppConnectorChannel`
- `CorrectWhatsAppConnectorChannel`
- `RetireWhatsAppConnectorChannel`

Reference Events:

- `WhatsAppConnectorChannelCreated`
- `WhatsAppConnectorChannelValidated`
- `WhatsAppConnectorChannelApproved`
- `WhatsAppConnectorChannelActivated`
- `WhatsAppConnectorChannelSuspended`
- `WhatsAppConnectorChannelCorrected`
- `WhatsAppConnectorChannelRetired`

Reference queries:

- `GetWhatsAppConnectorChannel`
- `ListWhatsAppConnectorChannelRecords`
- `GetWhatsAppConnectorChannelTimeline`
- `GetWhatsAppConnectorChannelEvidence`
- `GetWhatsAppConnectorChannelDecisionPackage`
- `GetWhatsAppConnectorChannelExceptions`
- `GetWhatsAppConnectorChannelAuditTrail`

Reference API surface:

```text
POST /api/v1/whatsappconnectorchannel/commands
GET  /api/v1/whatsappconnectorchannel/{id}
GET  /api/v1/whatsappconnectorchannel/{id}/timeline
GET  /api/v1/whatsappconnectorchannel/{id}/evidence
GET  /api/v1/whatsappconnectorchannel/{id}/decisions
POST /api/v1/whatsappconnectorchannel/{id}/exceptions
POST /api/v1/whatsappconnectorchannel/{id}/corrections
```
...
|---|---|
| `whatsappconnectorchannel_aggregate` | authoritative subject |
| `whatsappconnectorchannel_version` | immutable submitted, approved, issued, or signed versions |
| `whatsappconnectorchannel_relationship` | governed relationships |
| `whatsappconnectorchannel_decision` | binding Decisions and rationale |
| `whatsappconnectorchannel_evidence_link` | provenance and evidence relationships |
| `whatsappconnectorchannel_event_outbox` | transactional Event publication |
| `whatsappconnectorchannel_idempotency` | duplicate-write protection |
| `whatsappconnectorchannel_exception` | exception, claim, dispute, or hold |
| `whatsappconnectorchannel_correction` | correction and supersession lineage |
| `whatsappconnectorchannel_audit` | privileged action evidence |
