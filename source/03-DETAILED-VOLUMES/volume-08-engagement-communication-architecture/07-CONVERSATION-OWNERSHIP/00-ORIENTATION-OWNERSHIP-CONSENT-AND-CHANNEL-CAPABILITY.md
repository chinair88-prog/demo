# Conversation Ownership — Orientation, Ownership, Consent, and Channel Capability

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-07-00` |
| Subject | `ConversationOwnershipChannel` |
...
This chapter defines how GTOS shall **define ownership, participant identity, consent, channel capability, provider boundary, retention, and audit for Conversation Ownership**.
...
|---|---|
| `ConversationOwnershipChannel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipChannelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipChannelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipChannelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipChannelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ConversationOwnershipChannel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateConversationOwnershipChannel`
- `ValidateConversationOwnershipChannel`
- `ApproveConversationOwnershipChannel`
- `ActivateConversationOwnershipChannel`
- `SuspendConversationOwnershipChannel`
- `CorrectConversationOwnershipChannel`
- `RetireConversationOwnershipChannel`

Reference Events:

- `ConversationOwnershipChannelCreated`
- `ConversationOwnershipChannelValidated`
- `ConversationOwnershipChannelApproved`
- `ConversationOwnershipChannelActivated`
- `ConversationOwnershipChannelSuspended`
- `ConversationOwnershipChannelCorrected`
- `ConversationOwnershipChannelRetired`

Reference queries:

- `GetConversationOwnershipChannel`
- `ListConversationOwnershipChannelRecords`
- `GetConversationOwnershipChannelTimeline`
- `GetConversationOwnershipChannelEvidence`
- `GetConversationOwnershipChannelDecisionPackage`
- `GetConversationOwnershipChannelExceptions`
- `GetConversationOwnershipChannelAuditTrail`

Reference API surface:

```text
POST /api/v1/conversationownershipchannel/commands
GET  /api/v1/conversationownershipchannel/{id}
GET  /api/v1/conversationownershipchannel/{id}/timeline
GET  /api/v1/conversationownershipchannel/{id}/evidence
GET  /api/v1/conversationownershipchannel/{id}/decisions
POST /api/v1/conversationownershipchannel/{id}/exceptions
POST /api/v1/conversationownershipchannel/{id}/corrections
```
...
|---|---|
| `conversationownershipchannel_aggregate` | authoritative subject |
| `conversationownershipchannel_version` | immutable submitted, approved, issued, or signed versions |
| `conversationownershipchannel_relationship` | governed relationships |
| `conversationownershipchannel_decision` | binding Decisions and rationale |
| `conversationownershipchannel_evidence_link` | provenance and evidence relationships |
| `conversationownershipchannel_event_outbox` | transactional Event publication |
| `conversationownershipchannel_idempotency` | duplicate-write protection |
| `conversationownershipchannel_exception` | exception, claim, dispute, or hold |
| `conversationownershipchannel_correction` | correction and supersession lineage |
| `conversationownershipchannel_audit` | privileged action evidence |
