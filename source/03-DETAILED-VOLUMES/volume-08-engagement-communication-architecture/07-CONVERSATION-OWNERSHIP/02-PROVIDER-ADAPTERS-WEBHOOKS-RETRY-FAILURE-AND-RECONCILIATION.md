# Conversation Ownership — Provider Adapters, Webhooks, Retry, Failure, and Reconciliation

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-07-02` |
| Subject | `ConversationOwnershipProviderAdapter` |
...
This chapter defines how GTOS shall **define provider request, callback, signature, idempotency, ordering, retry, outage, Outcome Unknown, DLQ and reconciliation for Conversation Ownership**.
...
|---|---|
| `ConversationOwnershipProviderAdapter` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipProviderAdapterVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipProviderAdapterDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipProviderAdapterEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConversationOwnershipProviderAdapterException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ConversationOwnershipProviderAdapter {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateConversationOwnershipProviderAdapter`
- `ValidateConversationOwnershipProviderAdapter`
- `ApproveConversationOwnershipProviderAdapter`
- `ActivateConversationOwnershipProviderAdapter`
- `SuspendConversationOwnershipProviderAdapter`
- `CorrectConversationOwnershipProviderAdapter`
- `RetireConversationOwnershipProviderAdapter`

Reference Events:

- `ConversationOwnershipProviderAdapterCreated`
- `ConversationOwnershipProviderAdapterValidated`
- `ConversationOwnershipProviderAdapterApproved`
- `ConversationOwnershipProviderAdapterActivated`
- `ConversationOwnershipProviderAdapterSuspended`
- `ConversationOwnershipProviderAdapterCorrected`
- `ConversationOwnershipProviderAdapterRetired`

Reference queries:

- `GetConversationOwnershipProviderAdapter`
- `ListConversationOwnershipProviderAdapterRecords`
- `GetConversationOwnershipProviderAdapterTimeline`
- `GetConversationOwnershipProviderAdapterEvidence`
- `GetConversationOwnershipProviderAdapterDecisionPackage`
- `GetConversationOwnershipProviderAdapterExceptions`
- `GetConversationOwnershipProviderAdapterAuditTrail`

Reference API surface:

```text
POST /api/v1/conversationownershipprovideradapter/commands
GET  /api/v1/conversationownershipprovideradapter/{id}
GET  /api/v1/conversationownershipprovideradapter/{id}/timeline
GET  /api/v1/conversationownershipprovideradapter/{id}/evidence
GET  /api/v1/conversationownershipprovideradapter/{id}/decisions
POST /api/v1/conversationownershipprovideradapter/{id}/exceptions
POST /api/v1/conversationownershipprovideradapter/{id}/corrections
```
...
|---|---|
| `conversationownershipprovideradapter_aggregate` | authoritative subject |
| `conversationownershipprovideradapter_version` | immutable submitted, approved, issued, or signed versions |
| `conversationownershipprovideradapter_relationship` | governed relationships |
| `conversationownershipprovideradapter_decision` | binding Decisions and rationale |
| `conversationownershipprovideradapter_evidence_link` | provenance and evidence relationships |
| `conversationownershipprovideradapter_event_outbox` | transactional Event publication |
| `conversationownershipprovideradapter_idempotency` | duplicate-write protection |
| `conversationownershipprovideradapter_exception` | exception, claim, dispute, or hold |
| `conversationownershipprovideradapter_correction` | correction and supersession lineage |
| `conversationownershipprovideradapter_audit` | privileged action evidence |
