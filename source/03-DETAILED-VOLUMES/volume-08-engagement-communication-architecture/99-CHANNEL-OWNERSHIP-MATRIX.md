# Engagement Channel Ownership and Consent Matrix

| Metadata | Value |
|---|---|
| Volume | `8` |
| Chapter ID | `V08-SYNTH` |
| Subject | `ChannelOwnershipMatrix` |
...
| Accountable owner | Engagement Council |
...
This chapter defines how GTOS shall **connect channels, providers, consent, templates, conversations, delivery evidence, CRM, AI assistance, human handoff, retention, and audit**.
...
The accountable owner is **Engagement Council**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `ChannelOwnershipMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChannelOwnershipMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChannelOwnershipMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChannelOwnershipMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ChannelOwnershipMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ChannelOwnershipMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateChannelOwnershipMatrix`
- `ValidateChannelOwnershipMatrix`
- `ApproveChannelOwnershipMatrix`
- `ActivateChannelOwnershipMatrix`
- `SuspendChannelOwnershipMatrix`
- `CorrectChannelOwnershipMatrix`
- `RetireChannelOwnershipMatrix`

Reference Events:

- `ChannelOwnershipMatrixCreated`
- `ChannelOwnershipMatrixValidated`
- `ChannelOwnershipMatrixApproved`
- `ChannelOwnershipMatrixActivated`
- `ChannelOwnershipMatrixSuspended`
- `ChannelOwnershipMatrixCorrected`
- `ChannelOwnershipMatrixRetired`

Reference queries:

- `GetChannelOwnershipMatrix`
- `ListChannelOwnershipMatrixRecords`
- `GetChannelOwnershipMatrixTimeline`
- `GetChannelOwnershipMatrixEvidence`
- `GetChannelOwnershipMatrixDecisionPackage`
- `GetChannelOwnershipMatrixExceptions`
- `GetChannelOwnershipMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/channelownershipmatrix/commands
GET  /api/v1/channelownershipmatrix/{id}
GET  /api/v1/channelownershipmatrix/{id}/timeline
GET  /api/v1/channelownershipmatrix/{id}/evidence
GET  /api/v1/channelownershipmatrix/{id}/decisions
POST /api/v1/channelownershipmatrix/{id}/exceptions
POST /api/v1/channelownershipmatrix/{id}/corrections
```
...
|---|---|
| `channelownershipmatrix_aggregate` | authoritative subject |
| `channelownershipmatrix_version` | immutable submitted, approved, issued, or signed versions |
| `channelownershipmatrix_relationship` | governed relationships |
| `channelownershipmatrix_decision` | binding Decisions and rationale |
| `channelownershipmatrix_evidence_link` | provenance and evidence relationships |
| `channelownershipmatrix_event_outbox` | transactional Event publication |
| `channelownershipmatrix_idempotency` | duplicate-write protection |
| `channelownershipmatrix_exception` | exception, claim, dispute, or hold |
| `channelownershipmatrix_correction` | correction and supersession lineage |
| `channelownershipmatrix_audit` | privileged action evidence |
