# Volume 12 Conformance and Evidence Matrix

| Metadata | Value |
|---|---|
| Volume | `12` |
| Chapter ID | `V12-SYNTH` |
| Subject | `Volume12ConformanceMatrix` |
...
This chapter defines how GTOS shall **trace every requirement in Volume 12 to owner, repository source, configuration, deployment, runtime evidence, tests, runbooks, exceptions and review status**.
...
|---|---|
| `Volume12ConformanceMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume12ConformanceMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume12ConformanceMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume12ConformanceMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Volume12ConformanceMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Volume12ConformanceMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateVolume12ConformanceMatrix`
- `ValidateVolume12ConformanceMatrix`
- `ApproveVolume12ConformanceMatrix`
- `ActivateVolume12ConformanceMatrix`
- `SuspendVolume12ConformanceMatrix`
- `CorrectVolume12ConformanceMatrix`
- `RetireVolume12ConformanceMatrix`

Reference Events:

- `Volume12ConformanceMatrixCreated`
- `Volume12ConformanceMatrixValidated`
- `Volume12ConformanceMatrixApproved`
- `Volume12ConformanceMatrixActivated`
- `Volume12ConformanceMatrixSuspended`
- `Volume12ConformanceMatrixCorrected`
- `Volume12ConformanceMatrixRetired`

Reference queries:

- `GetVolume12ConformanceMatrix`
- `ListVolume12ConformanceMatrixRecords`
- `GetVolume12ConformanceMatrixTimeline`
- `GetVolume12ConformanceMatrixEvidence`
- `GetVolume12ConformanceMatrixDecisionPackage`
- `GetVolume12ConformanceMatrixExceptions`
- `GetVolume12ConformanceMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/volume12conformancematrix/commands
GET  /api/v1/volume12conformancematrix/{id}
GET  /api/v1/volume12conformancematrix/{id}/timeline
GET  /api/v1/volume12conformancematrix/{id}/evidence
GET  /api/v1/volume12conformancematrix/{id}/decisions
POST /api/v1/volume12conformancematrix/{id}/exceptions
POST /api/v1/volume12conformancematrix/{id}/corrections
```
...
|---|---|
| `volume12conformancematrix_aggregate` | authoritative subject |
| `volume12conformancematrix_version` | immutable submitted, approved, issued, or signed versions |
| `volume12conformancematrix_relationship` | governed relationships |
| `volume12conformancematrix_decision` | binding Decisions and rationale |
| `volume12conformancematrix_evidence_link` | provenance and evidence relationships |
| `volume12conformancematrix_event_outbox` | transactional Event publication |
| `volume12conformancematrix_idempotency` | duplicate-write protection |
| `volume12conformancematrix_exception` | exception, claim, dispute, or hold |
| `volume12conformancematrix_correction` | correction and supersession lineage |
| `volume12conformancematrix_audit` | privileged action evidence |
