# Edge Deployment Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-13-00` |
| Subject | `EdgeDeploymentProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Edge Deployment Profile**.
...
|---|---|
| `EdgeDeploymentProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateEdgeDeploymentProfile`
- `ValidateEdgeDeploymentProfile`
- `ApproveEdgeDeploymentProfile`
- `ActivateEdgeDeploymentProfile`
- `SuspendEdgeDeploymentProfile`
- `CorrectEdgeDeploymentProfile`
- `RetireEdgeDeploymentProfile`

Reference Events:

- `EdgeDeploymentProfileCreated`
- `EdgeDeploymentProfileValidated`
- `EdgeDeploymentProfileApproved`
- `EdgeDeploymentProfileActivated`
- `EdgeDeploymentProfileSuspended`
- `EdgeDeploymentProfileCorrected`
- `EdgeDeploymentProfileRetired`

Reference queries:

- `GetEdgeDeploymentProfile`
- `ListEdgeDeploymentProfileRecords`
- `GetEdgeDeploymentProfileTimeline`
- `GetEdgeDeploymentProfileEvidence`
- `GetEdgeDeploymentProfileDecisionPackage`
- `GetEdgeDeploymentProfileExceptions`
- `GetEdgeDeploymentProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/edgedeploymentprofile/commands
GET  /api/v1/edgedeploymentprofile/{id}
GET  /api/v1/edgedeploymentprofile/{id}/timeline
GET  /api/v1/edgedeploymentprofile/{id}/evidence
GET  /api/v1/edgedeploymentprofile/{id}/decisions
POST /api/v1/edgedeploymentprofile/{id}/exceptions
POST /api/v1/edgedeploymentprofile/{id}/corrections
```
...
|---|---|
| `edgedeploymentprofile_aggregate` | authoritative subject |
| `edgedeploymentprofile_version` | immutable submitted, approved, issued, or signed versions |
| `edgedeploymentprofile_relationship` | governed relationships |
| `edgedeploymentprofile_decision` | binding Decisions and rationale |
| `edgedeploymentprofile_evidence_link` | provenance and evidence relationships |
| `edgedeploymentprofile_event_outbox` | transactional Event publication |
| `edgedeploymentprofile_idempotency` | duplicate-write protection |
| `edgedeploymentprofile_exception` | exception, claim, dispute, or hold |
| `edgedeploymentprofile_correction` | correction and supersession lineage |
| `edgedeploymentprofile_audit` | privileged action evidence |
