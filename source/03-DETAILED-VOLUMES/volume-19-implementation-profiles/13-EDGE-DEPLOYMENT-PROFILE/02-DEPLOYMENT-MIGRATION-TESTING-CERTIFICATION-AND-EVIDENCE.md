# Edge Deployment Profile — Deployment, Migration, Testing, Certification, and Evidence

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-13-02` |
| Subject | `EdgeDeploymentProfileConformance` |
...
This chapter defines how GTOS shall **define deployment parameters, migration, test journeys, partner certification, release evidence, exceptions and continuous conformance for Edge Deployment Profile**.
...
|---|---|
| `EdgeDeploymentProfileConformance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileConformanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileConformanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileConformanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `EdgeDeploymentProfileConformanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
EdgeDeploymentProfileConformance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateEdgeDeploymentProfileConformance`
- `ValidateEdgeDeploymentProfileConformance`
- `ApproveEdgeDeploymentProfileConformance`
- `ActivateEdgeDeploymentProfileConformance`
- `SuspendEdgeDeploymentProfileConformance`
- `CorrectEdgeDeploymentProfileConformance`
- `RetireEdgeDeploymentProfileConformance`

Reference Events:

- `EdgeDeploymentProfileConformanceCreated`
- `EdgeDeploymentProfileConformanceValidated`
- `EdgeDeploymentProfileConformanceApproved`
- `EdgeDeploymentProfileConformanceActivated`
- `EdgeDeploymentProfileConformanceSuspended`
- `EdgeDeploymentProfileConformanceCorrected`
- `EdgeDeploymentProfileConformanceRetired`

Reference queries:

- `GetEdgeDeploymentProfileConformance`
- `ListEdgeDeploymentProfileConformanceRecords`
- `GetEdgeDeploymentProfileConformanceTimeline`
- `GetEdgeDeploymentProfileConformanceEvidence`
- `GetEdgeDeploymentProfileConformanceDecisionPackage`
- `GetEdgeDeploymentProfileConformanceExceptions`
- `GetEdgeDeploymentProfileConformanceAuditTrail`

Reference API surface:

```text
POST /api/v1/edgedeploymentprofileconformance/commands
GET  /api/v1/edgedeploymentprofileconformance/{id}
GET  /api/v1/edgedeploymentprofileconformance/{id}/timeline
GET  /api/v1/edgedeploymentprofileconformance/{id}/evidence
GET  /api/v1/edgedeploymentprofileconformance/{id}/decisions
POST /api/v1/edgedeploymentprofileconformance/{id}/exceptions
POST /api/v1/edgedeploymentprofileconformance/{id}/corrections
```
...
|---|---|
| `edgedeploymentprofileconformance_aggregate` | authoritative subject |
| `edgedeploymentprofileconformance_version` | immutable submitted, approved, issued, or signed versions |
| `edgedeploymentprofileconformance_relationship` | governed relationships |
| `edgedeploymentprofileconformance_decision` | binding Decisions and rationale |
| `edgedeploymentprofileconformance_evidence_link` | provenance and evidence relationships |
| `edgedeploymentprofileconformance_event_outbox` | transactional Event publication |
| `edgedeploymentprofileconformance_idempotency` | duplicate-write protection |
| `edgedeploymentprofileconformance_exception` | exception, claim, dispute, or hold |
| `edgedeploymentprofileconformance_correction` | correction and supersession lineage |
| `edgedeploymentprofileconformance_audit` | privileged action evidence |
