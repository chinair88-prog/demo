# Customer Portal Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-00-00` |
| Subject | `CustomerPortalProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Customer Portal Profile**.
...
|---|---|
| `CustomerPortalProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `CustomerPortalProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateCustomerPortalProfile`
- `ApproveCustomerPortalProfile`
- `ActivateCustomerPortalProfile`
- `SuspendCustomerPortalProfile`
- `CorrectCustomerPortalProfile`
- `RetireCustomerPortalProfile`

Reference Events:

- `CustomerPortalProfileCreated`
- `CustomerPortalProfileValidated`
- `CustomerPortalProfileApproved`
- `CustomerPortalProfileActivated`
- `CustomerPortalProfileSuspended`
- `CustomerPortalProfileCorrected`
- `CustomerPortalProfileRetired`

Reference queries:

- `GetCustomerPortalProfile`
- `ListCustomerPortalProfileRecords`
- `GetCustomerPortalProfileTimeline`
- `GetCustomerPortalProfileEvidence`
- `GetCustomerPortalProfileDecisionPackage`
- `GetCustomerPortalProfileExceptions`
- `GetCustomerPortalProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/customerportalprofile/commands
GET  /api/v1/customerportalprofile/{id}
GET  /api/v1/customerportalprofile/{id}/timeline
GET  /api/v1/customerportalprofile/{id}/evidence
GET  /api/v1/customerportalprofile/{id}/decisions
POST /api/v1/customerportalprofile/{id}/exceptions
POST /api/v1/customerportalprofile/{id}/corrections
```
...
|---|---|
| `customerportalprofile_aggregate` | authoritative subject |
| `customerportalprofile_version` | immutable submitted, approved, issued, or signed versions |
| `customerportalprofile_relationship` | governed relationships |
| `customerportalprofile_decision` | binding Decisions and rationale |
| `customerportalprofile_evidence_link` | provenance and evidence relationships |
| `customerportalprofile_event_outbox` | transactional Event publication |
| `customerportalprofile_idempotency` | duplicate-write protection |
| `customerportalprofile_exception` | exception, claim, dispute, or hold |
| `customerportalprofile_correction` | correction and supersession lineage |
| `customerportalprofile_audit` | privileged action evidence |
