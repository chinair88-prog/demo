# Single-Country Deployment Profile — Deployment, Migration, Testing, Certification, and Evidence

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-07-02` |
| Subject | `Single-CountryDeploymentProfileConformance` |
...
This chapter defines how GTOS shall **define deployment parameters, migration, test journeys, partner certification, release evidence, exceptions and continuous conformance for Single-Country Deployment Profile**.
...
|---|---|
| `Single-CountryDeploymentProfileConformance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileConformanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileConformanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileConformanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Single-CountryDeploymentProfileConformanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Single-CountryDeploymentProfileConformance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateSingle-CountryDeploymentProfileConformance`
- `ValidateSingle-CountryDeploymentProfileConformance`
- `ApproveSingle-CountryDeploymentProfileConformance`
- `ActivateSingle-CountryDeploymentProfileConformance`
- `SuspendSingle-CountryDeploymentProfileConformance`
- `CorrectSingle-CountryDeploymentProfileConformance`
- `RetireSingle-CountryDeploymentProfileConformance`

Reference Events:

- `Single-CountryDeploymentProfileConformanceCreated`
- `Single-CountryDeploymentProfileConformanceValidated`
- `Single-CountryDeploymentProfileConformanceApproved`
- `Single-CountryDeploymentProfileConformanceActivated`
- `Single-CountryDeploymentProfileConformanceSuspended`
- `Single-CountryDeploymentProfileConformanceCorrected`
- `Single-CountryDeploymentProfileConformanceRetired`

Reference queries:

- `GetSingle-CountryDeploymentProfileConformance`
- `ListSingle-CountryDeploymentProfileConformanceRecords`
- `GetSingle-CountryDeploymentProfileConformanceTimeline`
- `GetSingle-CountryDeploymentProfileConformanceEvidence`
- `GetSingle-CountryDeploymentProfileConformanceDecisionPackage`
- `GetSingle-CountryDeploymentProfileConformanceExceptions`
- `GetSingle-CountryDeploymentProfileConformanceAuditTrail`

Reference API surface:

```text
POST /api/v1/single_countrydeploymentprofileconformance/commands
GET  /api/v1/single_countrydeploymentprofileconformance/{id}
GET  /api/v1/single_countrydeploymentprofileconformance/{id}/timeline
GET  /api/v1/single_countrydeploymentprofileconformance/{id}/evidence
GET  /api/v1/single_countrydeploymentprofileconformance/{id}/decisions
POST /api/v1/single_countrydeploymentprofileconformance/{id}/exceptions
POST /api/v1/single_countrydeploymentprofileconformance/{id}/corrections
```
...
|---|---|
| `single_countrydeploymentprofileconformance_aggregate` | authoritative subject |
| `single_countrydeploymentprofileconformance_version` | immutable submitted, approved, issued, or signed versions |
| `single_countrydeploymentprofileconformance_relationship` | governed relationships |
| `single_countrydeploymentprofileconformance_decision` | binding Decisions and rationale |
| `single_countrydeploymentprofileconformance_evidence_link` | provenance and evidence relationships |
| `single_countrydeploymentprofileconformance_event_outbox` | transactional Event publication |
| `single_countrydeploymentprofileconformance_idempotency` | duplicate-write protection |
| `single_countrydeploymentprofileconformance_exception` | exception, claim, dispute, or hold |
| `single_countrydeploymentprofileconformance_correction` | correction and supersession lineage |
| `single_countrydeploymentprofileconformance_audit` | privileged action evidence |
