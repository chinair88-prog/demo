# Multi-Jurisdiction Deployment Profile — Deployment, Migration, Testing, Certification, and Evidence

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-08-02` |
| Subject | `Multi-JurisdictionDeploymentProfileConformance` |
...
This chapter defines how GTOS shall **define deployment parameters, migration, test journeys, partner certification, release evidence, exceptions and continuous conformance for Multi-Jurisdiction Deployment Profile**.
...
|---|---|
| `Multi-JurisdictionDeploymentProfileConformance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileConformanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileConformanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileConformanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileConformanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Multi-JurisdictionDeploymentProfileConformance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateMulti-JurisdictionDeploymentProfileConformance`
- `ValidateMulti-JurisdictionDeploymentProfileConformance`
- `ApproveMulti-JurisdictionDeploymentProfileConformance`
- `ActivateMulti-JurisdictionDeploymentProfileConformance`
- `SuspendMulti-JurisdictionDeploymentProfileConformance`
- `CorrectMulti-JurisdictionDeploymentProfileConformance`
- `RetireMulti-JurisdictionDeploymentProfileConformance`

Reference Events:

- `Multi-JurisdictionDeploymentProfileConformanceCreated`
- `Multi-JurisdictionDeploymentProfileConformanceValidated`
- `Multi-JurisdictionDeploymentProfileConformanceApproved`
- `Multi-JurisdictionDeploymentProfileConformanceActivated`
- `Multi-JurisdictionDeploymentProfileConformanceSuspended`
- `Multi-JurisdictionDeploymentProfileConformanceCorrected`
- `Multi-JurisdictionDeploymentProfileConformanceRetired`

Reference queries:

- `GetMulti-JurisdictionDeploymentProfileConformance`
- `ListMulti-JurisdictionDeploymentProfileConformanceRecords`
- `GetMulti-JurisdictionDeploymentProfileConformanceTimeline`
- `GetMulti-JurisdictionDeploymentProfileConformanceEvidence`
- `GetMulti-JurisdictionDeploymentProfileConformanceDecisionPackage`
- `GetMulti-JurisdictionDeploymentProfileConformanceExceptions`
- `GetMulti-JurisdictionDeploymentProfileConformanceAuditTrail`

Reference API surface:

```text
POST /api/v1/multi_jurisdictiondeploymentprofileconformance/commands
GET  /api/v1/multi_jurisdictiondeploymentprofileconformance/{id}
GET  /api/v1/multi_jurisdictiondeploymentprofileconformance/{id}/timeline
GET  /api/v1/multi_jurisdictiondeploymentprofileconformance/{id}/evidence
GET  /api/v1/multi_jurisdictiondeploymentprofileconformance/{id}/decisions
POST /api/v1/multi_jurisdictiondeploymentprofileconformance/{id}/exceptions
POST /api/v1/multi_jurisdictiondeploymentprofileconformance/{id}/corrections
```
...
|---|---|
| `multi_jurisdictiondeploymentprofileconformance_aggregate` | authoritative subject |
| `multi_jurisdictiondeploymentprofileconformance_version` | immutable submitted, approved, issued, or signed versions |
| `multi_jurisdictiondeploymentprofileconformance_relationship` | governed relationships |
| `multi_jurisdictiondeploymentprofileconformance_decision` | binding Decisions and rationale |
| `multi_jurisdictiondeploymentprofileconformance_evidence_link` | provenance and evidence relationships |
| `multi_jurisdictiondeploymentprofileconformance_event_outbox` | transactional Event publication |
| `multi_jurisdictiondeploymentprofileconformance_idempotency` | duplicate-write protection |
| `multi_jurisdictiondeploymentprofileconformance_exception` | exception, claim, dispute, or hold |
| `multi_jurisdictiondeploymentprofileconformance_correction` | correction and supersession lineage |
| `multi_jurisdictiondeploymentprofileconformance_audit` | privileged action evidence |
