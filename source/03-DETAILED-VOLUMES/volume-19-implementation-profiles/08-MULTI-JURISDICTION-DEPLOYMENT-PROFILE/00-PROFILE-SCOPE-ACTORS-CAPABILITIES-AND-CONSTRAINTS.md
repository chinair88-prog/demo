# Multi-Jurisdiction Deployment Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-08-00` |
| Subject | `Multi-JurisdictionDeploymentProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Multi-Jurisdiction Deployment Profile**.
...
|---|---|
| `Multi-JurisdictionDeploymentProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `Multi-JurisdictionDeploymentProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
Multi-JurisdictionDeploymentProfile {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateMulti-JurisdictionDeploymentProfile`
- `ValidateMulti-JurisdictionDeploymentProfile`
- `ApproveMulti-JurisdictionDeploymentProfile`
- `ActivateMulti-JurisdictionDeploymentProfile`
- `SuspendMulti-JurisdictionDeploymentProfile`
- `CorrectMulti-JurisdictionDeploymentProfile`
- `RetireMulti-JurisdictionDeploymentProfile`

Reference Events:

- `Multi-JurisdictionDeploymentProfileCreated`
- `Multi-JurisdictionDeploymentProfileValidated`
- `Multi-JurisdictionDeploymentProfileApproved`
- `Multi-JurisdictionDeploymentProfileActivated`
- `Multi-JurisdictionDeploymentProfileSuspended`
- `Multi-JurisdictionDeploymentProfileCorrected`
- `Multi-JurisdictionDeploymentProfileRetired`

Reference queries:

- `GetMulti-JurisdictionDeploymentProfile`
- `ListMulti-JurisdictionDeploymentProfileRecords`
- `GetMulti-JurisdictionDeploymentProfileTimeline`
- `GetMulti-JurisdictionDeploymentProfileEvidence`
- `GetMulti-JurisdictionDeploymentProfileDecisionPackage`
- `GetMulti-JurisdictionDeploymentProfileExceptions`
- `GetMulti-JurisdictionDeploymentProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/multi_jurisdictiondeploymentprofile/commands
GET  /api/v1/multi_jurisdictiondeploymentprofile/{id}
GET  /api/v1/multi_jurisdictiondeploymentprofile/{id}/timeline
GET  /api/v1/multi_jurisdictiondeploymentprofile/{id}/evidence
GET  /api/v1/multi_jurisdictiondeploymentprofile/{id}/decisions
POST /api/v1/multi_jurisdictiondeploymentprofile/{id}/exceptions
POST /api/v1/multi_jurisdictiondeploymentprofile/{id}/corrections
```
...
|---|---|
| `multi_jurisdictiondeploymentprofile_aggregate` | authoritative subject |
| `multi_jurisdictiondeploymentprofile_version` | immutable submitted, approved, issued, or signed versions |
| `multi_jurisdictiondeploymentprofile_relationship` | governed relationships |
| `multi_jurisdictiondeploymentprofile_decision` | binding Decisions and rationale |
| `multi_jurisdictiondeploymentprofile_evidence_link` | provenance and evidence relationships |
| `multi_jurisdictiondeploymentprofile_event_outbox` | transactional Event publication |
| `multi_jurisdictiondeploymentprofile_idempotency` | duplicate-write protection |
| `multi_jurisdictiondeploymentprofile_exception` | exception, claim, dispute, or hold |
| `multi_jurisdictiondeploymentprofile_correction` | correction and supersession lineage |
| `multi_jurisdictiondeploymentprofile_audit` | privileged action evidence |
