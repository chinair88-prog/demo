# Provider Portal Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-02-00` |
| Subject | `ProviderPortalProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Provider Portal Profile**.
...
|---|---|
| `ProviderPortalProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ProviderPortalProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateProviderPortalProfile`
- `ValidateProviderPortalProfile`
- `ApproveProviderPortalProfile`
- `ActivateProviderPortalProfile`
- `SuspendProviderPortalProfile`
- `CorrectProviderPortalProfile`
- `RetireProviderPortalProfile`

Reference Events:

- `ProviderPortalProfileCreated`
- `ProviderPortalProfileValidated`
- `ProviderPortalProfileApproved`
- `ProviderPortalProfileActivated`
- `ProviderPortalProfileSuspended`
- `ProviderPortalProfileCorrected`
- `ProviderPortalProfileRetired`

Reference queries:

- `GetProviderPortalProfile`
- `ListProviderPortalProfileRecords`
- `GetProviderPortalProfileTimeline`
- `GetProviderPortalProfileEvidence`
- `GetProviderPortalProfileDecisionPackage`
- `GetProviderPortalProfileExceptions`
- `GetProviderPortalProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/providerportalprofile/commands
GET  /api/v1/providerportalprofile/{id}
GET  /api/v1/providerportalprofile/{id}/timeline
GET  /api/v1/providerportalprofile/{id}/evidence
GET  /api/v1/providerportalprofile/{id}/decisions
POST /api/v1/providerportalprofile/{id}/exceptions
POST /api/v1/providerportalprofile/{id}/corrections
```
...
|---|---|
| `providerportalprofile_aggregate` | authoritative subject |
| `providerportalprofile_version` | immutable submitted, approved, issued, or signed versions |
| `providerportalprofile_relationship` | governed relationships |
| `providerportalprofile_decision` | binding Decisions and rationale |
| `providerportalprofile_evidence_link` | provenance and evidence relationships |
| `providerportalprofile_event_outbox` | transactional Event publication |
| `providerportalprofile_idempotency` | duplicate-write protection |
| `providerportalprofile_exception` | exception, claim, dispute, or hold |
| `providerportalprofile_correction` | correction and supersession lineage |
| `providerportalprofile_audit` | privileged action evidence |
