# AI Control Center Profile — Deployment, Migration, Testing, Certification, and Evidence

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-06-02` |
| Subject | `AIControlCenterProfileConformance` |
...
This chapter defines how GTOS shall **define deployment parameters, migration, test journeys, partner certification, release evidence, exceptions and continuous conformance for AI Control Center Profile**.
...
|---|---|
| `AIControlCenterProfileConformance` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIControlCenterProfileConformanceVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIControlCenterProfileConformanceDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIControlCenterProfileConformanceEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIControlCenterProfileConformanceException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
AIControlCenterProfileConformance {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateAIControlCenterProfileConformance`
- `ValidateAIControlCenterProfileConformance`
- `ApproveAIControlCenterProfileConformance`
- `ActivateAIControlCenterProfileConformance`
- `SuspendAIControlCenterProfileConformance`
- `CorrectAIControlCenterProfileConformance`
- `RetireAIControlCenterProfileConformance`

Reference Events:

- `AIControlCenterProfileConformanceCreated`
- `AIControlCenterProfileConformanceValidated`
- `AIControlCenterProfileConformanceApproved`
- `AIControlCenterProfileConformanceActivated`
- `AIControlCenterProfileConformanceSuspended`
- `AIControlCenterProfileConformanceCorrected`
- `AIControlCenterProfileConformanceRetired`

Reference queries:

- `GetAIControlCenterProfileConformance`
- `ListAIControlCenterProfileConformanceRecords`
- `GetAIControlCenterProfileConformanceTimeline`
- `GetAIControlCenterProfileConformanceEvidence`
- `GetAIControlCenterProfileConformanceDecisionPackage`
- `GetAIControlCenterProfileConformanceExceptions`
- `GetAIControlCenterProfileConformanceAuditTrail`

Reference API surface:

```text
POST /api/v1/aicontrolcenterprofileconformance/commands
GET  /api/v1/aicontrolcenterprofileconformance/{id}
GET  /api/v1/aicontrolcenterprofileconformance/{id}/timeline
GET  /api/v1/aicontrolcenterprofileconformance/{id}/evidence
GET  /api/v1/aicontrolcenterprofileconformance/{id}/decisions
POST /api/v1/aicontrolcenterprofileconformance/{id}/exceptions
POST /api/v1/aicontrolcenterprofileconformance/{id}/corrections
```
...
|---|---|
| `aicontrolcenterprofileconformance_aggregate` | authoritative subject |
| `aicontrolcenterprofileconformance_version` | immutable submitted, approved, issued, or signed versions |
| `aicontrolcenterprofileconformance_relationship` | governed relationships |
| `aicontrolcenterprofileconformance_decision` | binding Decisions and rationale |
| `aicontrolcenterprofileconformance_evidence_link` | provenance and evidence relationships |
| `aicontrolcenterprofileconformance_event_outbox` | transactional Event publication |
| `aicontrolcenterprofileconformance_idempotency` | duplicate-write protection |
| `aicontrolcenterprofileconformance_exception` | exception, claim, dispute, or hold |
| `aicontrolcenterprofileconformance_correction` | correction and supersession lineage |
| `aicontrolcenterprofileconformance_audit` | privileged action evidence |
