# Partner Portal Profile — Profile Scope, Actors, Capabilities, and Constraints

| Metadata | Value |
|---|---|
| Volume | `19` |
| Chapter ID | `V19-01-00` |
| Subject | `PartnerPortalProfile` |
...
This chapter defines how GTOS shall **define scope, actors, business capabilities, jurisdictions, non-goals, assumptions and constraints for Partner Portal Profile**.
...
|---|---|
| `PartnerPortalProfile` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalProfileVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalProfileDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalProfileEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalProfileException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePartnerPortalProfile`
- `ValidatePartnerPortalProfile`
- `ApprovePartnerPortalProfile`
- `ActivatePartnerPortalProfile`
- `SuspendPartnerPortalProfile`
- `CorrectPartnerPortalProfile`
- `RetirePartnerPortalProfile`

Reference Events:

- `PartnerPortalProfileCreated`
- `PartnerPortalProfileValidated`
- `PartnerPortalProfileApproved`
- `PartnerPortalProfileActivated`
- `PartnerPortalProfileSuspended`
- `PartnerPortalProfileCorrected`
- `PartnerPortalProfileRetired`

Reference queries:

- `GetPartnerPortalProfile`
- `ListPartnerPortalProfileRecords`
- `GetPartnerPortalProfileTimeline`
- `GetPartnerPortalProfileEvidence`
- `GetPartnerPortalProfileDecisionPackage`
- `GetPartnerPortalProfileExceptions`
- `GetPartnerPortalProfileAuditTrail`

Reference API surface:

```text
POST /api/v1/partnerportalprofile/commands
GET  /api/v1/partnerportalprofile/{id}
GET  /api/v1/partnerportalprofile/{id}/timeline
GET  /api/v1/partnerportalprofile/{id}/evidence
GET  /api/v1/partnerportalprofile/{id}/decisions
POST /api/v1/partnerportalprofile/{id}/exceptions
POST /api/v1/partnerportalprofile/{id}/corrections
```
...
|---|---|
| `partnerportalprofile_aggregate` | authoritative subject |
| `partnerportalprofile_version` | immutable submitted, approved, issued, or signed versions |
| `partnerportalprofile_relationship` | governed relationships |
| `partnerportalprofile_decision` | binding Decisions and rationale |
| `partnerportalprofile_evidence_link` | provenance and evidence relationships |
| `partnerportalprofile_event_outbox` | transactional Event publication |
| `partnerportalprofile_idempotency` | duplicate-write protection |
| `partnerportalprofile_exception` | exception, claim, dispute, or hold |
| `partnerportalprofile_correction` | correction and supersession lineage |
| `partnerportalprofile_audit` | privileged action evidence |
