# Identity and Tenant Conformance Matrix

| Metadata | Value |
|---|---|
| Volume | `5` |
| Chapter ID | `V05-SYNTH` |
| Subject | `IdentityConformanceMatrix` |
...
| Accountable owner | Identity Council |
...
This chapter defines how GTOS shall **trace identities, credentials, sessions, relationships, roles, attributes, mandates, tenants, facilities, Policies, audit and tests**.
...
The accountable owner is **Identity Council**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `IdentityConformanceMatrix` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityConformanceMatrixVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityConformanceMatrixDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityConformanceMatrixEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityConformanceMatrixException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
IdentityConformanceMatrix {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateIdentityConformanceMatrix`
- `ValidateIdentityConformanceMatrix`
- `ApproveIdentityConformanceMatrix`
- `ActivateIdentityConformanceMatrix`
- `SuspendIdentityConformanceMatrix`
- `CorrectIdentityConformanceMatrix`
- `RetireIdentityConformanceMatrix`

Reference Events:

- `IdentityConformanceMatrixCreated`
- `IdentityConformanceMatrixValidated`
- `IdentityConformanceMatrixApproved`
- `IdentityConformanceMatrixActivated`
- `IdentityConformanceMatrixSuspended`
- `IdentityConformanceMatrixCorrected`
- `IdentityConformanceMatrixRetired`

Reference queries:

- `GetIdentityConformanceMatrix`
- `ListIdentityConformanceMatrixRecords`
- `GetIdentityConformanceMatrixTimeline`
- `GetIdentityConformanceMatrixEvidence`
- `GetIdentityConformanceMatrixDecisionPackage`
- `GetIdentityConformanceMatrixExceptions`
- `GetIdentityConformanceMatrixAuditTrail`

Reference API surface:

```text
POST /api/v1/identityconformancematrix/commands
GET  /api/v1/identityconformancematrix/{id}
GET  /api/v1/identityconformancematrix/{id}/timeline
GET  /api/v1/identityconformancematrix/{id}/evidence
GET  /api/v1/identityconformancematrix/{id}/decisions
POST /api/v1/identityconformancematrix/{id}/exceptions
POST /api/v1/identityconformancematrix/{id}/corrections
```
...
|---|---|
| `identityconformancematrix_aggregate` | authoritative subject |
| `identityconformancematrix_version` | immutable submitted, approved, issued, or signed versions |
| `identityconformancematrix_relationship` | governed relationships |
| `identityconformancematrix_decision` | binding Decisions and rationale |
| `identityconformancematrix_evidence_link` | provenance and evidence relationships |
| `identityconformancematrix_event_outbox` | transactional Event publication |
| `identityconformancematrix_idempotency` | duplicate-write protection |
| `identityconformancematrix_exception` | exception, claim, dispute, or hold |
| `identityconformancematrix_correction` | correction and supersession lineage |
| `identityconformancematrix_audit` | privileged action evidence |
