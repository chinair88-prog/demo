# Identity and Tenant Architecture Introduction

| Metadata | Value |
|---|---|
| Volume | `5` |
| Chapter ID | `V05-00` |
| Subject | `IdentityArchitecture` |
...
This chapter defines how GTOS shall **define identity, authority, tenancy, relationships, credentials, sessions, delegation, audit, and cross-tenant conformance**.
...
|---|---|
| `IdentityArchitecture` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityArchitectureVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityArchitectureDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityArchitectureEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityArchitectureException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateIdentityArchitecture`
- `ValidateIdentityArchitecture`
- `ApproveIdentityArchitecture`
- `ActivateIdentityArchitecture`
- `SuspendIdentityArchitecture`
- `CorrectIdentityArchitecture`
- `RetireIdentityArchitecture`

Reference Events:

- `IdentityArchitectureCreated`
- `IdentityArchitectureValidated`
- `IdentityArchitectureApproved`
- `IdentityArchitectureActivated`
- `IdentityArchitectureSuspended`
- `IdentityArchitectureCorrected`
- `IdentityArchitectureRetired`

Reference queries:

- `GetIdentityArchitecture`
- `ListIdentityArchitectureRecords`
- `GetIdentityArchitectureTimeline`
- `GetIdentityArchitectureEvidence`
- `GetIdentityArchitectureDecisionPackage`
- `GetIdentityArchitectureExceptions`
- `GetIdentityArchitectureAuditTrail`

Reference API surface:

```text
POST /api/v1/identityarchitecture/commands
GET  /api/v1/identityarchitecture/{id}
GET  /api/v1/identityarchitecture/{id}/timeline
GET  /api/v1/identityarchitecture/{id}/evidence
GET  /api/v1/identityarchitecture/{id}/decisions
POST /api/v1/identityarchitecture/{id}/exceptions
POST /api/v1/identityarchitecture/{id}/corrections
```
...
|---|---|
| `identityarchitecture_aggregate` | authoritative subject |
| `identityarchitecture_version` | immutable submitted, approved, issued, or signed versions |
| `identityarchitecture_relationship` | governed relationships |
| `identityarchitecture_decision` | binding Decisions and rationale |
| `identityarchitecture_evidence_link` | provenance and evidence relationships |
| `identityarchitecture_event_outbox` | transactional Event publication |
| `identityarchitecture_idempotency` | duplicate-write protection |
| `identityarchitecture_exception` | exception, claim, dispute, or hold |
| `identityarchitecture_correction` | correction and supersession lineage |
| `identityarchitecture_audit` | privileged action evidence |
