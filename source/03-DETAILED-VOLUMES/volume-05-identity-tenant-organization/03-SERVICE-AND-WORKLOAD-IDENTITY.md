...
This chapter defines how GTOS shall **authenticate deployable services, jobs, gateways, adapters, and workloads with rotation and least privilege**.
...
|---|---|
| `ServiceIdentity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceIdentityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceIdentityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceIdentityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ServiceIdentityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ApproveServiceIdentity`
- `ActivateServiceIdentity`
- `SuspendServiceIdentity`
- `CorrectServiceIdentity`
- `RetireServiceIdentity`

Reference Events:

- `ServiceIdentityCreated`
- `ServiceIdentityValidated`
- `ServiceIdentityApproved`
- `ServiceIdentityActivated`
- `ServiceIdentitySuspended`
- `ServiceIdentityCorrected`
- `ServiceIdentityRetired`

Reference queries:

- `GetServiceIdentity`
- `ListServiceIdentityRecords`
- `GetServiceIdentityTimeline`
- `GetServiceIdentityEvidence`
- `GetServiceIdentityDecisionPackage`
- `GetServiceIdentityExceptions`
- `GetServiceIdentityAuditTrail`

Reference API surface:

```text
POST /api/v1/serviceidentity/commands
GET  /api/v1/serviceidentity/{id}
GET  /api/v1/serviceidentity/{id}/timeline
GET  /api/v1/serviceidentity/{id}/evidence
GET  /api/v1/serviceidentity/{id}/decisions
POST /api/v1/serviceidentity/{id}/exceptions
POST /api/v1/serviceidentity/{id}/corrections
```
...
|---|---|
| `serviceidentity_aggregate` | authoritative subject |
| `serviceidentity_version` | immutable submitted, approved, issued, or signed versions |
| `serviceidentity_relationship` | governed relationships |
| `serviceidentity_decision` | binding Decisions and rationale |
| `serviceidentity_evidence_link` | provenance and evidence relationships |
| `serviceidentity_event_outbox` | transactional Event publication |
| `serviceidentity_idempotency` | duplicate-write protection |
| `serviceidentity_exception` | exception, claim, dispute, or hold |
| `serviceidentity_correction` | correction and supersession lineage |
| `serviceidentity_audit` | privileged action evidence |
