# Consent, Purpose, Privacy, and Data Subject Rights

| Metadata | Value |
|---|---|
| Volume | `5` |
| Chapter ID | `V05-16` |
| Subject | `ConsentPrivacy` |
...
| Accountable owner | Privacy Council |
...
This chapter defines how GTOS shall **record consent, purpose, legal basis, preference, withdrawal, access, correction, deletion limits, and portability**.
...
The accountable owner is **Privacy Council**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `ConsentPrivacy` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentPrivacyVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentPrivacyDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentPrivacyEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ConsentPrivacyException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateConsentPrivacy`
- `ValidateConsentPrivacy`
- `ApproveConsentPrivacy`
- `ActivateConsentPrivacy`
- `SuspendConsentPrivacy`
- `CorrectConsentPrivacy`
- `RetireConsentPrivacy`

Reference Events:

- `ConsentPrivacyCreated`
- `ConsentPrivacyValidated`
- `ConsentPrivacyApproved`
- `ConsentPrivacyActivated`
- `ConsentPrivacySuspended`
- `ConsentPrivacyCorrected`
- `ConsentPrivacyRetired`

Reference queries:

- `GetConsentPrivacy`
- `ListConsentPrivacyRecords`
- `GetConsentPrivacyTimeline`
- `GetConsentPrivacyEvidence`
- `GetConsentPrivacyDecisionPackage`
- `GetConsentPrivacyExceptions`
- `GetConsentPrivacyAuditTrail`

Reference API surface:

```text
POST /api/v1/consentprivacy/commands
GET  /api/v1/consentprivacy/{id}
GET  /api/v1/consentprivacy/{id}/timeline
GET  /api/v1/consentprivacy/{id}/evidence
GET  /api/v1/consentprivacy/{id}/decisions
POST /api/v1/consentprivacy/{id}/exceptions
POST /api/v1/consentprivacy/{id}/corrections
```
...
|---|---|
| `consentprivacy_aggregate` | authoritative subject |
| `consentprivacy_version` | immutable submitted, approved, issued, or signed versions |
| `consentprivacy_relationship` | governed relationships |
| `consentprivacy_decision` | binding Decisions and rationale |
| `consentprivacy_evidence_link` | provenance and evidence relationships |
| `consentprivacy_event_outbox` | transactional Event publication |
| `consentprivacy_idempotency` | duplicate-write protection |
| `consentprivacy_exception` | exception, claim, dispute, or hold |
| `consentprivacy_correction` | correction and supersession lineage |
| `consentprivacy_audit` | privileged action evidence |
