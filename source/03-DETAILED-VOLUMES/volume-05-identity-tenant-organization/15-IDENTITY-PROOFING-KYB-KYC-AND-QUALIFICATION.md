# Identity Proofing, KYB, KYC, and Qualification

| Metadata | Value |
|---|---|
| Volume | `5` |
| Chapter ID | `V05-15` |
| Subject | `IdentityProofing` |
...
| Accountable owner | Compliance / Identity |
...
This chapter defines how GTOS shall **separate asserted identity, verified identity, business verification, sanctions checks, and scoped qualification**.
...
The accountable owner is **Compliance / Identity**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `IdentityProofing` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityProofingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityProofingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityProofingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `IdentityProofingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateIdentityProofing`
- `ValidateIdentityProofing`
- `ApproveIdentityProofing`
- `ActivateIdentityProofing`
- `SuspendIdentityProofing`
- `CorrectIdentityProofing`
- `RetireIdentityProofing`

Reference Events:

- `IdentityProofingCreated`
- `IdentityProofingValidated`
- `IdentityProofingApproved`
- `IdentityProofingActivated`
- `IdentityProofingSuspended`
- `IdentityProofingCorrected`
- `IdentityProofingRetired`

Reference queries:

- `GetIdentityProofing`
- `ListIdentityProofingRecords`
- `GetIdentityProofingTimeline`
- `GetIdentityProofingEvidence`
- `GetIdentityProofingDecisionPackage`
- `GetIdentityProofingExceptions`
- `GetIdentityProofingAuditTrail`

Reference API surface:

```text
POST /api/v1/identityproofing/commands
GET  /api/v1/identityproofing/{id}
GET  /api/v1/identityproofing/{id}/timeline
GET  /api/v1/identityproofing/{id}/evidence
GET  /api/v1/identityproofing/{id}/decisions
POST /api/v1/identityproofing/{id}/exceptions
POST /api/v1/identityproofing/{id}/corrections
```
...
|---|---|
| `identityproofing_aggregate` | authoritative subject |
| `identityproofing_version` | immutable submitted, approved, issued, or signed versions |
| `identityproofing_relationship` | governed relationships |
| `identityproofing_decision` | binding Decisions and rationale |
| `identityproofing_evidence_link` | provenance and evidence relationships |
| `identityproofing_event_outbox` | transactional Event publication |
| `identityproofing_idempotency` | duplicate-write protection |
| `identityproofing_exception` | exception, claim, dispute, or hold |
| `identityproofing_correction` | correction and supersession lineage |
| `identityproofing_audit` | privileged action evidence |
