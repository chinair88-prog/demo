# AI Agent and Agent-Run Identity

| Metadata | Value |
|---|---|
| Volume | `5` |
| Chapter ID | `V05-05` |
| Subject | `AIAgentIdentity` |
...
| Accountable owner | AI Orchestrator / Security |
...
This chapter defines how GTOS shall **identify AI Agents, runs, models, Tools, represented principals, approvals, and accountable owners**.
...
The accountable owner is **AI Orchestrator / Security**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `AIAgentIdentity` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAgentIdentityVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAgentIdentityDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAgentIdentityEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `AIAgentIdentityException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidateAIAgentIdentity`
- `ApproveAIAgentIdentity`
- `ActivateAIAgentIdentity`
- `SuspendAIAgentIdentity`
- `CorrectAIAgentIdentity`
- `RetireAIAgentIdentity`

Reference Events:

- `AIAgentIdentityCreated`
- `AIAgentIdentityValidated`
- `AIAgentIdentityApproved`
- `AIAgentIdentityActivated`
- `AIAgentIdentitySuspended`
- `AIAgentIdentityCorrected`
- `AIAgentIdentityRetired`

Reference queries:

- `GetAIAgentIdentity`
- `ListAIAgentIdentityRecords`
- `GetAIAgentIdentityTimeline`
- `GetAIAgentIdentityEvidence`
- `GetAIAgentIdentityDecisionPackage`
- `GetAIAgentIdentityExceptions`
- `GetAIAgentIdentityAuditTrail`

Reference API surface:

```text
POST /api/v1/aiagentidentity/commands
GET  /api/v1/aiagentidentity/{id}
GET  /api/v1/aiagentidentity/{id}/timeline
GET  /api/v1/aiagentidentity/{id}/evidence
GET  /api/v1/aiagentidentity/{id}/decisions
POST /api/v1/aiagentidentity/{id}/exceptions
POST /api/v1/aiagentidentity/{id}/corrections
```
...
|---|---|
| `aiagentidentity_aggregate` | authoritative subject |
| `aiagentidentity_version` | immutable submitted, approved, issued, or signed versions |
| `aiagentidentity_relationship` | governed relationships |
| `aiagentidentity_decision` | binding Decisions and rationale |
| `aiagentidentity_evidence_link` | provenance and evidence relationships |
| `aiagentidentity_event_outbox` | transactional Event publication |
| `aiagentidentity_idempotency` | duplicate-write protection |
| `aiagentidentity_exception` | exception, claim, dispute, or hold |
| `aiagentidentity_correction` | correction and supersession lineage |
| `aiagentidentity_audit` | privileged action evidence |
