# Scenario Simulator — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P12-00` |
| Subject | `ScenarioSimulatorPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for planners, analysts and executives, covering assumptions, scenarios, simulations, sensitivity, comparison, Decision support**.
...
|---|---|
| `ScenarioSimulatorPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ScenarioSimulatorPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ScenarioSimulatorPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ScenarioSimulatorPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ScenarioSimulatorPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ScenarioSimulatorPortal {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateScenarioSimulatorPortal`
- `ValidateScenarioSimulatorPortal`
- `ApproveScenarioSimulatorPortal`
- `ActivateScenarioSimulatorPortal`
- `SuspendScenarioSimulatorPortal`
- `CorrectScenarioSimulatorPortal`
- `RetireScenarioSimulatorPortal`

Reference Events:

- `ScenarioSimulatorPortalCreated`
- `ScenarioSimulatorPortalValidated`
- `ScenarioSimulatorPortalApproved`
- `ScenarioSimulatorPortalActivated`
- `ScenarioSimulatorPortalSuspended`
- `ScenarioSimulatorPortalCorrected`
- `ScenarioSimulatorPortalRetired`

Reference queries:

- `GetScenarioSimulatorPortal`
- `ListScenarioSimulatorPortalRecords`
- `GetScenarioSimulatorPortalTimeline`
- `GetScenarioSimulatorPortalEvidence`
- `GetScenarioSimulatorPortalDecisionPackage`
- `GetScenarioSimulatorPortalExceptions`
- `GetScenarioSimulatorPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/scenariosimulatorportal/commands
GET  /api/v1/scenariosimulatorportal/{id}
GET  /api/v1/scenariosimulatorportal/{id}/timeline
GET  /api/v1/scenariosimulatorportal/{id}/evidence
GET  /api/v1/scenariosimulatorportal/{id}/decisions
POST /api/v1/scenariosimulatorportal/{id}/exceptions
POST /api/v1/scenariosimulatorportal/{id}/corrections
```
...
|---|---|
| `scenariosimulatorportal_aggregate` | authoritative subject |
| `scenariosimulatorportal_version` | immutable submitted, approved, issued, or signed versions |
| `scenariosimulatorportal_relationship` | governed relationships |
| `scenariosimulatorportal_decision` | binding Decisions and rationale |
| `scenariosimulatorportal_evidence_link` | provenance and evidence relationships |
| `scenariosimulatorportal_event_outbox` | transactional Event publication |
| `scenariosimulatorportal_idempotency` | duplicate-write protection |
| `scenariosimulatorportal_exception` | exception, claim, dispute, or hold |
| `scenariosimulatorportal_correction` | correction and supersession lineage |
| `scenariosimulatorportal_audit` | privileged action evidence |
