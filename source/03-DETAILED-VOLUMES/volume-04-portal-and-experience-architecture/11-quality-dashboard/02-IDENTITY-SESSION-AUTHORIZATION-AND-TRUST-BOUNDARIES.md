# Quality Dashboard — Identity, Session, Authorization, and Trust Boundaries

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P11-02` |
| Subject | `QualityDashboardAccessModel` |
...
This chapter defines how GTOS shall **govern login, session, role, relationship, tenant, facility, channel, delegation, impersonation and privileged action for quality managers, inspectors and auditors, covering inspection plans, evidence, defects, nonconformance, release, corrective actions**.
...
|---|---|
| `QualityDashboardAccessModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardAccessModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardAccessModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardAccessModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardAccessModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
QualityDashboardAccessModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateQualityDashboardAccessModel`
- `ValidateQualityDashboardAccessModel`
- `ApproveQualityDashboardAccessModel`
- `ActivateQualityDashboardAccessModel`
- `SuspendQualityDashboardAccessModel`
- `CorrectQualityDashboardAccessModel`
- `RetireQualityDashboardAccessModel`

Reference Events:

- `QualityDashboardAccessModelCreated`
- `QualityDashboardAccessModelValidated`
- `QualityDashboardAccessModelApproved`
- `QualityDashboardAccessModelActivated`
- `QualityDashboardAccessModelSuspended`
- `QualityDashboardAccessModelCorrected`
- `QualityDashboardAccessModelRetired`

Reference queries:

- `GetQualityDashboardAccessModel`
- `ListQualityDashboardAccessModelRecords`
- `GetQualityDashboardAccessModelTimeline`
- `GetQualityDashboardAccessModelEvidence`
- `GetQualityDashboardAccessModelDecisionPackage`
- `GetQualityDashboardAccessModelExceptions`
- `GetQualityDashboardAccessModelAuditTrail`

Reference API surface:

```text
POST /api/v1/qualitydashboardaccessmodel/commands
GET  /api/v1/qualitydashboardaccessmodel/{id}
GET  /api/v1/qualitydashboardaccessmodel/{id}/timeline
GET  /api/v1/qualitydashboardaccessmodel/{id}/evidence
GET  /api/v1/qualitydashboardaccessmodel/{id}/decisions
POST /api/v1/qualitydashboardaccessmodel/{id}/exceptions
POST /api/v1/qualitydashboardaccessmodel/{id}/corrections
```
...
|---|---|
| `qualitydashboardaccessmodel_aggregate` | authoritative subject |
| `qualitydashboardaccessmodel_version` | immutable submitted, approved, issued, or signed versions |
| `qualitydashboardaccessmodel_relationship` | governed relationships |
| `qualitydashboardaccessmodel_decision` | binding Decisions and rationale |
| `qualitydashboardaccessmodel_evidence_link` | provenance and evidence relationships |
| `qualitydashboardaccessmodel_event_outbox` | transactional Event publication |
| `qualitydashboardaccessmodel_idempotency` | duplicate-write protection |
| `qualitydashboardaccessmodel_exception` | exception, claim, dispute, or hold |
| `qualitydashboardaccessmodel_correction` | correction and supersession lineage |
| `qualitydashboardaccessmodel_audit` | privileged action evidence |
