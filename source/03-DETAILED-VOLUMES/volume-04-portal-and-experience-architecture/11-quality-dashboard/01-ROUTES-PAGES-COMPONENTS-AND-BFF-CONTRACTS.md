# Quality Dashboard — Routes, Pages, Components, and BFF Contracts

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P11-01` |
| Subject | `QualityDashboardRouteRegistry` |
...
This chapter defines how GTOS shall **inventory routes, layouts, pages, components, server/client boundaries, BFFs, APIs, realtime channels and ownership for quality managers, inspectors and auditors, covering inspection plans, evidence, defects, nonconformance, release, corrective actions**.
...
|---|---|
| `QualityDashboardRouteRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardRouteRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardRouteRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardRouteRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `QualityDashboardRouteRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
QualityDashboardRouteRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateQualityDashboardRouteRegistry`
- `ValidateQualityDashboardRouteRegistry`
- `ApproveQualityDashboardRouteRegistry`
- `ActivateQualityDashboardRouteRegistry`
- `SuspendQualityDashboardRouteRegistry`
- `CorrectQualityDashboardRouteRegistry`
- `RetireQualityDashboardRouteRegistry`

Reference Events:

- `QualityDashboardRouteRegistryCreated`
- `QualityDashboardRouteRegistryValidated`
- `QualityDashboardRouteRegistryApproved`
- `QualityDashboardRouteRegistryActivated`
- `QualityDashboardRouteRegistrySuspended`
- `QualityDashboardRouteRegistryCorrected`
- `QualityDashboardRouteRegistryRetired`

Reference queries:

- `GetQualityDashboardRouteRegistry`
- `ListQualityDashboardRouteRegistryRecords`
- `GetQualityDashboardRouteRegistryTimeline`
- `GetQualityDashboardRouteRegistryEvidence`
- `GetQualityDashboardRouteRegistryDecisionPackage`
- `GetQualityDashboardRouteRegistryExceptions`
- `GetQualityDashboardRouteRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/qualitydashboardrouteregistry/commands
GET  /api/v1/qualitydashboardrouteregistry/{id}
GET  /api/v1/qualitydashboardrouteregistry/{id}/timeline
GET  /api/v1/qualitydashboardrouteregistry/{id}/evidence
GET  /api/v1/qualitydashboardrouteregistry/{id}/decisions
POST /api/v1/qualitydashboardrouteregistry/{id}/exceptions
POST /api/v1/qualitydashboardrouteregistry/{id}/corrections
```
...
|---|---|
| `qualitydashboardrouteregistry_aggregate` | authoritative subject |
| `qualitydashboardrouteregistry_version` | immutable submitted, approved, issued, or signed versions |
| `qualitydashboardrouteregistry_relationship` | governed relationships |
| `qualitydashboardrouteregistry_decision` | binding Decisions and rationale |
| `qualitydashboardrouteregistry_evidence_link` | provenance and evidence relationships |
| `qualitydashboardrouteregistry_event_outbox` | transactional Event publication |
| `qualitydashboardrouteregistry_idempotency` | duplicate-write protection |
| `qualitydashboardrouteregistry_exception` | exception, claim, dispute, or hold |
| `qualitydashboardrouteregistry_correction` | correction and supersession lineage |
| `qualitydashboardrouteregistry_audit` | privileged action evidence |
