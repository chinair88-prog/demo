# WhatsApp Admin — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P09-00` |
| Subject | `WhatsAppAdminPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for channel operators and support managers, covering templates, consent, conversation routing, provider state, human handoff, audit**.
...
|---|---|
| `WhatsAppAdminPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WhatsAppAdminPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWhatsAppAdminPortal`
- `ValidateWhatsAppAdminPortal`
- `ApproveWhatsAppAdminPortal`
- `ActivateWhatsAppAdminPortal`
- `SuspendWhatsAppAdminPortal`
- `CorrectWhatsAppAdminPortal`
- `RetireWhatsAppAdminPortal`

Reference Events:

- `WhatsAppAdminPortalCreated`
- `WhatsAppAdminPortalValidated`
- `WhatsAppAdminPortalApproved`
- `WhatsAppAdminPortalActivated`
- `WhatsAppAdminPortalSuspended`
- `WhatsAppAdminPortalCorrected`
- `WhatsAppAdminPortalRetired`

Reference queries:

- `GetWhatsAppAdminPortal`
- `ListWhatsAppAdminPortalRecords`
- `GetWhatsAppAdminPortalTimeline`
- `GetWhatsAppAdminPortalEvidence`
- `GetWhatsAppAdminPortalDecisionPackage`
- `GetWhatsAppAdminPortalExceptions`
- `GetWhatsAppAdminPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/whatsappadminportal/commands
GET  /api/v1/whatsappadminportal/{id}
GET  /api/v1/whatsappadminportal/{id}/timeline
GET  /api/v1/whatsappadminportal/{id}/evidence
GET  /api/v1/whatsappadminportal/{id}/decisions
POST /api/v1/whatsappadminportal/{id}/exceptions
POST /api/v1/whatsappadminportal/{id}/corrections
```
...
|---|---|
| `whatsappadminportal_aggregate` | authoritative subject |
| `whatsappadminportal_version` | immutable submitted, approved, issued, or signed versions |
| `whatsappadminportal_relationship` | governed relationships |
| `whatsappadminportal_decision` | binding Decisions and rationale |
| `whatsappadminportal_evidence_link` | provenance and evidence relationships |
| `whatsappadminportal_event_outbox` | transactional Event publication |
| `whatsappadminportal_idempotency` | duplicate-write protection |
| `whatsappadminportal_exception` | exception, claim, dispute, or hold |
| `whatsappadminportal_correction` | correction and supersession lineage |
| `whatsappadminportal_audit` | privileged action evidence |
