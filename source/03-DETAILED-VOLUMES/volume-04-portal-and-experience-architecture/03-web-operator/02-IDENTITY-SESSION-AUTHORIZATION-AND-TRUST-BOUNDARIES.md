# Web Operator — Identity, Session, Authorization, and Trust Boundaries

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P03-02` |
| Subject | `WebOperatorAccessModel` |
...
This chapter defines how GTOS shall **govern login, session, role, relationship, tenant, facility, channel, delegation, impersonation and privileged action for platform operators and support staff, covering exception management, reconciliation, workflow, service health, audit, correction**.
...
|---|---|
| `WebOperatorAccessModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorAccessModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorAccessModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorAccessModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorAccessModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WebOperatorAccessModel {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWebOperatorAccessModel`
- `ValidateWebOperatorAccessModel`
- `ApproveWebOperatorAccessModel`
- `ActivateWebOperatorAccessModel`
- `SuspendWebOperatorAccessModel`
- `CorrectWebOperatorAccessModel`
- `RetireWebOperatorAccessModel`

Reference Events:

- `WebOperatorAccessModelCreated`
- `WebOperatorAccessModelValidated`
- `WebOperatorAccessModelApproved`
- `WebOperatorAccessModelActivated`
- `WebOperatorAccessModelSuspended`
- `WebOperatorAccessModelCorrected`
- `WebOperatorAccessModelRetired`

Reference queries:

- `GetWebOperatorAccessModel`
- `ListWebOperatorAccessModelRecords`
- `GetWebOperatorAccessModelTimeline`
- `GetWebOperatorAccessModelEvidence`
- `GetWebOperatorAccessModelDecisionPackage`
- `GetWebOperatorAccessModelExceptions`
- `GetWebOperatorAccessModelAuditTrail`

Reference API surface:

```text
POST /api/v1/weboperatoraccessmodel/commands
GET  /api/v1/weboperatoraccessmodel/{id}
GET  /api/v1/weboperatoraccessmodel/{id}/timeline
GET  /api/v1/weboperatoraccessmodel/{id}/evidence
GET  /api/v1/weboperatoraccessmodel/{id}/decisions
POST /api/v1/weboperatoraccessmodel/{id}/exceptions
POST /api/v1/weboperatoraccessmodel/{id}/corrections
```
...
|---|---|
| `weboperatoraccessmodel_aggregate` | authoritative subject |
| `weboperatoraccessmodel_version` | immutable submitted, approved, issued, or signed versions |
| `weboperatoraccessmodel_relationship` | governed relationships |
| `weboperatoraccessmodel_decision` | binding Decisions and rationale |
| `weboperatoraccessmodel_evidence_link` | provenance and evidence relationships |
| `weboperatoraccessmodel_event_outbox` | transactional Event publication |
| `weboperatoraccessmodel_idempotency` | duplicate-write protection |
| `weboperatoraccessmodel_exception` | exception, claim, dispute, or hold |
| `weboperatoraccessmodel_correction` | correction and supersession lineage |
| `weboperatoraccessmodel_audit` | privileged action evidence |
