# Web Operator — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P03-00` |
| Subject | `WebOperatorPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for platform operators and support staff, covering exception management, reconciliation, workflow, service health, audit, correction**.
...
|---|---|
| `WebOperatorPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebOperatorPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWebOperatorPortal`
- `ValidateWebOperatorPortal`
- `ApproveWebOperatorPortal`
- `ActivateWebOperatorPortal`
- `SuspendWebOperatorPortal`
- `CorrectWebOperatorPortal`
- `RetireWebOperatorPortal`

Reference Events:

- `WebOperatorPortalCreated`
- `WebOperatorPortalValidated`
- `WebOperatorPortalApproved`
- `WebOperatorPortalActivated`
- `WebOperatorPortalSuspended`
- `WebOperatorPortalCorrected`
- `WebOperatorPortalRetired`

Reference queries:

- `GetWebOperatorPortal`
- `ListWebOperatorPortalRecords`
- `GetWebOperatorPortalTimeline`
- `GetWebOperatorPortalEvidence`
- `GetWebOperatorPortalDecisionPackage`
- `GetWebOperatorPortalExceptions`
- `GetWebOperatorPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/weboperatorportal/commands
GET  /api/v1/weboperatorportal/{id}
GET  /api/v1/weboperatorportal/{id}/timeline
GET  /api/v1/weboperatorportal/{id}/evidence
GET  /api/v1/weboperatorportal/{id}/decisions
POST /api/v1/weboperatorportal/{id}/exceptions
POST /api/v1/weboperatorportal/{id}/corrections
```
...
|---|---|
| `weboperatorportal_aggregate` | authoritative subject |
| `weboperatorportal_version` | immutable submitted, approved, issued, or signed versions |
| `weboperatorportal_relationship` | governed relationships |
| `weboperatorportal_decision` | binding Decisions and rationale |
| `weboperatorportal_evidence_link` | provenance and evidence relationships |
| `weboperatorportal_event_outbox` | transactional Event publication |
| `weboperatorportal_idempotency` | duplicate-write protection |
| `weboperatorportal_exception` | exception, claim, dispute, or hold |
| `weboperatorportal_correction` | correction and supersession lineage |
| `weboperatorportal_audit` | privileged action evidence |
