# ESG Dashboard — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P10-00` |
| Subject | `ESGDashboardPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for sustainability, compliance and executive users, covering ESG metrics, evidence, lineage, methodology, uncertainty, reporting**.
...
|---|---|
| `ESGDashboardPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateESGDashboardPortal`
- `ValidateESGDashboardPortal`
- `ApproveESGDashboardPortal`
- `ActivateESGDashboardPortal`
- `SuspendESGDashboardPortal`
- `CorrectESGDashboardPortal`
- `RetireESGDashboardPortal`

Reference Events:

- `ESGDashboardPortalCreated`
- `ESGDashboardPortalValidated`
- `ESGDashboardPortalApproved`
- `ESGDashboardPortalActivated`
- `ESGDashboardPortalSuspended`
- `ESGDashboardPortalCorrected`
- `ESGDashboardPortalRetired`

Reference queries:

- `GetESGDashboardPortal`
- `ListESGDashboardPortalRecords`
- `GetESGDashboardPortalTimeline`
- `GetESGDashboardPortalEvidence`
- `GetESGDashboardPortalDecisionPackage`
- `GetESGDashboardPortalExceptions`
- `GetESGDashboardPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/esgdashboardportal/commands
GET  /api/v1/esgdashboardportal/{id}
GET  /api/v1/esgdashboardportal/{id}/timeline
GET  /api/v1/esgdashboardportal/{id}/evidence
GET  /api/v1/esgdashboardportal/{id}/decisions
POST /api/v1/esgdashboardportal/{id}/exceptions
POST /api/v1/esgdashboardportal/{id}/corrections
```
...
|---|---|
| `esgdashboardportal_aggregate` | authoritative subject |
| `esgdashboardportal_version` | immutable submitted, approved, issued, or signed versions |
| `esgdashboardportal_relationship` | governed relationships |
| `esgdashboardportal_decision` | binding Decisions and rationale |
| `esgdashboardportal_evidence_link` | provenance and evidence relationships |
| `esgdashboardportal_event_outbox` | transactional Event publication |
| `esgdashboardportal_idempotency` | duplicate-write protection |
| `esgdashboardportal_exception` | exception, claim, dispute, or hold |
| `esgdashboardportal_correction` | correction and supersession lineage |
| `esgdashboardportal_audit` | privileged action evidence |
