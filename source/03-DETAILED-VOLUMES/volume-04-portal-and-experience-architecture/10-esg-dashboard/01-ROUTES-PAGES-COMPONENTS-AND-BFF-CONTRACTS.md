# ESG Dashboard — Routes, Pages, Components, and BFF Contracts

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P10-01` |
| Subject | `ESGDashboardRouteRegistry` |
...
This chapter defines how GTOS shall **inventory routes, layouts, pages, components, server/client boundaries, BFFs, APIs, realtime channels and ownership for sustainability, compliance and executive users, covering ESG metrics, evidence, lineage, methodology, uncertainty, reporting**.
...
|---|---|
| `ESGDashboardRouteRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardRouteRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardRouteRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardRouteRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `ESGDashboardRouteRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
ESGDashboardRouteRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateESGDashboardRouteRegistry`
- `ValidateESGDashboardRouteRegistry`
- `ApproveESGDashboardRouteRegistry`
- `ActivateESGDashboardRouteRegistry`
- `SuspendESGDashboardRouteRegistry`
- `CorrectESGDashboardRouteRegistry`
- `RetireESGDashboardRouteRegistry`

Reference Events:

- `ESGDashboardRouteRegistryCreated`
- `ESGDashboardRouteRegistryValidated`
- `ESGDashboardRouteRegistryApproved`
- `ESGDashboardRouteRegistryActivated`
- `ESGDashboardRouteRegistrySuspended`
- `ESGDashboardRouteRegistryCorrected`
- `ESGDashboardRouteRegistryRetired`

Reference queries:

- `GetESGDashboardRouteRegistry`
- `ListESGDashboardRouteRegistryRecords`
- `GetESGDashboardRouteRegistryTimeline`
- `GetESGDashboardRouteRegistryEvidence`
- `GetESGDashboardRouteRegistryDecisionPackage`
- `GetESGDashboardRouteRegistryExceptions`
- `GetESGDashboardRouteRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/esgdashboardrouteregistry/commands
GET  /api/v1/esgdashboardrouteregistry/{id}
GET  /api/v1/esgdashboardrouteregistry/{id}/timeline
GET  /api/v1/esgdashboardrouteregistry/{id}/evidence
GET  /api/v1/esgdashboardrouteregistry/{id}/decisions
POST /api/v1/esgdashboardrouteregistry/{id}/exceptions
POST /api/v1/esgdashboardrouteregistry/{id}/corrections
```
...
|---|---|
| `esgdashboardrouteregistry_aggregate` | authoritative subject |
| `esgdashboardrouteregistry_version` | immutable submitted, approved, issued, or signed versions |
| `esgdashboardrouteregistry_relationship` | governed relationships |
| `esgdashboardrouteregistry_decision` | binding Decisions and rationale |
| `esgdashboardrouteregistry_evidence_link` | provenance and evidence relationships |
| `esgdashboardrouteregistry_event_outbox` | transactional Event publication |
| `esgdashboardrouteregistry_idempotency` | duplicate-write protection |
| `esgdashboardrouteregistry_exception` | exception, claim, dispute, or hold |
| `esgdashboardrouteregistry_correction` | correction and supersession lineage |
| `esgdashboardrouteregistry_audit` | privileged action evidence |
