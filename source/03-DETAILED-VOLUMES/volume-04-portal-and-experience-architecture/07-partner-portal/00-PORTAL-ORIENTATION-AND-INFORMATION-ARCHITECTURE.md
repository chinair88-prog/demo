# Partner Portal — Portal Orientation and Information Architecture

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P07-00` |
| Subject | `PartnerPortalPortal` |
...
This chapter defines how GTOS shall **define personas, navigation, route ownership, domain dependencies and experience boundaries for suppliers, factories and commercial partners, covering profile, products, quotations, PI, PO, production, quality, documents, settlement**.
...
|---|---|
| `PartnerPortalPortal` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalPortalVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalPortalDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalPortalEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalPortalException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePartnerPortalPortal`
- `ValidatePartnerPortalPortal`
- `ApprovePartnerPortalPortal`
- `ActivatePartnerPortalPortal`
- `SuspendPartnerPortalPortal`
- `CorrectPartnerPortalPortal`
- `RetirePartnerPortalPortal`

Reference Events:

- `PartnerPortalPortalCreated`
- `PartnerPortalPortalValidated`
- `PartnerPortalPortalApproved`
- `PartnerPortalPortalActivated`
- `PartnerPortalPortalSuspended`
- `PartnerPortalPortalCorrected`
- `PartnerPortalPortalRetired`

Reference queries:

- `GetPartnerPortalPortal`
- `ListPartnerPortalPortalRecords`
- `GetPartnerPortalPortalTimeline`
- `GetPartnerPortalPortalEvidence`
- `GetPartnerPortalPortalDecisionPackage`
- `GetPartnerPortalPortalExceptions`
- `GetPartnerPortalPortalAuditTrail`

Reference API surface:

```text
POST /api/v1/partnerportalportal/commands
GET  /api/v1/partnerportalportal/{id}
GET  /api/v1/partnerportalportal/{id}/timeline
GET  /api/v1/partnerportalportal/{id}/evidence
GET  /api/v1/partnerportalportal/{id}/decisions
POST /api/v1/partnerportalportal/{id}/exceptions
POST /api/v1/partnerportalportal/{id}/corrections
```
...
|---|---|
| `partnerportalportal_aggregate` | authoritative subject |
| `partnerportalportal_version` | immutable submitted, approved, issued, or signed versions |
| `partnerportalportal_relationship` | governed relationships |
| `partnerportalportal_decision` | binding Decisions and rationale |
| `partnerportalportal_evidence_link` | provenance and evidence relationships |
| `partnerportalportal_event_outbox` | transactional Event publication |
| `partnerportalportal_idempotency` | duplicate-write protection |
| `partnerportalportal_exception` | exception, claim, dispute, or hold |
| `partnerportalportal_correction` | correction and supersession lineage |
| `partnerportalportal_audit` | privileged action evidence |
