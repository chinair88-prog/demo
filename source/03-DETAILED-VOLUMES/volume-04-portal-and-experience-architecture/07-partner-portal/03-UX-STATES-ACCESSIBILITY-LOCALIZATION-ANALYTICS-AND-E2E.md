# Partner Portal — UX States, Accessibility, Localization, Analytics, and E2E

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P07-03` |
| Subject | `PartnerPortalExperienceStandard` |
...
| Accountable owner | Portal Architecture / Partner Portal |
...
This chapter defines how GTOS shall **specify loading, empty, partial, stale, error, denied, offline, accessibility, RTL/LTR, analytics, audit and test journeys for suppliers, factories and commercial partners, covering profile, products, quotations, PI, PO, production, quality, documents, settlement**.
...
The accountable owner is **Portal Architecture / Partner Portal**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `PartnerPortalExperienceStandard` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalExperienceStandardVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalExperienceStandardDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalExperienceStandardEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalExperienceStandardException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PartnerPortalExperienceStandard {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePartnerPortalExperienceStandard`
- `ValidatePartnerPortalExperienceStandard`
- `ApprovePartnerPortalExperienceStandard`
- `ActivatePartnerPortalExperienceStandard`
- `SuspendPartnerPortalExperienceStandard`
- `CorrectPartnerPortalExperienceStandard`
- `RetirePartnerPortalExperienceStandard`

Reference Events:

- `PartnerPortalExperienceStandardCreated`
- `PartnerPortalExperienceStandardValidated`
- `PartnerPortalExperienceStandardApproved`
- `PartnerPortalExperienceStandardActivated`
- `PartnerPortalExperienceStandardSuspended`
- `PartnerPortalExperienceStandardCorrected`
- `PartnerPortalExperienceStandardRetired`

Reference queries:

- `GetPartnerPortalExperienceStandard`
- `ListPartnerPortalExperienceStandardRecords`
- `GetPartnerPortalExperienceStandardTimeline`
- `GetPartnerPortalExperienceStandardEvidence`
- `GetPartnerPortalExperienceStandardDecisionPackage`
- `GetPartnerPortalExperienceStandardExceptions`
- `GetPartnerPortalExperienceStandardAuditTrail`

Reference API surface:

```text
POST /api/v1/partnerportalexperiencestandard/commands
GET  /api/v1/partnerportalexperiencestandard/{id}
GET  /api/v1/partnerportalexperiencestandard/{id}/timeline
GET  /api/v1/partnerportalexperiencestandard/{id}/evidence
GET  /api/v1/partnerportalexperiencestandard/{id}/decisions
POST /api/v1/partnerportalexperiencestandard/{id}/exceptions
POST /api/v1/partnerportalexperiencestandard/{id}/corrections
```
...
|---|---|
| `partnerportalexperiencestandard_aggregate` | authoritative subject |
| `partnerportalexperiencestandard_version` | immutable submitted, approved, issued, or signed versions |
| `partnerportalexperiencestandard_relationship` | governed relationships |
| `partnerportalexperiencestandard_decision` | binding Decisions and rationale |
| `partnerportalexperiencestandard_evidence_link` | provenance and evidence relationships |
| `partnerportalexperiencestandard_event_outbox` | transactional Event publication |
| `partnerportalexperiencestandard_idempotency` | duplicate-write protection |
| `partnerportalexperiencestandard_exception` | exception, claim, dispute, or hold |
| `partnerportalexperiencestandard_correction` | correction and supersession lineage |
| `partnerportalexperiencestandard_audit` | privileged action evidence |
...
- Partner Portal: primary experience for suppliers, factories and commercial partners.
