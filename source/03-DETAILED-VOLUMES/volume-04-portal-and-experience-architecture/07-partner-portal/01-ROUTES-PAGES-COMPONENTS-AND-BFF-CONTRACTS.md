# Partner Portal — Routes, Pages, Components, and BFF Contracts

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P07-01` |
| Subject | `PartnerPortalRouteRegistry` |
...
This chapter defines how GTOS shall **inventory routes, layouts, pages, components, server/client boundaries, BFFs, APIs, realtime channels and ownership for suppliers, factories and commercial partners, covering profile, products, quotations, PI, PO, production, quality, documents, settlement**.
...
|---|---|
| `PartnerPortalRouteRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalRouteRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalRouteRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalRouteRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerPortalRouteRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PartnerPortalRouteRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePartnerPortalRouteRegistry`
- `ValidatePartnerPortalRouteRegistry`
- `ApprovePartnerPortalRouteRegistry`
- `ActivatePartnerPortalRouteRegistry`
- `SuspendPartnerPortalRouteRegistry`
- `CorrectPartnerPortalRouteRegistry`
- `RetirePartnerPortalRouteRegistry`

Reference Events:

- `PartnerPortalRouteRegistryCreated`
- `PartnerPortalRouteRegistryValidated`
- `PartnerPortalRouteRegistryApproved`
- `PartnerPortalRouteRegistryActivated`
- `PartnerPortalRouteRegistrySuspended`
- `PartnerPortalRouteRegistryCorrected`
- `PartnerPortalRouteRegistryRetired`

Reference queries:

- `GetPartnerPortalRouteRegistry`
- `ListPartnerPortalRouteRegistryRecords`
- `GetPartnerPortalRouteRegistryTimeline`
- `GetPartnerPortalRouteRegistryEvidence`
- `GetPartnerPortalRouteRegistryDecisionPackage`
- `GetPartnerPortalRouteRegistryExceptions`
- `GetPartnerPortalRouteRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/partnerportalrouteregistry/commands
GET  /api/v1/partnerportalrouteregistry/{id}
GET  /api/v1/partnerportalrouteregistry/{id}/timeline
GET  /api/v1/partnerportalrouteregistry/{id}/evidence
GET  /api/v1/partnerportalrouteregistry/{id}/decisions
POST /api/v1/partnerportalrouteregistry/{id}/exceptions
POST /api/v1/partnerportalrouteregistry/{id}/corrections
```
...
|---|---|
| `partnerportalrouteregistry_aggregate` | authoritative subject |
| `partnerportalrouteregistry_version` | immutable submitted, approved, issued, or signed versions |
| `partnerportalrouteregistry_relationship` | governed relationships |
| `partnerportalrouteregistry_decision` | binding Decisions and rationale |
| `partnerportalrouteregistry_evidence_link` | provenance and evidence relationships |
| `partnerportalrouteregistry_event_outbox` | transactional Event publication |
| `partnerportalrouteregistry_idempotency` | duplicate-write protection |
| `partnerportalrouteregistry_exception` | exception, claim, dispute, or hold |
| `partnerportalrouteregistry_correction` | correction and supersession lineage |
| `partnerportalrouteregistry_audit` | privileged action evidence |
