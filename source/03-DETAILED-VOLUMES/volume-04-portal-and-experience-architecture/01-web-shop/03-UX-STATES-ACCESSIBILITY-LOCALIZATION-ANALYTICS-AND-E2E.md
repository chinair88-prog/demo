# Web Shop — UX States, Accessibility, Localization, Analytics, and E2E

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P01-03` |
| Subject | `WebShopExperienceStandard` |
...
| Accountable owner | Portal Architecture / Web Shop |
...
This chapter defines how GTOS shall **specify loading, empty, partial, stale, error, denied, offline, accessibility, RTL/LTR, analytics, audit and test journeys for customers and anonymous shoppers, covering catalog, marketplace, pricing, cart, checkout, order, payment, delivery, returns**.
...
The accountable owner is **Portal Architecture / Web Shop**. Supporting applications, shared infrastructure, integration adapters, analytics, and AI coordinate or present the capability but shall not silently own its authoritative propositions.
...
|---|---|
| `WebShopExperienceStandard` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopExperienceStandardVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopExperienceStandardDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopExperienceStandardEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopExperienceStandardException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WebShopExperienceStandard {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWebShopExperienceStandard`
- `ValidateWebShopExperienceStandard`
- `ApproveWebShopExperienceStandard`
- `ActivateWebShopExperienceStandard`
- `SuspendWebShopExperienceStandard`
- `CorrectWebShopExperienceStandard`
- `RetireWebShopExperienceStandard`

Reference Events:

- `WebShopExperienceStandardCreated`
- `WebShopExperienceStandardValidated`
- `WebShopExperienceStandardApproved`
- `WebShopExperienceStandardActivated`
- `WebShopExperienceStandardSuspended`
- `WebShopExperienceStandardCorrected`
- `WebShopExperienceStandardRetired`

Reference queries:

- `GetWebShopExperienceStandard`
- `ListWebShopExperienceStandardRecords`
- `GetWebShopExperienceStandardTimeline`
- `GetWebShopExperienceStandardEvidence`
- `GetWebShopExperienceStandardDecisionPackage`
- `GetWebShopExperienceStandardExceptions`
- `GetWebShopExperienceStandardAuditTrail`

Reference API surface:

```text
POST /api/v1/webshopexperiencestandard/commands
GET  /api/v1/webshopexperiencestandard/{id}
GET  /api/v1/webshopexperiencestandard/{id}/timeline
GET  /api/v1/webshopexperiencestandard/{id}/evidence
GET  /api/v1/webshopexperiencestandard/{id}/decisions
POST /api/v1/webshopexperiencestandard/{id}/exceptions
POST /api/v1/webshopexperiencestandard/{id}/corrections
```
...
|---|---|
| `webshopexperiencestandard_aggregate` | authoritative subject |
| `webshopexperiencestandard_version` | immutable submitted, approved, issued, or signed versions |
| `webshopexperiencestandard_relationship` | governed relationships |
| `webshopexperiencestandard_decision` | binding Decisions and rationale |
| `webshopexperiencestandard_evidence_link` | provenance and evidence relationships |
| `webshopexperiencestandard_event_outbox` | transactional Event publication |
| `webshopexperiencestandard_idempotency` | duplicate-write protection |
| `webshopexperiencestandard_exception` | exception, claim, dispute, or hold |
| `webshopexperiencestandard_correction` | correction and supersession lineage |
| `webshopexperiencestandard_audit` | privileged action evidence |
...
- Web Shop: primary experience for customers and anonymous shoppers.
