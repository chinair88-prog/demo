# Web Shop — Routes, Pages, Components, and BFF Contracts

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P01-01` |
| Subject | `WebShopRouteRegistry` |
...
This chapter defines how GTOS shall **inventory routes, layouts, pages, components, server/client boundaries, BFFs, APIs, realtime channels and ownership for customers and anonymous shoppers, covering catalog, marketplace, pricing, cart, checkout, order, payment, delivery, returns**.
...
|---|---|
| `WebShopRouteRegistry` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopRouteRegistryVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopRouteRegistryDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopRouteRegistryEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopRouteRegistryException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
WebShopRouteRegistry {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateWebShopRouteRegistry`
- `ValidateWebShopRouteRegistry`
- `ApproveWebShopRouteRegistry`
- `ActivateWebShopRouteRegistry`
- `SuspendWebShopRouteRegistry`
- `CorrectWebShopRouteRegistry`
- `RetireWebShopRouteRegistry`

Reference Events:

- `WebShopRouteRegistryCreated`
- `WebShopRouteRegistryValidated`
- `WebShopRouteRegistryApproved`
- `WebShopRouteRegistryActivated`
- `WebShopRouteRegistrySuspended`
- `WebShopRouteRegistryCorrected`
- `WebShopRouteRegistryRetired`

Reference queries:

- `GetWebShopRouteRegistry`
- `ListWebShopRouteRegistryRecords`
- `GetWebShopRouteRegistryTimeline`
- `GetWebShopRouteRegistryEvidence`
- `GetWebShopRouteRegistryDecisionPackage`
- `GetWebShopRouteRegistryExceptions`
- `GetWebShopRouteRegistryAuditTrail`

Reference API surface:

```text
POST /api/v1/webshoprouteregistry/commands
GET  /api/v1/webshoprouteregistry/{id}
GET  /api/v1/webshoprouteregistry/{id}/timeline
GET  /api/v1/webshoprouteregistry/{id}/evidence
GET  /api/v1/webshoprouteregistry/{id}/decisions
POST /api/v1/webshoprouteregistry/{id}/exceptions
POST /api/v1/webshoprouteregistry/{id}/corrections
```
...
|---|---|
| `webshoprouteregistry_aggregate` | authoritative subject |
| `webshoprouteregistry_version` | immutable submitted, approved, issued, or signed versions |
| `webshoprouteregistry_relationship` | governed relationships |
| `webshoprouteregistry_decision` | binding Decisions and rationale |
| `webshoprouteregistry_evidence_link` | provenance and evidence relationships |
| `webshoprouteregistry_event_outbox` | transactional Event publication |
| `webshoprouteregistry_idempotency` | duplicate-write protection |
| `webshoprouteregistry_exception` | exception, claim, dispute, or hold |
| `webshoprouteregistry_correction` | correction and supersession lineage |
| `webshoprouteregistry_audit` | privileged action evidence |
