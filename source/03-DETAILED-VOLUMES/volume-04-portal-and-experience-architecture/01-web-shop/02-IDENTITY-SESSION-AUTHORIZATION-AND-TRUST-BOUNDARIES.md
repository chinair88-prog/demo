# Web Shop — Identity, Session, Authorization, and Trust Boundaries

| Metadata | Value |
|---|---|
| Volume | `4` |
| Chapter ID | `V04-P01-02` |
| Subject | `WebShopAccessModel` |
...
This chapter defines how GTOS shall **govern login, session, role, relationship, tenant, facility, channel, delegation, impersonation and privileged action for customers and anonymous shoppers, covering catalog, marketplace, pricing, cart, checkout, order, payment, delivery, returns**.
...
|---|---|
| `WebShopAccessModel` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopAccessModelVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopAccessModelDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopAccessModelEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `WebShopAccessModelException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateWebShopAccessModel`
- `ValidateWebShopAccessModel`
- `ApproveWebShopAccessModel`
- `ActivateWebShopAccessModel`
- `SuspendWebShopAccessModel`
- `CorrectWebShopAccessModel`
- `RetireWebShopAccessModel`

Reference Events:

- `WebShopAccessModelCreated`
- `WebShopAccessModelValidated`
- `WebShopAccessModelApproved`
- `WebShopAccessModelActivated`
- `WebShopAccessModelSuspended`
- `WebShopAccessModelCorrected`
- `WebShopAccessModelRetired`

Reference queries:

- `GetWebShopAccessModel`
- `ListWebShopAccessModelRecords`
- `GetWebShopAccessModelTimeline`
- `GetWebShopAccessModelEvidence`
- `GetWebShopAccessModelDecisionPackage`
- `GetWebShopAccessModelExceptions`
- `GetWebShopAccessModelAuditTrail`

Reference API surface:

```text
POST /api/v1/webshopaccessmodel/commands
GET  /api/v1/webshopaccessmodel/{id}
GET  /api/v1/webshopaccessmodel/{id}/timeline
GET  /api/v1/webshopaccessmodel/{id}/evidence
GET  /api/v1/webshopaccessmodel/{id}/decisions
POST /api/v1/webshopaccessmodel/{id}/exceptions
POST /api/v1/webshopaccessmodel/{id}/corrections
```
...
|---|---|
| `webshopaccessmodel_aggregate` | authoritative subject |
| `webshopaccessmodel_version` | immutable submitted, approved, issued, or signed versions |
| `webshopaccessmodel_relationship` | governed relationships |
| `webshopaccessmodel_decision` | binding Decisions and rationale |
| `webshopaccessmodel_evidence_link` | provenance and evidence relationships |
| `webshopaccessmodel_event_outbox` | transactional Event publication |
| `webshopaccessmodel_idempotency` | duplicate-write protection |
| `webshopaccessmodel_exception` | exception, claim, dispute, or hold |
| `webshopaccessmodel_correction` | correction and supersession lineage |
| `webshopaccessmodel_audit` | privileged action evidence |
