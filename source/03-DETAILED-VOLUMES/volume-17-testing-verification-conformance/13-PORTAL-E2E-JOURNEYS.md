...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Portal E2E Journeys**.
...
|---|---|
| `PortalE2EJourneys` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalE2EJourneysVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalE2EJourneysDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalE2EJourneysEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PortalE2EJourneysException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreatePortalE2EJourneys`
- `ValidatePortalE2EJourneys`
- `ApprovePortalE2EJourneys`
- `ActivatePortalE2EJourneys`
- `SuspendPortalE2EJourneys`
- `CorrectPortalE2EJourneys`
- `RetirePortalE2EJourneys`

Reference Events:

- `PortalE2EJourneysCreated`
- `PortalE2EJourneysValidated`
- `PortalE2EJourneysApproved`
- `PortalE2EJourneysActivated`
- `PortalE2EJourneysSuspended`
- `PortalE2EJourneysCorrected`
- `PortalE2EJourneysRetired`

Reference queries:

- `GetPortalE2EJourneys`
- `ListPortalE2EJourneysRecords`
- `GetPortalE2EJourneysTimeline`
- `GetPortalE2EJourneysEvidence`
- `GetPortalE2EJourneysDecisionPackage`
- `GetPortalE2EJourneysExceptions`
- `GetPortalE2EJourneysAuditTrail`

Reference API surface:

```text
POST /api/v1/portale2ejourneys/commands
GET  /api/v1/portale2ejourneys/{id}
GET  /api/v1/portale2ejourneys/{id}/timeline
GET  /api/v1/portale2ejourneys/{id}/evidence
GET  /api/v1/portale2ejourneys/{id}/decisions
POST /api/v1/portale2ejourneys/{id}/exceptions
POST /api/v1/portale2ejourneys/{id}/corrections
```
...
|---|---|
| `portale2ejourneys_aggregate` | authoritative subject |
| `portale2ejourneys_version` | immutable submitted, approved, issued, or signed versions |
| `portale2ejourneys_relationship` | governed relationships |
| `portale2ejourneys_decision` | binding Decisions and rationale |
| `portale2ejourneys_evidence_link` | provenance and evidence relationships |
| `portale2ejourneys_event_outbox` | transactional Event publication |
| `portale2ejourneys_idempotency` | duplicate-write protection |
| `portale2ejourneys_exception` | exception, claim, dispute, or hold |
| `portale2ejourneys_correction` | correction and supersession lineage |
| `portale2ejourneys_audit` | privileged action evidence |
...
- `Portal E2E Journeys` is part of the target GTOS handbook scope.
