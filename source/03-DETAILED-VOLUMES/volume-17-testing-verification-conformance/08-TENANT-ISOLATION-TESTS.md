...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Tenant Isolation Tests**.
...
|---|---|
| `TenantIsolationTests` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TenantIsolationTestsVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TenantIsolationTestsDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TenantIsolationTestsEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TenantIsolationTestsException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateTenantIsolationTests`
- `ValidateTenantIsolationTests`
- `ApproveTenantIsolationTests`
- `ActivateTenantIsolationTests`
- `SuspendTenantIsolationTests`
- `CorrectTenantIsolationTests`
- `RetireTenantIsolationTests`

Reference Events:

- `TenantIsolationTestsCreated`
- `TenantIsolationTestsValidated`
- `TenantIsolationTestsApproved`
- `TenantIsolationTestsActivated`
- `TenantIsolationTestsSuspended`
- `TenantIsolationTestsCorrected`
- `TenantIsolationTestsRetired`

Reference queries:

- `GetTenantIsolationTests`
- `ListTenantIsolationTestsRecords`
- `GetTenantIsolationTestsTimeline`
- `GetTenantIsolationTestsEvidence`
- `GetTenantIsolationTestsDecisionPackage`
- `GetTenantIsolationTestsExceptions`
- `GetTenantIsolationTestsAuditTrail`

Reference API surface:

```text
POST /api/v1/tenantisolationtests/commands
GET  /api/v1/tenantisolationtests/{id}
GET  /api/v1/tenantisolationtests/{id}/timeline
GET  /api/v1/tenantisolationtests/{id}/evidence
GET  /api/v1/tenantisolationtests/{id}/decisions
POST /api/v1/tenantisolationtests/{id}/exceptions
POST /api/v1/tenantisolationtests/{id}/corrections
```
...
|---|---|
| `tenantisolationtests_aggregate` | authoritative subject |
| `tenantisolationtests_version` | immutable submitted, approved, issued, or signed versions |
| `tenantisolationtests_relationship` | governed relationships |
| `tenantisolationtests_decision` | binding Decisions and rationale |
| `tenantisolationtests_evidence_link` | provenance and evidence relationships |
| `tenantisolationtests_event_outbox` | transactional Event publication |
| `tenantisolationtests_idempotency` | duplicate-write protection |
| `tenantisolationtests_exception` | exception, claim, dispute, or hold |
| `tenantisolationtests_correction` | correction and supersession lineage |
| `tenantisolationtests_audit` | privileged action evidence |
...
- `Tenant Isolation Tests` is part of the target GTOS handbook scope.
