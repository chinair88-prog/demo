...
| Volume | `17` |
| Chapter ID | `V17-17` |
| Subject | `DisasterRecoveryExercises` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Disaster Recovery Exercises**.
...
|---|---|
| `DisasterRecoveryExercises` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryExercisesVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryExercisesDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryExercisesEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `DisasterRecoveryExercisesException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
DisasterRecoveryExercises {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreateDisasterRecoveryExercises`
- `ValidateDisasterRecoveryExercises`
- `ApproveDisasterRecoveryExercises`
- `ActivateDisasterRecoveryExercises`
- `SuspendDisasterRecoveryExercises`
- `CorrectDisasterRecoveryExercises`
- `RetireDisasterRecoveryExercises`

Reference Events:

- `DisasterRecoveryExercisesCreated`
- `DisasterRecoveryExercisesValidated`
- `DisasterRecoveryExercisesApproved`
- `DisasterRecoveryExercisesActivated`
- `DisasterRecoveryExercisesSuspended`
- `DisasterRecoveryExercisesCorrected`
- `DisasterRecoveryExercisesRetired`

Reference queries:

- `GetDisasterRecoveryExercises`
- `ListDisasterRecoveryExercisesRecords`
- `GetDisasterRecoveryExercisesTimeline`
- `GetDisasterRecoveryExercisesEvidence`
- `GetDisasterRecoveryExercisesDecisionPackage`
- `GetDisasterRecoveryExercisesExceptions`
- `GetDisasterRecoveryExercisesAuditTrail`

Reference API surface:

```text
POST /api/v1/disasterrecoveryexercises/commands
GET  /api/v1/disasterrecoveryexercises/{id}
GET  /api/v1/disasterrecoveryexercises/{id}/timeline
GET  /api/v1/disasterrecoveryexercises/{id}/evidence
GET  /api/v1/disasterrecoveryexercises/{id}/decisions
POST /api/v1/disasterrecoveryexercises/{id}/exceptions
POST /api/v1/disasterrecoveryexercises/{id}/corrections
```
...
|---|---|
| `disasterrecoveryexercises_aggregate` | authoritative subject |
| `disasterrecoveryexercises_version` | immutable submitted, approved, issued, or signed versions |
| `disasterrecoveryexercises_relationship` | governed relationships |
| `disasterrecoveryexercises_decision` | binding Decisions and rationale |
| `disasterrecoveryexercises_evidence_link` | provenance and evidence relationships |
| `disasterrecoveryexercises_event_outbox` | transactional Event publication |
| `disasterrecoveryexercises_idempotency` | duplicate-write protection |
| `disasterrecoveryexercises_exception` | exception, claim, dispute, or hold |
| `disasterrecoveryexercises_correction` | correction and supersession lineage |
| `disasterrecoveryexercises_audit` | privileged action evidence |
...
- `Disaster Recovery Exercises` is part of the target GTOS handbook scope.
