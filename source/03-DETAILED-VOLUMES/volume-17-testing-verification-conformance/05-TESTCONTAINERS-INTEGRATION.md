...
| Volume | `17` |
| Chapter ID | `V17-05` |
| Subject | `TestcontainersIntegration` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Testcontainers Integration**.
...
|---|---|
| `TestcontainersIntegration` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestcontainersIntegrationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestcontainersIntegrationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestcontainersIntegrationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `TestcontainersIntegrationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `CreateTestcontainersIntegration`
- `ValidateTestcontainersIntegration`
- `ApproveTestcontainersIntegration`
- `ActivateTestcontainersIntegration`
- `SuspendTestcontainersIntegration`
- `CorrectTestcontainersIntegration`
- `RetireTestcontainersIntegration`

Reference Events:

- `TestcontainersIntegrationCreated`
- `TestcontainersIntegrationValidated`
- `TestcontainersIntegrationApproved`
- `TestcontainersIntegrationActivated`
- `TestcontainersIntegrationSuspended`
- `TestcontainersIntegrationCorrected`
- `TestcontainersIntegrationRetired`

Reference queries:

- `GetTestcontainersIntegration`
- `ListTestcontainersIntegrationRecords`
- `GetTestcontainersIntegrationTimeline`
- `GetTestcontainersIntegrationEvidence`
- `GetTestcontainersIntegrationDecisionPackage`
- `GetTestcontainersIntegrationExceptions`
- `GetTestcontainersIntegrationAuditTrail`

Reference API surface:

```text
POST /api/v1/testcontainersintegration/commands
GET  /api/v1/testcontainersintegration/{id}
GET  /api/v1/testcontainersintegration/{id}/timeline
GET  /api/v1/testcontainersintegration/{id}/evidence
GET  /api/v1/testcontainersintegration/{id}/decisions
POST /api/v1/testcontainersintegration/{id}/exceptions
POST /api/v1/testcontainersintegration/{id}/corrections
```
...
|---|---|
| `testcontainersintegration_aggregate` | authoritative subject |
| `testcontainersintegration_version` | immutable submitted, approved, issued, or signed versions |
| `testcontainersintegration_relationship` | governed relationships |
| `testcontainersintegration_decision` | binding Decisions and rationale |
| `testcontainersintegration_evidence_link` | provenance and evidence relationships |
| `testcontainersintegration_event_outbox` | transactional Event publication |
| `testcontainersintegration_idempotency` | duplicate-write protection |
| `testcontainersintegration_exception` | exception, claim, dispute, or hold |
| `testcontainersintegration_correction` | correction and supersession lineage |
| `testcontainersintegration_audit` | privileged action evidence |
...
- `Testcontainers Integration` is part of the target GTOS handbook scope.
