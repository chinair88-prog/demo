...
| Volume | `17` |
| Chapter ID | `V17-15` |
| Subject | `PerformanceandCapacityTesting` |
...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Performance and Capacity Testing**.
...
|---|---|
| `PerformanceandCapacityTesting` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PerformanceandCapacityTestingVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PerformanceandCapacityTestingDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PerformanceandCapacityTestingEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PerformanceandCapacityTestingException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |

Reference aggregate:

```text
PerformanceandCapacityTesting {
  subjectId
  tenantId
  organizationContext
  sourceIdentityRefs[]
...
- `CreatePerformanceandCapacityTesting`
- `ValidatePerformanceandCapacityTesting`
- `ApprovePerformanceandCapacityTesting`
- `ActivatePerformanceandCapacityTesting`
- `SuspendPerformanceandCapacityTesting`
- `CorrectPerformanceandCapacityTesting`
- `RetirePerformanceandCapacityTesting`

Reference Events:

- `PerformanceandCapacityTestingCreated`
- `PerformanceandCapacityTestingValidated`
- `PerformanceandCapacityTestingApproved`
- `PerformanceandCapacityTestingActivated`
- `PerformanceandCapacityTestingSuspended`
- `PerformanceandCapacityTestingCorrected`
- `PerformanceandCapacityTestingRetired`

Reference queries:

- `GetPerformanceandCapacityTesting`
- `ListPerformanceandCapacityTestingRecords`
- `GetPerformanceandCapacityTestingTimeline`
- `GetPerformanceandCapacityTestingEvidence`
- `GetPerformanceandCapacityTestingDecisionPackage`
- `GetPerformanceandCapacityTestingExceptions`
- `GetPerformanceandCapacityTestingAuditTrail`

Reference API surface:

```text
POST /api/v1/performanceandcapacitytesting/commands
GET  /api/v1/performanceandcapacitytesting/{id}
GET  /api/v1/performanceandcapacitytesting/{id}/timeline
GET  /api/v1/performanceandcapacitytesting/{id}/evidence
GET  /api/v1/performanceandcapacitytesting/{id}/decisions
POST /api/v1/performanceandcapacitytesting/{id}/exceptions
POST /api/v1/performanceandcapacitytesting/{id}/corrections
```
...
|---|---|
| `performanceandcapacitytesting_aggregate` | authoritative subject |
| `performanceandcapacitytesting_version` | immutable submitted, approved, issued, or signed versions |
| `performanceandcapacitytesting_relationship` | governed relationships |
| `performanceandcapacitytesting_decision` | binding Decisions and rationale |
| `performanceandcapacitytesting_evidence_link` | provenance and evidence relationships |
| `performanceandcapacitytesting_event_outbox` | transactional Event publication |
| `performanceandcapacitytesting_idempotency` | duplicate-write protection |
| `performanceandcapacitytesting_exception` | exception, claim, dispute, or hold |
| `performanceandcapacitytesting_correction` | correction and supersession lineage |
| `performanceandcapacitytesting_audit` | privileged action evidence |
...
- `Performance and Capacity Testing` is part of the target GTOS handbook scope.
