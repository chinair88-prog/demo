...
This chapter defines how GTOS shall **define the target architecture, implementation standard, evidence, security, reliability, operations, tests, migration and conformance requirements for Partner Certification**.
...
|---|---|
| `PartnerCertification` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerCertificationVersion` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerCertificationDecision` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerCertificationEvidenceSet` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
| `PartnerCertificationException` | Independent identified subject, governed subordinate entity, or qualified perspective; ownership must be explicit |
...
- `ValidatePartnerCertification`
- `ApprovePartnerCertification`
- `ActivatePartnerCertification`
- `SuspendPartnerCertification`
- `CorrectPartnerCertification`
- `RetirePartnerCertification`

Reference Events:

- `PartnerCertificationCreated`
- `PartnerCertificationValidated`
- `PartnerCertificationApproved`
- `PartnerCertificationActivated`
- `PartnerCertificationSuspended`
- `PartnerCertificationCorrected`
- `PartnerCertificationRetired`

Reference queries:

- `GetPartnerCertification`
- `ListPartnerCertificationRecords`
- `GetPartnerCertificationTimeline`
- `GetPartnerCertificationEvidence`
- `GetPartnerCertificationDecisionPackage`
- `GetPartnerCertificationExceptions`
- `GetPartnerCertificationAuditTrail`

Reference API surface:

```text
POST /api/v1/partnercertification/commands
GET  /api/v1/partnercertification/{id}
GET  /api/v1/partnercertification/{id}/timeline
GET  /api/v1/partnercertification/{id}/evidence
GET  /api/v1/partnercertification/{id}/decisions
POST /api/v1/partnercertification/{id}/exceptions
POST /api/v1/partnercertification/{id}/corrections
```
...
|---|---|
| `partnercertification_aggregate` | authoritative subject |
| `partnercertification_version` | immutable submitted, approved, issued, or signed versions |
| `partnercertification_relationship` | governed relationships |
| `partnercertification_decision` | binding Decisions and rationale |
| `partnercertification_evidence_link` | provenance and evidence relationships |
| `partnercertification_event_outbox` | transactional Event publication |
| `partnercertification_idempotency` | duplicate-write protection |
| `partnercertification_exception` | exception, claim, dispute, or hold |
| `partnercertification_correction` | correction and supersession lineage |
| `partnercertification_audit` | privileged action evidence |
...
- `Partner Certification` is part of the target GTOS handbook scope.
