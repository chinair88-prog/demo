...
Align stakeholders on the GTOS Reference Theory, Canon, Constitution, terminology, and conformance model.
...
- **STOP:** Domain terms conflict with Canon.
- **STOP:** Authority remains implicit.
- **STOP:** Event and Command semantics are mixed.
