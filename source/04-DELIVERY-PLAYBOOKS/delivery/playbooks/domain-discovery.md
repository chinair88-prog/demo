# Playbook — Domain Discovery

## Purpose

Turn interviews, existing systems, regulations, and process maps into a bounded domain model.
...
1. Collect business language and examples.
2. Identify authoritative propositions.
3. Map state and lifecycle.
4. Identify decisions and policies.
5. Separate current workaround from required business law.
