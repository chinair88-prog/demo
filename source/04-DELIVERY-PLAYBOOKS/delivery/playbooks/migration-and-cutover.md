# Playbook — Migration and Cutover

## Purpose

Move meaning, history, consumers, and operations safely to a new implementation.
...
1. Map source and target semantics.
2. Preserve identity and time.
3. Run dual-read or controlled dual-write.
4. Reconcile propositions.
5. Stage consumers.
