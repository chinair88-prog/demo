# Stage 2 — Business and Domain Design

## Objective

Define capabilities, value streams, domain boundaries, truth owners, decisions, policies, and service outcomes.
...
- **STOP:** Shared database drives boundaries.
- **STOP:** No owner for critical propositions.
- **STOP:** Capabilities lack outcome measures.
